...
import 'package:obp_dart/src/model/create_user_invitation_request.dart';
import 'package:obp_dart/src/model/get_user_invitation_anonymous_request.dart';
import 'package:obp_dart/src/model/get_user_invitations200_response.dart';
...
class UserInvitationApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetUserInvitations200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetUserInvitations200Response>> createUserInvitation({ 
    required String bankid,
    required CreateUserInvitationRequest createUserInvitationRequest,
    ...
    try {
      const _type = FullType(CreateUserInvitationRequest);
      _bodyData = _serializers.serialize(createUserInvitationRequest, specifiedType: _type);
    ...
    GetUserInvitations200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetUserInvitations200Response),
      ) as GetUserInvitations200Response;
    ...
    return Response<GetUserInvitations200Response>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [GetUserInvitations200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetUserInvitations200Response>> getUserInvitation({ 
    required String bankid,
  ...
  /// Returns a [Future] containing a [Response] with a [GetUserInvitations200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetUserInvitations200Response>> getUserInvitationAnonymous({ 
    required String bankid,
    required GetUserInvitationAnonymousRequest getUserInvitationAnonymousRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(GetUserInvitationAnonymousRequest);
      _bodyData = _serializers.serialize(getUserInvitationAnonymousRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [GetUserInvitations200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetUserInvitations200Response>> getUserInvitations({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
