...
import 'package:obp_dart/src/model/get_all_entitlements200_response.dart';
...
import 'package:obp_dart/src/model/get_roles_with_entitlement_counts_at_all_banks200_response.dart';
...
class EntitlementApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetAllEntitlements200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetAllEntitlements200Response>> getAllEntitlements({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetAllEntitlements200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAllEntitlements200Response),
      ) as GetAllEntitlements200Response;
    ...
    return Response<GetAllEntitlements200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetRolesWithEntitlementCountsAtAllBanks200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetRolesWithEntitlementCountsAtAllBanks200Response>> getRolesWithEntitlementCountsAtAllBanks({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetRolesWithEntitlementCountsAtAllBanks200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetRolesWithEntitlementCountsAtAllBanks200Response),
      ) as GetRolesWithEntitlementCountsAtAllBanks200Response;
    ...
    return Response<GetRolesWithEntitlementCountsAtAllBanks200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
