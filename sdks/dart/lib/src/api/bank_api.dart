...
import 'package:obp_dart/src/model/create_account_webhook_request.dart';
import 'package:obp_dart/src/model/create_bank_account_notification_webhook200_response.dart';
import 'package:obp_dart/src/model/create_bank_request.dart';
import 'package:obp_dart/src/model/create_or_update_transaction_request_attribute_definition_request.dart';
import 'package:obp_dart/src/model/create_settlement_account200_response.dart';
import 'package:obp_dart/src/model/create_settlement_account_request.dart';
import 'package:obp_dart/src/model/create_system_account_notification_webhook200_response.dart';
import 'package:obp_dart/src/model/create_system_account_notification_webhook_request.dart';
import 'package:obp_dart/src/model/create_transaction_type200_response.dart';
import 'package:obp_dart/src/model/enable_disable_account_webhook200_response.dart';
import 'package:obp_dart/src/model/enable_disable_account_webhook_request.dart';
import 'package:obp_dart/src/model/get_account_webhooks200_response.dart';
import 'package:obp_dart/src/model/get_bank200_response.dart';
import 'package:obp_dart/src/model/get_bank_attributes200_response.dart';
...
import 'package:obp_dart/src/model/update_bank200_response.dart';
import 'package:obp_dart/src/model/update_bank_request.dart';
...
class BankApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [EnableDisableAccountWebhook200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EnableDisableAccountWebhook200Response>> createAccountWebhook({ 
    required String bankid,
    required CreateAccountWebhookRequest createAccountWebhookRequest,
    ...
    try {
      const _type = FullType(CreateAccountWebhookRequest);
      _bodyData = _serializers.serialize(createAccountWebhookRequest, specifiedType: _type);
    ...
    EnableDisableAccountWebhook200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EnableDisableAccountWebhook200Response),
      ) as EnableDisableAccountWebhook200Response;
    ...
    return Response<EnableDisableAccountWebhook200Response>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetBank200Response>> createBank({ 
    required CreateBankRequest createBankRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateBankRequest);
      _bodyData = _serializers.serialize(createBankRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateBankAccountNotificationWebhook200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateBankAccountNotificationWebhook200Response>> createBankAccountNotificationWebhook({ 
    required String bankid,
    required CreateSystemAccountNotificationWebhookRequest createSystemAccountNotificationWebhookRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateSystemAccountNotificationWebhookRequest);
      _bodyData = _serializers.serialize(createSystemAccountNotificationWebhookRequest, specifiedType: _type);
    ...
    CreateBankAccountNotificationWebhook200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateBankAccountNotificationWebhook200Response),
      ) as CreateBankAccountNotificationWebhook200Response;
    ...
    return Response<CreateBankAccountNotificationWebhook200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetBankAttributes200ResponseBankAttributesInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetBankAttributes200ResponseBankAttributesInner>> createBankAttribute({ 
    required String bankid,
    ...
    GetBankAttributes200ResponseBankAttributesInner? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetBankAttributes200ResponseBankAttributesInner),
      ) as GetBankAttributes200ResponseBankAttributesInner;
    ...
    return Response<GetBankAttributes200ResponseBankAttributesInner>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetTransactionRequestAttributeDefinition200ResponseAttributesInner>> createOrUpdateBankAttributeDefinition({ 
    required String bankid,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateSettlementAccount200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateSettlementAccount200Response>> createSettlementAccount({ 
    required String bankid,
    required CreateSettlementAccountRequest createSettlementAccountRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateSettlementAccountRequest);
      _bodyData = _serializers.serialize(createSettlementAccountRequest, specifiedType: _type);
    ...
    CreateSettlementAccount200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateSettlementAccount200Response),
      ) as CreateSettlementAccount200Response;
    ...
    return Response<CreateSettlementAccount200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateSystemAccountNotificationWebhook200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateSystemAccountNotificationWebhook200Response>> createSystemAccountNotificationWebhook({ 
    required CreateSystemAccountNotificationWebhookRequest createSystemAccountNotificationWebhookRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    CreateSystemAccountNotificationWebhook200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateSystemAccountNotificationWebhook200Response),
      ) as CreateSystemAccountNotificationWebhook200Response;
    ...
    return Response<CreateSystemAccountNotificationWebhook200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateTransactionType200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateTransactionType200Response>> createTransactionType({ 
    required String bankid,
    required GetTransactionTypes200ResponseTransactionTypesInner getTransactionTypes200ResponseTransactionTypesInner,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(GetTransactionTypes200ResponseTransactionTypesInner);
      _bodyData = _serializers.serialize(getTransactionTypes200ResponseTransactionTypesInner, specifiedType: _type);
    ...
    CreateTransactionType200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateTransactionType200Response),
      ) as CreateTransactionType200Response;
    ...
    return Response<CreateTransactionType200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteBankAttribute({ 
    required String bankid,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteBankCascade({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [EnableDisableAccountWebhook200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EnableDisableAccountWebhook200Response>> enableDisableAccountWebhook({ 
    required String bankid,
    required EnableDisableAccountWebhookRequest enableDisableAccountWebhookRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(EnableDisableAccountWebhookRequest);
      _bodyData = _serializers.serialize(enableDisableAccountWebhookRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetAccountWebhooks200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetAccountWebhooks200Response>> getAccountWebhooks({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetAccountWebhooks200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetAccountWebhooks200Response),
      ) as GetAccountWebhooks200Response;
    ...
    return Response<GetAccountWebhooks200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetBankAttributes200ResponseBankAttributesInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetBankAttributes200ResponseBankAttributesInner>> getBankAttribute({ 
    required String bankid,
    required String bankattributeid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetBankAttributes200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetBankAttributes200Response>> getBankAttributes({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetBankAttributes200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetBankAttributes200Response),
      ) as GetBankAttributes200Response;
    ...
    return Response<GetBankAttributes200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateBank200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateBank200Response>> updateBank({ 
    required UpdateBankRequest updateBankRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateBankRequest);
      _bodyData = _serializers.serialize(updateBankRequest, specifiedType: _type);
    ...
    UpdateBank200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UpdateBank200Response),
      ) as UpdateBank200Response;
    ...
    return Response<UpdateBank200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateOrUpdateTransactionRequestAttributeDefinitionRequest] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateOrUpdateTransactionRequestAttributeDefinitionRequest>> updateBankAttribute({ 
    required String bankid,
    required String bankattributeid,
    required UpdateAtmAttributeRequest updateAtmAttributeRequest,
    CancelToken? cancelToken,
    ...
    CreateOrUpdateTransactionRequestAttributeDefinitionRequest? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateOrUpdateTransactionRequestAttributeDefinitionRequest),
      ) as CreateOrUpdateTransactionRequestAttributeDefinitionRequest;
    ...
    return Response<CreateOrUpdateTransactionRequestAttributeDefinitionRequest>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
