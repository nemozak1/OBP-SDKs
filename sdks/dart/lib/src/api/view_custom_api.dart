...
import 'package:obp_dart/src/model/get_custom_views200_response.dart';
...
import 'package:obp_dart/src/model/get_system_views200_response.dart';
import 'package:obp_dart/src/model/get_users_with_account_access200_response.dart';
import 'package:obp_dart/src/model/get_view_permissions200_response.dart';
...
import 'package:obp_dart/src/model/update_system_view_request.dart';
...
class ViewCustomApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetSystemViewById200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetSystemViewById200Response>> getCustomViewById({ 
    required String bankid,
    required String accountid,
    required String viewid,
    CancelToken? cancelToken,
    ...
    final _path = r'/obp/v6.0.0/management/banks/{bankid}/accounts/{accountid}/views/{viewid}'.replaceAll('{' r'bankid' '}', encodeQueryParameter(_serializers, bankid, const FullType(String)).toString()).replaceAll('{' r'accountid' '}', encodeQueryParameter(_serializers, accountid, const FullType(String)).toString()).replaceAll('{' r'viewid' '}', encodeQueryParameter(_serializers, viewid, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetSystemViewById200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetSystemViewById200Response),
      ) as GetSystemViewById200Response;
    ...
    return Response<GetSystemViewById200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCustomViews200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomViews200Response>> getCustomViews({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetCustomViews200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCustomViews200Response),
      ) as GetCustomViews200Response;
    ...
    return Response<GetCustomViews200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetSystemViewById200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetSystemViewById200Response>> getSystemViewById({ 
    required String viewid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetSystemViews200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetSystemViews200Response>> getSystemViews({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetSystemViews200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetSystemViews200Response),
      ) as GetSystemViews200Response;
    ...
    return Response<GetSystemViews200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetViewPermissions200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetViewPermissions200Response>> getViewPermissions({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetViewPermissions200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetViewPermissions200Response),
      ) as GetViewPermissions200Response;
    ...
    return Response<GetViewPermissions200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [viewid] - The VIEWID identifier
  /// * [updateSystemViewRequest] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [GetSystemViewById200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetSystemViewById200Response>> updateSystemView({ 
    required String viewid,
    required UpdateSystemViewRequest updateSystemViewRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateSystemViewRequest);
      _bodyData = _serializers.serialize(updateSystemViewRequest, specifiedType: _type);
