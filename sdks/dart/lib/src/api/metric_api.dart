...
import 'package:obp_dart/src/model/get_metrics_top_consumers200_response.dart';
...
class MetricApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetMetricsTopConsumers200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetMetricsTopConsumers200Response>> getMetricsTopConsumers({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetMetricsTopConsumers200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetMetricsTopConsumers200Response),
      ) as GetMetricsTopConsumers200Response;
    ...
    return Response<GetMetricsTopConsumers200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
