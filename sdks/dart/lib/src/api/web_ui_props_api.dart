...
import 'package:obp_dart/src/model/create_web_ui_props200_response.dart';
import 'package:obp_dart/src/model/get_transaction_types200_response_transaction_types_inner_id.dart';
import 'package:obp_dart/src/model/get_web_ui_props200_response.dart';
...
class WebUiPropsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CreateWebUiProps200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateWebUiProps200Response>> createOrUpdateWebUiProps({ 
    ...
    CreateWebUiProps200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateWebUiProps200Response),
      ) as CreateWebUiProps200Response;
    ...
    return Response<CreateWebUiProps200Response>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [CreateWebUiProps200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateWebUiProps200Response>> createWebUiProps({ 
    required CreateTransactionRequestCounterparty200ResponseAttributesInner createTransactionRequestCounterparty200ResponseAttributesInner,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateTransactionRequestCounterparty200ResponseAttributesInner);
      _bodyData = _serializers.serialize(createTransactionRequestCounterparty200ResponseAttributesInner, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteWebUiProps({ 
    required String webuipropname,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetWebUiProps200ResponseWebuiPropsInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetWebUiProps200ResponseWebuiPropsInner>> getWebUiProp({ 
    required String webuipropname,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetWebUiProps200ResponseWebuiPropsInner? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetWebUiProps200ResponseWebuiPropsInner),
      ) as GetWebUiProps200ResponseWebuiPropsInner;
    ...
    return Response<GetWebUiProps200ResponseWebuiPropsInner>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetWebUiProps200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetWebUiProps200Response>> getWebUiProps({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetWebUiProps200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetWebUiProps200Response),
      ) as GetWebUiProps200Response;
    ...
    return Response<GetWebUiProps200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
