...
import 'package:obp_dart/src/model/get_double_entry_transaction200_response.dart';
import 'package:obp_dart/src/model/get_firehose_transactions_for_bank_account200_response.dart';
import 'package:obp_dart/src/model/get_images_for_view_on_transaction200_response.dart';
import 'package:obp_dart/src/model/get_other_account_for_transaction200_response.dart';
...
class TransactionApi {
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteTransactionCascade({ 
    required String bankid,
    required String accountid,
    required String transactionid,
    CancelToken? cancelToken,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetDoubleEntryTransaction200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetDoubleEntryTransaction200Response>> getBalancingTransaction({ 
    required String transactionid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetDoubleEntryTransaction200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetDoubleEntryTransaction200Response),
      ) as GetDoubleEntryTransaction200Response;
    ...
    return Response<GetDoubleEntryTransaction200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetDoubleEntryTransaction200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetDoubleEntryTransaction200Response>> getDoubleEntryTransaction({ 
    required String bankid,
    required String accountid,
    required String viewid,
    required String transactionid,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetFirehoseTransactionsForBankAccount200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetFirehoseTransactionsForBankAccount200Response>> getFirehoseTransactionsForBankAccount({ 
    required String bankid,
    required String accountid,
    required String viewid,
    CancelToken? cancelToken,
    ...
    GetFirehoseTransactionsForBankAccount200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetFirehoseTransactionsForBankAccount200Response),
      ) as GetFirehoseTransactionsForBankAccount200Response;
    ...
    return Response<GetFirehoseTransactionsForBankAccount200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetOtherAccountForTransaction200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetOtherAccountForTransaction200Response>> getOtherAccountForTransaction({ 
    required String bankid,
    required String accountid,
    required String viewid,
    required String transactionid,
    ...
    GetOtherAccountForTransaction200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetOtherAccountForTransaction200Response),
      ) as GetOtherAccountForTransaction200Response;
    ...
    return Response<GetOtherAccountForTransaction200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetTransactionByIdForBankAccount200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetTransactionByIdForBankAccount200Response>> getTransactionByIdForBankAccount({ 
    required String bankid,
    required String accountid,
    required String viewid,
    required String transactionid,
    ...
    GetTransactionByIdForBankAccount200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetTransactionByIdForBankAccount200Response),
      ) as GetTransactionByIdForBankAccount200Response;
    ...
    return Response<GetTransactionByIdForBankAccount200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
