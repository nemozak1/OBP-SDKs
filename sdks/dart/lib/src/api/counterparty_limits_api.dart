...
import 'package:obp_dart/src/model/get_counterparty_limit200_response.dart';
import 'package:obp_dart/src/model/get_counterparty_limit_status200_response.dart';
...
class CounterpartyLimitsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetCounterpartyLimit200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCounterpartyLimit200Response>> createCounterpartyLimit({ 
    required String bankid,
    required String accountid,
    required String viewid,
    required String counterpartyid,
    required CreateVRPConsentRequestRequestToAccountLimit createVRPConsentRequestRequestToAccountLimit,
    ...
    try {
      const _type = FullType(CreateVRPConsentRequestRequestToAccountLimit);
      _bodyData = _serializers.serialize(createVRPConsentRequestRequestToAccountLimit, specifiedType: _type);
    ...
    GetCounterpartyLimit200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCounterpartyLimit200Response),
      ) as GetCounterpartyLimit200Response;
    ...
    return Response<GetCounterpartyLimit200Response>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteCounterpartyLimit({ 
    required String bankid,
    required String accountid,
    required String viewid,
    required String counterpartyid,
  ...
  /// Returns a [Future] containing a [Response] with a [GetCounterpartyLimit200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCounterpartyLimit200Response>> getCounterpartyLimit({ 
    required String bankid,
    required String accountid,
    required String viewid,
    required String counterpartyid,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCounterpartyLimitStatus200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCounterpartyLimitStatus200Response>> getCounterpartyLimitStatus({ 
    required String bankid,
    required String accountid,
    required String viewid,
    required String counterpartyid,
    ...
    GetCounterpartyLimitStatus200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCounterpartyLimitStatus200Response),
      ) as GetCounterpartyLimitStatus200Response;
    ...
    return Response<GetCounterpartyLimitStatus200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetCounterpartyLimit200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCounterpartyLimit200Response>> updateCounterpartyLimit({ 
    required String bankid,
    required String accountid,
    required String viewid,
    required String counterpartyid,
