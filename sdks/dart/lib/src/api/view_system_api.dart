...
import 'package:obp_dart/src/model/add_system_view_permission_request.dart';
import 'package:obp_dart/src/model/create_system_view_request.dart';
...
import 'package:obp_dart/src/model/get_system_views_ids200_response.dart';
...
class ViewSystemApi {
  ...
  Future<Response<AddSystemViewPermission200Response>> addSystemViewPermission({ 
    required String viewid,
    required AddSystemViewPermissionRequest addSystemViewPermissionRequest,
    ...
    try {
      const _type = FullType(AddSystemViewPermissionRequest);
      _bodyData = _serializers.serialize(addSystemViewPermissionRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetViewsForBankAccount200ResponseViewsInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetViewsForBankAccount200ResponseViewsInner>> createSystemView({ 
    required CreateSystemViewRequest createSystemViewRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateSystemViewRequest);
      _bodyData = _serializers.serialize(createSystemViewRequest, specifiedType: _type);
    ...
    GetViewsForBankAccount200ResponseViewsInner? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetViewsForBankAccount200ResponseViewsInner),
      ) as GetViewsForBankAccount200ResponseViewsInner;
    ...
    return Response<GetViewsForBankAccount200ResponseViewsInner>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteSystemView({ 
    required String viewid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteSystemViewPermission({ 
    required String viewid,
  ...
  /// Returns a [Future] containing a [Response] with a [GetViewsForBankAccount200ResponseViewsInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetViewsForBankAccount200ResponseViewsInner>> getSystemView({ 
    required String viewid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetSystemViewsIds200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetSystemViewsIds200Response>> getSystemViewsIds({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetSystemViewsIds200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetSystemViewsIds200Response),
      ) as GetSystemViewsIds200Response;
    ...
    return Response<GetSystemViewsIds200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
