...
import 'package:obp_dart/src/model/create_product_request.dart';
import 'package:obp_dart/src/model/get_product200_response.dart';
...
import 'package:obp_dart/src/model/get_product_fees200_response.dart';
import 'package:obp_dart/src/model/get_product_tree200_response.dart';
import 'package:obp_dart/src/model/get_products200_response.dart';
...
import 'package:obp_dart/src/model/update_product_fee_request.dart';
...
class ProductApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetProductFee200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetProductFee200Response>> createProductFee({ 
    required String bankid,
    required String productcode,
    required UpdateProductFeeRequest updateProductFeeRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateProductFeeRequest);
      _bodyData = _serializers.serialize(updateProductFeeRequest, specifiedType: _type);
    ...
    GetProductFee200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetProductFee200Response),
      ) as GetProductFee200Response;
    ...
    return Response<GetProductFee200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteProductCascade({ 
    required String bankid,
    required String productcode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteProductFee({ 
    required String bankid,
    required String productcode,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetProduct200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetProduct200Response>> getProduct({ 
    required String bankid,
    required String productcode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    GetProduct200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetProduct200Response),
      ) as GetProduct200Response;
    ...
    return Response<GetProduct200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetProductFee200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetProductFee200Response>> getProductFee({ 
    required String bankid,
    required String productcode,
    required String productfeeid,
    CancelToken? cancelToken,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetProductFees200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetProductFees200Response>> getProductFees({ 
    required String bankid,
    required String productcode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    GetProductFees200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetProductFees200Response),
      ) as GetProductFees200Response;
    ...
    return Response<GetProductFees200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetProductTree200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetProductTree200Response>> getProductTree({ 
    required String bankid,
    required String productcode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    GetProductTree200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetProductTree200Response),
      ) as GetProductTree200Response;
    ...
    return Response<GetProductTree200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetProductFee200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetProductFee200Response>> updateProductFee({ 
    required String bankid,
    required String productcode,
    required String productfeeid,
    required UpdateProductFeeRequest updateProductFeeRequest,
