...
import 'package:obp_dart/src/model/sandbox_data_import_request.dart';
...
class SandboxApi {
  ...
  Future<Response<UpdateTransactionNarrative200Response>> sandboxDataImport({ 
    required SandboxDataImportRequest sandboxDataImportRequest,
    ...
    try {
      const _type = FullType(SandboxDataImportRequest);
      _bodyData = _serializers.serialize(sandboxDataImportRequest, specifiedType: _type);
