...
import 'package:obp_dart/src/model/create_historical_transaction_at_bank_request.dart';
...
import 'package:obp_dart/src/model/get_transaction_request_types_supported_by_bank200_response.dart';
import 'package:obp_dart/src/model/get_transaction_requests200_response.dart';
import 'package:obp_dart/src/model/save_historical_transaction200_response.dart';
import 'package:obp_dart/src/model/save_historical_transaction_request.dart';
...
class TransactionRequestApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SaveHistoricalTransaction200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SaveHistoricalTransaction200Response>> createHistoricalTransactionAtBank({ 
    required String bankid,
    required CreateHistoricalTransactionAtBankRequest createHistoricalTransactionAtBankRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateHistoricalTransactionAtBankRequest);
      _bodyData = _serializers.serialize(createHistoricalTransactionAtBankRequest, specifiedType: _type);
    ...
    SaveHistoricalTransaction200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SaveHistoricalTransaction200Response),
      ) as SaveHistoricalTransaction200Response;
    ...
    return Response<SaveHistoricalTransaction200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [CreateTransactionRequestCounterparty200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateTransactionRequestCounterparty200Response>> createTransactionRequestFreeForm({ 
    required String bankid,
    required String accountid,
    required String viewid,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetTransactionRequestTypesSupportedByBank200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetTransactionRequestTypesSupportedByBank200Response>> getTransactionRequestTypesSupportedByBank({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetTransactionRequestTypesSupportedByBank200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetTransactionRequestTypesSupportedByBank200Response),
      ) as GetTransactionRequestTypesSupportedByBank200Response;
    ...
    return Response<GetTransactionRequestTypesSupportedByBank200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetTransactionRequests200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetTransactionRequests200Response>> getTransactionRequests({ 
    required String bankid,
    required String accountid,
    required String viewid,
    CancelToken? cancelToken,
    ...
    GetTransactionRequests200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetTransactionRequests200Response),
      ) as GetTransactionRequests200Response;
    ...
    return Response<GetTransactionRequests200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [SaveHistoricalTransaction200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SaveHistoricalTransaction200Response>> saveHistoricalTransaction({ 
    required SaveHistoricalTransactionRequest saveHistoricalTransactionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(SaveHistoricalTransactionRequest);
      _bodyData = _serializers.serialize(saveHistoricalTransactionRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateTransactionRequestStatusRequest] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateTransactionRequestStatusRequest>> updateTransactionRequestStatus({ 
    required String transactionrequestid,
    ...
    UpdateTransactionRequestStatusRequest? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UpdateTransactionRequestStatusRequest),
      ) as UpdateTransactionRequestStatusRequest;
    ...
    return Response<UpdateTransactionRequestStatusRequest>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
