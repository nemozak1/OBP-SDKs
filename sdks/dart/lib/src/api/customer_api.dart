...
import 'package:obp_dart/src/model/add_kyc_check_request.dart';
import 'package:obp_dart/src/model/add_kyc_document200_response.dart';
import 'package:obp_dart/src/model/add_kyc_document_request.dart';
import 'package:obp_dart/src/model/add_kyc_media200_response.dart';
import 'package:obp_dart/src/model/add_kyc_media_request.dart';
import 'package:obp_dart/src/model/add_kyc_status_request.dart';
import 'package:obp_dart/src/model/create_agent_request.dart';
import 'package:obp_dart/src/model/create_corporate_customer_request.dart';
...
import 'package:obp_dart/src/model/create_customer_address_request.dart';
...
import 'package:obp_dart/src/model/create_tax_residence_request.dart';
...
import 'package:obp_dart/src/model/get_crm_events200_response.dart';
import 'package:obp_dart/src/model/get_customer_account_links_by_customer_id200_response.dart';
import 'package:obp_dart/src/model/get_customer_account_links_by_customer_id200_response_links_inner.dart';
import 'package:obp_dart/src/model/get_customer_addresses200_response.dart';
...
import 'package:obp_dart/src/model/get_customer_messages200_response.dart';
import 'package:obp_dart/src/model/get_customer_overview200_response.dart';
import 'package:obp_dart/src/model/get_customer_overview_flat200_response.dart';
import 'package:obp_dart/src/model/get_customer_overview_flat_request.dart';
import 'package:obp_dart/src/model/get_customers_by_legal_name_request.dart';
import 'package:obp_dart/src/model/get_customers_for_user200_response.dart';
import 'package:obp_dart/src/model/get_customers_messages200_response.dart';
import 'package:obp_dart/src/model/get_customers_minimal_at_any_bank200_response.dart';
import 'package:obp_dart/src/model/get_kyc_checks200_response.dart';
import 'package:obp_dart/src/model/get_kyc_checks200_response_checks_inner.dart';
import 'package:obp_dart/src/model/get_kyc_documents200_response.dart';
import 'package:obp_dart/src/model/get_kyc_media200_response.dart';
import 'package:obp_dart/src/model/get_kyc_statuses200_response.dart';
...
import 'package:obp_dart/src/model/get_my_correlated_entities200_response.dart';
...
import 'package:obp_dart/src/model/get_social_media_handles200_response.dart';
import 'package:obp_dart/src/model/get_social_media_handles200_response_checks_inner.dart';
import 'package:obp_dart/src/model/get_tax_residence200_response.dart';
...
import 'package:obp_dart/src/model/get_user_customer_links_by_customer_id200_response.dart';
...
import 'package:obp_dart/src/model/update_customer_account_link_by_id_request.dart';
import 'package:obp_dart/src/model/update_customer_branch200_response.dart';
import 'package:obp_dart/src/model/update_customer_branch_request.dart';
import 'package:obp_dart/src/model/update_customer_credit_limit_request.dart';
import 'package:obp_dart/src/model/update_customer_credit_rating_and_source_request.dart';
import 'package:obp_dart/src/model/update_customer_data_request.dart';
import 'package:obp_dart/src/model/update_customer_email_request.dart';
import 'package:obp_dart/src/model/update_customer_identity_request.dart';
...
class CustomerApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetKycChecks200ResponseChecksInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetKycChecks200ResponseChecksInner>> addKycCheck({ 
    required String bankid,
    required String customerid,
    required String kyccheckid,
    required AddKycCheckRequest addKycCheckRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AddKycCheckRequest);
      _bodyData = _serializers.serialize(addKycCheckRequest, specifiedType: _type);
    ...
    GetKycChecks200ResponseChecksInner? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetKycChecks200ResponseChecksInner),
      ) as GetKycChecks200ResponseChecksInner;
    ...
    return Response<GetKycChecks200ResponseChecksInner>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AddKycDocument200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AddKycDocument200Response>> addKycDocument({ 
    required String bankid,
    required String customerid,
    required String kycdocumentid,
    required AddKycDocumentRequest addKycDocumentRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AddKycDocumentRequest);
      _bodyData = _serializers.serialize(addKycDocumentRequest, specifiedType: _type);
    ...
    AddKycDocument200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AddKycDocument200Response),
      ) as AddKycDocument200Response;
    ...
    return Response<AddKycDocument200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AddKycMedia200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AddKycMedia200Response>> addKycMedia({ 
    required String bankid,
    required String customerid,
    required String kycmediaid,
    required AddKycMediaRequest addKycMediaRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AddKycMediaRequest);
      _bodyData = _serializers.serialize(addKycMediaRequest, specifiedType: _type);
    ...
    AddKycMedia200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AddKycMedia200Response),
      ) as AddKycMedia200Response;
    ...
    return Response<AddKycMedia200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetKycStatuses200ResponseStatusesInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetKycStatuses200ResponseStatusesInner>> addKycStatus({ 
    required String bankid,
    required String customerid,
    required AddKycStatusRequest addKycStatusRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(AddKycStatusRequest);
      _bodyData = _serializers.serialize(addKycStatusRequest, specifiedType: _type);
    ...
    GetKycStatuses200ResponseStatusesInner? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetKycStatuses200ResponseStatusesInner),
      ) as GetKycStatuses200ResponseStatusesInner;
    ...
    return Response<GetKycStatuses200ResponseStatusesInner>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [bankid] - The BANKID identifier
  /// * [customerid] - The CUSTOMERID identifier
  /// * [getSocialMediaHandles200ResponseChecksInner] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [UpdateTransactionNarrative200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateTransactionNarrative200Response>> addSocialMediaHandle({ 
    required String bankid,
    required String customerid,
    required GetSocialMediaHandles200ResponseChecksInner getSocialMediaHandles200ResponseChecksInner,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(GetSocialMediaHandles200ResponseChecksInner);
      _bodyData = _serializers.serialize(getSocialMediaHandles200ResponseChecksInner, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerChildren200ResponseCustomersInner>> createCorporateCustomer({ 
    required String bankid,
    required CreateCorporateCustomerRequest createCorporateCustomerRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateCorporateCustomerRequest);
      _bodyData = _serializers.serialize(createCorporateCustomerRequest, specifiedType: _type);
  ...
  /// * [bankid] - The BANKID identifier
  /// * [customerid] - The CUSTOMERID identifier
  /// * [createCustomerAddressRequest] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateCustomerAddress200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateCustomerAddress200Response>> createCustomerAddress({ 
    required String bankid,
    required String customerid,
    required CreateCustomerAddressRequest createCustomerAddressRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateCustomerAddressRequest);
      _bodyData = _serializers.serialize(createCustomerAddressRequest, specifiedType: _type);
    ...
    CreateCustomerAddress200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateCustomerAddress200Response),
      ) as CreateCustomerAddress200Response;
    ...
    return Response<CreateCustomerAddress200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateTaxResidence200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateTaxResidence200Response>> createTaxResidence({ 
    required String bankid,
    required String customerid,
    required CreateTaxResidenceRequest createTaxResidenceRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateTaxResidenceRequest);
      _bodyData = _serializers.serialize(createTaxResidenceRequest, specifiedType: _type);
    ...
    CreateTaxResidence200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CreateTaxResidence200Response),
      ) as CreateTaxResidence200Response;
    ...
    return Response<CreateTaxResidence200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteCustomerAccountLinkById({ 
    required String bankid,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteCustomerAddress({ 
    required String bankid,
    required String customerid,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteCustomerCascade({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteTaxResidence({ 
    required String bankid,
    required String customerid,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteUserCustomerLink({ 
    required String bankid,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerByCustomerNumber200Response>> getCorporateCustomerByCustomerId({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerChildren200Response>> getCorporateCustomerSubsidiaries({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [GetCustomerChildren200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerChildren200Response>> getCorporateCustomersAtOneBank({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetMyCorrelatedEntities200ResponseCorrelatedEntitiesInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetMyCorrelatedEntities200ResponseCorrelatedEntitiesInner>> getCorrelatedUsersInfoByCustomerId({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    GetMyCorrelatedEntities200ResponseCorrelatedEntitiesInner? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetMyCorrelatedEntities200ResponseCorrelatedEntitiesInner),
      ) as GetMyCorrelatedEntities200ResponseCorrelatedEntitiesInner;
    ...
    return Response<GetMyCorrelatedEntities200ResponseCorrelatedEntitiesInner>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCrmEvents200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCrmEvents200Response>> getCrmEvents({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetCrmEvents200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCrmEvents200Response),
      ) as GetCrmEvents200Response;
    ...
    return Response<GetCrmEvents200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetCustomerAccountLinksByCustomerId200ResponseLinksInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerAccountLinksByCustomerId200ResponseLinksInner>> getCustomerAccountLinkById({ 
    required String bankid,
    required String customeraccountlinkid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCustomerAccountLinksByCustomerId200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerAccountLinksByCustomerId200Response>> getCustomerAccountLinksByBankIdAccountId({ 
    required String bankid,
    ...
    GetCustomerAccountLinksByCustomerId200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCustomerAccountLinksByCustomerId200Response),
      ) as GetCustomerAccountLinksByCustomerId200Response;
    ...
    return Response<GetCustomerAccountLinksByCustomerId200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetCustomerAccountLinksByCustomerId200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerAccountLinksByCustomerId200Response>> getCustomerAccountLinksByCustomerId({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCustomerAddresses200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerAddresses200Response>> getCustomerAddresses({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    GetCustomerAddresses200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCustomerAddresses200Response),
      ) as GetCustomerAddresses200Response;
    ...
    return Response<GetCustomerAddresses200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetCustomerByCustomerNumber200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerByCustomerNumber200Response>> getCustomerByCustomerId({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [GetCustomerByCustomerNumber200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerByCustomerNumber200Response>> getCustomerByCustomerNumber({ 
    required String bankid,
    required GetCustomerOverviewFlatRequest getCustomerOverviewFlatRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(GetCustomerOverviewFlatRequest);
      _bodyData = _serializers.serialize(getCustomerOverviewFlatRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [GetCustomerChildren200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerChildren200Response>> getCustomerChildren({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCustomerMessages200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerMessages200Response>> getCustomerMessages({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    GetCustomerMessages200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCustomerMessages200Response),
      ) as GetCustomerMessages200Response;
    ...
    return Response<GetCustomerMessages200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCustomerOverview200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerOverview200Response>> getCustomerOverview({ 
    required String bankid,
    required GetCustomerOverviewFlatRequest getCustomerOverviewFlatRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    GetCustomerOverview200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCustomerOverview200Response),
      ) as GetCustomerOverview200Response;
    ...
    return Response<GetCustomerOverview200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCustomerOverviewFlat200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerOverviewFlat200Response>> getCustomerOverviewFlat({ 
    required String bankid,
    required GetCustomerOverviewFlatRequest getCustomerOverviewFlatRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    GetCustomerOverviewFlat200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCustomerOverviewFlat200Response),
      ) as GetCustomerOverviewFlat200Response;
    ...
    return Response<GetCustomerOverviewFlat200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateCustomerBranch200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateCustomerBranch200Response>> getCustomersByCustomerPhoneNumber({ 
    required String bankid,
    required CreateTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo createTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo);
      _bodyData = _serializers.serialize(createTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo, specifiedType: _type);
    ...
    UpdateCustomerBranch200Response? _responseData;
    ...
    return Response<UpdateCustomerBranch200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetCustomerChildren200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerChildren200Response>> getCustomersByLegalName({ 
    required String bankid,
    required GetCustomersByLegalNameRequest getCustomersByLegalNameRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(GetCustomersByLegalNameRequest);
      _bodyData = _serializers.serialize(getCustomersByLegalNameRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCustomersMessages200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomersMessages200Response>> getCustomersMessages({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetCustomersMessages200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCustomersMessages200Response),
      ) as GetCustomersMessages200Response;
    ...
    return Response<GetCustomersMessages200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetKycChecks200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetKycChecks200Response>> getKycChecks({ 
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetKycChecks200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetKycChecks200Response),
      ) as GetKycChecks200Response;
    ...
    return Response<GetKycChecks200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetKycDocuments200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetKycDocuments200Response>> getKycDocuments({ 
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetKycDocuments200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetKycDocuments200Response),
      ) as GetKycDocuments200Response;
    ...
    return Response<GetKycDocuments200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetKycMedia200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetKycMedia200Response>> getKycMedia({ 
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetKycMedia200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetKycMedia200Response),
      ) as GetKycMedia200Response;
    ...
    return Response<GetKycMedia200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetKycStatuses200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetKycStatuses200Response>> getKycStatuses({ 
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetKycStatuses200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetKycStatuses200Response),
      ) as GetKycStatuses200Response;
    ...
    return Response<GetKycStatuses200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetMyCorrelatedEntities200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetMyCorrelatedEntities200Response>> getMyCorrelatedEntities({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    GetMyCorrelatedEntities200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetMyCorrelatedEntities200Response),
      ) as GetMyCorrelatedEntities200Response;
    ...
    return Response<GetMyCorrelatedEntities200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetMyCustomersAtBank200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetMyCustomersAtBank200Response>> getMyCustomersAtBank({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetSocialMediaHandles200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetSocialMediaHandles200Response>> getSocialMediaHandles({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    GetSocialMediaHandles200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetSocialMediaHandles200Response),
      ) as GetSocialMediaHandles200Response;
    ...
    return Response<GetSocialMediaHandles200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetTaxResidence200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetTaxResidence200Response>> getTaxResidence({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    GetTaxResidence200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetTaxResidence200Response),
      ) as GetTaxResidence200Response;
    ...
    return Response<GetTaxResidence200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetUserCustomerLinksByCustomerId200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetUserCustomerLinksByCustomerId200Response>> getUserCustomerLinksByCustomerId({ 
    required String bankid,
    required String customerid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    GetUserCustomerLinksByCustomerId200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetUserCustomerLinksByCustomerId200Response),
      ) as GetUserCustomerLinksByCustomerId200Response;
    ...
    return Response<GetUserCustomerLinksByCustomerId200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetUserCustomerLinksByCustomerId200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetUserCustomerLinksByCustomerId200Response>> getUserCustomerLinksByUserId({ 
    required String bankid,
  ...
  /// * [bankid] - The BANKID identifier
  /// * [customeraccountlinkid] - The CUSTOMERACCOUNTLINKID identifier
  /// * [updateCustomerAccountLinkByIdRequest] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [GetCustomerAccountLinksByCustomerId200ResponseLinksInner] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerAccountLinksByCustomerId200ResponseLinksInner>> updateCustomerAccountLinkById({ 
    required String bankid,
    required String customeraccountlinkid,
    required UpdateCustomerAccountLinkByIdRequest updateCustomerAccountLinkByIdRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateCustomerAccountLinkByIdRequest);
      _bodyData = _serializers.serialize(updateCustomerAccountLinkByIdRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [CreateCustomerAddress200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateCustomerAddress200Response>> updateCustomerAddress({ 
    required String bankid,
    required String customerid,
    required String customeraddressid,
    required CreateCustomerAddressRequest createCustomerAddressRequest,
  ...
  /// * [bankid] - The BANKID identifier
  /// * [customerid] - The CUSTOMERID identifier
  /// * [updateCustomerBranchRequest] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [UpdateCustomerBranch200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateCustomerBranch200Response>> updateCustomerBranch({ 
    required String bankid,
    required String customerid,
    required UpdateCustomerBranchRequest updateCustomerBranchRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateCustomerBranchRequest);
      _bodyData = _serializers.serialize(updateCustomerBranchRequest, specifiedType: _type);
  ...
  /// * [bankid] - The BANKID identifier
  /// * [customerid] - The CUSTOMERID identifier
  /// * [updateCustomerCreditLimitRequest] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [UpdateCustomerBranch200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateCustomerBranch200Response>> updateCustomerCreditLimit({ 
    required String bankid,
    required String customerid,
    required UpdateCustomerCreditLimitRequest updateCustomerCreditLimitRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateCustomerCreditLimitRequest);
      _bodyData = _serializers.serialize(updateCustomerCreditLimitRequest, specifiedType: _type);
  ...
  /// * [bankid] - The BANKID identifier
  /// * [customerid] - The CUSTOMERID identifier
  /// * [updateCustomerCreditRatingAndSourceRequest] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [UpdateCustomerBranch200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateCustomerBranch200Response>> updateCustomerCreditRatingAndSource({ 
    required String bankid,
    required String customerid,
    required UpdateCustomerCreditRatingAndSourceRequest updateCustomerCreditRatingAndSourceRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateCustomerCreditRatingAndSourceRequest);
      _bodyData = _serializers.serialize(updateCustomerCreditRatingAndSourceRequest, specifiedType: _type);
  ...
  /// * [bankid] - The BANKID identifier
  /// * [customerid] - The CUSTOMERID identifier
  /// * [updateCustomerDataRequest] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [UpdateCustomerBranch200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateCustomerBranch200Response>> updateCustomerData({ 
    required String bankid,
    required String customerid,
    required UpdateCustomerDataRequest updateCustomerDataRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateCustomerDataRequest);
      _bodyData = _serializers.serialize(updateCustomerDataRequest, specifiedType: _type);
  ...
  /// * [bankid] - The BANKID identifier
  /// * [customerid] - The CUSTOMERID identifier
  /// * [updateCustomerEmailRequest] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [UpdateCustomerBranch200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateCustomerBranch200Response>> updateCustomerEmail({ 
    required String bankid,
    required String customerid,
    required UpdateCustomerEmailRequest updateCustomerEmailRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateCustomerEmailRequest);
      _bodyData = _serializers.serialize(updateCustomerEmailRequest, specifiedType: _type);
  ...
  /// * [bankid] - The BANKID identifier
  /// * [customerid] - The CUSTOMERID identifier
  /// * [updateCustomerIdentityRequest] - Request body
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [UpdateCustomerBranch200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateCustomerBranch200Response>> updateCustomerIdentity({ 
    required String bankid,
    required String customerid,
    required UpdateCustomerIdentityRequest updateCustomerIdentityRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateCustomerIdentityRequest);
      _bodyData = _serializers.serialize(updateCustomerIdentityRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [UpdateCustomerBranch200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateCustomerBranch200Response>> updateCustomerMobileNumber({ 
    required String bankid,
    required String customerid,
    required CreateTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo createTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [UpdateCustomerBranch200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateCustomerBranch200Response>> updateCustomerNumber({ 
    required String bankid,
    required String customerid,
    required GetCustomerOverviewFlatRequest getCustomerOverviewFlatRequest,
    CancelToken? cancelToken,
