...
import 'package:obp_dart/src/model/create_retail_customer_request.dart';
import 'package:obp_dart/src/model/get_customer_by_customer_number200_response.dart';
...
class RetailCustomerApi {
  ...
  Future<Response<GetCustomerChildren200ResponseCustomersInner>> createRetailCustomer({ 
    required String bankid,
    required CreateRetailCustomerRequest createRetailCustomerRequest,
    ...
    try {
      const _type = FullType(CreateRetailCustomerRequest);
      _bodyData = _serializers.serialize(createRetailCustomerRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCustomerByCustomerNumber200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerByCustomerNumber200Response>> getRetailCustomerByCustomerId({ 
    required String bankid,
    ...
    GetCustomerByCustomerNumber200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetCustomerByCustomerNumber200Response),
      ) as GetCustomerByCustomerNumber200Response;
    ...
    return Response<GetCustomerByCustomerNumber200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCustomerChildren200Response>> getRetailCustomersAtOneBank({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
