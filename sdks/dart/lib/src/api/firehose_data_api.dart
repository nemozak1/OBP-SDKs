...
import 'package:obp_dart/src/model/get_my_customers_at_bank200_response.dart';
...
class FirehoseDataApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetMyCustomersAtBank200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetMyCustomersAtBank200Response>> getFirehoseCustomers({ 
    required String bankid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    GetMyCustomersAtBank200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetMyCustomersAtBank200Response),
      ) as GetMyCustomersAtBank200Response;
    ...
    return Response<GetMyCustomersAtBank200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
