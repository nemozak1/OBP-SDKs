...
import 'package:obp_dart/src/model/get_api_glossary200_response.dart';
...
class DocumentationApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetApiGlossary200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetApiGlossary200Response>> getApiGlossary({ 
    ...
    GetApiGlossary200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetApiGlossary200Response),
      ) as GetApiGlossary200Response;
    ...
    return Response<GetApiGlossary200Response>(
      data: _responseData,
