...
part 'get_customer_children200_response_customers_inner.g.dart';
...
/// * [kycStatus] 
@BuiltValue()
abstract class GetCustomerChildren200ResponseCustomersInner implements Built<GetCustomerChildren200ResponseCustomersInner, GetCustomerChildren200ResponseCustomersInnerBuilder> {
  ...
  GetCustomerChildren200ResponseCustomersInner._();

  factory GetCustomerChildren200ResponseCustomersInner([void updates(GetCustomerChildren200ResponseCustomersInnerBuilder b)]) = _$GetCustomerChildren200ResponseCustomersInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetCustomerChildren200ResponseCustomersInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetCustomerChildren200ResponseCustomersInner> get serializer => _$GetCustomerChildren200ResponseCustomersInnerSerializer();
}

class _$GetCustomerChildren200ResponseCustomersInnerSerializer implements PrimitiveSerializer<GetCustomerChildren200ResponseCustomersInner> {
  @override
  final Iterable<Type> types = const [GetCustomerChildren200ResponseCustomersInner, _$GetCustomerChildren200ResponseCustomersInner];

  @override
  final String wireName = r'GetCustomerChildren200ResponseCustomersInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    GetCustomerChildren200ResponseCustomersInner object, {
  ...
  void _deserializeProperties(
    ...
    required GetCustomerChildren200ResponseCustomersInnerBuilder result,
  ...
  @override
  GetCustomerChildren200ResponseCustomersInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GetCustomerChildren200ResponseCustomersInnerBuilder();
