...
part 'get_cards_for_bank200_response_cards_inner.g.dart';
...
/// * [onHotList] 
@BuiltValue()
abstract class GetCardsForBank200ResponseCardsInner implements Built<GetCardsForBank200ResponseCardsInner, GetCardsForBank200ResponseCardsInnerBuilder> {
  ...
  GetCardsForBank200ResponseCardsInner._();

  factory GetCardsForBank200ResponseCardsInner([void updates(GetCardsForBank200ResponseCardsInnerBuilder b)]) = _$GetCardsForBank200ResponseCardsInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetCardsForBank200ResponseCardsInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetCardsForBank200ResponseCardsInner> get serializer => _$GetCardsForBank200ResponseCardsInnerSerializer();
}

class _$GetCardsForBank200ResponseCardsInnerSerializer implements PrimitiveSerializer<GetCardsForBank200ResponseCardsInner> {
  @override
  final Iterable<Type> types = const [GetCardsForBank200ResponseCardsInner, _$GetCardsForBank200ResponseCardsInner];

  @override
  final String wireName = r'GetCardsForBank200ResponseCardsInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    GetCardsForBank200ResponseCardsInner object, {
  ...
  void _deserializeProperties(
    ...
    required GetCardsForBank200ResponseCardsInnerBuilder result,
  ...
  @override
  GetCardsForBank200ResponseCardsInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GetCardsForBank200ResponseCardsInnerBuilder();
