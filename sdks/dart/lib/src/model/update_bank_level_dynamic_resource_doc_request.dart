...
part 'update_bank_level_dynamic_resource_doc_request.g.dart';
...
/// * [summary] 
@BuiltValue()
abstract class UpdateBankLevelDynamicResourceDocRequest implements Built<UpdateBankLevelDynamicResourceDocRequest, UpdateBankLevelDynamicResourceDocRequestBuilder> {
  ...
  UpdateBankLevelDynamicResourceDocRequest._();

  factory UpdateBankLevelDynamicResourceDocRequest([void updates(UpdateBankLevelDynamicResourceDocRequestBuilder b)]) = _$UpdateBankLevelDynamicResourceDocRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateBankLevelDynamicResourceDocRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateBankLevelDynamicResourceDocRequest> get serializer => _$UpdateBankLevelDynamicResourceDocRequestSerializer();
}

class _$UpdateBankLevelDynamicResourceDocRequestSerializer implements PrimitiveSerializer<UpdateBankLevelDynamicResourceDocRequest> {
  @override
  final Iterable<Type> types = const [UpdateBankLevelDynamicResourceDocRequest, _$UpdateBankLevelDynamicResourceDocRequest];

  @override
  final String wireName = r'UpdateBankLevelDynamicResourceDocRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UpdateBankLevelDynamicResourceDocRequest object, {
  ...
  void _deserializeProperties(
    ...
    required UpdateBankLevelDynamicResourceDocRequestBuilder result,
  ...
  @override
  UpdateBankLevelDynamicResourceDocRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UpdateBankLevelDynamicResourceDocRequestBuilder();
