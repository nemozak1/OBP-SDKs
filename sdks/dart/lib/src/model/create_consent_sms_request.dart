...
part 'create_consent_sms_request.g.dart';
...
/// * [entitlements] 
@BuiltValue()
abstract class CreateConsentSmsRequest implements Built<CreateConsentSmsRequest, CreateConsentSmsRequestBuilder> {
  ...
  CreateConsentSmsRequest._();

  factory CreateConsentSmsRequest([void updates(CreateConsentSmsRequestBuilder b)]) = _$CreateConsentSmsRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateConsentSmsRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateConsentSmsRequest> get serializer => _$CreateConsentSmsRequestSerializer();
}

class _$CreateConsentSmsRequestSerializer implements PrimitiveSerializer<CreateConsentSmsRequest> {
  @override
  final Iterable<Type> types = const [CreateConsentSmsRequest, _$CreateConsentSmsRequest];

  @override
  final String wireName = r'CreateConsentSmsRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CreateConsentSmsRequest object, {
  ...
  void _deserializeProperties(
    ...
    required CreateConsentSmsRequestBuilder result,
  ...
  @override
  CreateConsentSmsRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CreateConsentSmsRequestBuilder();
