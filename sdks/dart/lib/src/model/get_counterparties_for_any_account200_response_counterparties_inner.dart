...
part 'get_counterparties_for_any_account200_response_counterparties_inner.g.dart';
...
@BuiltValue()
abstract class GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner implements Built<GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner, GetCounterpartiesForAnyAccount200ResponseCounterpartiesInnerBuilder> {
  ...
  GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner._();

  factory GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner([void updates(GetCounterpartiesForAnyAccount200ResponseCounterpartiesInnerBuilder b)]) = _$GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GetCounterpartiesForAnyAccount200ResponseCounterpartiesInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner> get serializer => _$GetCounterpartiesForAnyAccount200ResponseCounterpartiesInnerSerializer();
}

class _$GetCounterpartiesForAnyAccount200ResponseCounterpartiesInnerSerializer implements PrimitiveSerializer<GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner> {
  @override
  final Iterable<Type> types = const [GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner, _$GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner];

  @override
  final String wireName = r'GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner object, {
  ...
  void _deserializeProperties(
    ...
    required GetCounterpartiesForAnyAccount200ResponseCounterpartiesInnerBuilder result,
  ...
  @override
  GetCounterpartiesForAnyAccount200ResponseCounterpartiesInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = GetCounterpartiesForAnyAccount200ResponseCounterpartiesInnerBuilder();
