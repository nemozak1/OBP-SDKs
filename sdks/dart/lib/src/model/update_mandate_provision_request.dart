...
part 'update_mandate_provision_request.g.dart';
...
@BuiltValue()
abstract class UpdateMandateProvisionRequest implements Built<UpdateMandateProvisionRequest, UpdateMandateProvisionRequestBuilder> {
  ...
  UpdateMandateProvisionRequest._();

  factory UpdateMandateProvisionRequest([void updates(UpdateMandateProvisionRequestBuilder b)]) = _$UpdateMandateProvisionRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateMandateProvisionRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateMandateProvisionRequest> get serializer => _$UpdateMandateProvisionRequestSerializer();
}

class _$UpdateMandateProvisionRequestSerializer implements PrimitiveSerializer<UpdateMandateProvisionRequest> {
  @override
  final Iterable<Type> types = const [UpdateMandateProvisionRequest, _$UpdateMandateProvisionRequest];

  @override
  final String wireName = r'UpdateMandateProvisionRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UpdateMandateProvisionRequest object, {
  ...
  void _deserializeProperties(
    ...
    required UpdateMandateProvisionRequestBuilder result,
  ...
  @override
  UpdateMandateProvisionRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UpdateMandateProvisionRequestBuilder();
