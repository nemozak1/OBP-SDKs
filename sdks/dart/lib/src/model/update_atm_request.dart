...
part 'update_atm_request.g.dart';
...
/// * [phone] 
@BuiltValue()
abstract class UpdateAtmRequest implements Built<UpdateAtmRequest, UpdateAtmRequestBuilder> {
  ...
  factory UpdateAtmRequest([void updates(UpdateAtmRequestBuilder b)]) = _$UpdateAtmRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdateAtmRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdateAtmRequest> get serializer => _$UpdateAtmRequestSerializer();
}

class _$UpdateAtmRequestSerializer implements PrimitiveSerializer<UpdateAtmRequest> {
  @override
  final Iterable<Type> types = const [UpdateAtmRequest, _$UpdateAtmRequest];

  @override
  final String wireName = r'UpdateAtmRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UpdateAtmRequest object, {
  ...
  void _deserializeProperties(
    ...
    required UpdateAtmRequestBuilder result,
  ...
  @override
  UpdateAtmRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UpdateAtmRequestBuilder();
