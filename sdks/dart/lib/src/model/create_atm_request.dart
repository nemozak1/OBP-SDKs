...
part 'create_atm_request.g.dart';
...
/// * [phone] 
@BuiltValue()
abstract class CreateAtmRequest implements Built<CreateAtmRequest, CreateAtmRequestBuilder> {
  ...
  factory CreateAtmRequest([void updates(CreateAtmRequestBuilder b)]) = _$CreateAtmRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateAtmRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateAtmRequest> get serializer => _$CreateAtmRequestSerializer();
}

class _$CreateAtmRequestSerializer implements PrimitiveSerializer<CreateAtmRequest> {
  @override
  final Iterable<Type> types = const [CreateAtmRequest, _$CreateAtmRequest];

  @override
  final String wireName = r'CreateAtmRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CreateAtmRequest object, {
  ...
  void _deserializeProperties(
    ...
    required CreateAtmRequestBuilder result,
  ...
  @override
  CreateAtmRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CreateAtmRequestBuilder();
