...
part 'head_atms200_response_atms_inner.g.dart';
...
/// * [minimumWithdrawal] 
@BuiltValue()
abstract class HeadAtms200ResponseAtmsInner implements Built<HeadAtms200ResponseAtmsInner, HeadAtms200ResponseAtmsInnerBuilder> {
  ...
  HeadAtms200ResponseAtmsInner._();

  factory HeadAtms200ResponseAtmsInner([void updates(HeadAtms200ResponseAtmsInnerBuilder b)]) = _$HeadAtms200ResponseAtmsInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HeadAtms200ResponseAtmsInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<HeadAtms200ResponseAtmsInner> get serializer => _$HeadAtms200ResponseAtmsInnerSerializer();
}

class _$HeadAtms200ResponseAtmsInnerSerializer implements PrimitiveSerializer<HeadAtms200ResponseAtmsInner> {
  @override
  final Iterable<Type> types = const [HeadAtms200ResponseAtmsInner, _$HeadAtms200ResponseAtmsInner];

  @override
  final String wireName = r'HeadAtms200ResponseAtmsInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HeadAtms200ResponseAtmsInner object, {
  ...
  void _deserializeProperties(
    ...
    required HeadAtms200ResponseAtmsInnerBuilder result,
  ...
  @override
  HeadAtms200ResponseAtmsInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HeadAtms200ResponseAtmsInnerBuilder();
