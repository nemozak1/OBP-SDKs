...
part 'updated_card_for_bank_request.g.dart';
...
/// * [cardType] 
@BuiltValue()
abstract class UpdatedCardForBankRequest implements Built<UpdatedCardForBankRequest, UpdatedCardForBankRequestBuilder> {
  ...
  UpdatedCardForBankRequest._();

  factory UpdatedCardForBankRequest([void updates(UpdatedCardForBankRequestBuilder b)]) = _$UpdatedCardForBankRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UpdatedCardForBankRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UpdatedCardForBankRequest> get serializer => _$UpdatedCardForBankRequestSerializer();
}

class _$UpdatedCardForBankRequestSerializer implements PrimitiveSerializer<UpdatedCardForBankRequest> {
  @override
  final Iterable<Type> types = const [UpdatedCardForBankRequest, _$UpdatedCardForBankRequest];

  @override
  final String wireName = r'UpdatedCardForBankRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    UpdatedCardForBankRequest object, {
  ...
  void _deserializeProperties(
    ...
    required UpdatedCardForBankRequestBuilder result,
  ...
  @override
  UpdatedCardForBankRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = UpdatedCardForBankRequestBuilder();
