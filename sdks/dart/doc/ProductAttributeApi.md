...
try {
    ...
    print('Exception when calling ProductAttributeApi->createOrUpdateProductAttributeDefinition: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ProductAttributeApi->deleteProductAttributeDefinition: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ProductAttributeApi->getProductAttributeDefinition: $e\n');
}
```
