...
try {
    ...
    print('Exception when calling MetricApi->elasticSearchMetrics: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->getAggregateMetrics: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->getConnectorCallCounts: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->getConnectorMetrics: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->getConnectorTraces: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->getMetrics: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->getMetricsAtBank: $e\n');
}
```
...
try {
    final response = api.getMetricsTopConsumers();
    print(response);
} on DioException catch (e) {
    print('Exception when calling MetricApi->getMetricsTopConsumers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->getPopularApis: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MetricApi->getTopAPIs: $e\n');
}
```
