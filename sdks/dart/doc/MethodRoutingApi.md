...
try {
    ...
    print('Exception when calling MethodRoutingApi->createMethodRouting: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MethodRoutingApi->deleteMethodRouting: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MethodRoutingApi->getConnectorMethodNames: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MethodRoutingApi->getMethodRoutings: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MethodRoutingApi->updateMethodRouting: $e\n');
}
```
