...
try {
    ...
    print('Exception when calling WebhookApi->createAccountWebhook: $e\n');
}
```
...
try {
    ...
    print('Exception when calling WebhookApi->createBankAccountNotificationWebhook: $e\n');
}
```
...
try {
    ...
    print('Exception when calling WebhookApi->createSystemAccountNotificationWebhook: $e\n');
}
```
...
try {
    ...
    print('Exception when calling WebhookApi->enableDisableAccountWebhook: $e\n');
}
```
...
try {
    ...
    print('Exception when calling WebhookApi->getAccountWebhooks: $e\n');
}
```
