...
try {
    ...
    print('Exception when calling MessageDocApi->getMessageDocs: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MessageDocApi->getMessageDocsJsonSchema: $e\n');
}
```
...
try {
    ...
    print('Exception when calling MessageDocApi->getMessageDocsSwagger: $e\n');
}
```
