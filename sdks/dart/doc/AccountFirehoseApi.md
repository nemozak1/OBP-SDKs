...
try {
    ...
    print('Exception when calling AccountFirehoseApi->getFastFirehoseAccountsAtOneBank: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountFirehoseApi->getFirehoseAccountsAtOneBank: $e\n');
}
```
...
try {
    final response = api.getFirehoseTransactionsForBankAccount(bankid, accountid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountFirehoseApi->getFirehoseTransactionsForBankAccount: $e\n');
}
```
