...
try {
    ...
    print('Exception when calling ChannelApi->deleteSignalChannel: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ChannelApi->getSignalChannelInfo: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ChannelApi->getSignalChannels: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ChannelApi->getSignalMessages: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ChannelApi->getSignalStats: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ChannelApi->publishSignalMessage: $e\n');
}
```
