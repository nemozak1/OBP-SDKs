...
final api = ObpDart().getAccountAccessApi();
...
try {
    ...
    print('Exception when calling AccountAccessApi->createUserWithAccountAccessById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountAccessApi->grantUserAccessToViewById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountAccessApi->revokeUserAccessToViewById: $e\n');
}
```
