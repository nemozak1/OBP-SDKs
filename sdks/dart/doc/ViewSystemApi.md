...
final AddSystemViewPermissionRequest addSystemViewPermissionRequest = {"type":"object","properties":{"extra_data":{"type":"array","items":{"type":"string"}},"permission_name":{"type":"string"}}}; // AddSystemViewPermissionRequest | Request body

try {
    final response = api.addSystemViewPermission(viewid, addSystemViewPermissionRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->addSystemViewPermission: $e\n');
}
```
...
final api = ObpDart().getViewSystemApi();
final CreateSystemViewRequest createSystemViewRequest = {"type":"object","properties":{"hide_metadata_if_alias_used":{"type":"boolean"},"description":{"type":"string"},"is_public":{"type":"boolean"},"which_alias_to_use":{"type":"string"},"can_revoke_access_to_views":{"type":"array","items":{"type":"string"}},"can_grant_access_to_views":{"type":"array","items":{"type":"string"}},"name":{"type":"string"},"allowed_actions":{"type":"array","items":{"type":"string"}},"metadata_view":{"type":"string"}}}; // CreateSystemViewRequest | Request body

try {
    final response = api.createSystemView(createSystemViewRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->createSystemView: $e\n');
}
```
...
try {
    api.deleteSystemView(viewid);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->deleteSystemView: $e\n');
}
```
...
try {
    api.deleteSystemViewPermission(viewid, permissionname);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->deleteSystemViewPermission: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewSystemApi->getCustomViewById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewSystemApi->getCustomViews: $e\n');
}
```
...
try {
    final response = api.getSystemView(viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->getSystemView: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewSystemApi->getSystemViewById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewSystemApi->getSystemViews: $e\n');
}
```
...
try {
    final response = api.getSystemViewsIds();
    print(response);
} on DioException catch (e) {
    print('Exception when calling ViewSystemApi->getSystemViewsIds: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewSystemApi->getViewPermissions: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ViewSystemApi->updateSystemView: $e\n');
}
```
