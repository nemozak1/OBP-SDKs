...
try {
    ...
    print('Exception when calling OIDCApi->getOAuth2ServerJWKsURIs: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OIDCApi->getObpConnectorLoopback: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OIDCApi->getOidcClient: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OIDCApi->verifyOidcClient: $e\n');
}
```
