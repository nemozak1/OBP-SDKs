...
# **addAccount**
> AddAccount200Response addAccount(bankid, addAccountRequest)
...
final AddAccountRequest addAccountRequest = {"type":"object","properties":{"account_routings":{"type":"array","items":{"type":"object","properties":{"address":{"type":"string"},"scheme":{"type":"string"}}}},"product_code":{"type":"string"},"label":{"type":"string"},"balance":{"type":"object","properties":{"currency":{"type":"string"},"amount":{"type":"string"}}},"branch_id":{"type":"string"},"user_id":{"type":"string"}}}; // AddAccountRequest | Request body

try {
    final response = api.addAccount(bankid, addAccountRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->addAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->addTagForViewOnAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->checkFundsAvailable: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->corePrivateAccountsAllBanks: $e\n');
}
```
...
try {
    final response = api.createAccount(bankid, accountid, addAccountRequest);
    print(response);
} on DioException catch (e) {
...
try {
    ...
    print('Exception when calling AccountApi->createAccountApplication: $e\n');
}
```
...
final UpdateAccountAttributeRequest updateAccountAttributeRequest = {type=object, properties={value={type=string}, product_instance_code={type=string}, type={type=string}, name={type=string}}}; // UpdateAccountAttributeRequest | Request body

try {
    final response = api.createAccountAttribute(bankid, accountid, productcode, updateAccountAttributeRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->createAccountAttribute: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->createBankAccountBalance: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->createCounterparty: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->createCounterpartyForAnyAccount: $e\n');
}
```
...
# **createCustomView**
> CreateCustomView200Response createCustomView(bankid, accountid, viewid, createCustomViewRequest)
...
final String accountid = accountid_example; // String | The ACCOUNTID identifier
final String viewid = viewid_example; // String | The VIEWID identifier
final CreateCustomViewRequest createCustomViewRequest = {"type":"object","properties":{"allowed_permissions":{"type":"array","items":{"type":"string"}},"hide_metadata_if_alias_used":{"type":"boolean"},"description":{"type":"string"},"is_public":{"type":"boolean"},"metadata_view":{"type":"string"},"which_alias_to_use":{"type":"string"},"name":{"type":"string"}}}; // CreateCustomViewRequest | Request body

try {
    final response = api.createCustomView(bankid, accountid, viewid, createCustomViewRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->createCustomView: $e\n');
}
```
...
> CreateUserWithAccountAccessById200ResponseHead createCustomViewManagement(bankid, accountid, createCustomViewManagementRequest)
...
final String bankid = bankid_example; // String | The BANKID identifier
final String accountid = accountid_example; // String | The ACCOUNTID identifier
final CreateCustomViewManagementRequest createCustomViewManagementRequest = {"type":"object","properties":{"hide_metadata_if_alias_used":{"type":"boolean"},"name":{"type":"string"},"description":{"type":"string"},"is_public":{"type":"boolean"},"metadata_view":{"type":"string"},"which_alias_to_use":{"type":"string"},"allowed_actions":{"type":"array","items":{"type":"string"}}}}; // CreateCustomViewManagementRequest | Request body

try {
    final response = api.createCustomViewManagement(bankid, accountid, createCustomViewManagementRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->createCustomViewManagement: $e\n');
}
```
...
final api = ObpDart().getAccountApi();
final String bankid = bankid_example; // String | The BANKID identifier
final CreateCustomerAccountLinkRequest createCustomerAccountLinkRequest = {"type":"object","properties":{"customer_id":{"type":"string"},"bank_id":{"type":"string"},"account_id":{"type":"string"},"relationship_type":{"type":"string"}}}; // CreateCustomerAccountLinkRequest | Request body

try {
    final response = api.createCustomerAccountLink(bankid, createCustomerAccountLinkRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->createCustomerAccountLink: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->createDirectDebit: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->createDirectDebitManagement: $e\n');
}
```
...
try {
    final response = api.createOrUpdateAccountAttributeDefinition(bankid, createOrUpdateTransactionRequestAttributeDefinitionRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->createOrUpdateAccountAttributeDefinition: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->createStandingOrder: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->createStandingOrderManagement: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->createUserWithAccountAccessById: $e\n');
}
```
...
> CreateUserWithAccountAccessById200ResponseHead createViewForBankAccount(bankid, accountid, createCustomViewManagementRequest)
...
try {
    final response = api.createViewForBankAccount(bankid, accountid, createCustomViewManagementRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->createViewForBankAccount: $e\n');
}
```
...
try {
    api.deleteAccountAttributeDefinition(bankid, attributedefinitionid);
} on DioException catch (e) {
    print('Exception when calling AccountApi->deleteAccountAttributeDefinition: $e\n');
}
```
...
try {
    api.deleteAccountCascade(bankid, accountid);
} on DioException catch (e) {
    print('Exception when calling AccountApi->deleteAccountCascade: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->deleteBankAccountBalance: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->deleteCounterpartyForAnyAccount: $e\n');
}
```
...
try {
    api.deleteCustomView(bankid, accountid, viewid, targetviewid);
} on DioException catch (e) {
    print('Exception when calling AccountApi->deleteCustomView: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->deleteExplicitCounterparty: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->deleteTagForViewOnAccount: $e\n');
}
```
...
try {
    api.deleteViewForBankAccount(bankid, accountid, viewid);
} on DioException catch (e) {
    print('Exception when calling AccountApi->deleteViewForBankAccount: $e\n');
}
```
...
> GetApiTags200Response getAccountAccessByUserId(userid)
...
try {
    final response = api.getAccountAccessByUserId(userid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getAccountAccessByUserId: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getAccountApplication: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getAccountApplications: $e\n');
}
```
...
try {
    final response = api.getAccountAttributeDefinition(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getAccountAttributeDefinition: $e\n');
}
```
...
> GetAccountsByAccountRoutingRegex200ResponseAccountsInner getAccountByAccountRouting(getAccountsByAccountRoutingRegexRequest)
...
final api = ObpDart().getAccountApi();
final GetAccountsByAccountRoutingRegexRequest getAccountsByAccountRoutingRegexRequest = {type=object, properties={bank_id={type=string}, account_routing={type=object, properties={address={type=string}, scheme={type=string}}}}}; // GetAccountsByAccountRoutingRegexRequest | Request body

try {
    final response = api.getAccountByAccountRouting(getAccountsByAccountRoutingRegexRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getAccountByAccountRouting: $e\n');
}
```
...
# **getAccountDirectory**
> GetAccountDirectory200Response getAccountDirectory(bankid)
...
try {
    final response = api.getAccountDirectory(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getAccountDirectory: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getAccountsAtBank: $e\n');
}
```
...
> GetAccountsByAccountRoutingRegex200Response getAccountsByAccountRoutingRegex(getAccountsByAccountRoutingRegexRequest)
...
try {
    final response = api.getAccountsByAccountRoutingRegex(getAccountsByAccountRoutingRegexRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getAccountsByAccountRoutingRegex: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getAccountsHeld: $e\n');
}
```
...
> GetAccountsHeldByUserAtBank200Response getAccountsHeldByUser(userid)
...
try {
    final response = api.getAccountsHeldByUser(userid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getAccountsHeldByUser: $e\n');
}
```
...
> GetAccountsHeldByUserAtBank200Response getAccountsHeldByUserAtBank(userid, bankid)
...
try {
    final response = api.getAccountsHeldByUserAtBank(userid, bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getAccountsHeldByUserAtBank: $e\n');
}
```
...
> GetApiTags200Response getAccountsMinimalByCustomerId(customerid)
...
try {
    final response = api.getAccountsMinimalByCustomerId(customerid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getAccountsMinimalByCustomerId: $e\n');
}
```
...
# **getAgent**
> GetAgent200Response getAgent(bankid, agentid)
...
try {
    final response = api.getAgent(bankid, agentid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getAgent: $e\n');
}
```
...
# **getAgents**
> GetAgents200Response getAgents(bankid)
...
try {
    final response = api.getAgents(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getAgents: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getAllBankAccountBalances: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getBankAccountBalanceById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getBankAccountBalances: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getBankAccountsBalances: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getBankAccountsBalancesThroughView: $e\n');
}
```
...
# **getCheckbookOrders**
> GetCheckbookOrders200Response getCheckbookOrders(bankid, accountid, viewid)
...
try {
    final response = api.getCheckbookOrders(bankid, accountid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getCheckbookOrders: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getCoreAccountByIdThroughView: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getCoreAccountByIdV600: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getCoreTransactionsForBankAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getCounterpartiesForAnyAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getCounterpartyByIdForAnyAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getCounterpartyByNameForAnyAccount: $e\n');
}
```
...
# **getCustomView**
> CreateCustomView200Response getCustomView(bankid, accountid, viewid, targetviewid)
...
try {
    final response = api.getCustomView(bankid, accountid, viewid, targetviewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getCustomView: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getExplicitCounterpartiesForAccount: $e\n');
}
```
...
> GetFastFirehoseAccountsAtOneBank200Response getFastFirehoseAccountsAtOneBank(bankid)
...
try {
    final response = api.getFastFirehoseAccountsAtOneBank(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getFastFirehoseAccountsAtOneBank: $e\n');
}
```
...
> GetFirehoseAccountsAtOneBank200Response getFirehoseAccountsAtOneBank(bankid, viewid)
...
try {
    final response = api.getFirehoseAccountsAtOneBank(bankid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getFirehoseAccountsAtOneBank: $e\n');
}
```
...
> GetHoldingAccountByReleaser200Response getHoldingAccountByReleaser(bankid, accountid, viewid)
...
try {
    final response = api.getHoldingAccountByReleaser(bankid, accountid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getHoldingAccountByReleaser: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getOtherAccountByIdForBankAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getOtherAccountsForBankAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getPermissionForUserForBankAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getPermissionsForBankAccount: $e\n');
}
```
...
> GetPrivateAccountByIdFull200Response getPrivateAccountByIdFull(bankid, accountid, viewid)
...
try {
    final response = api.getPrivateAccountByIdFull(bankid, accountid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getPrivateAccountByIdFull: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getPrivateAccountIdsbyBankId: $e\n');
}
```
...
try {
    final response = api.getPublicAccountById(bankid, accountid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getPublicAccountById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->getTagsForViewOnAccount: $e\n');
}
```
...
> GetTransactionsForBankAccount200Response getTransactionsForBankAccount(bankid, accountid, viewid)
...
try {
    final response = api.getTransactionsForBankAccount(bankid, accountid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getTransactionsForBankAccount: $e\n');
}
```
...
> GetUsersWithAccountAccess200Response getUsersWithAccountAccess(bankid, accountid, viewid)
...
try {
    final response = api.getUsersWithAccountAccess(bankid, accountid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getUsersWithAccountAccess: $e\n');
}
```
...
> GetViewsForBankAccount200Response getViewsForBankAccount(bankid, accountid)
...
try {
    final response = api.getViewsForBankAccount(bankid, accountid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->getViewsForBankAccount: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->grantUserAccessToViewById: $e\n');
}
```
...
# **hasAccountAccess**
> HasAccountAccess200Response hasAccountAccess(bankid, accountid, viewid)
...
try {
    final response = api.hasAccountAccess(bankid, accountid, viewid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->hasAccountAccess: $e\n');
}
```
...
# **ibanChecker**
> IbanChecker200Response ibanChecker(ibanCheckerRequest)
...
final api = ObpDart().getAccountApi();
final IbanCheckerRequest ibanCheckerRequest = {"type":"object","properties":{"address":{"type":"string"}}}; // IbanCheckerRequest | Request body

try {
    final response = api.ibanChecker(ibanCheckerRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->ibanChecker: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->privateAccountsAtOneBank: $e\n');
}
```
...
try {
    final response = api.publicAccountsAllBanks();
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->publicAccountsAllBanks: $e\n');
}
```
...
try {
    final response = api.publicAccountsAtOneBank(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->publicAccountsAtOneBank: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->revokeUserAccessToViewById: $e\n');
}
```
...
# **updateAccount**
> UpdateAccount200Response updateAccount(bankid, accountid, updateAccountRequest)
...
final String bankid = bankid_example; // String | The BANKID identifier
final String accountid = accountid_example; // String | The ACCOUNTID identifier
final UpdateAccountRequest updateAccountRequest = {"type":"object","properties":{"account_routings":{"type":"array","items":{"type":"object","properties":{"address":{"type":"string"},"scheme":{"type":"string"}}}},"branch_id":{"type":"string"},"label":{"type":"string"},"type":{"type":"string"}}}; // UpdateAccountRequest | Request body

try {
    final response = api.updateAccount(bankid, accountid, updateAccountRequest);
    print(response);
} on DioException catch (e) {
...
try {
    ...
    print('Exception when calling AccountApi->updateAccountApplicationStatus: $e\n');
}
```
...
try {
    final response = api.updateAccountAttribute(bankid, accountid, productcode, accountattributeid, updateAccountAttributeRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->updateAccountAttribute: $e\n');
}
```
...
# **updateAccountLabel**
> UpdateTransactionNarrative200Response updateAccountLabel(bankid, accountid, updateAccountLabelRequest)
...
final String bankid = bankid_example; // String | The BANKID identifier
final String accountid = accountid_example; // String | The ACCOUNTID identifier
final UpdateAccountLabelRequest updateAccountLabelRequest = {"type":"object","properties":{"label":{"type":"string"}}}; // UpdateAccountLabelRequest | Request body

try {
    final response = api.updateAccountLabel(bankid, accountid, updateAccountLabelRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->updateAccountLabel: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AccountApi->updateBankAccountBalance: $e\n');
}
```
...
# **updateCustomView**
> CreateCustomView200Response updateCustomView(bankid, accountid, viewid, targetviewid, updateCustomViewRequest)
...
final String viewid = viewid_example; // String | The VIEWID identifier
final String targetviewid = targetviewid_example; // String | The TARGETVIEWID identifier
final UpdateCustomViewRequest updateCustomViewRequest = {"type":"object","properties":{"allowed_permissions":{"type":"array","items":{"type":"string"}},"hide_metadata_if_alias_used":{"type":"boolean"},"description":{"type":"string"},"is_public":{"type":"boolean"},"metadata_view":{"type":"string"},"which_alias_to_use":{"type":"string"}}}; // UpdateCustomViewRequest | Request body

try {
    final response = api.updateCustomView(bankid, accountid, viewid, targetviewid, updateCustomViewRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->updateCustomView: $e\n');
}
```
...
> CreateUserWithAccountAccessById200ResponseHead updateViewForBankAccount(bankid, accountid, viewid, updateViewForBankAccountRequest)
...
final String accountid = accountid_example; // String | The ACCOUNTID identifier
final String viewid = viewid_example; // String | The VIEWID identifier
final UpdateViewForBankAccountRequest updateViewForBankAccountRequest = {"type":"object","properties":{"allowed_actions":{"type":"array","items":{"type":"string"}},"description":{"type":"string"},"hide_metadata_if_alias_used":{"type":"boolean"},"metadata_view":{"type":"string"},"is_public":{"type":"boolean"},"which_alias_to_use":{"type":"string"}}}; // UpdateViewForBankAccountRequest | Request body

try {
    final response = api.updateViewForBankAccount(bankid, accountid, viewid, updateViewForBankAccountRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling AccountApi->updateViewForBankAccount: $e\n');
}
```
