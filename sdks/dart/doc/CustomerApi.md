...
try {
    ...
    print('Exception when calling CustomerApi->addCustomerMessage: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->addKycCheck: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->addKycDocument: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->addKycMedia: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->addKycStatus: $e\n');
}
```
...
final String bankid = bankid_example; // String | The BANKID identifier
final String customerid = customerid_example; // String | The CUSTOMERID identifier
final GetSocialMediaHandles200ResponseChecksInner getSocialMediaHandles200ResponseChecksInner = {"type":"object","properties":{"date_activated":{"type":"string","format":"date-time"},"type":{"type":"string"},"customer_number":{"type":"string"},"date_added":{"type":"string","format":"date-time"},"handle":{"type":"string"}}}; // GetSocialMediaHandles200ResponseChecksInner | Request body

try {
    final response = api.addSocialMediaHandle(bankid, customerid, getSocialMediaHandles200ResponseChecksInner);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->addSocialMediaHandle: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->createAgent: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->createCorporateCustomer: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->createCustomerAccountLink: $e\n');
}
```
...
final String bankid = bankid_example; // String | The BANKID identifier
final String customerid = customerid_example; // String | The CUSTOMERID identifier
final CreateCustomerAddressRequest createCustomerAddressRequest = {"type":"object","properties":{"city":{"type":"string"},"tags":{"type":"array","items":{"type":"string"}},"postcode":{"type":"string"},"line_1":{"type":"string"},"line_2":{"type":"string"},"line_3":{"type":"string"},"state":{"type":"string"},"status":{"type":"string"},"country_code":{"type":"string"},"county":{"type":"string"}}}; // CreateCustomerAddressRequest | Request body

try {
    final response = api.createCustomerAddress(bankid, customerid, createCustomerAddressRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->createCustomerAddress: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->createCustomerAttribute: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->createCustomerMessage: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->createMeeting: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->createOrUpdateCustomerAttributeAttributeDefinition: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->createRetailCustomer: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->createTaxResidence: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->createUserCustomerLinks: $e\n');
}
```
...
try {
    api.deleteCustomerAccountLinkById(bankid, customeraccountlinkid);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->deleteCustomerAccountLinkById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->deleteCustomerAddress: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->deleteCustomerAttribute: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->deleteCustomerAttributeDefinition: $e\n');
}
```
...
try {
    api.deleteCustomerCascade(bankid, customerid);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->deleteCustomerCascade: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->deleteTaxResidence: $e\n');
}
```
...
try {
    api.deleteUserCustomerLink(bankid, usercustomerlinkid);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->deleteUserCustomerLink: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCorporateCustomerByCustomerId: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCorporateCustomerSubsidiaries: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCorporateCustomersAtOneBank: $e\n');
}
```
...
try {
    final response = api.getCorrelatedUsersInfoByCustomerId(bankid, customerid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getCorrelatedUsersInfoByCustomerId: $e\n');
}
```
...
try {
    final response = api.getCrmEvents(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getCrmEvents: $e\n');
}
```
...
try {
    final response = api.getCustomerAccountLinkById(bankid, customeraccountlinkid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getCustomerAccountLinkById: $e\n');
}
```
...
try {
    final response = api.getCustomerAccountLinksByBankIdAccountId(bankid, accountid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getCustomerAccountLinksByBankIdAccountId: $e\n');
}
```
...
try {
    final response = api.getCustomerAccountLinksByCustomerId(bankid, customerid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getCustomerAccountLinksByCustomerId: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomerAddresses: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomerAttributeById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomerAttributeDefinition: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomerAttributes: $e\n');
}
```
...
try {
    final response = api.getCustomerByCustomerId(bankid, customerid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getCustomerByCustomerId: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomerByCustomerNumber: $e\n');
}
```
...
try {
    final response = api.getCustomerChildren(bankid, customerid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getCustomerChildren: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomerMessages: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomerOverview: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomerOverviewFlat: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomersAtAllBanks: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomersAtOneBank: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomersByCustomerPhoneNumber: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomersByLegalName: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomersForUser: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomersForUserIdsOnly: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomersMessages: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomersMinimalAtAnyBank: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getCustomersMinimalAtOneBank: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getFirehoseCustomers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getKycChecks: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getKycDocuments: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getKycMedia: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getKycStatuses: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getMeeting: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getMeetings: $e\n');
}
```
...
try {
    final response = api.getMyCorrelatedEntities();
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getMyCorrelatedEntities: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getMyCustomersAtAnyBank: $e\n');
}
```
...
try {
    final response = api.getMyCustomersAtBank(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getMyCustomersAtBank: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getRetailCustomerByCustomerId: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getRetailCustomersAtOneBank: $e\n');
}
```
...
try {
    final response = api.getSocialMediaHandles(bankid, customerid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getSocialMediaHandles: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->getTaxResidence: $e\n');
}
```
...
try {
    final response = api.getUserCustomerLinksByCustomerId(bankid, customerid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getUserCustomerLinksByCustomerId: $e\n');
}
```
...
try {
    final response = api.getUserCustomerLinksByUserId(bankid, userid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->getUserCustomerLinksByUserId: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->updateAgentStatus: $e\n');
}
```
...
final String bankid = bankid_example; // String | The BANKID identifier
final String customeraccountlinkid = customeraccountlinkid_example; // String | The CUSTOMERACCOUNTLINKID identifier
final UpdateCustomerAccountLinkByIdRequest updateCustomerAccountLinkByIdRequest = {"type":"object","properties":{"relationship_type":{"type":"string"}}}; // UpdateCustomerAccountLinkByIdRequest | Request body

try {
    final response = api.updateCustomerAccountLinkById(bankid, customeraccountlinkid, updateCustomerAccountLinkByIdRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->updateCustomerAccountLinkById: $e\n');
}
```
...
try {
    final response = api.updateCustomerAddress(bankid, customerid, customeraddressid, createCustomerAddressRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->updateCustomerAddress: $e\n');
}
```
...
try {
    ...
    print('Exception when calling CustomerApi->updateCustomerAttribute: $e\n');
}
```
...
final String bankid = bankid_example; // String | The BANKID identifier
final String customerid = customerid_example; // String | The CUSTOMERID identifier
final UpdateCustomerBranchRequest updateCustomerBranchRequest = {"type":"object","properties":{"branch_id":{"type":"string"}}}; // UpdateCustomerBranchRequest | Request body

try {
    final response = api.updateCustomerBranch(bankid, customerid, updateCustomerBranchRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->updateCustomerBranch: $e\n');
}
```
...
final String bankid = bankid_example; // String | The BANKID identifier
final String customerid = customerid_example; // String | The CUSTOMERID identifier
final UpdateCustomerCreditLimitRequest updateCustomerCreditLimitRequest = {"type":"object","properties":{"credit_limit":{"type":"object","properties":{"currency":{"type":"string"},"amount":{"type":"string"}}}}}; // UpdateCustomerCreditLimitRequest | Request body

try {
    final response = api.updateCustomerCreditLimit(bankid, customerid, updateCustomerCreditLimitRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->updateCustomerCreditLimit: $e\n');
}
```
...
final String bankid = bankid_example; // String | The BANKID identifier
final String customerid = customerid_example; // String | The CUSTOMERID identifier
final UpdateCustomerCreditRatingAndSourceRequest updateCustomerCreditRatingAndSourceRequest = {"type":"object","properties":{"credit_source":{"type":"string"},"credit_rating":{"type":"string"}}}; // UpdateCustomerCreditRatingAndSourceRequest | Request body

try {
    final response = api.updateCustomerCreditRatingAndSource(bankid, customerid, updateCustomerCreditRatingAndSourceRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->updateCustomerCreditRatingAndSource: $e\n');
}
```
...
final String bankid = bankid_example; // String | The BANKID identifier
final String customerid = customerid_example; // String | The CUSTOMERID identifier
final UpdateCustomerDataRequest updateCustomerDataRequest = {"type":"object","properties":{"dependants":{"type":"integer"},"face_image":{"type":"object","properties":{"url":{"type":"string"},"date":{"type":"string","format":"date-time"}}},"employment_status":{"type":"string"},"relationship_status":{"type":"string"},"highest_education_attained":{"type":"string"}}}; // UpdateCustomerDataRequest | Request body

try {
    final response = api.updateCustomerData(bankid, customerid, updateCustomerDataRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->updateCustomerData: $e\n');
}
```
...
final String bankid = bankid_example; // String | The BANKID identifier
final String customerid = customerid_example; // String | The CUSTOMERID identifier
final UpdateCustomerEmailRequest updateCustomerEmailRequest = {"type":"object","properties":{"email":{"type":"string"}}}; // UpdateCustomerEmailRequest | Request body

try {
    final response = api.updateCustomerEmail(bankid, customerid, updateCustomerEmailRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->updateCustomerEmail: $e\n');
}
```
...
final String bankid = bankid_example; // String | The BANKID identifier
final String customerid = customerid_example; // String | The CUSTOMERID identifier
final UpdateCustomerIdentityRequest updateCustomerIdentityRequest = {"type":"object","properties":{"date_of_birth":{"type":"string","format":"date-time"},"name_suffix":{"type":"string"},"legal_name":{"type":"string"},"title":{"type":"string"}}}; // UpdateCustomerIdentityRequest | Request body

try {
    final response = api.updateCustomerIdentity(bankid, customerid, updateCustomerIdentityRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->updateCustomerIdentity: $e\n');
}
```
...
try {
    final response = api.updateCustomerMobileNumber(bankid, customerid, createTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->updateCustomerMobileNumber: $e\n');
}
```
...
try {
    final response = api.updateCustomerNumber(bankid, customerid, getCustomerOverviewFlatRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling CustomerApi->updateCustomerNumber: $e\n');
}
```
