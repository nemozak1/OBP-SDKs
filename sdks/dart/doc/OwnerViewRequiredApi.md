# obp_dart.api.OwnerViewRequiredApi
...
final api = ObpDart().getOwnerViewRequiredApi();
...
try {
    ...
    print('Exception when calling OwnerViewRequiredApi->createUserWithAccountAccessById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OwnerViewRequiredApi->grantUserAccessToViewById: $e\n');
}
```
...
try {
    ...
    print('Exception when calling OwnerViewRequiredApi->revokeUserAccessToViewById: $e\n');
}
```
