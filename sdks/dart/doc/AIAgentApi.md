...
try {
    ...
    print('Exception when calling AIAgentApi->deleteSignalChannel: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AIAgentApi->getSignalChannelInfo: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AIAgentApi->getSignalChannels: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AIAgentApi->getSignalMessages: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AIAgentApi->getSignalStats: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AIAgentApi->publishSignalMessage: $e\n');
}
```
