...
try {
    api.deleteBranch(bankid, branchid);
} on DioException catch (e) {
    print('Exception when calling BranchApi->deleteBranch: $e\n');
}
```
...
try {
    ...
    print('Exception when calling BranchApi->getBranch: $e\n');
}
```
