...
try {
    ...
    print('Exception when calling FirehoseDataApi->getFastFirehoseAccountsAtOneBank: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FirehoseDataApi->getFirehoseAccountsAtOneBank: $e\n');
}
```
...
try {
    final response = api.getFirehoseCustomers(bankid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling FirehoseDataApi->getFirehoseCustomers: $e\n');
}
```
...
try {
    ...
    print('Exception when calling FirehoseDataApi->getFirehoseTransactionsForBankAccount: $e\n');
}
```
