...
try {
    final response = api.getApiGlossary();
    print(response);
} on DioException catch (e) {
    print('Exception when calling DocumentationApi->getApiGlossary: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->getBankLevelDynamicResourceDocsObp: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->getMessageDocs: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->getMessageDocsJsonSchema: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->getMessageDocsSwagger: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->getResourceDocsObp: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->getResourceDocsOpenAPI31: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->getResourceDocsSwagger: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DocumentationApi->getScannedApiVersions: $e\n');
}
```
