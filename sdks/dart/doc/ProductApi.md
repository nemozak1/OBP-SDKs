...
try {
    ...
    print('Exception when calling ProductApi->createOrUpdateProductAttributeDefinition: $e\n');
}
```
...
final CreateProductRequest createProductRequest = {"type":"object","properties":{"description":{"type":"string"},"more_info_url":{"type":"string"},"terms_and_conditions_url":{"type":"string"},"parent_product_code":{"type":"string"},"meta":{"type":"object","properties":{"license":{"type":"object","properties":{"name":{"type":"string"},"id":{"type":"string"}}}}},"name":{"type":"string"}}}; // CreateProductRequest | Request body

try {
    final response = api.createProduct(bankid, productcode, createProductRequest);
    print(response);
} on DioException catch (e) {
...
try {
    ...
    print('Exception when calling ProductApi->createProductAttribute: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ProductApi->createProductCollection: $e\n');
}
```
...
final String bankid = bankid_example; // String | The BANKID identifier
final String productcode = productcode_example; // String | The PRODUCTCODE identifier
final UpdateProductFeeRequest updateProductFeeRequest = {type=object, properties={is_active={type=boolean}, name={type=string}, more_info={type=string}, value={type=object, properties={type={type=string}, currency={type=string}, frequency={type=string}, amount={type=number}}}}}; // UpdateProductFeeRequest | Request body

try {
    final response = api.createProductFee(bankid, productcode, updateProductFeeRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ProductApi->createProductFee: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ProductApi->deleteProductAttribute: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ProductApi->deleteProductAttributeDefinition: $e\n');
}
```
...
try {
    api.deleteProductCascade(bankid, productcode);
} on DioException catch (e) {
    print('Exception when calling ProductApi->deleteProductCascade: $e\n');
}
```
...
try {
    api.deleteProductFee(bankid, productcode, productfeeid);
} on DioException catch (e) {
    print('Exception when calling ProductApi->deleteProductFee: $e\n');
}
```
...
try {
    final response = api.getProduct(bankid, productcode);
    print(response);
} on DioException catch (e) {
...
try {
    ...
    print('Exception when calling ProductApi->getProductAttribute: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ProductApi->getProductAttributeDefinition: $e\n');
}
```
...
try {
    ...
    print('Exception when calling ProductApi->getProductCollection: $e\n');
}
```
...
try {
    final response = api.getProductFee(bankid, productcode, productfeeid);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ProductApi->getProductFee: $e\n');
}
```
...
try {
    final response = api.getProductFees(bankid, productcode);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ProductApi->getProductFees: $e\n');
}
```
...
try {
    final response = api.getProductTree(bankid, productcode);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ProductApi->getProductTree: $e\n');
}
```
...
try {
    final response = api.getProducts(bankid);
    print(response);
} on DioException catch (e) {
...
try {
    ...
    print('Exception when calling ProductApi->updateProductAttribute: $e\n');
}
```
...
try {
    final response = api.updateProductFee(bankid, productcode, productfeeid, updateProductFeeRequest);
    print(response);
} on DioException catch (e) {
    print('Exception when calling ProductApi->updateProductFee: $e\n');
}
```
