...
try {
    ...
    println("4xx response calling BranchApi#deleteBranch")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling BranchApi#deleteBranch")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling BranchApi#getBranch")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling BranchApi#getBranch")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling BranchApi#getBranches")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling BranchApi#getBranches")
    e.printStackTrace()
}
```
