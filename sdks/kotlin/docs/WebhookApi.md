...
try {
    ...
    println("4xx response calling WebhookApi#createAccountWebhook")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebhookApi#createAccountWebhook")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling WebhookApi#createBankAccountNotificationWebhook")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebhookApi#createBankAccountNotificationWebhook")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling WebhookApi#createSystemAccountNotificationWebhook")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebhookApi#createSystemAccountNotificationWebhook")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling WebhookApi#enableDisableAccountWebhook")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebhookApi#enableDisableAccountWebhook")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling WebhookApi#getAccountWebhooks")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebhookApi#getAccountWebhooks")
    e.printStackTrace()
}
```
