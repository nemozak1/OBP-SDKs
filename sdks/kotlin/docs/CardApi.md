...
<a id="addCardForBank"></a>
# **addCardForBank**
> AddCardForBank200Response addCardForBank(bankid, addCardForBankRequest)
...
try {
    ...
    println("4xx response calling CardApi#createCardAttribute")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CardApi#createCardAttribute")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling CardApi#createOrUpdateCardAttributeDefinition")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CardApi#createOrUpdateCardAttributeDefinition")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling CardApi#deleteCardAttributeDefinition")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CardApi#deleteCardAttributeDefinition")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling CardApi#deleteCardForBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CardApi#deleteCardForBank")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling CardApi#getCardAttributeDefinition")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CardApi#getCardAttributeDefinition")
    e.printStackTrace()
}
```
...
<a id="getCardForBank"></a>
# **getCardForBank**
> GetCardForBank200Response getCardForBank(bankid, cardid)
...
val cardid : kotlin.String = cardid_example // kotlin.String | The CARDID identifier
try {
    val result : GetCardForBank200Response = apiInstance.getCardForBank(bankid, cardid)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling CardApi#getCardForBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CardApi#getCardForBank")
    e.printStackTrace()
}
```
...
val apiInstance = CardApi()
try {
    val result : GetCards200Response = apiInstance.getCards()
    println(result)
} catch (e: ClientException) {
    println("4xx response calling CardApi#getCards")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CardApi#getCards")
    e.printStackTrace()
}
```
...
<a id="getCardsForBank"></a>
# **getCardsForBank**
> GetCardsForBank200Response getCardsForBank(bankid)
...
val bankid : kotlin.String = bankid_example // kotlin.String | The BANKID identifier
try {
    val result : GetCardsForBank200Response = apiInstance.getCardsForBank(bankid)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling CardApi#getCardsForBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CardApi#getCardsForBank")
    e.printStackTrace()
}
```
...
<a id="getStatusOfCreditCardOrder"></a>
# **getStatusOfCreditCardOrder**
> GetStatusOfCreditCardOrder200Response getStatusOfCreditCardOrder(bankid, accountid, viewid)
...
try {
    val result : GetStatusOfCreditCardOrder200Response = apiInstance.getStatusOfCreditCardOrder(bankid, accountid, viewid)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling CardApi#getStatusOfCreditCardOrder")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CardApi#getStatusOfCreditCardOrder")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling CardApi#updateCardAttribute")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CardApi#updateCardAttribute")
    e.printStackTrace()
}
```
...
<a id="updatedCardForBank"></a>
# **updatedCardForBank**
> GetCardsForBank200ResponseCardsInner updatedCardForBank(bankid, cardid, updatedCardForBankRequest)
...
val bankid : kotlin.String = bankid_example // kotlin.String | The BANKID identifier
val cardid : kotlin.String = cardid_example // kotlin.String | The CARDID identifier
val updatedCardForBankRequest : UpdatedCardForBankRequest = {"type":"object","properties":{"enabled":{"type":"boolean"},"expires_date":{"type":"string","format":"date-time"},"allows":{"type":"array","items":{"type":"string"}},"replacement":{"type":"object","properties":{"requested_date":{"type":"string","format":"date-time"},"reason_requested":{"type":"string"}}},"collected":{"type":"string","format":"date-time"},"technology":{"type":"string"},"valid_from_date":{"type":"string","format":"date-time"},"card_type":{"type":"string"},"name_on_card":{"type":"string"},"pin_reset":{"type":"array","items":{"type":"object","properties":{"requested_date":{"type":"string","format":"date-time"},"reason_requested":{"type":"string"}}}},"customer_id":{"type":"string"},"networks":{"type":"array","items":{"type":"string"}},"issue_number":{"type":"string"},"posted":{"type":"string","format":"date-time"},"serial_number":{"type":"string"},"account_id":{"type":"string"}}} // UpdatedCardForBankRequest | Request body
try {
    val result : GetCardsForBank200ResponseCardsInner = apiInstance.updatedCardForBank(bankid, cardid, updatedCardForBankRequest)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling CardApi#updatedCardForBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CardApi#updatedCardForBank")
    e.printStackTrace()
}
```
