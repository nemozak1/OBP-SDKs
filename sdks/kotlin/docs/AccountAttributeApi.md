...
try {
    ...
    println("4xx response calling AccountAttributeApi#createAccountAttribute")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountAttributeApi#createAccountAttribute")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling AccountAttributeApi#createOrUpdateAccountAttributeDefinition")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountAttributeApi#createOrUpdateAccountAttributeDefinition")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling AccountAttributeApi#deleteAccountAttributeDefinition")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountAttributeApi#deleteAccountAttributeDefinition")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling AccountAttributeApi#getAccountAttributeDefinition")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountAttributeApi#getAccountAttributeDefinition")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling AccountAttributeApi#updateAccountAttribute")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountAttributeApi#updateAccountAttribute")
    e.printStackTrace()
}
```
