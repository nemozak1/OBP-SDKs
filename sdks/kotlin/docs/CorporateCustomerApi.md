...
try {
    ...
    println("4xx response calling CorporateCustomerApi#createCorporateCustomer")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CorporateCustomerApi#createCorporateCustomer")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling CorporateCustomerApi#getCorporateCustomerByCustomerId")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CorporateCustomerApi#getCorporateCustomerByCustomerId")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling CorporateCustomerApi#getCorporateCustomerSubsidiaries")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CorporateCustomerApi#getCorporateCustomerSubsidiaries")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling CorporateCustomerApi#getCorporateCustomersAtOneBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CorporateCustomerApi#getCorporateCustomersAtOneBank")
    e.printStackTrace()
}
```
