...
try {
    ...
    println("4xx response calling CustomerMeetingApi#createMeeting")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CustomerMeetingApi#createMeeting")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling CustomerMeetingApi#getMeeting")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CustomerMeetingApi#getMeeting")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling CustomerMeetingApi#getMeetings")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CustomerMeetingApi#getMeetings")
    e.printStackTrace()
}
```
