...
try {
    ...
    println("4xx response calling ConnectorApi#getConnectors")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ConnectorApi#getConnectors")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ConnectorApi#getStoredProcedureConnectorHealth")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ConnectorApi#getStoredProcedureConnectorHealth")
    e.printStackTrace()
}
```
