...
<a id="createAccountApplication"></a>
...
val createAccountApplicationRequest : CreateAccountApplicationRequest = {"type":"object","properties":{"user_id":{"type":"string"},"product_code":{"type":"string"},"customer_id":{"type":"string"}}} // CreateAccountApplicationRequest | Request body
try {
    val result : GetAccountApplications200ResponseAccountApplicationsInner = apiInstance.createAccountApplication(bankid, createAccountApplicationRequest)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling AccountApplicationApi#createAccountApplication")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountApplicationApi#createAccountApplication")
    e.printStackTrace()
}
```
...
try {
    val result : GetAccountApplications200ResponseAccountApplicationsInner = apiInstance.getAccountApplication(bankid, accountapplicationid)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling AccountApplicationApi#getAccountApplication")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountApplicationApi#getAccountApplication")
    e.printStackTrace()
}
```
...
val bankid : kotlin.String = bankid_example // kotlin.String | The BANKID identifier
try {
    val result : GetAccountApplications200Response = apiInstance.getAccountApplications(bankid)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling AccountApplicationApi#getAccountApplications")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountApplicationApi#getAccountApplications")
    e.printStackTrace()
}
```
...
<a id="updateAccountApplicationStatus"></a>
...
try {
    val result : GetAccountApplications200ResponseAccountApplicationsInner = apiInstance.updateAccountApplicationStatus(bankid, accountapplicationid, updateTransactionRequestStatusRequest)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling AccountApplicationApi#updateAccountApplicationStatus")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountApplicationApi#updateAccountApplicationStatus")
    e.printStackTrace()
}
```
