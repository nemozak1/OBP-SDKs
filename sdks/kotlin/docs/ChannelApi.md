...
try {
    ...
    println("4xx response calling ChannelApi#deleteSignalChannel")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#deleteSignalChannel")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ChannelApi#getSignalChannelInfo")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#getSignalChannelInfo")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ChannelApi#getSignalChannels")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#getSignalChannels")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ChannelApi#getSignalMessages")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#getSignalMessages")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ChannelApi#getSignalStats")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#getSignalStats")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ChannelApi#publishSignalMessage")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ChannelApi#publishSignalMessage")
    e.printStackTrace()
}
```
