...
try {
    val result : CreateWebUiProps200Response = apiInstance.createOrUpdateWebUiProps(webuipropname, getTransactionTypes200ResponseTransactionTypesInnerId)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling WebUiPropsApi#createOrUpdateWebUiProps")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#createOrUpdateWebUiProps")
    e.printStackTrace()
}
```
...
val apiInstance = WebUiPropsApi()
val createTransactionRequestCounterparty200ResponseAttributesInner : CreateTransactionRequestCounterparty200ResponseAttributesInner = {"type":"object","properties":{"name":{"type":"string"},"value":{"type":"string"}}} // CreateTransactionRequestCounterparty200ResponseAttributesInner | Request body
try {
    val result : CreateWebUiProps200Response = apiInstance.createWebUiProps(createTransactionRequestCounterparty200ResponseAttributesInner)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling WebUiPropsApi#createWebUiProps")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#createWebUiProps")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling WebUiPropsApi#deleteWebUiProps")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#deleteWebUiProps")
    e.printStackTrace()
}
```
...
val webuipropname : kotlin.String = webuipropname_example // kotlin.String | The WEBUIPROPNAME identifier
try {
    val result : GetWebUiProps200ResponseWebuiPropsInner = apiInstance.getWebUiProp(webuipropname)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling WebUiPropsApi#getWebUiProp")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#getWebUiProp")
    e.printStackTrace()
}
```
...
val apiInstance = WebUiPropsApi()
try {
    val result : GetWebUiProps200Response = apiInstance.getWebUiProps()
    println(result)
} catch (e: ClientException) {
    println("4xx response calling WebUiPropsApi#getWebUiProps")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling WebUiPropsApi#getWebUiProps")
    e.printStackTrace()
}
```
