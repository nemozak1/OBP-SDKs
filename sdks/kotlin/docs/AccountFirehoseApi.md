...
<a id="getFastFirehoseAccountsAtOneBank"></a>
...
try {
    val result : GetFastFirehoseAccountsAtOneBank200Response = apiInstance.getFastFirehoseAccountsAtOneBank(bankid)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling AccountFirehoseApi#getFastFirehoseAccountsAtOneBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountFirehoseApi#getFastFirehoseAccountsAtOneBank")
    e.printStackTrace()
}
```
...
<a id="getFirehoseAccountsAtOneBank"></a>
...
try {
    val result : GetFirehoseAccountsAtOneBank200Response = apiInstance.getFirehoseAccountsAtOneBank(bankid, viewid)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling AccountFirehoseApi#getFirehoseAccountsAtOneBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountFirehoseApi#getFirehoseAccountsAtOneBank")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling AccountFirehoseApi#getFirehoseTransactionsForBankAccount")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling AccountFirehoseApi#getFirehoseTransactionsForBankAccount")
    e.printStackTrace()
}
```
