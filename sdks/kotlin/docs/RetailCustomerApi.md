...
try {
    ...
    println("4xx response calling RetailCustomerApi#createRetailCustomer")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling RetailCustomerApi#createRetailCustomer")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling RetailCustomerApi#getRetailCustomerByCustomerId")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling RetailCustomerApi#getRetailCustomerByCustomerId")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling RetailCustomerApi#getRetailCustomersAtOneBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling RetailCustomerApi#getRetailCustomersAtOneBank")
    e.printStackTrace()
}
```
