...
try {
    ...
    println("4xx response calling TransactionFirehoseApi#getFirehoseTransactionsForBankAccount")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling TransactionFirehoseApi#getFirehoseTransactionsForBankAccount")
    e.printStackTrace()
}
```
