...
try {
    ...
    println("4xx response calling FirehoseDataApi#getFastFirehoseAccountsAtOneBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling FirehoseDataApi#getFastFirehoseAccountsAtOneBank")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling FirehoseDataApi#getFirehoseAccountsAtOneBank")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling FirehoseDataApi#getFirehoseAccountsAtOneBank")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling FirehoseDataApi#getFirehoseCustomers")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling FirehoseDataApi#getFirehoseCustomers")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling FirehoseDataApi#getFirehoseTransactionsForBankAccount")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling FirehoseDataApi#getFirehoseTransactionsForBankAccount")
    e.printStackTrace()
}
```
