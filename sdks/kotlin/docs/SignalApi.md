...
try {
    ...
    println("4xx response calling SignalApi#deleteSignalChannel")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignalApi#deleteSignalChannel")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignalApi#getSignalChannelInfo")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignalApi#getSignalChannelInfo")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignalApi#getSignalChannels")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignalApi#getSignalChannels")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignalApi#getSignalMessages")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignalApi#getSignalMessages")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignalApi#getSignalStats")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignalApi#getSignalStats")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignalApi#publishSignalMessage")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignalApi#publishSignalMessage")
    e.printStackTrace()
}
```
