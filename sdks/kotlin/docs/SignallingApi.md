...
try {
    ...
    println("4xx response calling SignallingApi#deleteSignalChannel")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#deleteSignalChannel")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignallingApi#getSignalChannelInfo")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#getSignalChannelInfo")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignallingApi#getSignalChannels")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#getSignalChannels")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignallingApi#getSignalMessages")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#getSignalMessages")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignallingApi#getSignalStats")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#getSignalStats")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling SignallingApi#publishSignalMessage")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SignallingApi#publishSignalMessage")
    e.printStackTrace()
}
```
