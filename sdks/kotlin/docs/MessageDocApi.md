...
try {
    ...
    println("4xx response calling MessageDocApi#getMessageDocs")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MessageDocApi#getMessageDocs")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling MessageDocApi#getMessageDocsJsonSchema")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MessageDocApi#getMessageDocsJsonSchema")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling MessageDocApi#getMessageDocsSwagger")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MessageDocApi#getMessageDocsSwagger")
    e.printStackTrace()
}
```
