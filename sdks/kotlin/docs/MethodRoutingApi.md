...
try {
    ...
    println("4xx response calling MethodRoutingApi#createMethodRouting")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MethodRoutingApi#createMethodRouting")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling MethodRoutingApi#deleteMethodRouting")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MethodRoutingApi#deleteMethodRouting")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling MethodRoutingApi#getConnectorMethodNames")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MethodRoutingApi#getConnectorMethodNames")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling MethodRoutingApi#getMethodRoutings")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MethodRoutingApi#getMethodRoutings")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling MethodRoutingApi#updateMethodRouting")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling MethodRoutingApi#updateMethodRouting")
    e.printStackTrace()
}
```
