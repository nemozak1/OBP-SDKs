...
open class DocumentationApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun getApiGlossary() : GetApiGlossary200Response {
        val localVarResponse = getApiGlossaryWithHttpInfo()

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as GetApiGlossary200Response
    ...
    fun getApiGlossaryWithHttpInfo() : ApiResponse<GetApiGlossary200Response?> {
        val localVariableConfig = getApiGlossaryRequestConfig()

        return request<Unit, GetApiGlossary200Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation getApiGlossary
     *
     * @return RequestConfig
     */
    fun getApiGlossaryRequestConfig() : RequestConfig<Unit> {
