...
open class OnboardingApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun createAccount(bankid: kotlin.String, accountid: kotlin.String, addAccountRequest: AddAccountRequest) : AddAccount200Response {
        val localVarResponse = createAccountWithHttpInfo(bankid = bankid, accountid = accountid, addAccountRequest = addAccountRequest)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as AddAccount200Response
    ...
    fun createAccountWithHttpInfo(bankid: kotlin.String, accountid: kotlin.String, addAccountRequest: AddAccountRequest) : ApiResponse<AddAccount200Response?> {
        val localVariableConfig = createAccountRequestConfig(bankid = bankid, accountid = accountid, addAccountRequest = addAccountRequest)

        return request<AddAccountRequest, AddAccount200Response>(
            localVariableConfig
        )
    }
     ...
     */
    fun createAccountRequestConfig(bankid: kotlin.String, accountid: kotlin.String, addAccountRequest: AddAccountRequest) : RequestConfig<AddAccountRequest> {
        val localVariableBody = addAccountRequest
