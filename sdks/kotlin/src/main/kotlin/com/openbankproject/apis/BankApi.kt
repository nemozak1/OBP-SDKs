...
import com.openbankproject.models.CreateBankRequest
import com.openbankproject.models.CreateOrUpdateTransactionRequestAttributeDefinitionRequest
import com.openbankproject.models.CreateSettlementAccount200Response
import com.openbankproject.models.CreateSettlementAccountRequest
...
import com.openbankproject.models.UpdateBank200Response
...
open class BankApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun createBank(createBankRequest: CreateBankRequest) : GetBank200Response {
        val localVarResponse = createBankWithHttpInfo(createBankRequest = createBankRequest)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun createBankWithHttpInfo(createBankRequest: CreateBankRequest) : ApiResponse<GetBank200Response?> {
        val localVariableConfig = createBankRequestConfig(createBankRequest = createBankRequest)

        return request<CreateBankRequest, GetBank200Response>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun createBankRequestConfig(createBankRequest: CreateBankRequest) : RequestConfig<CreateBankRequest> {
        val localVariableBody = createBankRequest
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun createSettlementAccount(bankid: kotlin.String, createSettlementAccountRequest: CreateSettlementAccountRequest) : CreateSettlementAccount200Response {
        val localVarResponse = createSettlementAccountWithHttpInfo(bankid = bankid, createSettlementAccountRequest = createSettlementAccountRequest)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as CreateSettlementAccount200Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun createSettlementAccountWithHttpInfo(bankid: kotlin.String, createSettlementAccountRequest: CreateSettlementAccountRequest) : ApiResponse<CreateSettlementAccount200Response?> {
        val localVariableConfig = createSettlementAccountRequestConfig(bankid = bankid, createSettlementAccountRequest = createSettlementAccountRequest)

        return request<CreateSettlementAccountRequest, CreateSettlementAccount200Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation createSettlementAccount
     *
     * @param bankid The BANKID identifier
     * @param createSettlementAccountRequest Request body
     * @return RequestConfig
     */
    fun createSettlementAccountRequestConfig(bankid: kotlin.String, createSettlementAccountRequest: CreateSettlementAccountRequest) : RequestConfig<CreateSettlementAccountRequest> {
        val localVariableBody = createSettlementAccountRequest
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun createTransactionType(bankid: kotlin.String, getTransactionTypes200ResponseTransactionTypesInner: GetTransactionTypes200ResponseTransactionTypesInner) : CreateTransactionType200Response {
        val localVarResponse = createTransactionTypeWithHttpInfo(bankid = bankid, getTransactionTypes200ResponseTransactionTypesInner = getTransactionTypes200ResponseTransactionTypesInner)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as CreateTransactionType200Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun createTransactionTypeWithHttpInfo(bankid: kotlin.String, getTransactionTypes200ResponseTransactionTypesInner: GetTransactionTypes200ResponseTransactionTypesInner) : ApiResponse<CreateTransactionType200Response?> {
        val localVariableConfig = createTransactionTypeRequestConfig(bankid = bankid, getTransactionTypes200ResponseTransactionTypesInner = getTransactionTypes200ResponseTransactionTypesInner)

        return request<GetTransactionTypes200ResponseTransactionTypesInner, CreateTransactionType200Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation createTransactionType
     *
     * @param bankid The BANKID identifier
     * @param getTransactionTypes200ResponseTransactionTypesInner Request body
     * @return RequestConfig
     */
    fun createTransactionTypeRequestConfig(bankid: kotlin.String, getTransactionTypes200ResponseTransactionTypesInner: GetTransactionTypes200ResponseTransactionTypesInner) : RequestConfig<GetTransactionTypes200ResponseTransactionTypesInner> {
        val localVariableBody = getTransactionTypes200ResponseTransactionTypesInner
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json"
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun deleteBankCascade(bankid: kotlin.String) : Unit {
        val localVarResponse = deleteBankCascadeWithHttpInfo(bankid = bankid)
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun deleteBankCascadeWithHttpInfo(bankid: kotlin.String) : ApiResponse<Unit?> {
        val localVariableConfig = deleteBankCascadeRequestConfig(bankid = bankid)
    ...
    /**
     * To obtain the request config of the operation deleteBankCascade
     *
     * @param bankid The BANKID identifier
     * @return RequestConfig
     */
    fun deleteBankCascadeRequestConfig(bankid: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getBranch(bankid: kotlin.String, branchid: kotlin.String) : GetBranches200ResponseBranchesInner {
        val localVarResponse = getBranchWithHttpInfo(bankid = bankid, branchid = branchid)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as GetBranches200ResponseBranchesInner
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getBranchWithHttpInfo(bankid: kotlin.String, branchid: kotlin.String) : ApiResponse<GetBranches200ResponseBranchesInner?> {
        val localVariableConfig = getBranchRequestConfig(bankid = bankid, branchid = branchid)

        return request<Unit, GetBranches200ResponseBranchesInner>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun getBranchRequestConfig(bankid: kotlin.String, branchid: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getBranches(bankid: kotlin.String) : GetBranches200Response {
        val localVarResponse = getBranchesWithHttpInfo(bankid = bankid)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as GetBranches200Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getBranchesWithHttpInfo(bankid: kotlin.String) : ApiResponse<GetBranches200Response?> {
        val localVariableConfig = getBranchesRequestConfig(bankid = bankid)

        return request<Unit, GetBranches200Response>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun getBranchesRequestConfig(bankid: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getTransactionRequestTypesSupportedByBank(bankid: kotlin.String) : GetTransactionRequestTypesSupportedByBank200Response {
        val localVarResponse = getTransactionRequestTypesSupportedByBankWithHttpInfo(bankid = bankid)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as GetTransactionRequestTypesSupportedByBank200Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getTransactionRequestTypesSupportedByBankWithHttpInfo(bankid: kotlin.String) : ApiResponse<GetTransactionRequestTypesSupportedByBank200Response?> {
        val localVariableConfig = getTransactionRequestTypesSupportedByBankRequestConfig(bankid = bankid)

        return request<Unit, GetTransactionRequestTypesSupportedByBank200Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation getTransactionRequestTypesSupportedByBank
     *
     * @param bankid The BANKID identifier
     * @return RequestConfig
     */
    fun getTransactionRequestTypesSupportedByBankRequestConfig(bankid: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun updateBank(updateBankRequest: UpdateBankRequest) : UpdateBank200Response {
        val localVarResponse = updateBankWithHttpInfo(updateBankRequest = updateBankRequest)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as UpdateBank200Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun updateBankWithHttpInfo(updateBankRequest: UpdateBankRequest) : ApiResponse<UpdateBank200Response?> {
        val localVariableConfig = updateBankRequestConfig(updateBankRequest = updateBankRequest)

        return request<UpdateBankRequest, UpdateBank200Response>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun updateBankRequestConfig(updateBankRequest: UpdateBankRequest) : RequestConfig<UpdateBankRequest> {
        val localVariableBody = updateBankRequest
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json"
