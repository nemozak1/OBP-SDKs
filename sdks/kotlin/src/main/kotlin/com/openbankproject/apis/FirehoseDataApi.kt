...
open class FirehoseDataApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun getFastFirehoseAccountsAtOneBank(bankid: kotlin.String) : GetFastFirehoseAccountsAtOneBank200Response {
        val localVarResponse = getFastFirehoseAccountsAtOneBankWithHttpInfo(bankid = bankid)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as GetFastFirehoseAccountsAtOneBank200Response
    ...
    fun getFastFirehoseAccountsAtOneBankWithHttpInfo(bankid: kotlin.String) : ApiResponse<GetFastFirehoseAccountsAtOneBank200Response?> {
        val localVariableConfig = getFastFirehoseAccountsAtOneBankRequestConfig(bankid = bankid)

        return request<Unit, GetFastFirehoseAccountsAtOneBank200Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation getFastFirehoseAccountsAtOneBank
     *
     * @param bankid The BANKID identifier
     * @return RequestConfig
     */
    fun getFastFirehoseAccountsAtOneBankRequestConfig(bankid: kotlin.String) : RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getFirehoseAccountsAtOneBank(bankid: kotlin.String, viewid: kotlin.String) : GetFirehoseAccountsAtOneBank200Response {
        val localVarResponse = getFirehoseAccountsAtOneBankWithHttpInfo(bankid = bankid, viewid = viewid)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as GetFirehoseAccountsAtOneBank200Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getFirehoseAccountsAtOneBankWithHttpInfo(bankid: kotlin.String, viewid: kotlin.String) : ApiResponse<GetFirehoseAccountsAtOneBank200Response?> {
        val localVariableConfig = getFirehoseAccountsAtOneBankRequestConfig(bankid = bankid, viewid = viewid)

        return request<Unit, GetFirehoseAccountsAtOneBank200Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation getFirehoseAccountsAtOneBank
     *
     * @param bankid The BANKID identifier
     * @param viewid The VIEWID identifier
     * @return RequestConfig
     */
    fun getFirehoseAccountsAtOneBankRequestConfig(bankid: kotlin.String, viewid: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
