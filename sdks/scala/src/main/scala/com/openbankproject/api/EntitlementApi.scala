...
object EntitlementApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new EntitlementApi(baseUrl)
}
...
class EntitlementApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : GetGroupEntitlements200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def getGroupEntitlements(apiKeyHeader: String, apiKeyHeader: String)(groupid: String): Request[Either[ResponseException[String, Exception], GetGroupEntitlements200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/groups/${groupid}/entitlements")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetGroupEntitlements200Response])
