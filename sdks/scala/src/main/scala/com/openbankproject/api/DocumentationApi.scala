...
object DocumentationApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new DocumentationApi(baseUrl)
}
...
class DocumentationApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : GetApiGlossary200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   */
  def getApiGlossary(): Request[Either[ResponseException[String, Exception], GetApiGlossary200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.0.0/api/glossary")
      .contentType("application/json")
      .response(asJson[GetApiGlossary200Response])
