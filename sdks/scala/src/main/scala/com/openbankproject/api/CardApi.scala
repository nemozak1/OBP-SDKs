...
import com.openbankproject.model.AddCardForBank200Response
import com.openbankproject.model.AddCardForBankRequest
...
import com.openbankproject.model.GetCardForBank200Response
import com.openbankproject.model.GetCards200Response
import com.openbankproject.model.GetCardsForBank200Response
import com.openbankproject.model.GetCardsForBank200ResponseCardsInner
import com.openbankproject.model.GetStatusOfCreditCardOrder200Response
...
import com.openbankproject.model.UpdatedCardForBankRequest
import org.openapitools.client.core.JsonSupport._
import sttp.client4._
import sttp.model.Method

object CardApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new CardApi(baseUrl)
}
...
class CardApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : AddCardForBank200Response (Successful operation)
   *   code 404 :  (Not Found)
   ...
   */
  def addCardForBank(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, addCardForBankRequest: AddCardForBankRequest): Request[Either[ResponseException[String, Exception], AddCardForBank200Response]] =
    basicRequest
      ...
      .body(addCardForBankRequest)
      .response(asJson[AddCardForBank200Response])
   ...
   * @param cardid The CARDID identifier
   */
  def deleteCardForBank(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, cardid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetCardForBank200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param cardid The CARDID identifier
   */
  def getCardForBank(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, cardid: String): Request[Either[ResponseException[String, Exception], GetCardForBank200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.1.0/management/banks/${bankid}/cards/${cardid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetCardForBank200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetCards200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getCards(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetCards200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v1.3.0/cards")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetCards200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetCardsForBank200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param bankid The BANKID identifier
   */
  def getCardsForBank(apiKeyHeader: String, apiKeyHeader: String)(bankid: String): Request[Either[ResponseException[String, Exception], GetCardsForBank200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.1.0/management/banks/${bankid}/cards")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetCardsForBank200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetStatusOfCreditCardOrder200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def getStatusOfCreditCardOrder(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String): Request[Either[ResponseException[String, Exception], GetStatusOfCreditCardOrder200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.1.0/banks/${bankid}/accounts/${accountid}/${viewid}/credit_cards/orders")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetStatusOfCreditCardOrder200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetCardsForBank200ResponseCardsInner (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def updatedCardForBank(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, cardid: String, updatedCardForBankRequest: UpdatedCardForBankRequest): Request[Either[ResponseException[String, Exception], GetCardsForBank200ResponseCardsInner]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v3.1.0/management/banks/${bankid}/cards/${cardid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(updatedCardForBankRequest)
      .response(asJson[GetCardsForBank200ResponseCardsInner])
