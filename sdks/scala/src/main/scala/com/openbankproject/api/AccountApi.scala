...
import com.openbankproject.model.AddAccount200Response
import com.openbankproject.model.AddAccountRequest
...
import com.openbankproject.model.CreateCustomView200Response
import com.openbankproject.model.CreateCustomViewManagementRequest
import com.openbankproject.model.CreateCustomViewRequest
...
import com.openbankproject.model.CreateStandingOrder200Response
import com.openbankproject.model.CreateStandingOrderRequest
import com.openbankproject.model.CreateUserWithAccountAccessById200Response
import com.openbankproject.model.CreateUserWithAccountAccessById200ResponseHead
import com.openbankproject.model.CreateUserWithAccountAccessByIdRequest
...
import com.openbankproject.model.GetAccountDirectory200Response
import com.openbankproject.model.GetAccountsAtBank200Response
import com.openbankproject.model.GetAccountsByAccountRoutingRegex200Response
import com.openbankproject.model.GetAccountsByAccountRoutingRegex200ResponseAccountsInner
import com.openbankproject.model.GetAccountsByAccountRoutingRegex200ResponseAccountsInnerAccountAttributesInner
import com.openbankproject.model.GetAccountsByAccountRoutingRegexRequest
...
import com.openbankproject.model.GetAgents200Response
...
import com.openbankproject.model.GetCheckbookOrders200Response
...
import com.openbankproject.model.GetFastFirehoseAccountsAtOneBank200Response
import com.openbankproject.model.GetFirehoseAccountsAtOneBank200Response
import com.openbankproject.model.GetHoldingAccountByReleaser200Response
import com.openbankproject.model.GetOtherAccountsForBankAccount200Response
import com.openbankproject.model.GetPermissionForUserForBankAccount200Response
import com.openbankproject.model.GetPermissionsForBankAccount200Response
import com.openbankproject.model.GetPrivateAccountByIdFull200Response
import com.openbankproject.model.GetPrivateAccountIdsbyBankId200Response
import com.openbankproject.model.GetPublicAccountById200Response
...
import com.openbankproject.model.GetUsersWithAccountAccess200Response
import com.openbankproject.model.GetViewsForBankAccount200Response
import com.openbankproject.model.HasAccountAccess200Response
import com.openbankproject.model.IbanChecker200Response
import com.openbankproject.model.IbanCheckerRequest
import com.openbankproject.model.PrivateAccountsAtOneBank200Response
import com.openbankproject.model.PublicAccountsAllBanks200Response
import com.openbankproject.model.RevokeUserAccessToViewById200Response
import com.openbankproject.model.RevokeUserAccessToViewByIdRequest
import com.openbankproject.model.UpdateAccount200Response
import com.openbankproject.model.UpdateAccountAttributeRequest
import com.openbankproject.model.UpdateAccountLabelRequest
import com.openbankproject.model.UpdateAccountRequest
import com.openbankproject.model.UpdateCustomViewRequest
...
import com.openbankproject.model.UpdateViewForBankAccountRequest
import org.openapitools.client.core.JsonSupport._
import sttp.client4._
import sttp.model.Method

object AccountApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new AccountApi(baseUrl)
}
...
class AccountApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : AddAccount200Response (Successful operation)
   ...
   * @param addAccountRequest Request body
   */
  def addAccount(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, addAccountRequest: AddAccountRequest): Request[Either[ResponseException[String, Exception], AddAccount200Response]] =
    basicRequest
      ...
      .response(asJson[AddAccount200Response])
   ...
   * @param addAccountRequest Request body
   */
  def createAccount(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, addAccountRequest: AddAccountRequest): Request[Either[ResponseException[String, Exception], AddAccount200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : CreateCustomView200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param accountid The ACCOUNTID identifier
   * @param viewid The VIEWID identifier
   * @param createCustomViewRequest Request body
   */
  def createCustomView(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, createCustomViewRequest: CreateCustomViewRequest): Request[Either[ResponseException[String, Exception], CreateCustomView200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.1.0/banks/${bankid}/accounts/${accountid}/views/${viewid}/target-views")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createCustomViewRequest)
      .response(asJson[CreateCustomView200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : CreateUserWithAccountAccessById200ResponseHead (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param bankid The BANKID identifier
   * @param accountid The ACCOUNTID identifier
   * @param createCustomViewManagementRequest Request body
   */
  def createCustomViewManagement(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, createCustomViewManagementRequest: CreateCustomViewManagementRequest): Request[Either[ResponseException[String, Exception], CreateUserWithAccountAccessById200ResponseHead]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/management/banks/${bankid}/accounts/${accountid}/views")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createCustomViewManagementRequest)
      .response(asJson[CreateUserWithAccountAccessById200ResponseHead])
   ...
   * 
   * Expected answers:
   *   code 200 : CreateDirectDebit200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def createDirectDebit(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, createDirectDebitRequest: CreateDirectDebitRequest): Request[Either[ResponseException[String, Exception], CreateDirectDebit200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/direct-debit")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createDirectDebitRequest)
      .response(asJson[CreateDirectDebit200Response])
   ...
   * @param createDirectDebitRequest Request body
   */
  def createDirectDebitManagement(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, createDirectDebitRequest: CreateDirectDebitRequest): Request[Either[ResponseException[String, Exception], CreateDirectDebit200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : CreateStandingOrder200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def createStandingOrder(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, createStandingOrderRequest: CreateStandingOrderRequest): Request[Either[ResponseException[String, Exception], CreateStandingOrder200Response]] =
    basicRequest
      ...
      .response(asJson[CreateStandingOrder200Response])
   ...
   * @param createStandingOrderRequest Request body
   */
  def createStandingOrderManagement(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, createStandingOrderRequest: CreateStandingOrderRequest): Request[Either[ResponseException[String, Exception], CreateStandingOrder200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : CreateUserWithAccountAccessById200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def createUserWithAccountAccessById(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, createUserWithAccountAccessByIdRequest: CreateUserWithAccountAccessByIdRequest): Request[Either[ResponseException[String, Exception], CreateUserWithAccountAccessById200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.1.0/banks/${bankid}/accounts/${accountid}/views/${viewid}/user-account-access")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createUserWithAccountAccessByIdRequest)
      .response(asJson[CreateUserWithAccountAccessById200Response])
   ...
   * @param createCustomViewManagementRequest Request body
   */
  def createViewForBankAccount(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, createCustomViewManagementRequest: CreateCustomViewManagementRequest): Request[Either[ResponseException[String, Exception], CreateUserWithAccountAccessById200ResponseHead]] =
    basicRequest
   ...
   * @param accountid The ACCOUNTID identifier
   */
  def deleteAccountCascade(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   */
  def deleteCustomView(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, targetviewid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * @param viewid The VIEWID identifier
   */
  def deleteViewForBankAccount(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   */
  def getAccountAccessByUserId(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], GetApiTags200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetAccountsByAccountRoutingRegex200ResponseAccountsInner (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   *   DirectLogin (apiKey)
   * 
   * @param getAccountsByAccountRoutingRegexRequest Request body
   */
  def getAccountByAccountRouting(apiKeyHeader: String, apiKeyHeader: String)(getAccountsByAccountRoutingRegexRequest: GetAccountsByAccountRoutingRegexRequest): Request[Either[ResponseException[String, Exception], GetAccountsByAccountRoutingRegex200ResponseAccountsInner]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/management/accounts/account-routing-query")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(getAccountsByAccountRoutingRegexRequest)
      .response(asJson[GetAccountsByAccountRoutingRegex200ResponseAccountsInner])
   ...
   * 
   * Expected answers:
   *   code 200 : GetAccountDirectory200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param bankid The BANKID identifier
   */
  def getAccountDirectory(apiKeyHeader: String, apiKeyHeader: String)(bankid: String): Request[Either[ResponseException[String, Exception], GetAccountDirectory200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/account-directory")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetAccountDirectory200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetAccountsAtBank200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param bankid The BANKID identifier
   */
  def getAccountsAtBank(apiKeyHeader: String, apiKeyHeader: String)(bankid: String): Request[Either[ResponseException[String, Exception], GetAccountsAtBank200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/accounts")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetAccountsAtBank200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetAccountsByAccountRoutingRegex200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param getAccountsByAccountRoutingRegexRequest Request body
   */
  def getAccountsByAccountRoutingRegex(apiKeyHeader: String, apiKeyHeader: String)(getAccountsByAccountRoutingRegexRequest: GetAccountsByAccountRoutingRegexRequest): Request[Either[ResponseException[String, Exception], GetAccountsByAccountRoutingRegex200Response]] =
    basicRequest
      ...
      .header("DirectLogin", apiKeyHeader)
      .body(getAccountsByAccountRoutingRegexRequest)
      .response(asJson[GetAccountsByAccountRoutingRegex200Response])
   ...
   * @param userid The USERID identifier
   */
  def getAccountsHeldByUser(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], GetAccountsHeldByUserAtBank200Response]] =
    basicRequest
   ...
   * @param bankid The BANKID identifier
   */
  def getAccountsHeldByUserAtBank(apiKeyHeader: String, apiKeyHeader: String)(userid: String, bankid: String): Request[Either[ResponseException[String, Exception], GetAccountsHeldByUserAtBank200Response]] =
    basicRequest
   ...
   */
  def getAccountsMinimalByCustomerId(apiKeyHeader: String, apiKeyHeader: String)(customerid: String): Request[Either[ResponseException[String, Exception], GetApiTags200Response]] =
    basicRequest
   ...
   */
  def getAgent(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, agentid: String): Request[Either[ResponseException[String, Exception], GetAgent200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetAgents200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * @param bankid The BANKID identifier
   */
  def getAgents(bankid: String): Request[Either[ResponseException[String, Exception], GetAgents200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/banks/${bankid}/agents")
      .contentType("application/json")
      .response(asJson[GetAgents200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetCheckbookOrders200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param viewid The VIEWID identifier
   */
  def getCheckbookOrders(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String): Request[Either[ResponseException[String, Exception], GetCheckbookOrders200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.1.0/banks/${bankid}/accounts/${accountid}/${viewid}/checkbook/orders")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetCheckbookOrders200Response])
   ...
   * @param targetviewid The TARGETVIEWID identifier
   */
  def getCustomView(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, targetviewid: String): Request[Either[ResponseException[String, Exception], CreateCustomView200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetFastFirehoseAccountsAtOneBank200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param bankid The BANKID identifier
   */
  def getFastFirehoseAccountsAtOneBank(apiKeyHeader: String, apiKeyHeader: String)(bankid: String): Request[Either[ResponseException[String, Exception], GetFastFirehoseAccountsAtOneBank200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/management/banks/${bankid}/fast-firehose/accounts")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetFastFirehoseAccountsAtOneBank200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetFirehoseAccountsAtOneBank200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param viewid The VIEWID identifier
   */
  def getFirehoseAccountsAtOneBank(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, viewid: String): Request[Either[ResponseException[String, Exception], GetFirehoseAccountsAtOneBank200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/banks/${bankid}/firehose/accounts/views/${viewid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetFirehoseAccountsAtOneBank200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetHoldingAccountByReleaser200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param viewid The VIEWID identifier
   */
  def getHoldingAccountByReleaser(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String): Request[Either[ResponseException[String, Exception], GetHoldingAccountByReleaser200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/holding-accounts")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetHoldingAccountByReleaser200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetPermissionForUserForBankAccount200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def getPermissionForUserForBankAccount(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, provider: String, providerid: String): Request[Either[ResponseException[String, Exception], GetPermissionForUserForBankAccount200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.0.0/banks/${bankid}/accounts/${accountid}/permissions/${provider}/${providerid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetPermissionForUserForBankAccount200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetPermissionsForBankAccount200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param accountid The ACCOUNTID identifier
   */
  def getPermissionsForBankAccount(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String): Request[Either[ResponseException[String, Exception], GetPermissionsForBankAccount200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v2.0.0/banks/${bankid}/accounts/${accountid}/permissions")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetPermissionsForBankAccount200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetPrivateAccountByIdFull200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param viewid The VIEWID identifier
   */
  def getPrivateAccountByIdFull(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String): Request[Either[ResponseException[String, Exception], GetPrivateAccountByIdFull200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/account")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetPrivateAccountByIdFull200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetPublicAccountById200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * @param bankid The BANKID identifier
   ...
   * @param viewid The VIEWID identifier
   */
  def getPublicAccountById(bankid: String, accountid: String, viewid: String): Request[Either[ResponseException[String, Exception], GetPublicAccountById200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.0.0/banks/${bankid}/public/accounts/${accountid}/${viewid}/account")
      .contentType("application/json")
      .response(asJson[GetPublicAccountById200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetUsersWithAccountAccess200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param viewid The VIEWID identifier
   */
  def getUsersWithAccountAccess(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String): Request[Either[ResponseException[String, Exception], GetUsersWithAccountAccess200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/accounts/${accountid}/views/${viewid}/users-with-access")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetUsersWithAccountAccess200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetViewsForBankAccount200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param accountid The ACCOUNTID identifier
   */
  def getViewsForBankAccount(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String): Request[Either[ResponseException[String, Exception], GetViewsForBankAccount200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.0.0/banks/${bankid}/accounts/${accountid}/views")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetViewsForBankAccount200Response])
   ...
   */
  def grantUserAccessToViewById(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, revokeUserAccessToViewByIdRequest: RevokeUserAccessToViewByIdRequest): Request[Either[ResponseException[String, Exception], CreateUserWithAccountAccessById200ResponseHead]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.1.0/banks/${bankid}/accounts/${accountid}/views/${viewid}/account-access/grant")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(revokeUserAccessToViewByIdRequest)
      .response(asJson[CreateUserWithAccountAccessById200ResponseHead])
   ...
   * 
   * Expected answers:
   *   code 200 : HasAccountAccess200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param viewid The VIEWID identifier
   */
  def hasAccountAccess(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String): Request[Either[ResponseException[String, Exception], HasAccountAccess200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/accounts/${accountid}/views/${viewid}/has-account-access")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[HasAccountAccess200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : IbanChecker200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * @param ibanCheckerRequest Request body
   */
  def ibanChecker(ibanCheckerRequest: IbanCheckerRequest): Request[Either[ResponseException[String, Exception], IbanChecker200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/account/check/scheme/iban")
      .contentType("application/json")
      .body(ibanCheckerRequest)
      .response(asJson[IbanChecker200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : PublicAccountsAllBanks200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   */
  def publicAccountsAllBanks(): Request[Either[ResponseException[String, Exception], PublicAccountsAllBanks200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v2.0.0/accounts/public")
      .contentType("application/json")
      .response(asJson[PublicAccountsAllBanks200Response])
   ...
   * @param bankid The BANKID identifier
   */
  def publicAccountsAtOneBank(bankid: String): Request[Either[ResponseException[String, Exception], PublicAccountsAllBanks200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : RevokeUserAccessToViewById200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param revokeUserAccessToViewByIdRequest Request body
   */
  def revokeUserAccessToViewById(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, revokeUserAccessToViewByIdRequest: RevokeUserAccessToViewByIdRequest): Request[Either[ResponseException[String, Exception], RevokeUserAccessToViewById200Response]] =
    basicRequest
      ...
      .header("DirectLogin", apiKeyHeader)
      .body(revokeUserAccessToViewByIdRequest)
      .response(asJson[RevokeUserAccessToViewById200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : UpdateAccount200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param bankid The BANKID identifier
   * @param accountid The ACCOUNTID identifier
   * @param updateAccountRequest Request body
   */
  def updateAccount(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, updateAccountRequest: UpdateAccountRequest): Request[Either[ResponseException[String, Exception], UpdateAccount200Response]] =
    basicRequest
      ...
      .response(asJson[UpdateAccount200Response])
   ...
   * @param bankid The BANKID identifier
   * @param accountid The ACCOUNTID identifier
   * @param updateAccountLabelRequest Request body
   */
  def updateAccountLabel(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, updateAccountLabelRequest: UpdateAccountLabelRequest): Request[Either[ResponseException[String, Exception], UpdateTransactionNarrative200Response]] =
    basicRequest
   ...
   * @param viewid The VIEWID identifier
   * @param targetviewid The TARGETVIEWID identifier
   * @param updateCustomViewRequest Request body
   */
  def updateCustomView(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, targetviewid: String, updateCustomViewRequest: UpdateCustomViewRequest): Request[Either[ResponseException[String, Exception], CreateCustomView200Response]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v5.1.0/banks/${bankid}/accounts/${accountid}/views/${viewid}/target-views/${targetviewid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(updateCustomViewRequest)
      .response(asJson[CreateCustomView200Response])
   ...
   * @param accountid The ACCOUNTID identifier
   * @param viewid The VIEWID identifier
   * @param updateViewForBankAccountRequest Request body
   */
  def updateViewForBankAccount(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, updateViewForBankAccountRequest: UpdateViewForBankAccountRequest): Request[Either[ResponseException[String, Exception], CreateUserWithAccountAccessById200ResponseHead]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v3.0.0/banks/${bankid}/accounts/${accountid}/views/${viewid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(updateViewForBankAccountRequest)
      .response(asJson[CreateUserWithAccountAccessById200ResponseHead])
