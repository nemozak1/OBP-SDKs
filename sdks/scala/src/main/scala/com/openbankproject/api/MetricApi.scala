...
object MetricApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new MetricApi(baseUrl)
}
...
class MetricApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : GetAggregateMetrics200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getAggregateMetrics(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetAggregateMetrics200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/aggregate-metrics")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetAggregateMetrics200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetMetricsTopConsumers200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getMetricsTopConsumers(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetMetricsTopConsumers200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.1.0/management/metrics/top-consumers")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetMetricsTopConsumers200Response])
