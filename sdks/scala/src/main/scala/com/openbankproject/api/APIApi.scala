...
import com.openbankproject.model.CleanupOrphanedDynamicEntityRecords200Response
import com.openbankproject.model.Config200Response
...
import com.openbankproject.model.GetAdapterInfo200Response
...
import com.openbankproject.model.GetApiTags200Response
import com.openbankproject.model.GetAppDirectory200Response
...
import com.openbankproject.model.GetBankLevelEndpointTags200Response
...
import com.openbankproject.model.GetConfigProps200Response
...
import com.openbankproject.model.GetDynamicEntityDiagnostics200Response
...
import com.openbankproject.model.GetFeatures200Response
import com.openbankproject.model.GetMapperDatabaseInfo200Response
...
import com.openbankproject.model.GetReferenceTypes200Response
...
import com.openbankproject.model.Root200Response
import com.openbankproject.model.SuggestedSessionTimeout200Response
...
import com.openbankproject.model.UpdateSystemLevelEndpointTagRequest
import com.openbankproject.model.WaitingForGodot200Response
import org.openapitools.client.core.JsonSupport._
import sttp.client4._
import sttp.model.Method

object APIApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new APIApi(baseUrl)
}
...
class APIApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : CleanupOrphanedDynamicEntityRecords200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def cleanupOrphanedDynamicEntityRecords(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], CleanupOrphanedDynamicEntityRecords200Response]] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/obp/v6.0.0/management/diagnostics/dynamic-entities/orphaned-records")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[CleanupOrphanedDynamicEntityRecords200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : Config200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def config(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], Config200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.1.0/config")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[Config200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetApiProducts200ResponseApiProductsInner (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def createApiProduct(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, apiproductcode: String, createOrUpdateApiProductRequest: CreateOrUpdateApiProductRequest): Request[Either[ResponseException[String, Exception], GetApiProducts200ResponseApiProductsInner]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/api-products/${apiproductcode}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createOrUpdateApiProductRequest)
      .response(asJson[GetApiProducts200ResponseApiProductsInner])
   ...
   * 
   * Expected answers:
   *   code 200 : UpdateSystemLevelEndpointTag200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def createBankLevelEndpointTag(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, operationid: String, updateSystemLevelEndpointTagRequest: UpdateSystemLevelEndpointTagRequest): Request[Either[ResponseException[String, Exception], UpdateSystemLevelEndpointTag200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/management/banks/${bankid}/endpoints/${operationid}/tags")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(updateSystemLevelEndpointTagRequest)
      .response(asJson[UpdateSystemLevelEndpointTag200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetMethodRoutings200ResponseMethodRoutingsInner (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def createMethodRouting(apiKeyHeader: String, apiKeyHeader: String)(createMethodRoutingRequest: CreateMethodRoutingRequest): Request[Either[ResponseException[String, Exception], GetMethodRoutings200ResponseMethodRoutingsInner]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v3.1.0/management/method_routings")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createMethodRoutingRequest)
      .response(asJson[GetMethodRoutings200ResponseMethodRoutingsInner])
   ...
   * @param createOrUpdateApiProductRequest Request body
   */
  def createOrUpdateApiProduct(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, apiproductcode: String, createOrUpdateApiProductRequest: CreateOrUpdateApiProductRequest): Request[Either[ResponseException[String, Exception], GetApiProducts200ResponseApiProductsInner]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetRegulatedEntityById200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def createRegulatedEntity(apiKeyHeader: String, apiKeyHeader: String)(createRegulatedEntityRequest: CreateRegulatedEntityRequest): Request[Either[ResponseException[String, Exception], GetRegulatedEntityById200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.1.0/regulated-entities")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createRegulatedEntityRequest)
      .response(asJson[GetRegulatedEntityById200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetRegulatedEntityAttributeById200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   * @param createCounterpartyAttributeRequest Request body
   */
  def createRegulatedEntityAttribute(apiKeyHeader: String, apiKeyHeader: String)(regulatedentityid: String, createCounterpartyAttributeRequest: CreateCounterpartyAttributeRequest): Request[Either[ResponseException[String, Exception], GetRegulatedEntityAttributeById200Response]] =
    basicRequest
      ...
      .header("DirectLogin", apiKeyHeader)
      .body(createCounterpartyAttributeRequest)
      .response(asJson[GetRegulatedEntityAttributeById200Response])
   ...
   * @param updateSystemLevelEndpointTagRequest Request body
   */
  def createSystemLevelEndpointTag(apiKeyHeader: String, apiKeyHeader: String)(operationid: String, updateSystemLevelEndpointTagRequest: UpdateSystemLevelEndpointTagRequest): Request[Either[ResponseException[String, Exception], UpdateSystemLevelEndpointTag200Response]] =
    basicRequest
   ...
   * @param apiproductcode The APIPRODUCTCODE identifier
   */
  def deleteApiProduct(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, apiproductcode: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   */
  def deleteBankLevelEndpointTag(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, operationid: String, endpointtagid: String): Request[Either[ResponseException[String, Exception], DeleteSystemLevelEndpointTag200Response]] =
    basicRequest
   ...
   */
  def deleteMethodRouting(apiKeyHeader: String, apiKeyHeader: String)(methodroutingid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * @param regulatedentityid The REGULATEDENTITYID identifier
   */
  def deleteRegulatedEntity(apiKeyHeader: String, apiKeyHeader: String)(regulatedentityid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   */
  def deleteRegulatedEntityAttribute(apiKeyHeader: String, apiKeyHeader: String)(regulatedentityid: String, regulatedentityattributeid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * @param endpointtagid The ENDPOINTTAGID identifier
   */
  def deleteSystemLevelEndpointTag(apiKeyHeader: String, apiKeyHeader: String)(operationid: String, endpointtagid: String): Request[Either[ResponseException[String, Exception], DeleteSystemLevelEndpointTag200Response]] =
    basicRequest
   ...
   *   DirectLogin (apiKey)
   */
  def elasticSearchMetrics(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], Any]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetAdapterInfo200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getAdapterInfo(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetAdapterInfo200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.0.0/adapter")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetAdapterInfo200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetMapperDatabaseInfo200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   * @param bankid The BANKID identifier
   */
  def getAdapterInfoForBank(apiKeyHeader: String, apiKeyHeader: String)(bankid: String): Request[Either[ResponseException[String, Exception], GetMapperDatabaseInfo200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.0.0/banks/${bankid}/adapter")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetMapperDatabaseInfo200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetAllRegulatedEntityAttributes200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   * @param regulatedentityid The REGULATEDENTITYID identifier
   */
  def getAllRegulatedEntityAttributes(apiKeyHeader: String, apiKeyHeader: String)(regulatedentityid: String): Request[Either[ResponseException[String, Exception], GetAllRegulatedEntityAttributes200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/regulated-entities/${regulatedentityid}/attributes")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetAllRegulatedEntityAttributes200Response])
   ...
   * @param apiproductcode The APIPRODUCTCODE identifier
   */
  def getApiProduct(bankid: String, apiproductcode: String): Request[Either[ResponseException[String, Exception], GetApiProducts200ResponseApiProductsInner]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetApiProducts200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * @param bankid The BANKID identifier
   */
  def getApiProducts(bankid: String): Request[Either[ResponseException[String, Exception], GetApiProducts200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/api-products")
      .contentType("application/json")
      .response(asJson[GetApiProducts200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetApiTags200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   */
  def getApiTags(): Request[Either[ResponseException[String, Exception], GetApiTags200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/tags")
      .contentType("application/json")
      .response(asJson[GetApiTags200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetAppDirectory200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getAppDirectory(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetAppDirectory200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/app-directory")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetAppDirectory200Response])
   ...
   *   DirectLogin (apiKey)
   */
  def getAvailablePersonalDynamicEntities(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetAvailablePersonalDynamicEntities200Response]] =
    basicRequest
   ...
   */
  def getBankLevelDynamicResourceDocsObp(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, apiversion: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetBankLevelEndpointTags200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param operationid The OPERATIONID identifier
   */
  def getBankLevelEndpointTags(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, operationid: String): Request[Either[ResponseException[String, Exception], GetBankLevelEndpointTags200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/management/banks/${bankid}/endpoints/${operationid}/tags")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetBankLevelEndpointTags200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetCacheConfig200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getCacheConfig(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetCacheConfig200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/system/cache/config")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetCacheConfig200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetCacheInfo200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getCacheInfo(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetCacheInfo200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/system/cache/info")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetCacheInfo200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetCacheNamespaces200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getCacheNamespaces(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetCacheNamespaces200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/system/cache/namespaces")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetCacheNamespaces200Response])
   ...
   *   DirectLogin (apiKey)
   */
  def getCallContext(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetConfigProps200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getConfigProps(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetConfigProps200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/config-props")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetConfigProps200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetConnectorCallCounts200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getConnectorCallCounts(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetConnectorCallCounts200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/connector/metrics/counts")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetConnectorCallCounts200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetConnectorMetrics200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getConnectorMetrics(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetConnectorMetrics200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v2.2.0/management/connector/metrics")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetConnectorMetrics200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetConnectorTraces200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getConnectorTraces(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetConnectorTraces200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/connector/traces")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetConnectorTraces200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetConnectors200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   */
  def getConnectors(): Request[Either[ResponseException[String, Exception], GetConnectors200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/system/connectors")
      .contentType("application/json")
      .response(asJson[GetConnectors200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetCurrentConsumer200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getCurrentConsumer(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetCurrentConsumer200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/consumers/current")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetCurrentConsumer200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetDatabasePoolInfo200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getDatabasePoolInfo(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetDatabasePoolInfo200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/system/database/pool")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetDatabasePoolInfo200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetDynamicEntityDiagnostics200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getDynamicEntityDiagnostics(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetDynamicEntityDiagnostics200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/diagnostics/dynamic-entities")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetDynamicEntityDiagnostics200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetFeatures200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getFeatures(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetFeatures200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/features")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetFeatures200Response])
   ...
   *   DirectLogin (apiKey)
   */
  def getMapperDatabaseInfo(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetMapperDatabaseInfo200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetMessageDocs200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * @param connector The CONNECTOR identifier
   */
  def getMessageDocs(connector: String): Request[Either[ResponseException[String, Exception], GetMessageDocs200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v2.2.0/message-docs/${connector}")
      .contentType("application/json")
      .response(asJson[GetMessageDocs200Response])
   ...
   * @param connector The CONNECTOR identifier
   */
  def getMessageDocsJsonSchema(connector: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * @param connector The CONNECTOR identifier
   */
  def getMessageDocsSwagger(connector: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetMethodRoutings200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getMethodRoutings(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetMethodRoutings200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.1.0/management/method_routings")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetMethodRoutings200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetMetrics200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getMetrics(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetMetrics200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/metrics")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetMetrics200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetMetricsAtBank200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   * @param bankid The BANKID identifier
   */
  def getMetricsAtBank(apiKeyHeader: String, apiKeyHeader: String)(bankid: String): Request[Either[ResponseException[String, Exception], GetMetricsAtBank200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.0.0/management/metrics/banks/${bankid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetMetricsAtBank200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetMigrations200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getMigrations(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetMigrations200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/system/migrations")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetMigrations200Response])
   ...
   *   code 500 :  (Internal Server Error)
   */
  def getOAuth2ServerWellKnown(): Request[Either[ResponseException[String, Exception], GetOAuth2ServerJWKsURIs200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetPopularApis200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   */
  def getPopularApis(): Request[Either[ResponseException[String, Exception], GetPopularApis200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/api/popular-endpoints")
      .contentType("application/json")
      .response(asJson[GetPopularApis200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetReferenceTypes200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getReferenceTypes(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetReferenceTypes200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/dynamic-entities/reference-types")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetReferenceTypes200Response])
   ...
   * @param regulatedentityattributeid The REGULATEDENTITYATTRIBUTEID identifier
   */
  def getRegulatedEntityAttributeById(apiKeyHeader: String, apiKeyHeader: String)(regulatedentityid: String, regulatedentityattributeid: String): Request[Either[ResponseException[String, Exception], GetRegulatedEntityAttributeById200Response]] =
    basicRequest
   ...
   * @param regulatedentityid The REGULATEDENTITYID identifier
   */
  def getRegulatedEntityById(regulatedentityid: String): Request[Either[ResponseException[String, Exception], GetRegulatedEntityById200Response]] =
    basicRequest
   ...
   * @param apiversion The APIVERSION identifier
   */
  def getResourceDocsObp(apiKeyHeader: String, apiKeyHeader: String)(apiversion: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * @param apiversion The APIVERSION identifier
   */
  def getResourceDocsOpenAPI31(apiversion: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * @param apiversion The APIVERSION identifier
   */
  def getResourceDocsSwagger(apiversion: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetScannedApiVersions200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getScannedApiVersions(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetScannedApiVersions200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/api/versions")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetScannedApiVersions200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetStoredProcedureConnectorHealth200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getStoredProcedureConnectorHealth(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetStoredProcedureConnectorHealth200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/system/connectors/stored_procedure_vDec2019/health")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetStoredProcedureConnectorHealth200Response])
   ...
   * @param operationid The OPERATIONID identifier
   */
  def getSystemLevelEndpointTags(apiKeyHeader: String, apiKeyHeader: String)(operationid: String): Request[Either[ResponseException[String, Exception], GetBankLevelEndpointTags200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetTopAPIs200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getTopAPIs(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetTopAPIs200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/metrics/top-apis")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetTopAPIs200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : InvalidateCacheNamespace200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def invalidateCacheNamespace(apiKeyHeader: String, apiKeyHeader: String)(invalidateCacheNamespaceRequest: InvalidateCacheNamespaceRequest): Request[Either[ResponseException[String, Exception], InvalidateCacheNamespace200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/management/cache/namespaces/invalidate")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(invalidateCacheNamespaceRequest)
      .response(asJson[InvalidateCacheNamespace200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : RegulatedEntities200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   */
  def regulatedEntities(): Request[Either[ResponseException[String, Exception], RegulatedEntities200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/regulated-entities")
      .contentType("application/json")
      .response(asJson[RegulatedEntities200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : Root200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   */
  def root(): Request[Either[ResponseException[String, Exception], Root200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/root")
      .contentType("application/json")
      .response(asJson[Root200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : SuggestedSessionTimeout200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   */
  def suggestedSessionTimeout(): Request[Either[ResponseException[String, Exception], SuggestedSessionTimeout200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/ui/suggested-session-timeout")
      .contentType("application/json")
      .response(asJson[SuggestedSessionTimeout200Response])
   ...
   * @param updateSystemLevelEndpointTagRequest Request body
   */
  def updateBankLevelEndpointTag(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, operationid: String, endpointtagid: String, updateSystemLevelEndpointTagRequest: UpdateSystemLevelEndpointTagRequest): Request[Either[ResponseException[String, Exception], UpdateSystemLevelEndpointTag200Response]] =
    basicRequest
   ...
   * @param createMethodRoutingRequest Request body
   */
  def updateMethodRouting(apiKeyHeader: String, apiKeyHeader: String)(methodroutingid: String, createMethodRoutingRequest: CreateMethodRoutingRequest): Request[Either[ResponseException[String, Exception], GetMethodRoutings200ResponseMethodRoutingsInner]] =
    basicRequest
   ...
   * @param createCounterpartyAttributeRequest Request body
   */
  def updateRegulatedEntityAttribute(apiKeyHeader: String, apiKeyHeader: String)(regulatedentityid: String, regulatedentityattributeid: String, createCounterpartyAttributeRequest: CreateCounterpartyAttributeRequest): Request[Either[ResponseException[String, Exception], GetRegulatedEntityAttributeById200Response]] =
    basicRequest
   ...
   * @param updateSystemLevelEndpointTagRequest Request body
   */
  def updateSystemLevelEndpointTag(apiKeyHeader: String, apiKeyHeader: String)(operationid: String, endpointtagid: String, updateSystemLevelEndpointTagRequest: UpdateSystemLevelEndpointTagRequest): Request[Either[ResponseException[String, Exception], UpdateSystemLevelEndpointTag200Response]] =
    basicRequest
   ...
   *   DirectLogin (apiKey)
   */
  def verifyRequestSignResponse(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : WaitingForGodot200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   */
  def waitingForGodot(): Request[Either[ResponseException[String, Exception], WaitingForGodot200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/waiting-for-godot")
      .contentType("application/json")
      .response(asJson[WaitingForGodot200Response])
