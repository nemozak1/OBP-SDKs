...
object SandboxApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new SandboxApi(baseUrl)
}
...
class SandboxApi(baseUrl: String) {
   ...
   *   DirectLogin (apiKey)
   * 
   * @param sandboxDataImportRequest Request body
   */
  def sandboxDataImport(apiKeyHeader: String, apiKeyHeader: String)(sandboxDataImportRequest: SandboxDataImportRequest): Request[Either[ResponseException[String, Exception], UpdateTransactionNarrative200Response]] =
    basicRequest
