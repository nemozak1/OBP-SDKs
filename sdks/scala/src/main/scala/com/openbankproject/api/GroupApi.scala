...
object GroupApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new GroupApi(baseUrl)
}
...
class GroupApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : GetGroups200ResponseGroupsInner (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def createGroup(apiKeyHeader: String, apiKeyHeader: String)(createGroupRequest: CreateGroupRequest): Request[Either[ResponseException[String, Exception], GetGroups200ResponseGroupsInner]] =
    basicRequest
      ...
      .response(asJson[GetGroups200ResponseGroupsInner])
   ...
   */
  def deleteGroup(apiKeyHeader: String, apiKeyHeader: String)(groupid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * @param groupid The GROUPID identifier
   */
  def getGroup(apiKeyHeader: String, apiKeyHeader: String)(groupid: String): Request[Either[ResponseException[String, Exception], GetGroups200ResponseGroupsInner]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetGroups200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getGroups(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetGroups200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/groups")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetGroups200Response])
   ...
   */
  def updateGroup(apiKeyHeader: String, apiKeyHeader: String)(groupid: String, updateGroupRequest: UpdateGroupRequest): Request[Either[ResponseException[String, Exception], GetGroups200ResponseGroupsInner]] =
    basicRequest
