...
object JSONSchemaValidationApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new JSONSchemaValidationApi(baseUrl)
}
...
class JSONSchemaValidationApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : GetAllJsonSchemaValidationsPublic200ResponseJsonSchemaValidationsInner (Successful operation)
   ...
   */
  def createJsonSchemaValidation(apiKeyHeader: String, apiKeyHeader: String)(operationid: String, getAllJsonSchemaValidationsPublic200ResponseJsonSchemaValidationsInnerJsonSchema: GetAllJsonSchemaValidationsPublic200ResponseJsonSchemaValidationsInnerJsonSchema): Request[Either[ResponseException[String, Exception], GetAllJsonSchemaValidationsPublic200ResponseJsonSchemaValidationsInner]] =
    basicRequest
      ...
      .body(getAllJsonSchemaValidationsPublic200ResponseJsonSchemaValidationsInnerJsonSchema)
      .response(asJson[GetAllJsonSchemaValidationsPublic200ResponseJsonSchemaValidationsInner])
   ...
   * @param operationid The OPERATIONID identifier
   */
  def deleteJsonSchemaValidation(apiKeyHeader: String, apiKeyHeader: String)(operationid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetAllJsonSchemaValidationsPublic200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getAllJsonSchemaValidations(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetAllJsonSchemaValidationsPublic200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/management/json-schema-validations")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetAllJsonSchemaValidationsPublic200Response])
   ...
   *   code 500 :  (Internal Server Error)
   */
  def getAllJsonSchemaValidationsPublic(): Request[Either[ResponseException[String, Exception], GetAllJsonSchemaValidationsPublic200Response]] =
    basicRequest
   ...
   * @param operationid The OPERATIONID identifier
   */
  def getJsonSchemaValidation(apiKeyHeader: String, apiKeyHeader: String)(operationid: String): Request[Either[ResponseException[String, Exception], GetAllJsonSchemaValidationsPublic200ResponseJsonSchemaValidationsInner]] =
    basicRequest
   ...
   * @param getAllJsonSchemaValidationsPublic200ResponseJsonSchemaValidationsInnerJsonSchema Request body
   */
  def updateJsonSchemaValidation(apiKeyHeader: String, apiKeyHeader: String)(operationid: String, getAllJsonSchemaValidationsPublic200ResponseJsonSchemaValidationsInnerJsonSchema: GetAllJsonSchemaValidationsPublic200ResponseJsonSchemaValidationsInnerJsonSchema): Request[Either[ResponseException[String, Exception], GetAllJsonSchemaValidationsPublic200ResponseJsonSchemaValidationsInner]] =
    basicRequest
