...
import com.openbankproject.model.AnswerUserAuthContextUpdateChallenge200Response
...
import com.openbankproject.model.CreateUserRequest
...
import com.openbankproject.model.GetLogoutLink200Response
import com.openbankproject.model.GetMyCustomersAtBank200ResponseCustomersInner
import com.openbankproject.model.GetMySpaces200Response
...
import com.openbankproject.model.GetProviders200Response
import com.openbankproject.model.GetUserAuthContexts200Response
import com.openbankproject.model.GetUserByProviderAndUsername200Response
...
import com.openbankproject.model.GetUserLockStatus200Response
import com.openbankproject.model.GetUsers200Response
import com.openbankproject.model.GetUsers200ResponseUsersInner
import com.openbankproject.model.GetUsersByEmail200Response
import com.openbankproject.model.LockUserByProviderAndUsername200Response
import com.openbankproject.model.RefreshUser200Response
import com.openbankproject.model.ResetPasswordComplete200Response
import com.openbankproject.model.ResetPasswordCompleteRequest
import com.openbankproject.model.ResetPasswordUrl200Response
import com.openbankproject.model.ResetPasswordUrlAnonymousRequest
import com.openbankproject.model.ResetPasswordUrlRequest
...
import com.openbankproject.model.ValidateUserByUserId200Response
import com.openbankproject.model.ValidateUserEmail200Response
import com.openbankproject.model.ValidateUserEmailRequest
import com.openbankproject.model.VerifyUserCredentials200Response
import com.openbankproject.model.VerifyUserCredentialsRequest
import org.openapitools.client.core.JsonSupport._
import sttp.client4._
import sttp.model.Method

object UserApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new UserApi(baseUrl)
}
...
class UserApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : AddUserToGroup200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def addUserToGroup(apiKeyHeader: String, apiKeyHeader: String)(userid: String, addUserToGroupRequest: AddUserToGroupRequest): Request[Either[ResponseException[String, Exception], AddUserToGroup200Response]] =
    basicRequest
      ...
      .response(asJson[AddUserToGroup200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : AnswerUserAuthContextUpdateChallenge200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def answerUserAuthContextUpdateChallenge(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, authcontextupdateid: String, answerConsentChallengeRequest: AnswerConsentChallengeRequest): Request[Either[ResponseException[String, Exception], AnswerUserAuthContextUpdateChallenge200Response]] =
    basicRequest
      ...
      .response(asJson[AnswerUserAuthContextUpdateChallenge200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : VerifyUserCredentials200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * @param createUserRequest Request body
   */
  def createUser(createUserRequest: CreateUserRequest): Request[Either[ResponseException[String, Exception], VerifyUserCredentials200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/users")
      .contentType("application/json")
      .body(createUserRequest)
      .response(asJson[VerifyUserCredentials200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetUserAuthContexts200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def createUserAuthContext(apiKeyHeader: String, apiKeyHeader: String)(userid: String, getExplicitCounterpartyById200ResponseBespokeInner: GetExplicitCounterpartyById200ResponseBespokeInner): Request[Either[ResponseException[String, Exception], GetUserAuthContexts200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.0.0/users/${userid}/auth-context")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(getExplicitCounterpartyById200ResponseBespokeInner)
      .response(asJson[GetUserAuthContexts200Response])
   ...
   * @param getExplicitCounterpartyById200ResponseBespokeInner Request body
   */
  def createUserAuthContextUpdateRequest(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, scamethod: String, getExplicitCounterpartyById200ResponseBespokeInner: GetExplicitCounterpartyById200ResponseBespokeInner): Request[Either[ResponseException[String, Exception], AnswerUserAuthContextUpdateChallenge200Response]] =
    basicRequest
   ...
   * @param userid The USERID identifier
   */
  def deleteUser(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   */
  def deleteUserAuthContextById(apiKeyHeader: String, apiKeyHeader: String)(userid: String, userauthcontextid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * @param userid The USERID identifier
   */
  def deleteUserAuthContexts(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : ValidateUserEmailRequest (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def directLoginEndpoint(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], ValidateUserEmailRequest]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/my/logins/direct")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[ValidateUserEmailRequest])
   ...
   *   DirectLogin (apiKey)
   */
  def getCurrentUser(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetEntitlementsAndPermissions200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : AddConsentUserRequest (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getCurrentUserId(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], AddConsentUserRequest]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/users/current/user_id")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[AddConsentUserRequest])
   ...
   * 
   * Expected answers:
   *   code 200 : GetLogoutLink200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getLogoutLink(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetLogoutLink200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/users/current/logout-link")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetLogoutLink200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetMySpaces200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getMySpaces(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetMySpaces200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/my/spaces")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetMySpaces200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetProviders200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getProviders(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetProviders200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/providers")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetProviders200Response])
   ...
   * @param userid The USERID identifier
   */
  def getUserAuthContexts(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], GetUserAuthContexts200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetUserByProviderAndUsername200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def getUserByProviderAndUsername(apiKeyHeader: String, apiKeyHeader: String)(provider: String, username: String): Request[Either[ResponseException[String, Exception], GetUserByProviderAndUsername200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/users/provider/${provider}/username/${username}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetUserByProviderAndUsername200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetUsers200ResponseUsersInner (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param userid The USERID identifier
   */
  def getUserByUserId(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], GetUsers200ResponseUsersInner]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/users/user-id/${userid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetUsers200ResponseUsersInner])
   ...
   * 
   * Expected answers:
   *   code 200 : GetUserGroupMemberships200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   * @param userid The USERID identifier
   */
  def getUserGroupMemberships(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], GetUserGroupMemberships200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/users/${userid}/group-entitlements")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetUserGroupMemberships200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetUserLockStatus200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param username The USERNAME identifier
   */
  def getUserLockStatus(apiKeyHeader: String, apiKeyHeader: String)(provider: String, username: String): Request[Either[ResponseException[String, Exception], GetUserLockStatus200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/users/${provider}/${username}/lock-status")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetUserLockStatus200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetUsers200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getUsers(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetUsers200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/users")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetUsers200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetUsersByEmail200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def getUsersByEmail(apiKeyHeader: String, apiKeyHeader: String)(email: String): Request[Either[ResponseException[String, Exception], GetUsersByEmail200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/users/email/${email}/terminator")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetUsersByEmail200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : LockUserByProviderAndUsername200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param username The USERNAME identifier
   */
  def lockUserByProviderAndUsername(apiKeyHeader: String, apiKeyHeader: String)(provider: String, username: String): Request[Either[ResponseException[String, Exception], LockUserByProviderAndUsername200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.1.0/users/${provider}/${username}/locks")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[LockUserByProviderAndUsername200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : RefreshUser200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   * @param userid The USERID identifier
   */
  def refreshUser(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], RefreshUser200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v3.1.0/users/${userid}/refresh")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[RefreshUser200Response])
   ...
   */
  def removeUserFromGroup(apiKeyHeader: String, apiKeyHeader: String)(userid: String, groupid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : ResetPasswordComplete200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def resetPasswordComplete(apiKeyHeader: String, apiKeyHeader: String)(resetPasswordCompleteRequest: ResetPasswordCompleteRequest): Request[Either[ResponseException[String, Exception], ResetPasswordComplete200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/users/password")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(resetPasswordCompleteRequest)
      .response(asJson[ResetPasswordComplete200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : ResetPasswordUrl200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def resetPasswordUrl(apiKeyHeader: String, apiKeyHeader: String)(resetPasswordUrlRequest: ResetPasswordUrlRequest): Request[Either[ResponseException[String, Exception], ResetPasswordUrl200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/management/user/reset-password-url")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(resetPasswordUrlRequest)
      .response(asJson[ResetPasswordUrl200Response])
   ...
   */
  def resetPasswordUrlAnonymous(apiKeyHeader: String, apiKeyHeader: String)(resetPasswordUrlAnonymousRequest: ResetPasswordUrlAnonymousRequest): Request[Either[ResponseException[String, Exception], ResetPasswordComplete200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/users/password-reset-url")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(resetPasswordUrlAnonymousRequest)
      .response(asJson[ResetPasswordComplete200Response])
   ...
   * @param providerid The PROVIDERID identifier
   */
  def syncExternalUser(apiKeyHeader: String, apiKeyHeader: String)(provider: String, providerid: String): Request[Either[ResponseException[String, Exception], RefreshUser200Response]] =
    basicRequest
   ...
   * @param username The USERNAME identifier
   */
  def unlockUserByProviderAndUsername(apiKeyHeader: String, apiKeyHeader: String)(provider: String, username: String): Request[Either[ResponseException[String, Exception], GetUserLockStatus200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : ValidateUserByUserId200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param userid The USERID identifier
   */
  def validateUserByUserId(apiKeyHeader: String, apiKeyHeader: String)(userid: String): Request[Either[ResponseException[String, Exception], ValidateUserByUserId200Response]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v5.1.0/management/users/${userid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[ValidateUserByUserId200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : ValidateUserEmail200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def validateUserEmail(apiKeyHeader: String, apiKeyHeader: String)(validateUserEmailRequest: ValidateUserEmailRequest): Request[Either[ResponseException[String, Exception], ValidateUserEmail200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/users/email-validation")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(validateUserEmailRequest)
      .response(asJson[ValidateUserEmail200Response])
   ...
   */
  def verifyUserCredentials(apiKeyHeader: String, apiKeyHeader: String)(verifyUserCredentialsRequest: VerifyUserCredentialsRequest): Request[Either[ResponseException[String, Exception], VerifyUserCredentials200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/users/verify-credentials")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(verifyUserCredentialsRequest)
      .response(asJson[VerifyUserCredentials200Response])
