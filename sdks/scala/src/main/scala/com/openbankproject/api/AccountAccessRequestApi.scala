...
object AccountAccessRequestApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new AccountAccessRequestApi(baseUrl)
}
...
class AccountAccessRequestApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : RejectAccountAccessRequest200Response (Successful operation)
   *   code 404 :  (Not Found)
   ...
   */
  def approveAccountAccessRequest(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, accountaccessrequestid: String, rejectAccountAccessRequestRequest: RejectAccountAccessRequestRequest): Request[Either[ResponseException[String, Exception], RejectAccountAccessRequest200Response]] =
    basicRequest
      ...
      .body(rejectAccountAccessRequestRequest)
      .response(asJson[RejectAccountAccessRequest200Response])
   ...
   */
  def createAccountAccessRequest(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, createAccountAccessRequestRequest: CreateAccountAccessRequestRequest): Request[Either[ResponseException[String, Exception], RejectAccountAccessRequest200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/accounts/${accountid}/account-access-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createAccountAccessRequestRequest)
      .response(asJson[RejectAccountAccessRequest200Response])
   ...
   * @param accountaccessrequestid The ACCOUNTACCESSREQUESTID identifier
   */
  def getAccountAccessRequestById(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, accountaccessrequestid: String): Request[Either[ResponseException[String, Exception], RejectAccountAccessRequest200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetAccountAccessRequestsForAccount200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param accountid The ACCOUNTID identifier
   */
  def getAccountAccessRequestsForAccount(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String): Request[Either[ResponseException[String, Exception], GetAccountAccessRequestsForAccount200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/accounts/${accountid}/account-access-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetAccountAccessRequestsForAccount200Response])
   ...
   *   DirectLogin (apiKey)
   */
  def getMyAccountAccessRequests(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetAccountAccessRequestsForAccount200Response]] =
    basicRequest
   ...
   * @param rejectAccountAccessRequestRequest Request body
   */
  def rejectAccountAccessRequest(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, accountaccessrequestid: String, rejectAccountAccessRequestRequest: RejectAccountAccessRequestRequest): Request[Either[ResponseException[String, Exception], RejectAccountAccessRequest200Response]] =
    basicRequest
