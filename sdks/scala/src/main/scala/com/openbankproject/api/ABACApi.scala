...
object ABACApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new ABACApi(baseUrl)
}
...
class ABACApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : GetAbacRule200Response (Successful operation)
   ...
   */
  def createAbacRule(apiKeyHeader: String, apiKeyHeader: String)(updateAbacRuleRequest: UpdateAbacRuleRequest): Request[Either[ResponseException[String, Exception], GetAbacRule200Response]] =
    basicRequest
      ...
      .body(updateAbacRuleRequest)
      .response(asJson[GetAbacRule200Response])
   ...
   */
  def deleteAbacRule(apiKeyHeader: String, apiKeyHeader: String)(abacruleid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : ExecuteAbacPolicy200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def executeAbacPolicy(apiKeyHeader: String, apiKeyHeader: String)(policy: String, executeAbacPolicyRequest: ExecuteAbacPolicyRequest): Request[Either[ResponseException[String, Exception], ExecuteAbacPolicy200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/management/abac-policies/${policy}/execute")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(executeAbacPolicyRequest)
      .response(asJson[ExecuteAbacPolicy200Response])
   ...
   * @param executeAbacPolicyRequest Request body
   */
  def executeAbacRule(apiKeyHeader: String, apiKeyHeader: String)(abacruleid: String, executeAbacPolicyRequest: ExecuteAbacPolicyRequest): Request[Either[ResponseException[String, Exception], ExecuteAbacPolicy200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetAbacPolicies200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getAbacPolicies(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetAbacPolicies200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/abac-policies")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetAbacPolicies200Response])
   ...
   * @param abacruleid The ABACRULEID identifier
   */
  def getAbacRule(apiKeyHeader: String, apiKeyHeader: String)(abacruleid: String): Request[Either[ResponseException[String, Exception], GetAbacRule200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetAbacRuleSchema200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getAbacRuleSchema(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetAbacRuleSchema200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/abac-rules-schema")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetAbacRuleSchema200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetAbacRulesByPolicy200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getAbacRules(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetAbacRulesByPolicy200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/abac-rules")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetAbacRulesByPolicy200Response])
   ...
   * @param policy The POLICY identifier
   */
  def getAbacRulesByPolicy(apiKeyHeader: String, apiKeyHeader: String)(policy: String): Request[Either[ResponseException[String, Exception], GetAbacRulesByPolicy200Response]] =
    basicRequest
   ...
   * @param updateAbacRuleRequest Request body
   */
  def updateAbacRule(apiKeyHeader: String, apiKeyHeader: String)(abacruleid: String, updateAbacRuleRequest: UpdateAbacRuleRequest): Request[Either[ResponseException[String, Exception], GetAbacRule200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : ValidateAbacRule200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def validateAbacRule(apiKeyHeader: String, apiKeyHeader: String)(validateAbacRuleRequest: ValidateAbacRuleRequest): Request[Either[ResponseException[String, Exception], ValidateAbacRule200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/management/abac-rules/validate")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(validateAbacRuleRequest)
      .response(asJson[ValidateAbacRule200Response])
