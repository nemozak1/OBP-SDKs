...
object FXApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new FXApi(baseUrl)
}
...
class FXApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : CreateFxRequest (Successful operation)
   *   code 404 :  (Not Found)
   ...
   */
  def createFx(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, createFxRequest: CreateFxRequest): Request[Either[ResponseException[String, Exception], CreateFxRequest]] =
    basicRequest
      ...
      .body(createFxRequest)
      .response(asJson[CreateFxRequest])
   ...
   * 
   * Expected answers:
   *   code 200 : GetCurrenciesAtBank200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   * @param bankid The BANKID identifier
   */
  def getCurrenciesAtBank(apiKeyHeader: String, apiKeyHeader: String)(bankid: String): Request[Either[ResponseException[String, Exception], GetCurrenciesAtBank200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/banks/${bankid}/currencies")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetCurrenciesAtBank200Response])
   ...
   */
  def getCurrentFxRate(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, fromcurrencycode: String, tocurrencycode: String): Request[Either[ResponseException[String, Exception], CreateFxRequest]] =
    basicRequest
