...
import com.openbankproject.model.AnswerTransactionRequestChallengeRequest
...
import com.openbankproject.model.CreateTransactionRequestAccountRequest
import com.openbankproject.model.CreateTransactionRequestAgentCashWithDrawalRequest
import com.openbankproject.model.CreateTransactionRequestCardRequest
import com.openbankproject.model.CreateTransactionRequestCardanoRequest
import com.openbankproject.model.CreateTransactionRequestCounterparty200Response
import com.openbankproject.model.CreateTransactionRequestCounterpartyRequest
import com.openbankproject.model.CreateTransactionRequestEthSendRawTransactionRequest
import com.openbankproject.model.CreateTransactionRequestEthereumeSendTransactionRequest
import com.openbankproject.model.CreateTransactionRequestFreeFormRequest
import com.openbankproject.model.CreateTransactionRequestRefundRequest
import com.openbankproject.model.CreateTransactionRequestSepaRequest
import com.openbankproject.model.CreateTransactionRequestSimpleRequest
...
import com.openbankproject.model.GetTransactionRequestTypes200Response
...
object PSD2Api {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new PSD2Api(baseUrl)
}

class PSD2Api(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : GetTransactionRequestById200Response (Successful operation)
   ...
   */
  def answerTransactionRequestChallenge(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, transactionrequesttype: String, transactionrequestid: String, answerTransactionRequestChallengeRequest: AnswerTransactionRequestChallengeRequest): Request[Either[ResponseException[String, Exception], GetTransactionRequestById200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/transaction-request-types/${transactionrequesttype}/transaction-requests/${transactionrequestid}/challenge")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(answerTransactionRequestChallengeRequest)
      .response(asJson[GetTransactionRequestById200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : CreateTransactionRequestCounterparty200Response (Successful operation)
   *   code 400 :  (Bad Request)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   ...
   */
  def createTransactionRequestAccount(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, account: String, createTransactionRequestAccountRequest: CreateTransactionRequestAccountRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/transaction-request-types/${account}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestAccountRequest)
      .response(asJson[CreateTransactionRequestCounterparty200Response])
   ...
   * @param createTransactionRequestAccountRequest Request body
   */
  def createTransactionRequestAccountOtp(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, accountotp: String, createTransactionRequestAccountRequest: CreateTransactionRequestAccountRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/transaction-request-types/${accountotp}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestAccountRequest)
   ...
   */
  def createTransactionRequestAgentCashWithDrawal(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, agentcashwithdrawal: String, createTransactionRequestAgentCashWithDrawalRequest: CreateTransactionRequestAgentCashWithDrawalRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/transaction-request-types/${agentcashwithdrawal}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestAgentCashWithDrawalRequest)
      .response(asJson[CreateTransactionRequestCounterparty200Response])
   ...
   */
  def createTransactionRequestCard(apiKeyHeader: String, apiKeyHeader: String)(card: String, createTransactionRequestCardRequest: CreateTransactionRequestCardRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/transaction-request-types/${card}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestCardRequest)
      .response(asJson[CreateTransactionRequestCounterparty200Response])
   ...
   */
  def createTransactionRequestCardano(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, cardano: String, createTransactionRequestCardanoRequest: CreateTransactionRequestCardanoRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/accounts/${accountid}/owner/transaction-request-types/${cardano}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestCardanoRequest)
      .response(asJson[CreateTransactionRequestCounterparty200Response])
   ...
   */
  def createTransactionRequestCounterparty(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, counterparty: String, createTransactionRequestCounterpartyRequest: CreateTransactionRequestCounterpartyRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/transaction-request-types/${counterparty}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestCounterpartyRequest)
      .response(asJson[CreateTransactionRequestCounterparty200Response])
   ...
   */
  def createTransactionRequestEthSendRawTransaction(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, ethsendrawtransaction: String, createTransactionRequestEthSendRawTransactionRequest: CreateTransactionRequestEthSendRawTransactionRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/accounts/${accountid}/owner/transaction-request-types/${ethsendrawtransaction}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestEthSendRawTransactionRequest)
      .response(asJson[CreateTransactionRequestCounterparty200Response])
   ...
   */
  def createTransactionRequestEthereumeSendTransaction(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, ethsendtransaction: String, createTransactionRequestEthereumeSendTransactionRequest: CreateTransactionRequestEthereumeSendTransactionRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/accounts/${accountid}/owner/transaction-request-types/${ethsendtransaction}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestEthereumeSendTransactionRequest)
      .response(asJson[CreateTransactionRequestCounterparty200Response])
   ...
   */
  def createTransactionRequestHold(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, hold: String, createTransactionRequestFreeFormRequest: CreateTransactionRequestFreeFormRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/banks/${bankid}/accounts/${accountid}/owner/transaction-request-types/${hold}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestFreeFormRequest)
      .response(asJson[CreateTransactionRequestCounterparty200Response])
   ...
   */
  def createTransactionRequestRefund(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, refund: String, createTransactionRequestRefundRequest: CreateTransactionRequestRefundRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/transaction-request-types/${refund}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestRefundRequest)
      .response(asJson[CreateTransactionRequestCounterparty200Response])
   ...
   * @param createTransactionRequestAccountRequest Request body
   */
  def createTransactionRequestSandboxTan(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, sandboxtan: String, createTransactionRequestAccountRequest: CreateTransactionRequestAccountRequest): Request[Either[ResponseException[String, Exception], GetTransactionRequestById200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v2.1.0/banks/${bankid}/accounts/${accountid}/${viewid}/transaction-request-types/${sandboxtan}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestAccountRequest)
   ...
   */
  def createTransactionRequestSepa(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, sepa: String, createTransactionRequestSepaRequest: CreateTransactionRequestSepaRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/transaction-request-types/${sepa}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestSepaRequest)
      .response(asJson[CreateTransactionRequestCounterparty200Response])
   ...
   */
  def createTransactionRequestSimple(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, simple: String, createTransactionRequestSimpleRequest: CreateTransactionRequestSimpleRequest): Request[Either[ResponseException[String, Exception], CreateTransactionRequestCounterparty200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v4.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/transaction-request-types/${simple}/transaction-requests")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createTransactionRequestSimpleRequest)
      .response(asJson[CreateTransactionRequestCounterparty200Response])
   ...
   * @param transactionrequestid The TRANSACTIONREQUESTID identifier
   */
  def getTransactionRequest(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String, transactionrequestid: String): Request[Either[ResponseException[String, Exception], GetTransactionRequestById200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v4.0.0/banks/${bankid}/accounts/${accountid}/${viewid}/transaction-requests/${transactionrequestid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetTransactionRequestById200Response])
   ...
   * @param transactionrequestid The TRANSACTIONREQUESTID identifier
   */
  def getTransactionRequestById(apiKeyHeader: String, apiKeyHeader: String)(transactionrequestid: String): Request[Either[ResponseException[String, Exception], GetTransactionRequestById200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/management/transaction-requests/${transactionrequestid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetTransactionRequestById200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetTransactionRequestTypes200Response (Successful operation)
   *   code 400 :  (Bad Request)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   ...
   * @param viewid The VIEWID identifier
   */
  def getTransactionRequestTypes(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, accountid: String, viewid: String): Request[Either[ResponseException[String, Exception], GetTransactionRequestTypes200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v1.4.0/banks/${bankid}/accounts/${accountid}/${viewid}/transaction-request-types")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetTransactionRequestTypes200Response])
