...
object ConsumerApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new ConsumerApi(baseUrl)
}
...
class ConsumerApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : CreateCallLimits200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def createCallLimits(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String, createCallLimitsRequest: CreateCallLimitsRequest): Request[Either[ResponseException[String, Exception], CreateCallLimits200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v6.0.0/management/consumers/${consumerid}/consumer/rate-limits")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createCallLimitsRequest)
      .response(asJson[CreateCallLimits200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : CreateConsumer200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def createConsumer(apiKeyHeader: String, apiKeyHeader: String)(createConsumerRequest: CreateConsumerRequest): Request[Either[ResponseException[String, Exception], CreateConsumer200Response]] =
    basicRequest
      ...
      .response(asJson[CreateConsumer200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : UpdateConsumerName200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def createConsumerDynamicRegistration(apiKeyHeader: String, apiKeyHeader: String)(createConsumerDynamicRegistrationRequest: CreateConsumerDynamicRegistrationRequest): Request[Either[ResponseException[String, Exception], UpdateConsumerName200Response]] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/obp/v5.1.0/dynamic-registration/consumers")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(createConsumerDynamicRegistrationRequest)
      .response(asJson[UpdateConsumerName200Response])
   ...
   * @param createConsumerRequest Request body
   */
  def createMyConsumer(apiKeyHeader: String, apiKeyHeader: String)(createConsumerRequest: CreateConsumerRequest): Request[Either[ResponseException[String, Exception], UpdateConsumerName200Response]] =
    basicRequest
   ...
   */
  def deleteCallLimits(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String, ratelimitingid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : EnableDisableConsumersRequest (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def enableDisableConsumers(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String, enableDisableConsumersRequest: EnableDisableConsumersRequest): Request[Either[ResponseException[String, Exception], EnableDisableConsumersRequest]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v3.1.0/management/consumers/${consumerid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(enableDisableConsumersRequest)
      .response(asJson[EnableDisableConsumersRequest])
   ...
   * 
   * Expected answers:
   *   code 200 : GetActiveRateLimitsAtDate200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   */
  def getActiveRateLimitsAtDate(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String, datewithhour: String): Request[Either[ResponseException[String, Exception], GetActiveRateLimitsAtDate200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/consumers/${consumerid}/active-rate-limits/${datewithhour}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetActiveRateLimitsAtDate200Response])
   ...
   * @param consumerid The CONSUMERID identifier
   */
  def getActiveRateLimitsNow(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String): Request[Either[ResponseException[String, Exception], GetActiveRateLimitsAtDate200Response]] =
    basicRequest
   ...
   * 
   * Expected answers:
   *   code 200 : GetCallsLimit200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param consumerid The CONSUMERID identifier
   */
  def getCallsLimit(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String): Request[Either[ResponseException[String, Exception], GetCallsLimit200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/management/consumers/${consumerid}/consumer/rate-limits")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetCallsLimit200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetConsumer200Response (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param consumerid The CONSUMERID identifier
   */
  def getConsumer(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String): Request[Either[ResponseException[String, Exception], GetConsumer200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/consumers/${consumerid}")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetConsumer200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetCurrentConsumer200ResponseCallCounters (Successful operation)
   *   code 404 :  (Not Found)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   ...
   * @param consumerid The CONSUMERID identifier
   */
  def getConsumerCallCounters(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String): Request[Either[ResponseException[String, Exception], GetCurrentConsumer200ResponseCallCounters]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v6.0.0/management/consumers/${consumerid}/call-counters")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetCurrentConsumer200ResponseCallCounters])
   ...
   * 
   * Expected answers:
   *   code 200 : GetConsumers200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getConsumers(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetConsumers200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v5.1.0/management/consumers")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetConsumers200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : GetConsumersForCurrentUser200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   *   DirectLogin (apiKey)
   */
  def getConsumersForCurrentUser(apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetConsumersForCurrentUser200Response]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/obp/v3.1.0/management/users/current/consumers")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .response(asJson[GetConsumersForCurrentUser200Response])
   ...
   */
  def updateConsumerCertificate(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String, updateConsumerCertificateRequest: UpdateConsumerCertificateRequest): Request[Either[ResponseException[String, Exception], UpdateConsumerName200Response]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v5.1.0/management/consumers/${consumerid}/consumer/certificate")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(updateConsumerCertificateRequest)
      .response(asJson[UpdateConsumerName200Response])
   ...
   */
  def updateConsumerLogoURL(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String, updateConsumerLogoURLRequest: UpdateConsumerLogoURLRequest): Request[Either[ResponseException[String, Exception], UpdateConsumerName200Response]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v5.1.0/management/consumers/${consumerid}/consumer/logo_url")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(updateConsumerLogoURLRequest)
      .response(asJson[UpdateConsumerName200Response])
   ...
   */
  def updateConsumerName(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String, updateConsumerNameRequest: UpdateConsumerNameRequest): Request[Either[ResponseException[String, Exception], UpdateConsumerName200Response]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v5.1.0/management/consumers/${consumerid}/consumer/name")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(updateConsumerNameRequest)
      .response(asJson[UpdateConsumerName200Response])
   ...
   * 
   * Expected answers:
   *   code 200 : UpdateConsumerRedirectURL200Response (Successful operation)
   *   code 500 :  (Internal Server Error)
   * 
   * Available security schemes:
   *   GatewayLogin (apiKey)
   ...
   */
  def updateConsumerRedirectURL(apiKeyHeader: String, apiKeyHeader: String)(consumerid: String, updateConsumerRedirectURLRequest: UpdateConsumerRedirectURLRequest): Request[Either[ResponseException[String, Exception], UpdateConsumerRedirectURL200Response]] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/obp/v5.1.0/management/consumers/${consumerid}/consumer/redirect_url")
      .contentType("application/json")
      .header("Authorization", apiKeyHeader)
      .header("DirectLogin", apiKeyHeader)
      .body(updateConsumerRedirectURLRequest)
      .response(asJson[UpdateConsumerRedirectURL200Response])
