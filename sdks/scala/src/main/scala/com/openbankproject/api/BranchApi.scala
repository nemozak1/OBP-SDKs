...
object BranchApi {
  def apply(baseUrl: String = "http://127.0.0.1:8080") = new BranchApi(baseUrl)
}
...
class BranchApi(baseUrl: String) {
   ...
   */
  def createBranch(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, getBranches200ResponseBranchesInner: GetBranches200ResponseBranchesInner): Request[Either[ResponseException[String, Exception], GetBranches200ResponseBranchesInner]] =
    basicRequest
      ...
      .body(getBranches200ResponseBranchesInner)
   ...
   */
  def deleteBranch(apiKeyHeader: String, apiKeyHeader: String)(bankid: String, branchid: String): Request[Either[ResponseException[String, Exception], Unit]] =
    basicRequest
