...
<a id="addscope"></a>
# **AddScope**
> GetScopes200ResponseListInner AddScope (string consumerid, CreateConsentImplicitRequestEntitlementsInner createConsentImplicitRequestEntitlementsInner)
...
# **CreateCallLimits**
> CreateCallLimits200Response CreateCallLimits (string consumerid, CreateCallLimitsRequest createCallLimitsRequest)
...
# **CreateConsumer**
> CreateConsumer200Response CreateConsumer (CreateConsumerRequest createConsumerRequest)
...
> UpdateConsumerName200Response CreateConsumerDynamicRegistration (CreateConsumerDynamicRegistrationRequest createConsumerDynamicRegistrationRequest)
...
# **CreateMyConsumer**
> UpdateConsumerName200Response CreateMyConsumer (CreateConsumerRequest createConsumerRequest)
...
# **DeleteCallLimits**
> void DeleteCallLimits (string consumerid, string ratelimitingid)
...
<a id="deletescope"></a>
# **DeleteScope**
> void DeleteScope (string consumerid, string scopeid)
...
> EnableDisableConsumersRequest EnableDisableConsumers (string consumerid, EnableDisableConsumersRequest enableDisableConsumersRequest)
...
> GetActiveRateLimitsAtDate200Response GetActiveRateLimitsAtDate (string consumerid, string datewithhour)
...
> GetActiveRateLimitsAtDate200Response GetActiveRateLimitsNow (string consumerid)
...
# **GetCallsLimit**
> GetCallsLimit200Response GetCallsLimit (string consumerid)
...
<a id="getconsumer"></a>
# **GetConsumer**
> GetConsumer200Response GetConsumer (string consumerid)
...
> GetCurrentConsumer200ResponseCallCounters GetConsumerCallCounters (string consumerid)
...
<a id="getscopes"></a>
# **GetScopes**
> GetScopes200Response GetScopes (string consumerid)
...
> UpdateConsumerName200Response UpdateConsumerCertificate (string consumerid, UpdateConsumerCertificateRequest updateConsumerCertificateRequest)
...
> UpdateConsumerName200Response UpdateConsumerLogoURL (string consumerid, UpdateConsumerLogoURLRequest updateConsumerLogoURLRequest)
...
# **UpdateConsumerName**
> UpdateConsumerName200Response UpdateConsumerName (string consumerid, UpdateConsumerNameRequest updateConsumerNameRequest)
...
> UpdateConsumerRedirectURL200Response UpdateConsumerRedirectURL (string consumerid, UpdateConsumerRedirectURLRequest updateConsumerRedirectURLRequest)
