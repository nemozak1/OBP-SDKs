...
> GetAccountApplications200ResponseAccountApplicationsInner CreateAccountApplication (string bankid, CreateAccountApplicationRequest createAccountApplicationRequest)
...
> GetAccountApplications200ResponseAccountApplicationsInner GetAccountApplication (string bankid, string accountapplicationid)
...
> GetAccountApplications200Response GetAccountApplications (string bankid)
...
> GetAccountApplications200ResponseAccountApplicationsInner UpdateAccountApplicationStatus (string bankid, string accountapplicationid, UpdateTransactionRequestStatusRequest updateTransactionRequestStatusRequest)
