...
> UpdateTransactionNarrative200Response AddSocialMediaHandle (string bankid, string customerid, GetSocialMediaHandles200ResponseChecksInner getSocialMediaHandles200ResponseChecksInner)
...
> CreateCustomerAddress200Response CreateCustomerAddress (string bankid, string customerid, CreateCustomerAddressRequest createCustomerAddressRequest)
...
> void DeleteCustomerAccountLinkById (string bankid, string customeraccountlinkid)
...
> void DeleteCustomerCascade (string bankid, string customerid)
...
> void DeleteUserCustomerLink (string bankid, string usercustomerlinkid)
...
> GetMyCorrelatedEntities200ResponseCorrelatedEntitiesInner GetCorrelatedUsersInfoByCustomerId (string bankid, string customerid)
...
<a id="getcrmevents"></a>
# **GetCrmEvents**
> GetCrmEvents200Response GetCrmEvents (string bankid)
...
> GetCustomerAccountLinksByCustomerId200ResponseLinksInner GetCustomerAccountLinkById (string bankid, string customeraccountlinkid)
...
> GetCustomerAccountLinksByCustomerId200Response GetCustomerAccountLinksByBankIdAccountId (string bankid, string accountid)
...
> GetCustomerAccountLinksByCustomerId200Response GetCustomerAccountLinksByCustomerId (string bankid, string customerid)
...
> GetCustomerByCustomerNumber200Response GetCustomerByCustomerId (string bankid, string customerid)
...
# **GetCustomerChildren**
> GetCustomerChildren200Response GetCustomerChildren (string bankid, string customerid)
...
# **GetCustomerMessages**
> GetCustomerMessages200Response GetCustomerMessages (string bankid, string customerid)
...
> GetCustomersMessages200Response GetCustomersMessages (string bankid)
...
> GetMyCustomersAtBank200Response GetMyCustomersAtBank (string bankid)
...
> GetSocialMediaHandles200Response GetSocialMediaHandles (string bankid, string customerid)
...
> GetUserCustomerLinksByCustomerId200Response GetUserCustomerLinksByCustomerId (string bankid, string customerid)
...
> GetUserCustomerLinksByCustomerId200Response GetUserCustomerLinksByUserId (string bankid, string userid)
...
> GetCustomerAccountLinksByCustomerId200ResponseLinksInner UpdateCustomerAccountLinkById (string bankid, string customeraccountlinkid, UpdateCustomerAccountLinkByIdRequest updateCustomerAccountLinkByIdRequest)
...
> CreateCustomerAddress200Response UpdateCustomerAddress (string bankid, string customerid, string customeraddressid, CreateCustomerAddressRequest createCustomerAddressRequest)
...
> UpdateCustomerBranch200Response UpdateCustomerBranch (string bankid, string customerid, UpdateCustomerBranchRequest updateCustomerBranchRequest)
...
> UpdateCustomerBranch200Response UpdateCustomerCreditLimit (string bankid, string customerid, UpdateCustomerCreditLimitRequest updateCustomerCreditLimitRequest)
...
> UpdateCustomerBranch200Response UpdateCustomerCreditRatingAndSource (string bankid, string customerid, UpdateCustomerCreditRatingAndSourceRequest updateCustomerCreditRatingAndSourceRequest)
...
# **UpdateCustomerData**
> UpdateCustomerBranch200Response UpdateCustomerData (string bankid, string customerid, UpdateCustomerDataRequest updateCustomerDataRequest)
...
# **UpdateCustomerEmail**
> UpdateCustomerBranch200Response UpdateCustomerEmail (string bankid, string customerid, UpdateCustomerEmailRequest updateCustomerEmailRequest)
...
> UpdateCustomerBranch200Response UpdateCustomerIdentity (string bankid, string customerid, UpdateCustomerIdentityRequest updateCustomerIdentityRequest)
...
> UpdateCustomerBranch200Response UpdateCustomerMobileNumber (string bankid, string customerid, CreateTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo createTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo)
...
> UpdateCustomerBranch200Response UpdateCustomerNumber (string bankid, string customerid, GetCustomerOverviewFlatRequest getCustomerOverviewFlatRequest)
