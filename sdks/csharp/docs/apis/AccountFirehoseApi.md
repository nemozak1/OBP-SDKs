...
> GetFastFirehoseAccountsAtOneBank200Response GetFastFirehoseAccountsAtOneBank (string bankid)
...
> GetFirehoseAccountsAtOneBank200Response GetFirehoseAccountsAtOneBank (string bankid, string viewid)
...
> GetFirehoseTransactionsForBankAccount200Response GetFirehoseTransactionsForBankAccount (string bankid, string accountid, string viewid)
