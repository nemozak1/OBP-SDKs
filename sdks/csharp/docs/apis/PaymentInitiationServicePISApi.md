...
> GetCounterpartiesForAnyAccount200Response GetCounterpartiesForAnyAccount (string bankid, string accountid, string viewid)
...
> GetCounterpartiesForAnyAccount200Response GetExplicitCounterpartiesForAccount (string bankid, string accountid, string viewid)
