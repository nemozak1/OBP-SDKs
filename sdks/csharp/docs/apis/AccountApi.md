...
<a id="addaccount"></a>
# **AddAccount**
> AddAccount200Response AddAccount (string bankid, AddAccountRequest addAccountRequest)
...
> GetAccountsByAccountRoutingRegex200ResponseAccountsInnerAccountAttributesInner CreateAccountAttribute (string bankid, string accountid, string productcode, UpdateAccountAttributeRequest updateAccountAttributeRequest)
...
# **CreateCounterparty**
> GetExplicitCounterpartyById200Response CreateCounterparty (string bankid, string accountid, string viewid, CreateCounterpartyForAnyAccountRequest createCounterpartyForAnyAccountRequest)
...
> GetExplicitCounterpartyById200Response CreateCounterpartyForAnyAccount (string bankid, string accountid, string viewid, CreateCounterpartyForAnyAccountRequest createCounterpartyForAnyAccountRequest)
...
> GetCustomerAccountLinksByCustomerId200ResponseLinksInner CreateCustomerAccountLink (string bankid, CreateCustomerAccountLinkRequest createCustomerAccountLinkRequest)
...
> GetTransactionRequestAttributeDefinition200ResponseAttributesInner CreateOrUpdateAccountAttributeDefinition (string bankid, CreateOrUpdateTransactionRequestAttributeDefinitionRequest createOrUpdateTransactionRequestAttributeDefinitionRequest)
...
> void DeleteAccountAttributeDefinition (string bankid, string attributedefinitionid)
...
> void DeleteAccountCascade (string bankid, string accountid)
...
> void DeleteCounterpartyForAnyAccount (string bankid, string accountid, string viewid, string counterpartyid)
...
> void DeleteExplicitCounterparty (string bankid, string accountid, string viewid, string counterpartyid)
...
> GetApiTags200Response GetAccountAccessByUserId (string userid)
...
> GetTransactionRequestAttributeDefinition200Response GetAccountAttributeDefinition (string bankid)
...
> GetAccountsByAccountRoutingRegex200ResponseAccountsInner GetAccountByAccountRouting (GetAccountsByAccountRoutingRegexRequest getAccountsByAccountRoutingRegexRequest)
...
# **GetAccountDirectory**
> GetAccountDirectory200Response GetAccountDirectory (string bankid)
...
> GetAccountsByAccountRoutingRegex200Response GetAccountsByAccountRoutingRegex (GetAccountsByAccountRoutingRegexRequest getAccountsByAccountRoutingRegexRequest)
...
> GetAccountsHeldByUserAtBank200Response GetAccountsHeldByUser (string userid)
...
> GetAccountsHeldByUserAtBank200Response GetAccountsHeldByUserAtBank (string userid, string bankid)
...
> GetApiTags200Response GetAccountsMinimalByCustomerId (string customerid)
...
<a id="getagent"></a>
# **GetAgent**
> GetAgent200Response GetAgent (string bankid, string agentid)
...
<a id="getagents"></a>
# **GetAgents**
> GetAgents200Response GetAgents (string bankid)
...
# **GetCheckbookOrders**
> GetCheckbookOrders200Response GetCheckbookOrders (string bankid, string accountid, string viewid)
...
> GetExplicitCounterpartyById200Response GetCounterpartyByIdForAnyAccount (string bankid, string accountid, string viewid, string counterpartyid)
...
> GetExplicitCounterpartyById200Response GetCounterpartyByNameForAnyAccount (string bankid, string accountid, string viewid, string counterpartyname)
...
> GetHoldingAccountByReleaser200Response GetHoldingAccountByReleaser (string bankid, string accountid, string viewid)
...
> GetTransactionByIdForBankAccount200ResponseOtherAccount GetOtherAccountByIdForBankAccount (string bankid, string accountid, string viewid, string otheraccountid)
...
> GetOtherAccountsForBankAccount200Response GetOtherAccountsForBankAccount (string bankid, string accountid, string viewid)
...
> GetPrivateAccountByIdFull200Response GetPrivateAccountByIdFull (string bankid, string accountid, string viewid)
...
> GetTransactionsForBankAccount200Response GetTransactionsForBankAccount (string bankid, string accountid, string viewid)
...
<a id="ibanchecker"></a>
# **IbanChecker**
> IbanChecker200Response IbanChecker (IbanCheckerRequest ibanCheckerRequest)
...
# **UpdateAccount**
> UpdateAccount200Response UpdateAccount (string bankid, string accountid, UpdateAccountRequest updateAccountRequest)
...
> GetAccountsByAccountRoutingRegex200ResponseAccountsInnerAccountAttributesInner UpdateAccountAttribute (string bankid, string accountid, string productcode, string accountattributeid, UpdateAccountAttributeRequest updateAccountAttributeRequest)
...
# **UpdateAccountLabel**
> UpdateTransactionNarrative200Response UpdateAccountLabel (string bankid, string accountid, UpdateAccountLabelRequest updateAccountLabelRequest)
