...
> GetPublicAccountById200Response GetPublicAccountById (string bankid, string accountid, string viewid)
...
> PublicAccountsAllBanks200Response PublicAccountsAtOneBank (string bankid)
