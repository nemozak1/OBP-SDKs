...
<a id="createbank"></a>
# **CreateBank**
> GetBank200Response CreateBank (CreateBankRequest createBankRequest)
...
# **CreateBankAttribute**
> GetBankAttributes200ResponseBankAttributesInner CreateBankAttribute (string bankid, UpdateAtmAttributeRequest updateAtmAttributeRequest)
...
> GetTransactionRequestAttributeDefinition200ResponseAttributesInner CreateOrUpdateBankAttributeDefinition (string bankid, CreateOrUpdateTransactionRequestAttributeDefinitionRequest createOrUpdateTransactionRequestAttributeDefinitionRequest)
...
> CreateSettlementAccount200Response CreateSettlementAccount (string bankid, CreateSettlementAccountRequest createSettlementAccountRequest)
...
> CreateTransactionType200Response CreateTransactionType (string bankid, GetTransactionTypes200ResponseTransactionTypesInner getTransactionTypes200ResponseTransactionTypesInner)
...
# **DeleteBankAttribute**
> void DeleteBankAttribute (string bankid, string bankattributeid)
...
# **DeleteBankCascade**
> void DeleteBankCascade (string bankid)
...
# **GetBankAttribute**
> GetBankAttributes200ResponseBankAttributesInner GetBankAttribute (string bankid, string bankattributeid)
...
# **GetBankAttributes**
> GetBankAttributes200Response GetBankAttributes (string bankid)
...
<a id="getbranch"></a>
# **GetBranch**
> GetBranches200ResponseBranchesInner GetBranch (string bankid, string branchid)
...
<a id="getbranches"></a>
# **GetBranches**
> GetBranches200Response GetBranches (string bankid)
...
<a id="updatebank"></a>
# **UpdateBank**
> UpdateBank200Response UpdateBank (UpdateBankRequest updateBankRequest)
...
# **UpdateBankAttribute**
> CreateOrUpdateTransactionRequestAttributeDefinitionRequest UpdateBankAttribute (string bankid, string bankattributeid, UpdateAtmAttributeRequest updateAtmAttributeRequest)
