...
# **AddEntitlement**
> AddSystemViewPermission200Response AddEntitlement (string userid, CreateConsentImplicitRequestEntitlementsInner createConsentImplicitRequestEntitlementsInner)
...
> GetAllEntitlementRequests200ResponseEntitlementRequestsInner AddEntitlementRequest (CreateConsentImplicitRequestEntitlementsInner createConsentImplicitRequestEntitlementsInner)
...
> AnswerUserAuthContextUpdateChallenge200Response AnswerUserAuthContextUpdateChallenge (string bankid, string authcontextupdateid, AnswerConsentChallengeRequest answerConsentChallengeRequest)
...
<a id="createuser"></a>
# **CreateUser**
> VerifyUserCredentials200Response CreateUser (CreateUserRequest createUserRequest)
...
> GetUserAuthContexts200Response CreateUserAuthContext (string userid, GetExplicitCounterpartyById200ResponseBespokeInner getExplicitCounterpartyById200ResponseBespokeInner)
...
> AnswerUserAuthContextUpdateChallenge200Response CreateUserAuthContextUpdateRequest (string bankid, string scamethod, GetExplicitCounterpartyById200ResponseBespokeInner getExplicitCounterpartyById200ResponseBespokeInner)
...
> GetUserCustomerLinksByCustomerId200ResponseUserCustomerLinksInner CreateUserCustomerLinks (string bankid, CreateUserCustomerLinksRequest createUserCustomerLinksRequest)
...
> CreateUserWithAccountAccessById200Response CreateUserWithAccountAccessById (string bankid, string accountid, string viewid, CreateUserWithAccountAccessByIdRequest createUserWithAccountAccessByIdRequest)
...
# **CreateUserWithRoles**
> GetEntitlements200Response CreateUserWithRoles (CreateUserWithRolesRequest createUserWithRolesRequest)
...
> void DeleteEntitlementRequest (string entitlementrequestid)
...
> void DeleteUserAuthContextById (string userid, string userauthcontextid)
...
> void DeleteUserAuthContexts (string userid)
...
> GetCustomerChildren200Response GetCustomersAtOneBank (string bankid)
...
> GetCustomersMinimalAtAnyBank200Response GetCustomersMinimalAtOneBank (string bankid)
...
> GetAllEntitlementRequests200Response GetEntitlementRequests (string userid)
...
# **GetEntitlements**
> GetEntitlements200Response GetEntitlements (string userid)
...
> GetEntitlementsAndPermissions200Response GetEntitlementsAndPermissions (string userid)
...
> GetUserByProviderAndUsername200ResponseEntitlements GetEntitlementsByBankAndUser (string bankid, string userid)
...
> GetEntitlements200Response GetEntitlementsForBank (string bankid)
...
> GetPermissionForUserForBankAccount200Response GetPermissionForUserForBankAccount (string bankid, string accountid, string provider, string providerid)
...
> GetPermissionsForBankAccount200Response GetPermissionsForBankAccount (string bankid, string accountid)
...
# **GetUserAuthContexts**
> GetUserAuthContexts200Response GetUserAuthContexts (string userid)
...
> GetUserByProviderAndUsername200Response GetUserByProviderAndUsername (string provider, string username)
...
# **GetUserByUserId**
> GetUsers200ResponseUsersInner GetUserByUserId (string userid)
...
# **GetUserLockStatus**
> GetUserLockStatus200Response GetUserLockStatus (string provider, string username)
...
# **GetUsersByEmail**
> GetUsersByEmail200Response GetUsersByEmail (string email)
...
> CreateUserWithAccountAccessById200ResponseHead GrantUserAccessToViewById (string bankid, string accountid, string viewid, RevokeUserAccessToViewByIdRequest revokeUserAccessToViewByIdRequest)
...
> LockUserByProviderAndUsername200Response LockUserByProviderAndUsername (string provider, string username)
...
<a id="refreshuser"></a>
# **RefreshUser**
> RefreshUser200Response RefreshUser (string userid)
...
> ResetPasswordComplete200Response ResetPasswordComplete (ResetPasswordCompleteRequest resetPasswordCompleteRequest)
...
# **ResetPasswordUrl**
> ResetPasswordUrl200Response ResetPasswordUrl (ResetPasswordUrlRequest resetPasswordUrlRequest)
...
> ResetPasswordComplete200Response ResetPasswordUrlAnonymous (ResetPasswordUrlAnonymousRequest resetPasswordUrlAnonymousRequest)
...
> RevokeUserAccessToViewById200Response RevokeUserAccessToViewById (string bankid, string accountid, string viewid, RevokeUserAccessToViewByIdRequest revokeUserAccessToViewByIdRequest)
...
# **SyncExternalUser**
> RefreshUser200Response SyncExternalUser (string provider, string providerid)
...
> GetUserLockStatus200Response UnlockUserByProviderAndUsername (string provider, string username)
...
> ValidateUserByUserId200Response ValidateUserByUserId (string userid)
...
# **ValidateUserEmail**
> ValidateUserEmail200Response ValidateUserEmail (ValidateUserEmailRequest validateUserEmailRequest)
...
> VerifyUserCredentials200Response VerifyUserCredentials (VerifyUserCredentialsRequest verifyUserCredentialsRequest)
