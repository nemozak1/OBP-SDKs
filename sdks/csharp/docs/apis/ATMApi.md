...
<a id="createatm"></a>
# **CreateAtm**
> GetAtm200Response CreateAtm (string bankid, CreateAtmRequest createAtmRequest)
...
<a id="deleteatm"></a>
# **DeleteAtm**
> void DeleteAtm (string bankid, string atmid)
...
<a id="getatm"></a>
# **GetAtm**
> GetAtm200Response GetAtm (string bankid, string atmid)
...
<a id="getatms"></a>
# **GetAtms**
> GetAtms200Response GetAtms (string bankid)
...
<a id="headatms"></a>
# **HeadAtms**
> HeadAtms200Response HeadAtms (string bankid)
...
<a id="updateatm"></a>
# **UpdateAtm**
> GetAtm200Response UpdateAtm (string bankid, string atmid, UpdateAtmRequest updateAtmRequest)
...
> UpdateAtmAccessibilityFeatures200Response UpdateAtmAccessibilityFeatures (string bankid, string atmid, UpdateAtmAccessibilityFeaturesRequest updateAtmAccessibilityFeaturesRequest)
...
> UpdateAtmLocationCategories200Response UpdateAtmLocationCategories (string bankid, string atmid, UpdateAtmLocationCategoriesRequest updateAtmLocationCategoriesRequest)
...
# **UpdateAtmNotes**
> UpdateAtmNotes200Response UpdateAtmNotes (string bankid, string atmid, UpdateAtmNotesRequest updateAtmNotesRequest)
...
# **UpdateAtmServices**
> UpdateAtmServices200Response UpdateAtmServices (string bankid, string atmid, UpdateAtmServicesRequest updateAtmServicesRequest)
...
> UpdateAtmSupportedCurrencies200Response UpdateAtmSupportedCurrencies (string bankid, string atmid, UpdateAtmSupportedCurrenciesRequest updateAtmSupportedCurrenciesRequest)
...
> UpdateAtmSupportedLanguages200Response UpdateAtmSupportedLanguages (string bankid, string atmid, UpdateAtmSupportedLanguagesRequest updateAtmSupportedLanguagesRequest)
