...
# **CreateProduct**
> CreateProduct200Response CreateProduct (string bankid, string productcode, CreateProductRequest createProductRequest)
...
# **CreateProductFee**
> GetProductFee200Response CreateProductFee (string bankid, string productcode, UpdateProductFeeRequest updateProductFeeRequest)
...
> void DeleteProductCascade (string bankid, string productcode)
...
# **DeleteProductFee**
> void DeleteProductFee (string bankid, string productcode, string productfeeid)
...
<a id="getproduct"></a>
# **GetProduct**
> GetProduct200Response GetProduct (string bankid, string productcode)
...
# **GetProductFee**
> GetProductFee200Response GetProductFee (string bankid, string productcode, string productfeeid)
...
# **GetProductFees**
> GetProductFees200Response GetProductFees (string bankid, string productcode)
...
# **GetProductTree**
> GetProductTree200Response GetProductTree (string bankid, string productcode)
...
<a id="getproducts"></a>
# **GetProducts**
> GetProducts200Response GetProducts (string bankid)
...
# **UpdateProductFee**
> GetProductFee200Response UpdateProductFee (string bankid, string productcode, string productfeeid, UpdateProductFeeRequest updateProductFeeRequest)
