...
> GetTransactionRequestAttributeDefinition200ResponseAttributesInner CreateOrUpdateProductAttributeDefinition (string bankid, CreateOrUpdateTransactionRequestAttributeDefinitionRequest createOrUpdateTransactionRequestAttributeDefinitionRequest)
...
> CreateProductAttribute200Response CreateProductAttribute (string bankid, string productcode, UpdateAtmAttributeRequest updateAtmAttributeRequest)
...
> void DeleteProductAttribute (string bankid, string productcode, string productattributeid)
...
> void DeleteProductAttributeDefinition (string bankid, string attributedefinitionid)
...
# **GetProductAttribute**
> CreateProductAttribute200Response GetProductAttribute (string bankid, string productcode, string productattributeid)
...
> GetTransactionRequestAttributeDefinition200Response GetProductAttributeDefinition (string bankid)
...
> CreateProductAttribute200Response UpdateProductAttribute (string bankid, string productcode, string productattributeid, UpdateAtmAttributeRequest updateAtmAttributeRequest)
