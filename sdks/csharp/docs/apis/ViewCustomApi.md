...
# **CreateCustomView**
> CreateCustomView200Response CreateCustomView (string bankid, string accountid, string viewid, CreateCustomViewRequest createCustomViewRequest)
...
> CreateUserWithAccountAccessById200ResponseHead CreateCustomViewManagement (string bankid, string accountid, CreateCustomViewManagementRequest createCustomViewManagementRequest)
...
> CreateUserWithAccountAccessById200ResponseHead CreateViewForBankAccount (string bankid, string accountid, CreateCustomViewManagementRequest createCustomViewManagementRequest)
...
# **DeleteCustomView**
> void DeleteCustomView (string bankid, string accountid, string viewid, string targetviewid)
...
> void DeleteViewForBankAccount (string bankid, string accountid, string viewid)
...
# **GetCustomView**
> CreateCustomView200Response GetCustomView (string bankid, string accountid, string viewid, string targetviewid)
...
# **GetCustomViewById**
> GetSystemViewById200Response GetCustomViewById (string bankid, string accountid, string viewid)
...
# **GetSystemViewById**
> GetSystemViewById200Response GetSystemViewById (string viewid)
...
> GetUsersWithAccountAccess200Response GetUsersWithAccountAccess (string bankid, string accountid, string viewid)
...
> GetViewsForBankAccount200Response GetViewsForBankAccount (string bankid, string accountid)
...
# **HasAccountAccess**
> HasAccountAccess200Response HasAccountAccess (string bankid, string accountid, string viewid)
...
# **UpdateCustomView**
> CreateCustomView200Response UpdateCustomView (string bankid, string accountid, string viewid, string targetviewid, UpdateCustomViewRequest updateCustomViewRequest)
...
# **UpdateSystemView**
> GetSystemViewById200Response UpdateSystemView (string viewid, UpdateSystemViewRequest updateSystemViewRequest)
...
> CreateUserWithAccountAccessById200ResponseHead UpdateViewForBankAccount (string bankid, string accountid, string viewid, UpdateViewForBankAccountRequest updateViewForBankAccountRequest)
