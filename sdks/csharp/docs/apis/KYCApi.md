...
<a id="addkyccheck"></a>
# **AddKycCheck**
> GetKycChecks200ResponseChecksInner AddKycCheck (string bankid, string customerid, string kyccheckid, AddKycCheckRequest addKycCheckRequest)
...
# **AddKycDocument**
> AddKycDocument200Response AddKycDocument (string bankid, string customerid, string kycdocumentid, AddKycDocumentRequest addKycDocumentRequest)
...
<a id="addkycmedia"></a>
# **AddKycMedia**
> AddKycMedia200Response AddKycMedia (string bankid, string customerid, string kycmediaid, AddKycMediaRequest addKycMediaRequest)
...
<a id="addkycstatus"></a>
# **AddKycStatus**
> GetKycStatuses200ResponseStatusesInner AddKycStatus (string bankid, string customerid, AddKycStatusRequest addKycStatusRequest)
...
# **CreateTaxResidence**
> CreateTaxResidence200Response CreateTaxResidence (string bankid, string customerid, CreateTaxResidenceRequest createTaxResidenceRequest)
...
> GetUserInvitations200Response CreateUserInvitation (string bankid, CreateUserInvitationRequest createUserInvitationRequest)
...
> void DeleteCustomerAddress (string bankid, string customerid, string customeraddressid)
...
# **DeleteTaxResidence**
> void DeleteTaxResidence (string bankid, string customerid, string taxresidenceid)
...
> GetCustomerAddresses200Response GetCustomerAddresses (string bankid, string customerid)
...
> GetCustomerByCustomerNumber200Response GetCustomerByCustomerNumber (string bankid, GetCustomerOverviewFlatRequest getCustomerOverviewFlatRequest)
...
# **GetCustomerOverview**
> GetCustomerOverview200Response GetCustomerOverview (string bankid, GetCustomerOverviewFlatRequest getCustomerOverviewFlatRequest)
...
> GetCustomerOverviewFlat200Response GetCustomerOverviewFlat (string bankid, GetCustomerOverviewFlatRequest getCustomerOverviewFlatRequest)
...
> UpdateCustomerBranch200Response GetCustomersByCustomerPhoneNumber (string bankid, CreateTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo createTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo)
...
> GetCustomerChildren200Response GetCustomersByLegalName (string bankid, GetCustomersByLegalNameRequest getCustomersByLegalNameRequest)
...
<a id="getkycchecks"></a>
# **GetKycChecks**
> GetKycChecks200Response GetKycChecks (string customerid)
...
# **GetKycDocuments**
> GetKycDocuments200Response GetKycDocuments (string customerid)
...
<a id="getkycmedia"></a>
# **GetKycMedia**
> GetKycMedia200Response GetKycMedia (string customerid)
...
# **GetKycStatuses**
> GetKycStatuses200Response GetKycStatuses (string customerid)
...
# **GetTaxResidence**
> GetTaxResidence200Response GetTaxResidence (string bankid, string customerid)
...
> GetUserInvitations200Response GetUserInvitationAnonymous (string bankid, GetUserInvitationAnonymousRequest getUserInvitationAnonymousRequest)
