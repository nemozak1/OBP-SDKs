...
> AddSystemViewPermission200Response AddSystemViewPermission (string viewid, AddSystemViewPermissionRequest addSystemViewPermissionRequest)
...
# **CreateSystemView**
> GetViewsForBankAccount200ResponseViewsInner CreateSystemView (CreateSystemViewRequest createSystemViewRequest)
...
# **DeleteSystemView**
> void DeleteSystemView (string viewid)
...
> void DeleteSystemViewPermission (string viewid, string permissionname)
...
# **GetSystemView**
> GetViewsForBankAccount200ResponseViewsInner GetSystemView (string viewid)
