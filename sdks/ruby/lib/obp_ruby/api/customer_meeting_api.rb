  ...
  class CustomerMeetingApi
    ...
    def create_meeting_with_http_info(bankid, create_meeting_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomerMeetingApi.create_meeting ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling CustomerMeetingApi.create_meeting"
      end
      ...
      if @api_client.config.client_side_validation && create_meeting_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_meeting_request' when calling CustomerMeetingApi.create_meeting"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CustomerMeetingApi.create_meeting",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomerMeetingApi#create_meeting\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_meeting_with_http_info(bankid, meetingid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomerMeetingApi.get_meeting ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling CustomerMeetingApi.get_meeting"
      end
      # verify the required parameter 'meetingid' is set
      if @api_client.config.client_side_validation && meetingid.nil?
        fail ArgumentError, "Missing the required parameter 'meetingid' when calling CustomerMeetingApi.get_meeting"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CustomerMeetingApi.get_meeting",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomerMeetingApi#get_meeting\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_meetings_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CustomerMeetingApi.get_meetings ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling CustomerMeetingApi.get_meetings"
      end
      # resource path
      local_var_path = '/obp/v3.1.0/banks/{bankid}/meetings'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"CustomerMeetingApi.get_meetings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomerMeetingApi#get_meetings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
