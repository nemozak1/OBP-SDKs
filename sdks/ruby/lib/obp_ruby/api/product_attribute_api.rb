  ...
  class ProductAttributeApi
    ...
    def create_or_update_product_attribute_definition_with_http_info(bankid, create_or_update_transaction_request_attribute_definition_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductAttributeApi.create_or_update_product_attribute_definition ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling ProductAttributeApi.create_or_update_product_attribute_definition"
      end
      ...
      if @api_client.config.client_side_validation && create_or_update_transaction_request_attribute_definition_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_or_update_transaction_request_attribute_definition_request' when calling ProductAttributeApi.create_or_update_product_attribute_definition"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ProductAttributeApi.create_or_update_product_attribute_definition",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductAttributeApi#create_or_update_product_attribute_definition\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_product_attribute_with_http_info(bankid, productcode, update_atm_attribute_request, opts = {})
      ...
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling ProductAttributeApi.create_product_attribute"
      end
      # verify the required parameter 'productcode' is set
      if @api_client.config.client_side_validation && productcode.nil?
        fail ArgumentError, "Missing the required parameter 'productcode' when calling ProductAttributeApi.create_product_attribute"
      end
      ...
      if @api_client.config.client_side_validation && update_atm_attribute_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_atm_attribute_request' when calling ProductAttributeApi.create_product_attribute"
      end
      # resource path
    ...
    def delete_product_attribute_with_http_info(bankid, productcode, productattributeid, opts = {})
      ...
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling ProductAttributeApi.delete_product_attribute"
      end
      # verify the required parameter 'productcode' is set
      if @api_client.config.client_side_validation && productcode.nil?
        fail ArgumentError, "Missing the required parameter 'productcode' when calling ProductAttributeApi.delete_product_attribute"
      end
      ...
      if @api_client.config.client_side_validation && productattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'productattributeid' when calling ProductAttributeApi.delete_product_attribute"
      end
      # resource path
    ...
    def delete_product_attribute_definition_with_http_info(bankid, attributedefinitionid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductAttributeApi.delete_product_attribute_definition ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling ProductAttributeApi.delete_product_attribute_definition"
      end
      ...
      if @api_client.config.client_side_validation && attributedefinitionid.nil?
        fail ArgumentError, "Missing the required parameter 'attributedefinitionid' when calling ProductAttributeApi.delete_product_attribute_definition"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ProductAttributeApi.delete_product_attribute_definition",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductAttributeApi#delete_product_attribute_definition\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_product_attribute_with_http_info(bankid, productcode, productattributeid, opts = {})
      ...
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling ProductAttributeApi.get_product_attribute"
      end
      # verify the required parameter 'productcode' is set
      if @api_client.config.client_side_validation && productcode.nil?
        fail ArgumentError, "Missing the required parameter 'productcode' when calling ProductAttributeApi.get_product_attribute"
      end
      # verify the required parameter 'productattributeid' is set
      if @api_client.config.client_side_validation && productattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'productattributeid' when calling ProductAttributeApi.get_product_attribute"
      end
      # resource path
    ...
    def get_product_attribute_definition_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ProductAttributeApi.get_product_attribute_definition ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling ProductAttributeApi.get_product_attribute_definition"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/banks/{bankid}/attribute-definitions/product'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ProductAttributeApi.get_product_attribute_definition",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ProductAttributeApi#get_product_attribute_definition\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_product_attribute_with_http_info(bankid, productcode, productattributeid, update_atm_attribute_request, opts = {})
      ...
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling ProductAttributeApi.update_product_attribute"
      end
      # verify the required parameter 'productcode' is set
      if @api_client.config.client_side_validation && productcode.nil?
        fail ArgumentError, "Missing the required parameter 'productcode' when calling ProductAttributeApi.update_product_attribute"
      end
      # verify the required parameter 'productattributeid' is set
      if @api_client.config.client_side_validation && productattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'productattributeid' when calling ProductAttributeApi.update_product_attribute"
      end
      # verify the required parameter 'update_atm_attribute_request' is set
      if @api_client.config.client_side_validation && update_atm_attribute_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_atm_attribute_request' when calling ProductAttributeApi.update_product_attribute"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/banks/{bankid}/products/{productcode}/attributes/{productattributeid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'productcode' + '}', CGI.escape(productcode.to_s)).sub('{' + 'productattributeid' + '}', CGI.escape(productattributeid.to_s))
