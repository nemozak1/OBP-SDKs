  ...
  class ChannelApi
    ...
    def delete_signal_channel_with_http_info(channelname, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ChannelApi.delete_signal_channel ...'
      end
      # verify the required parameter 'channelname' is set
      if @api_client.config.client_side_validation && channelname.nil?
        fail ArgumentError, "Missing the required parameter 'channelname' when calling ChannelApi.delete_signal_channel"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ChannelApi.delete_signal_channel",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChannelApi#delete_signal_channel\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_signal_channel_info_with_http_info(channelname, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ChannelApi.get_signal_channel_info ...'
      end
      # verify the required parameter 'channelname' is set
      if @api_client.config.client_side_validation && channelname.nil?
        fail ArgumentError, "Missing the required parameter 'channelname' when calling ChannelApi.get_signal_channel_info"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ChannelApi.get_signal_channel_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChannelApi#get_signal_channel_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_signal_channels_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ChannelApi.get_signal_channels ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ChannelApi.get_signal_channels",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChannelApi#get_signal_channels\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_signal_messages_with_http_info(channelname, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ChannelApi.get_signal_messages ...'
      end
      # verify the required parameter 'channelname' is set
      if @api_client.config.client_side_validation && channelname.nil?
        fail ArgumentError, "Missing the required parameter 'channelname' when calling ChannelApi.get_signal_messages"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ChannelApi.get_signal_messages",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChannelApi#get_signal_messages\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_signal_stats_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ChannelApi.get_signal_stats ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ChannelApi.get_signal_stats",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChannelApi#get_signal_stats\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def publish_signal_message_with_http_info(channelname, publish_signal_message_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ChannelApi.publish_signal_message ...'
      end
      # verify the required parameter 'channelname' is set
      if @api_client.config.client_side_validation && channelname.nil?
        fail ArgumentError, "Missing the required parameter 'channelname' when calling ChannelApi.publish_signal_message"
      end
      ...
      if @api_client.config.client_side_validation && publish_signal_message_request.nil?
        fail ArgumentError, "Missing the required parameter 'publish_signal_message_request' when calling ChannelApi.publish_signal_message"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/signal/channels/{channelname}/messages'.sub('{' + 'channelname' + '}', CGI.escape(channelname.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ChannelApi.publish_signal_message",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ChannelApi#publish_signal_message\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
