...
module OpenBankProject
  class DocumentationApi
    ...
    def get_api_glossary(opts = {})
      data, _status_code, _headers = get_api_glossary_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get API Glossary&lt;/p&gt; &lt;p&gt;Returns the glossary of the API.&lt;/p&gt; &lt;p&gt;The glossary content is static and only changes when the API is redeployed.&lt;br /&gt; This endpoint supports HTTP caching:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;The response includes a &lt;strong&gt;Cache-Control&lt;/strong&gt; header (max-age&#x3D;3600) indicating clients should cache for 1 hour.&lt;/li&gt; &lt;li&gt;The response includes an &lt;strong&gt;ETag&lt;/strong&gt; header. Clients can send &lt;strong&gt;If-None-Match&lt;/strong&gt; with the ETag value on subsequent requests to receive a &lt;strong&gt;304 Not Modified&lt;/strong&gt; if the content has not changed.&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;Clients and agents are encouraged to cache the glossary response locally.&lt;/p&gt; &lt;p&gt;User Authentication is Optional. The User need not be logged in.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#description\&quot;&gt;&lt;strong&gt;description&lt;/strong&gt;&lt;/a&gt;: Description of the object. Maximum length is 2000. It can be any characters here.&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#glossary_items\&quot;&gt;&lt;strong&gt;glossary_items&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#html\&quot;&gt;&lt;strong&gt;html&lt;/strong&gt;&lt;/a&gt;: html format content&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#markdown\&quot;&gt;&lt;strong&gt;markdown&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;title&lt;/strong&gt;&lt;/a&gt;: Dr.&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetApiGlossary200Response, Integer, Hash)>] GetApiGlossary200Response data, response status code and response headers
    def get_api_glossary_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentationApi.get_api_glossary ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetApiGlossary200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"DocumentationApi.get_api_glossary",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentationApi#get_api_glossary\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_bank_level_dynamic_resource_docs_obp_with_http_info(bankid, apiversion, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentationApi.get_bank_level_dynamic_resource_docs_obp ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling DocumentationApi.get_bank_level_dynamic_resource_docs_obp"
      end
      # verify the required parameter 'apiversion' is set
      if @api_client.config.client_side_validation && apiversion.nil?
        fail ArgumentError, "Missing the required parameter 'apiversion' when calling DocumentationApi.get_bank_level_dynamic_resource_docs_obp"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DocumentationApi.get_bank_level_dynamic_resource_docs_obp",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentationApi#get_bank_level_dynamic_resource_docs_obp\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_message_docs_with_http_info(connector, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentationApi.get_message_docs ...'
      end
      # verify the required parameter 'connector' is set
      if @api_client.config.client_side_validation && connector.nil?
        fail ArgumentError, "Missing the required parameter 'connector' when calling DocumentationApi.get_message_docs"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DocumentationApi.get_message_docs",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentationApi#get_message_docs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_message_docs_json_schema_with_http_info(connector, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentationApi.get_message_docs_json_schema ...'
      end
      # verify the required parameter 'connector' is set
      if @api_client.config.client_side_validation && connector.nil?
        fail ArgumentError, "Missing the required parameter 'connector' when calling DocumentationApi.get_message_docs_json_schema"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DocumentationApi.get_message_docs_json_schema",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentationApi#get_message_docs_json_schema\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_message_docs_swagger_with_http_info(connector, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentationApi.get_message_docs_swagger ...'
      end
      # verify the required parameter 'connector' is set
      if @api_client.config.client_side_validation && connector.nil?
        fail ArgumentError, "Missing the required parameter 'connector' when calling DocumentationApi.get_message_docs_swagger"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DocumentationApi.get_message_docs_swagger",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentationApi#get_message_docs_swagger\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_resource_docs_obp_with_http_info(apiversion, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentationApi.get_resource_docs_obp ...'
      end
      # verify the required parameter 'apiversion' is set
      if @api_client.config.client_side_validation && apiversion.nil?
        fail ArgumentError, "Missing the required parameter 'apiversion' when calling DocumentationApi.get_resource_docs_obp"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DocumentationApi.get_resource_docs_obp",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentationApi#get_resource_docs_obp\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_resource_docs_open_api31_with_http_info(apiversion, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentationApi.get_resource_docs_open_api31 ...'
      end
      # verify the required parameter 'apiversion' is set
      if @api_client.config.client_side_validation && apiversion.nil?
        fail ArgumentError, "Missing the required parameter 'apiversion' when calling DocumentationApi.get_resource_docs_open_api31"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DocumentationApi.get_resource_docs_open_api31",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentationApi#get_resource_docs_open_api31\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_resource_docs_swagger_with_http_info(apiversion, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentationApi.get_resource_docs_swagger ...'
      end
      # verify the required parameter 'apiversion' is set
      if @api_client.config.client_side_validation && apiversion.nil?
        fail ArgumentError, "Missing the required parameter 'apiversion' when calling DocumentationApi.get_resource_docs_swagger"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DocumentationApi.get_resource_docs_swagger",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentationApi#get_resource_docs_swagger\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_scanned_api_versions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DocumentationApi.get_scanned_api_versions ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DocumentationApi.get_scanned_api_versions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DocumentationApi#get_scanned_api_versions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
