  ...
  class MethodRoutingApi
    ...
    def create_method_routing_with_http_info(create_method_routing_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MethodRoutingApi.create_method_routing ...'
      end
      ...
      if @api_client.config.client_side_validation && create_method_routing_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_method_routing_request' when calling MethodRoutingApi.create_method_routing"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"MethodRoutingApi.create_method_routing",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MethodRoutingApi#create_method_routing\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_method_routing_with_http_info(methodroutingid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MethodRoutingApi.delete_method_routing ...'
      end
      # verify the required parameter 'methodroutingid' is set
      if @api_client.config.client_side_validation && methodroutingid.nil?
        fail ArgumentError, "Missing the required parameter 'methodroutingid' when calling MethodRoutingApi.delete_method_routing"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"MethodRoutingApi.delete_method_routing",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MethodRoutingApi#delete_method_routing\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_connector_method_names_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MethodRoutingApi.get_connector_method_names ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"MethodRoutingApi.get_connector_method_names",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MethodRoutingApi#get_connector_method_names\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_method_routings_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MethodRoutingApi.get_method_routings ...'
      end
      # resource path
      local_var_path = '/obp/v3.1.0/management/method_routings'
      ...
      new_options = opts.merge(
        :operation => :"MethodRoutingApi.get_method_routings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MethodRoutingApi#get_method_routings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_method_routing_with_http_info(methodroutingid, create_method_routing_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MethodRoutingApi.update_method_routing ...'
      end
      # verify the required parameter 'methodroutingid' is set
      if @api_client.config.client_side_validation && methodroutingid.nil?
        fail ArgumentError, "Missing the required parameter 'methodroutingid' when calling MethodRoutingApi.update_method_routing"
      end
      # verify the required parameter 'create_method_routing_request' is set
      if @api_client.config.client_side_validation && create_method_routing_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_method_routing_request' when calling MethodRoutingApi.update_method_routing"
      end
      # resource path
      local_var_path = '/obp/v3.1.0/management/method_routings/{methodroutingid}'.sub('{' + 'methodroutingid' + '}', CGI.escape(methodroutingid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"MethodRoutingApi.update_method_routing",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MethodRoutingApi#update_method_routing\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
