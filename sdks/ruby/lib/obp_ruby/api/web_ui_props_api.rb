...
module OpenBankProject
  class WebUiPropsApi
    ...
    def create_or_update_web_ui_props(webuipropname, get_transaction_types200_response_transaction_types_inner_id, opts = {})
      data, _status_code, _headers = create_or_update_web_ui_props_with_http_info(webuipropname, get_transaction_types200_response_transaction_types_inner_id, opts)
      data
    end
    ...
    # @param get_transaction_types200_response_transaction_types_inner_id [GetTransactionTypes200ResponseTransactionTypesInnerId] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateWebUiProps200Response, Integer, Hash)>] CreateWebUiProps200Response data, response status code and response headers
    def create_or_update_web_ui_props_with_http_info(webuipropname, get_transaction_types200_response_transaction_types_inner_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebUiPropsApi.create_or_update_web_ui_props ...'
      end
      # verify the required parameter 'webuipropname' is set
      if @api_client.config.client_side_validation && webuipropname.nil?
        fail ArgumentError, "Missing the required parameter 'webuipropname' when calling WebUiPropsApi.create_or_update_web_ui_props"
      end
      ...
      if @api_client.config.client_side_validation && get_transaction_types200_response_transaction_types_inner_id.nil?
        fail ArgumentError, "Missing the required parameter 'get_transaction_types200_response_transaction_types_inner_id' when calling WebUiPropsApi.create_or_update_web_ui_props"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateWebUiProps200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"WebUiPropsApi.create_or_update_web_ui_props",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebUiPropsApi#create_or_update_web_ui_props\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param create_transaction_request_counterparty200_response_attributes_inner [CreateTransactionRequestCounterparty200ResponseAttributesInner] Request body
    # @param [Hash] opts the optional parameters
    # @return [CreateWebUiProps200Response]
    def create_web_ui_props(create_transaction_request_counterparty200_response_attributes_inner, opts = {})
      data, _status_code, _headers = create_web_ui_props_with_http_info(create_transaction_request_counterparty200_response_attributes_inner, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateWebUiProps200Response, Integer, Hash)>] CreateWebUiProps200Response data, response status code and response headers
    def create_web_ui_props_with_http_info(create_transaction_request_counterparty200_response_attributes_inner, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebUiPropsApi.create_web_ui_props ...'
      end
      # verify the required parameter 'create_transaction_request_counterparty200_response_attributes_inner' is set
      if @api_client.config.client_side_validation && create_transaction_request_counterparty200_response_attributes_inner.nil?
        fail ArgumentError, "Missing the required parameter 'create_transaction_request_counterparty200_response_attributes_inner' when calling WebUiPropsApi.create_web_ui_props"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_transaction_request_counterparty200_response_attributes_inner)
      ...
      new_options = opts.merge(
        :operation => :"WebUiPropsApi.create_web_ui_props",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebUiPropsApi#create_web_ui_props\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_web_ui_props(webuipropname, opts = {})
      delete_web_ui_props_with_http_info(webuipropname, opts)
      nil
    end
    ...
    def delete_web_ui_props_with_http_info(webuipropname, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebUiPropsApi.delete_web_ui_props ...'
      end
      # verify the required parameter 'webuipropname' is set
      if @api_client.config.client_side_validation && webuipropname.nil?
        fail ArgumentError, "Missing the required parameter 'webuipropname' when calling WebUiPropsApi.delete_web_ui_props"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/management/webui_props/{webuipropname}'.sub('{' + 'webuipropname' + '}', CGI.escape(webuipropname.to_s))
      ...
      new_options = opts.merge(
        :operation => :"WebUiPropsApi.delete_web_ui_props",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebUiPropsApi#delete_web_ui_props\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_web_ui_prop(webuipropname, opts = {})
      data, _status_code, _headers = get_web_ui_prop_with_http_info(webuipropname, opts)
      data
    end
    ...
    # @param webuipropname [String] The WEBUIPROPNAME identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetWebUiProps200ResponseWebuiPropsInner, Integer, Hash)>] GetWebUiProps200ResponseWebuiPropsInner data, response status code and response headers
    def get_web_ui_prop_with_http_info(webuipropname, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebUiPropsApi.get_web_ui_prop ...'
      end
      # verify the required parameter 'webuipropname' is set
      if @api_client.config.client_side_validation && webuipropname.nil?
        fail ArgumentError, "Missing the required parameter 'webuipropname' when calling WebUiPropsApi.get_web_ui_prop"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetWebUiProps200ResponseWebuiPropsInner'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"WebUiPropsApi.get_web_ui_prop",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebUiPropsApi#get_web_ui_prop\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_web_ui_props(opts = {})
      data, _status_code, _headers = get_web_ui_props_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get WebUiProps - properties that configure the Web UI behavior and appearance.&lt;/p&gt; &lt;p&gt;Properties with names starting with &amp;quot;webui_&amp;quot; can be stored in the database and managed via API.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Data Sources:&lt;/strong&gt;&lt;/p&gt; &lt;ol&gt; &lt;li&gt; &lt;p&gt;&lt;strong&gt;Explicit WebUiProps (Database)&lt;/strong&gt;: Custom values created/updated via the API and stored in the database.&lt;/p&gt; &lt;/li&gt; &lt;li&gt; &lt;p&gt;&lt;strong&gt;Implicit WebUiProps (Configuration File)&lt;/strong&gt;: Default values defined in the &lt;code&gt;sample.props.template&lt;/code&gt; configuration file.&lt;/p&gt; &lt;/li&gt; &lt;/ol&gt; &lt;p&gt;&lt;strong&gt;Response Fields:&lt;/strong&gt;&lt;/p&gt; &lt;ul&gt; &lt;li&gt;&lt;code&gt;name&lt;/code&gt;: The property name&lt;/li&gt; &lt;li&gt;&lt;code&gt;value&lt;/code&gt;: The property value&lt;/li&gt; &lt;li&gt;&lt;code&gt;webUiPropsId&lt;/code&gt; (optional): UUID for database props, omitted for config props&lt;/li&gt; &lt;li&gt;&lt;code&gt;source&lt;/code&gt;: Either &amp;quot;database&amp;quot; (editable via API) or &amp;quot;config&amp;quot; (read-only from config file)&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;&lt;strong&gt;Query Parameter:&lt;/strong&gt;&lt;/p&gt; &lt;ul&gt; &lt;li&gt;&lt;code&gt;what&lt;/code&gt; (optional, string, default: &amp;quot;active&amp;quot;)&lt;/li&gt; &lt;li&gt;&lt;code&gt;active&lt;/code&gt;: Returns one value per property name &lt;ul&gt; &lt;li&gt;If property exists in database: returns database value (source&#x3D;&amp;quot;database&amp;quot;)&lt;/li&gt; &lt;li&gt;If property only in config file: returns config default value (source&#x3D;&amp;quot;config&amp;quot;)&lt;/li&gt; &lt;/ul&gt; &lt;/li&gt; &lt;li&gt;&lt;code&gt;database&lt;/code&gt;: Returns ONLY properties explicitly stored in the database (source&#x3D;&amp;quot;database&amp;quot;)&lt;/li&gt; &lt;li&gt;&lt;code&gt;config&lt;/code&gt;: Returns ONLY default properties from configuration file (source&#x3D;&amp;quot;config&amp;quot;)&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;&lt;strong&gt;Examples:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;Get active props (database overrides config, one value per prop):&lt;br /&gt; &lt;a href&#x3D;\&quot;http://127.0.0.1:8080/obp/v6.0.0/webui-props\&quot;&gt;http://127.0.0.1:8080/obp/v6.0.0/webui-props&lt;/a&gt;&lt;br /&gt; &lt;a href&#x3D;\&quot;http://127.0.0.1:8080/obp/v6.0.0/webui-props?what&#x3D;active\&quot;&gt;http://127.0.0.1:8080/obp/v6.0.0/webui-props?what&#x3D;active&lt;/a&gt;&lt;/p&gt; &lt;p&gt;Get only database-stored props:&lt;br /&gt; &lt;a href&#x3D;\&quot;http://127.0.0.1:8080/obp/v6.0.0/webui-props?what&#x3D;database\&quot;&gt;http://127.0.0.1:8080/obp/v6.0.0/webui-props?what&#x3D;database&lt;/a&gt;&lt;/p&gt; &lt;p&gt;Get only default props from configuration:&lt;br /&gt; &lt;a href&#x3D;\&quot;http://127.0.0.1:8080/obp/v6.0.0/webui-props?what&#x3D;config\&quot;&gt;http://127.0.0.1:8080/obp/v6.0.0/webui-props?what&#x3D;config&lt;/a&gt;&lt;/p&gt; &lt;p&gt;For more details about WebUI Props, including how to set config file defaults and precedence order, see &lt;a href&#x3D;\&quot;/glossary#webui_props\&quot;&gt;here&lt;/a&gt;.&lt;/p&gt; &lt;p&gt;User Authentication is Optional. The User need not be logged in.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#name\&quot;&gt;&lt;strong&gt;name&lt;/strong&gt;&lt;/a&gt;: ACCOUNT_MANAGEMENT_FEE&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;value&lt;/strong&gt;&lt;/a&gt;: 5987953&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;source&lt;/a&gt;:&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetWebUiProps200Response, Integer, Hash)>] GetWebUiProps200Response data, response status code and response headers
    def get_web_ui_props_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebUiPropsApi.get_web_ui_props ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetWebUiProps200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"WebUiPropsApi.get_web_ui_props",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebUiPropsApi#get_web_ui_props\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
