  ...
  class OldStyleApi
    ...
    def elastic_search_metrics_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OldStyleApi.elastic_search_metrics ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"OldStyleApi.elastic_search_metrics",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OldStyleApi#elastic_search_metrics\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
