  ...
  class ConnectorApi
    ...
    def get_connectors_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConnectorApi.get_connectors ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ConnectorApi.get_connectors",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConnectorApi#get_connectors\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_stored_procedure_connector_health_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConnectorApi.get_stored_procedure_connector_health ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ConnectorApi.get_stored_procedure_connector_health",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConnectorApi#get_stored_procedure_connector_health\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
