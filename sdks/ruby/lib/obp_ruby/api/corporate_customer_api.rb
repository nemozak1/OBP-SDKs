  ...
  class CorporateCustomerApi
    ...
    def create_corporate_customer_with_http_info(bankid, create_corporate_customer_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CorporateCustomerApi.create_corporate_customer ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling CorporateCustomerApi.create_corporate_customer"
      end
      ...
      if @api_client.config.client_side_validation && create_corporate_customer_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_corporate_customer_request' when calling CorporateCustomerApi.create_corporate_customer"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CorporateCustomerApi.create_corporate_customer",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CorporateCustomerApi#create_corporate_customer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_corporate_customer_by_customer_id_with_http_info(bankid, customerid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CorporateCustomerApi.get_corporate_customer_by_customer_id ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling CorporateCustomerApi.get_corporate_customer_by_customer_id"
      end
      # verify the required parameter 'customerid' is set
      if @api_client.config.client_side_validation && customerid.nil?
        fail ArgumentError, "Missing the required parameter 'customerid' when calling CorporateCustomerApi.get_corporate_customer_by_customer_id"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CorporateCustomerApi.get_corporate_customer_by_customer_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CorporateCustomerApi#get_corporate_customer_by_customer_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_corporate_customer_subsidiaries_with_http_info(bankid, customerid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CorporateCustomerApi.get_corporate_customer_subsidiaries ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling CorporateCustomerApi.get_corporate_customer_subsidiaries"
      end
      # verify the required parameter 'customerid' is set
      if @api_client.config.client_side_validation && customerid.nil?
        fail ArgumentError, "Missing the required parameter 'customerid' when calling CorporateCustomerApi.get_corporate_customer_subsidiaries"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CorporateCustomerApi.get_corporate_customer_subsidiaries",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CorporateCustomerApi#get_corporate_customer_subsidiaries\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_corporate_customers_at_one_bank_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CorporateCustomerApi.get_corporate_customers_at_one_bank ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling CorporateCustomerApi.get_corporate_customers_at_one_bank"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/banks/{bankid}/corporate-customers'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"CorporateCustomerApi.get_corporate_customers_at_one_bank",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CorporateCustomerApi#get_corporate_customers_at_one_bank\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
