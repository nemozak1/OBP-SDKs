  ...
  class ConsumerApi
    ...
    def add_scope_with_http_info(consumerid, create_consent_implicit_request_entitlements_inner, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.add_scope ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.add_scope"
      end
      ...
      if @api_client.config.client_side_validation && create_consent_implicit_request_entitlements_inner.nil?
        fail ArgumentError, "Missing the required parameter 'create_consent_implicit_request_entitlements_inner' when calling ConsumerApi.add_scope"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.add_scope",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#add_scope\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param consumerid [String] The CONSUMERID identifier
    # @param update_rate_limits_request [UpdateRateLimitsRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [UpdateRateLimitsRequest]
    def calls_limit(consumerid, update_rate_limits_request, opts = {})
      data, _status_code, _headers = calls_limit_with_http_info(consumerid, update_rate_limits_request, opts)
      data
    end
    ...
    # @param update_rate_limits_request [UpdateRateLimitsRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateRateLimitsRequest, Integer, Hash)>] UpdateRateLimitsRequest data, response status code and response headers
    def calls_limit_with_http_info(consumerid, update_rate_limits_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.calls_limit ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.calls_limit"
      end
      # verify the required parameter 'update_rate_limits_request' is set
      if @api_client.config.client_side_validation && update_rate_limits_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_rate_limits_request' when calling ConsumerApi.calls_limit"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_rate_limits_request)

      # return_type
      return_type = opts[:debug_return_type] || 'UpdateRateLimitsRequest'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.calls_limit",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#calls_limit\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param consumerid [String] The CONSUMERID identifier
    # @param create_call_limits_request [CreateCallLimitsRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [CreateCallLimits200Response]
    def create_call_limits(consumerid, create_call_limits_request, opts = {})
      data, _status_code, _headers = create_call_limits_with_http_info(consumerid, create_call_limits_request, opts)
      data
    end
    ...
    # @param create_call_limits_request [CreateCallLimitsRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateCallLimits200Response, Integer, Hash)>] CreateCallLimits200Response data, response status code and response headers
    def create_call_limits_with_http_info(consumerid, create_call_limits_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.create_call_limits ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.create_call_limits"
      end
      # verify the required parameter 'create_call_limits_request' is set
      if @api_client.config.client_side_validation && create_call_limits_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_call_limits_request' when calling ConsumerApi.create_call_limits"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_call_limits_request)

      # return_type
      return_type = opts[:debug_return_type] || 'CreateCallLimits200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.create_call_limits",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#create_call_limits\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param create_consumer_request [CreateConsumerRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [CreateConsumer200Response]
    def create_consumer(create_consumer_request, opts = {})
      data, _status_code, _headers = create_consumer_with_http_info(create_consumer_request, opts)
      data
    end
    ...
    # @param create_consumer_request [CreateConsumerRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateConsumer200Response, Integer, Hash)>] CreateConsumer200Response data, response status code and response headers
    def create_consumer_with_http_info(create_consumer_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.create_consumer ...'
      end
      # verify the required parameter 'create_consumer_request' is set
      if @api_client.config.client_side_validation && create_consumer_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_consumer_request' when calling ConsumerApi.create_consumer"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_consumer_request)

      # return_type
      return_type = opts[:debug_return_type] || 'CreateConsumer200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.create_consumer",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#create_consumer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param create_consumer_dynamic_registration_request [CreateConsumerDynamicRegistrationRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [UpdateConsumerName200Response]
    def create_consumer_dynamic_registration(create_consumer_dynamic_registration_request, opts = {})
      data, _status_code, _headers = create_consumer_dynamic_registration_with_http_info(create_consumer_dynamic_registration_request, opts)
      data
    end
    ...
    # @param create_consumer_dynamic_registration_request [CreateConsumerDynamicRegistrationRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateConsumerName200Response, Integer, Hash)>] UpdateConsumerName200Response data, response status code and response headers
    def create_consumer_dynamic_registration_with_http_info(create_consumer_dynamic_registration_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.create_consumer_dynamic_registration ...'
      end
      # verify the required parameter 'create_consumer_dynamic_registration_request' is set
      if @api_client.config.client_side_validation && create_consumer_dynamic_registration_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_consumer_dynamic_registration_request' when calling ConsumerApi.create_consumer_dynamic_registration"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_consumer_dynamic_registration_request)

      # return_type
      return_type = opts[:debug_return_type] || 'UpdateConsumerName200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.create_consumer_dynamic_registration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#create_consumer_dynamic_registration\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [UpdateConsumerName200Response]
    def create_my_consumer(create_consumer_request, opts = {})
      data, _status_code, _headers = create_my_consumer_with_http_info(create_consumer_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateConsumerName200Response, Integer, Hash)>] UpdateConsumerName200Response data, response status code and response headers
    def create_my_consumer_with_http_info(create_consumer_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.create_my_consumer ...'
      end
      # verify the required parameter 'create_consumer_request' is set
      if @api_client.config.client_side_validation && create_consumer_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_consumer_request' when calling ConsumerApi.create_my_consumer"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.create_my_consumer",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#create_my_consumer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_call_limits(consumerid, ratelimitingid, opts = {})
      delete_call_limits_with_http_info(consumerid, ratelimitingid, opts)
      nil
    end
    ...
    def delete_call_limits_with_http_info(consumerid, ratelimitingid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.delete_call_limits ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.delete_call_limits"
      end
      # verify the required parameter 'ratelimitingid' is set
      if @api_client.config.client_side_validation && ratelimitingid.nil?
        fail ArgumentError, "Missing the required parameter 'ratelimitingid' when calling ConsumerApi.delete_call_limits"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.delete_call_limits",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#delete_call_limits\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_scope_with_http_info(consumerid, scopeid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.delete_scope ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.delete_scope"
      end
      # verify the required parameter 'scopeid' is set
      if @api_client.config.client_side_validation && scopeid.nil?
        fail ArgumentError, "Missing the required parameter 'scopeid' when calling ConsumerApi.delete_scope"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.delete_scope",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#delete_scope\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param consumerid [String] The CONSUMERID identifier
    # @param enable_disable_consumers_request [EnableDisableConsumersRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [EnableDisableConsumersRequest]
    def enable_disable_consumers(consumerid, enable_disable_consumers_request, opts = {})
      data, _status_code, _headers = enable_disable_consumers_with_http_info(consumerid, enable_disable_consumers_request, opts)
      data
    end
    ...
    # @param enable_disable_consumers_request [EnableDisableConsumersRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(EnableDisableConsumersRequest, Integer, Hash)>] EnableDisableConsumersRequest data, response status code and response headers
    def enable_disable_consumers_with_http_info(consumerid, enable_disable_consumers_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.enable_disable_consumers ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.enable_disable_consumers"
      end
      # verify the required parameter 'enable_disable_consumers_request' is set
      if @api_client.config.client_side_validation && enable_disable_consumers_request.nil?
        fail ArgumentError, "Missing the required parameter 'enable_disable_consumers_request' when calling ConsumerApi.enable_disable_consumers"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(enable_disable_consumers_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EnableDisableConsumersRequest'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.enable_disable_consumers",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#enable_disable_consumers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_active_rate_limits_at_date(consumerid, datewithhour, opts = {})
      data, _status_code, _headers = get_active_rate_limits_at_date_with_http_info(consumerid, datewithhour, opts)
      data
    end
    ...
    # @param datewithhour [String] The DATEWITHHOUR identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetActiveRateLimitsAtDate200Response, Integer, Hash)>] GetActiveRateLimitsAtDate200Response data, response status code and response headers
    def get_active_rate_limits_at_date_with_http_info(consumerid, datewithhour, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.get_active_rate_limits_at_date ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.get_active_rate_limits_at_date"
      end
      # verify the required parameter 'datewithhour' is set
      if @api_client.config.client_side_validation && datewithhour.nil?
        fail ArgumentError, "Missing the required parameter 'datewithhour' when calling ConsumerApi.get_active_rate_limits_at_date"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetActiveRateLimitsAtDate200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.get_active_rate_limits_at_date",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#get_active_rate_limits_at_date\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetActiveRateLimitsAtDate200Response]
    def get_active_rate_limits_now(consumerid, opts = {})
      data, _status_code, _headers = get_active_rate_limits_now_with_http_info(consumerid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetActiveRateLimitsAtDate200Response, Integer, Hash)>] GetActiveRateLimitsAtDate200Response data, response status code and response headers
    def get_active_rate_limits_now_with_http_info(consumerid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.get_active_rate_limits_now ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.get_active_rate_limits_now"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.get_active_rate_limits_now",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#get_active_rate_limits_now\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_calls_limit(consumerid, opts = {})
      data, _status_code, _headers = get_calls_limit_with_http_info(consumerid, opts)
      data
    end
    ...
    # @param consumerid [String] The CONSUMERID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetCallsLimit200Response, Integer, Hash)>] GetCallsLimit200Response data, response status code and response headers
    def get_calls_limit_with_http_info(consumerid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.get_calls_limit ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.get_calls_limit"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetCallsLimit200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.get_calls_limit",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#get_calls_limit\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_consumer(consumerid, opts = {})
      data, _status_code, _headers = get_consumer_with_http_info(consumerid, opts)
      data
    end
    ...
    # @param consumerid [String] The CONSUMERID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetConsumer200Response, Integer, Hash)>] GetConsumer200Response data, response status code and response headers
    def get_consumer_with_http_info(consumerid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.get_consumer ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.get_consumer"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetConsumer200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.get_consumer",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#get_consumer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_consumer_call_counters(consumerid, opts = {})
      data, _status_code, _headers = get_consumer_call_counters_with_http_info(consumerid, opts)
      data
    end
    ...
    # @param consumerid [String] The CONSUMERID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetCurrentConsumer200ResponseCallCounters, Integer, Hash)>] GetCurrentConsumer200ResponseCallCounters data, response status code and response headers
    def get_consumer_call_counters_with_http_info(consumerid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.get_consumer_call_counters ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.get_consumer_call_counters"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetCurrentConsumer200ResponseCallCounters'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.get_consumer_call_counters",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#get_consumer_call_counters\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_consumers(opts = {})
      data, _status_code, _headers = get_consumers_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get the all Consumers.&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;Possible custom url parameters for pagination:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;limit&#x3D;NUMBER &#x3D;&#x3D;&amp;gt; default value: 50&lt;/li&gt; &lt;li&gt;offset&#x3D;NUMBER &#x3D;&#x3D;&amp;gt; default value: 0&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;eg1:?limit&#x3D;100&amp;amp;offset&#x3D;0&lt;/p&gt; &lt;ul&gt; &lt;li&gt;sort_direction&#x3D;ASC/DESC &#x3D;&#x3D;&amp;gt; default value: DESC.&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;eg2:?limit&#x3D;100&amp;amp;offset&#x3D;0&amp;amp;sort_direction&#x3D;ASC&lt;/p&gt; &lt;ul&gt; &lt;li&gt;from_date&#x3D;DATE &#x3D;&amp;gt; example value: 1970-01-01T00:00:00.000Z. NOTE! The default value is one year ago (1970-01-01T00:00:00.000Z).&lt;/li&gt; &lt;li&gt;to_date&#x3D;DATE &#x3D;&amp;gt; example value: 2026-03-25T12:16:25.409Z. NOTE! The default value is now (2026-03-25T12:16:25.409Z).&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;Date format parameter: yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSS&#39;Z&#39;(1100-01-01T01:01:01.000Z) &#x3D;&#x3D;&amp;gt; time zone is UTC.&lt;/p&gt; &lt;p&gt;eg3:?sort_direction&#x3D;ASC&amp;amp;limit&#x3D;100&amp;amp;offset&#x3D;0&amp;amp;from_date&#x3D;1100-01-01T01:01:01.000Z&amp;amp;to_date&#x3D;1100-01-01T01:01:01.000Z&lt;/p&gt; &lt;p&gt;This endpoint supports &lt;strong&gt;User OR Application&lt;/strong&gt; authentication. You can authenticate either as a logged-in User (with Entitlements) or as an Application using a Consumer Key (with Scopes).&lt;br /&gt; See [here](/glossary#API.Endpoint Auth Modes) for more information.&lt;/p&gt; &lt;p&gt;This endpoint supports &lt;strong&gt;User OR Application&lt;/strong&gt; authentication. You can authenticate either as a logged-in User (with Entitlements) or as an Application using a Consumer Key (with Scopes).&lt;br /&gt; See [here](/glossary#API.Endpoint Auth Modes) for more information.&lt;/p&gt; &lt;p&gt;This endpoint supports &lt;strong&gt;User OR Application&lt;/strong&gt; authentication. You can authenticate either as a logged-in User (with Entitlements) or as an Application using a Consumer Key (with Scopes).&lt;br /&gt; See [here](/glossary#API.Endpoint Auth Modes) for more information.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#app_name\&quot;&gt;&lt;strong&gt;app_name&lt;/strong&gt;&lt;/a&gt;: appNameBank&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#app_type\&quot;&gt;&lt;strong&gt;app_type&lt;/strong&gt;&lt;/a&gt;: Web&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;certificate_pem&lt;/strong&gt;&lt;/a&gt;: certificate_pem&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#company\&quot;&gt;&lt;strong&gt;company&lt;/strong&gt;&lt;/a&gt;: Tesobe GmbH&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;consumer_id&lt;/strong&gt;&lt;/a&gt;: 7uy8a7e4-6d02-40e3-a129-0b2bf89de8uh&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;consumer_key&lt;/strong&gt;&lt;/a&gt;: bwf0ykmwoirip1yjxcn15wnhuyxcziwgtcoaildq&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#consumers\&quot;&gt;&lt;strong&gt;consumers&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#created\&quot;&gt;&lt;strong&gt;created&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#created_by_user\&quot;&gt;&lt;strong&gt;created_by_user&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#description\&quot;&gt;&lt;strong&gt;description&lt;/strong&gt;&lt;/a&gt;: Description of the object. Maximum length is 2000. It can be any characters here.&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#developer_email\&quot;&gt;&lt;strong&gt;developer_email&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;email&lt;/strong&gt;&lt;/a&gt;: &lt;a href&#x3D;\&quot;ma&amp;#x69;&amp;#x6c;&amp;#x74;o&amp;#58;&amp;#x66;e&amp;#108;&amp;#x69;&amp;#120;&amp;#115;&amp;#109;&amp;#105;&amp;#116;h&amp;#x40;&amp;#101;&amp;#x78;&amp;#97;&amp;#109;&amp;#x70;&amp;#x6c;&amp;#x65;&amp;#46;&amp;#x63;o&amp;#109;\&quot;&gt;f&amp;#101;&amp;#x6c;i&amp;#x78;&amp;#x73;&amp;#x6d;&amp;#x69;&amp;#116;h@&amp;#x65;&amp;#120;&amp;#97;m&amp;#x70;&amp;#x6c;&amp;#x65;&amp;#46;&amp;#x63;&amp;#111;&amp;#109;&lt;/a&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#enabled\&quot;&gt;&lt;strong&gt;enabled&lt;/strong&gt;&lt;/a&gt;: false&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;issuer_domain_name&lt;/strong&gt;&lt;/a&gt;: issuer_domain_name&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;not_after&lt;/strong&gt;&lt;/a&gt;: not_after&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;not_before&lt;/strong&gt;&lt;/a&gt;: not_before&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#provider\&quot;&gt;&lt;strong&gt;provider&lt;/strong&gt;&lt;/a&gt;: ETHEREUM&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#provider_id\&quot;&gt;&lt;strong&gt;provider_id&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#redirect_url\&quot;&gt;&lt;strong&gt;redirect_url&lt;/strong&gt;&lt;/a&gt;: &lt;a href&#x3D;\&quot;https://apisandbox.openbankproject.com\&quot;&gt;https://apisandbox.openbankproject.com&lt;/a&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;subject_domain_name&lt;/strong&gt;&lt;/a&gt;: subject_domain_name&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;user_id&lt;/strong&gt;&lt;/a&gt;: 9ca9a7e4-6d02-40e3-a129-0b2bf89de9b1&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;username&lt;/strong&gt;&lt;/a&gt;: felixsmith&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;certificate_info&lt;/a&gt;: certificate_info&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#logo_url\&quot;&gt;logo_url&lt;/a&gt;: logo_url&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#roles\&quot;&gt;roles&lt;/a&gt;: CanCreateMyUser&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;roles_info&lt;/a&gt;: roles_info&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetConsumers200Response, Integer, Hash)>] GetConsumers200Response data, response status code and response headers
    def get_consumers_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.get_consumers ...'
      end
      # resource path
      local_var_path = '/obp/v5.1.0/management/consumers'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetConsumers200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.get_consumers",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#get_consumers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_consumers_for_current_user(opts = {})
      data, _status_code, _headers = get_consumers_for_current_user_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get the Consumers for logged in User.&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#app_name\&quot;&gt;&lt;strong&gt;app_name&lt;/strong&gt;&lt;/a&gt;: appNameBank&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#app_type\&quot;&gt;&lt;strong&gt;app_type&lt;/strong&gt;&lt;/a&gt;: Web&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;consumer_id&lt;/strong&gt;&lt;/a&gt;: 7uy8a7e4-6d02-40e3-a129-0b2bf89de8uh&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#consumers\&quot;&gt;&lt;strong&gt;consumers&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#created\&quot;&gt;&lt;strong&gt;created&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#created_by_user\&quot;&gt;&lt;strong&gt;created_by_user&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#description\&quot;&gt;&lt;strong&gt;description&lt;/strong&gt;&lt;/a&gt;: Description of the object. Maximum length is 2000. It can be any characters here.&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#developer_email\&quot;&gt;&lt;strong&gt;developer_email&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;email&lt;/strong&gt;&lt;/a&gt;: &lt;a href&#x3D;\&quot;&amp;#109;a&amp;#x69;&amp;#108;&amp;#x74;&amp;#x6f;&amp;#x3a;&amp;#102;&amp;#x65;&amp;#108;&amp;#105;&amp;#120;&amp;#x73;&amp;#109;i&amp;#x74;&amp;#104;&amp;#x40;&amp;#x65;&amp;#x78;&amp;#x61;m&amp;#x70;&amp;#108;e&amp;#46;&amp;#99;&amp;#x6f;&amp;#109;\&quot;&gt;f&amp;#x65;&amp;#x6c;&amp;#105;&amp;#x78;&amp;#115;&amp;#x6d;it&amp;#x68;&amp;#64;&amp;#x65;&amp;#120;a&amp;#x6d;&amp;#112;&amp;#x6c;&amp;#x65;&amp;#46;&amp;#x63;o&amp;#109;&lt;/a&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#enabled\&quot;&gt;&lt;strong&gt;enabled&lt;/strong&gt;&lt;/a&gt;: false&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#provider\&quot;&gt;&lt;strong&gt;provider&lt;/strong&gt;&lt;/a&gt;: ETHEREUM&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#provider_id\&quot;&gt;&lt;strong&gt;provider_id&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#redirect_url\&quot;&gt;&lt;strong&gt;redirect_url&lt;/strong&gt;&lt;/a&gt;: &lt;a href&#x3D;\&quot;https://apisandbox.openbankproject.com\&quot;&gt;https://apisandbox.openbankproject.com&lt;/a&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;user_id&lt;/strong&gt;&lt;/a&gt;: 9ca9a7e4-6d02-40e3-a129-0b2bf89de9b1&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;username&lt;/strong&gt;&lt;/a&gt;: felixsmith&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetConsumersForCurrentUser200Response, Integer, Hash)>] GetConsumersForCurrentUser200Response data, response status code and response headers
    def get_consumers_for_current_user_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.get_consumers_for_current_user ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetConsumersForCurrentUser200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.get_consumers_for_current_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#get_consumers_for_current_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_current_consumer_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.get_current_consumer ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.get_current_consumer",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#get_current_consumer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_oidc_client_with_http_info(clientid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.get_oidc_client ...'
      end
      # verify the required parameter 'clientid' is set
      if @api_client.config.client_side_validation && clientid.nil?
        fail ArgumentError, "Missing the required parameter 'clientid' when calling ConsumerApi.get_oidc_client"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.get_oidc_client",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#get_oidc_client\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_scopes_with_http_info(consumerid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.get_scopes ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.get_scopes"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/consumers/{consumerid}/scopes'.sub('{' + 'consumerid' + '}', CGI.escape(consumerid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.get_scopes",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#get_scopes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param consumerid [String] The CONSUMERID identifier
    # @param update_consumer_certificate_request [UpdateConsumerCertificateRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [UpdateConsumerName200Response]
    def update_consumer_certificate(consumerid, update_consumer_certificate_request, opts = {})
      data, _status_code, _headers = update_consumer_certificate_with_http_info(consumerid, update_consumer_certificate_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateConsumerName200Response, Integer, Hash)>] UpdateConsumerName200Response data, response status code and response headers
    def update_consumer_certificate_with_http_info(consumerid, update_consumer_certificate_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.update_consumer_certificate ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.update_consumer_certificate"
      end
      # verify the required parameter 'update_consumer_certificate_request' is set
      if @api_client.config.client_side_validation && update_consumer_certificate_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_consumer_certificate_request' when calling ConsumerApi.update_consumer_certificate"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_consumer_certificate_request)
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.update_consumer_certificate",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#update_consumer_certificate\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param consumerid [String] The CONSUMERID identifier
    # @param update_consumer_logo_url_request [UpdateConsumerLogoURLRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [UpdateConsumerName200Response]
    def update_consumer_logo_url(consumerid, update_consumer_logo_url_request, opts = {})
      data, _status_code, _headers = update_consumer_logo_url_with_http_info(consumerid, update_consumer_logo_url_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateConsumerName200Response, Integer, Hash)>] UpdateConsumerName200Response data, response status code and response headers
    def update_consumer_logo_url_with_http_info(consumerid, update_consumer_logo_url_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.update_consumer_logo_url ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.update_consumer_logo_url"
      end
      # verify the required parameter 'update_consumer_logo_url_request' is set
      if @api_client.config.client_side_validation && update_consumer_logo_url_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_consumer_logo_url_request' when calling ConsumerApi.update_consumer_logo_url"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_consumer_logo_url_request)
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.update_consumer_logo_url",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#update_consumer_logo_url\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param consumerid [String] The CONSUMERID identifier
    # @param update_consumer_name_request [UpdateConsumerNameRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [UpdateConsumerName200Response]
    def update_consumer_name(consumerid, update_consumer_name_request, opts = {})
      data, _status_code, _headers = update_consumer_name_with_http_info(consumerid, update_consumer_name_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateConsumerName200Response, Integer, Hash)>] UpdateConsumerName200Response data, response status code and response headers
    def update_consumer_name_with_http_info(consumerid, update_consumer_name_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.update_consumer_name ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.update_consumer_name"
      end
      # verify the required parameter 'update_consumer_name_request' is set
      if @api_client.config.client_side_validation && update_consumer_name_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_consumer_name_request' when calling ConsumerApi.update_consumer_name"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_consumer_name_request)
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.update_consumer_name",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#update_consumer_name\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param consumerid [String] The CONSUMERID identifier
    # @param update_consumer_redirect_url_request [UpdateConsumerRedirectURLRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [UpdateConsumerRedirectURL200Response]
    def update_consumer_redirect_url(consumerid, update_consumer_redirect_url_request, opts = {})
      data, _status_code, _headers = update_consumer_redirect_url_with_http_info(consumerid, update_consumer_redirect_url_request, opts)
      data
    end
    ...
    # @param update_consumer_redirect_url_request [UpdateConsumerRedirectURLRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateConsumerRedirectURL200Response, Integer, Hash)>] UpdateConsumerRedirectURL200Response data, response status code and response headers
    def update_consumer_redirect_url_with_http_info(consumerid, update_consumer_redirect_url_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.update_consumer_redirect_url ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.update_consumer_redirect_url"
      end
      # verify the required parameter 'update_consumer_redirect_url_request' is set
      if @api_client.config.client_side_validation && update_consumer_redirect_url_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_consumer_redirect_url_request' when calling ConsumerApi.update_consumer_redirect_url"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_consumer_redirect_url_request)

      # return_type
      return_type = opts[:debug_return_type] || 'UpdateConsumerRedirectURL200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"ConsumerApi.update_consumer_redirect_url",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#update_consumer_redirect_url\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [UpdateRateLimitsRequest]
    def update_rate_limits(consumerid, ratelimitingid, update_rate_limits_request, opts = {})
      data, _status_code, _headers = update_rate_limits_with_http_info(consumerid, ratelimitingid, update_rate_limits_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateRateLimitsRequest, Integer, Hash)>] UpdateRateLimitsRequest data, response status code and response headers
    def update_rate_limits_with_http_info(consumerid, ratelimitingid, update_rate_limits_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.update_rate_limits ...'
      end
      # verify the required parameter 'consumerid' is set
      if @api_client.config.client_side_validation && consumerid.nil?
        fail ArgumentError, "Missing the required parameter 'consumerid' when calling ConsumerApi.update_rate_limits"
      end
      # verify the required parameter 'ratelimitingid' is set
      if @api_client.config.client_side_validation && ratelimitingid.nil?
        fail ArgumentError, "Missing the required parameter 'ratelimitingid' when calling ConsumerApi.update_rate_limits"
      end
      # verify the required parameter 'update_rate_limits_request' is set
      if @api_client.config.client_side_validation && update_rate_limits_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_rate_limits_request' when calling ConsumerApi.update_rate_limits"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/management/consumers/{consumerid}/consumer/rate-limits/{ratelimitingid}'.sub('{' + 'consumerid' + '}', CGI.escape(consumerid.to_s)).sub('{' + 'ratelimitingid' + '}', CGI.escape(ratelimitingid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.update_rate_limits",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#update_rate_limits\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def verify_oidc_client_with_http_info(verify_oidc_client_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ConsumerApi.verify_oidc_client ...'
      end
      ...
      if @api_client.config.client_side_validation && verify_oidc_client_request.nil?
        fail ArgumentError, "Missing the required parameter 'verify_oidc_client_request' when calling ConsumerApi.verify_oidc_client"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ConsumerApi.verify_oidc_client",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ConsumerApi#verify_oidc_client\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
