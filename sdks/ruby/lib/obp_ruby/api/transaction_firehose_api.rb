  ...
  class TransactionFirehoseApi
    ...
    def get_firehose_transactions_for_bank_account_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TransactionFirehoseApi.get_firehose_transactions_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling TransactionFirehoseApi.get_firehose_transactions_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling TransactionFirehoseApi.get_firehose_transactions_for_bank_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling TransactionFirehoseApi.get_firehose_transactions_for_bank_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"TransactionFirehoseApi.get_firehose_transactions_for_bank_account",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransactionFirehoseApi#get_firehose_transactions_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
