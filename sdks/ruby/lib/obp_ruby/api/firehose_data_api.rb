  ...
  class FirehoseDataApi
    ...
    def get_fast_firehose_accounts_at_one_bank_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FirehoseDataApi.get_fast_firehose_accounts_at_one_bank ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling FirehoseDataApi.get_fast_firehose_accounts_at_one_bank"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"FirehoseDataApi.get_fast_firehose_accounts_at_one_bank",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FirehoseDataApi#get_fast_firehose_accounts_at_one_bank\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_firehose_accounts_at_one_bank_with_http_info(bankid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FirehoseDataApi.get_firehose_accounts_at_one_bank ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling FirehoseDataApi.get_firehose_accounts_at_one_bank"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling FirehoseDataApi.get_firehose_accounts_at_one_bank"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"FirehoseDataApi.get_firehose_accounts_at_one_bank",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FirehoseDataApi#get_firehose_accounts_at_one_bank\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_firehose_customers_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FirehoseDataApi.get_firehose_customers ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling FirehoseDataApi.get_firehose_customers"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"FirehoseDataApi.get_firehose_customers",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FirehoseDataApi#get_firehose_customers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_firehose_transactions_for_bank_account_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FirehoseDataApi.get_firehose_transactions_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling FirehoseDataApi.get_firehose_transactions_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling FirehoseDataApi.get_firehose_transactions_for_bank_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling FirehoseDataApi.get_firehose_transactions_for_bank_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"FirehoseDataApi.get_firehose_transactions_for_bank_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FirehoseDataApi#get_firehose_transactions_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
