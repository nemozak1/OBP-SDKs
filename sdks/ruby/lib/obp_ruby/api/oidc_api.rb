  ...
  class OIDCApi
    ...
    def get_o_auth2_server_jwks_uris_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OIDCApi.get_o_auth2_server_jwks_uris ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"OIDCApi.get_o_auth2_server_jwks_uris",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OIDCApi#get_o_auth2_server_jwks_uris\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_obp_connector_loopback_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OIDCApi.get_obp_connector_loopback ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"OIDCApi.get_obp_connector_loopback",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OIDCApi#get_obp_connector_loopback\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_oidc_client_with_http_info(clientid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OIDCApi.get_oidc_client ...'
      end
      # verify the required parameter 'clientid' is set
      if @api_client.config.client_side_validation && clientid.nil?
        fail ArgumentError, "Missing the required parameter 'clientid' when calling OIDCApi.get_oidc_client"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"OIDCApi.get_oidc_client",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OIDCApi#get_oidc_client\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def verify_oidc_client_with_http_info(verify_oidc_client_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OIDCApi.verify_oidc_client ...'
      end
      ...
      if @api_client.config.client_side_validation && verify_oidc_client_request.nil?
        fail ArgumentError, "Missing the required parameter 'verify_oidc_client_request' when calling OIDCApi.verify_oidc_client"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"OIDCApi.verify_oidc_client",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OIDCApi#verify_oidc_client\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
