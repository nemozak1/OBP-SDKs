  ...
  class CacheApi
    ...
    def get_cache_config_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CacheApi.get_cache_config ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CacheApi.get_cache_config",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CacheApi#get_cache_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_cache_info_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CacheApi.get_cache_info ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CacheApi.get_cache_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CacheApi#get_cache_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_cache_namespaces_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CacheApi.get_cache_namespaces ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CacheApi.get_cache_namespaces",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CacheApi#get_cache_namespaces\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def invalidate_cache_namespace_with_http_info(invalidate_cache_namespace_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CacheApi.invalidate_cache_namespace ...'
      end
      ...
      if @api_client.config.client_side_validation && invalidate_cache_namespace_request.nil?
        fail ArgumentError, "Missing the required parameter 'invalidate_cache_namespace_request' when calling CacheApi.invalidate_cache_namespace"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"CacheApi.invalidate_cache_namespace",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CacheApi#invalidate_cache_namespace\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
