  ...
  class AggregateMetricsApi
    ...
    def get_aggregate_metrics_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AggregateMetricsApi.get_aggregate_metrics ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AggregateMetricsApi.get_aggregate_metrics",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AggregateMetricsApi#get_aggregate_metrics\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
