...
module OpenBankProject
  class AccountApi
    ...
    def add_account(bankid, add_account_request, opts = {})
      data, _status_code, _headers = add_account_with_http_info(bankid, add_account_request, opts)
      data
    end
    ...
    def add_account_with_http_info(bankid, add_account_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.add_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.add_account"
      end
      ...
      if @api_client.config.client_side_validation && add_account_request.nil?
        fail ArgumentError, "Missing the required parameter 'add_account_request' when calling AccountApi.add_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.add_account",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#add_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def add_tag_for_view_on_account_with_http_info(bankid, accountid, viewid, get_transaction_types200_response_transaction_types_inner_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.add_tag_for_view_on_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.add_tag_for_view_on_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.add_tag_for_view_on_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.add_tag_for_view_on_account"
      end
      ...
      if @api_client.config.client_side_validation && get_transaction_types200_response_transaction_types_inner_id.nil?
        fail ArgumentError, "Missing the required parameter 'get_transaction_types200_response_transaction_types_inner_id' when calling AccountApi.add_tag_for_view_on_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.add_tag_for_view_on_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#add_tag_for_view_on_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def check_funds_available_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.check_funds_available ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.check_funds_available"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.check_funds_available"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.check_funds_available"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.check_funds_available",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#check_funds_available\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def core_private_accounts_all_banks(opts = {})
      data, _status_code, _headers = core_private_accounts_all_banks_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Returns the list of accounts containing private views for the user.&lt;br /&gt; Each account lists the views available to the user.&lt;/p&gt; &lt;p&gt;optional request parameters:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;account_type_filter: one or many accountType value, split by comma&lt;/li&gt; &lt;li&gt;account_type_filter_operation: the filter type of account_type_filter, value must be INCLUDE or EXCLUDE&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;whole url example:&lt;br /&gt; /my/accounts?account_type_filter&#x3D;330,CURRENT+PLUS&amp;amp;account_type_filter_operation&#x3D;INCLUDE&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#account_routings\&quot;&gt;&lt;strong&gt;account_routings&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;account_type&lt;/strong&gt;&lt;/a&gt;: AC&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#accounts\&quot;&gt;&lt;strong&gt;accounts&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#address\&quot;&gt;&lt;strong&gt;address&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;bank_id&lt;/strong&gt;&lt;/a&gt;: gh.29.uk&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#description\&quot;&gt;&lt;strong&gt;description&lt;/strong&gt;&lt;/a&gt;: Description of the object. Maximum length is 2000. It can be any characters here.&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#id\&quot;&gt;&lt;strong&gt;id&lt;/strong&gt;&lt;/a&gt;: d8839721-ad8f-45dd-9f78-2080414b93f9&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#is_public\&quot;&gt;&lt;strong&gt;is_public&lt;/strong&gt;&lt;/a&gt;: false&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;label&lt;/strong&gt;&lt;/a&gt;: My Account&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#scheme\&quot;&gt;&lt;strong&gt;scheme&lt;/strong&gt;&lt;/a&gt;: OBP&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#short_name\&quot;&gt;&lt;strong&gt;short_name&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#views\&quot;&gt;&lt;strong&gt;views&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PrivateAccountsAtOneBank200Response, Integer, Hash)>] PrivateAccountsAtOneBank200Response data, response status code and response headers
    def core_private_accounts_all_banks_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.core_private_accounts_all_banks ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PrivateAccountsAtOneBank200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.core_private_accounts_all_banks",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#core_private_accounts_all_banks\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_account_with_http_info(bankid, accountid, add_account_request, opts = {})
      ...
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_account"
      end
      # verify the required parameter 'add_account_request' is set
      if @api_client.config.client_side_validation && add_account_request.nil?
        fail ArgumentError, "Missing the required parameter 'add_account_request' when calling AccountApi.create_account"
      end
      # resource path
    ...
    def create_account_application_with_http_info(bankid, create_account_application_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_account_application ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_account_application"
      end
      ...
      if @api_client.config.client_side_validation && create_account_application_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_account_application_request' when calling AccountApi.create_account_application"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_account_application",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_account_application\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_account_attribute_with_http_info(bankid, accountid, productcode, update_account_attribute_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_account_attribute ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_account_attribute"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_account_attribute"
      end
      # verify the required parameter 'productcode' is set
      if @api_client.config.client_side_validation && productcode.nil?
        fail ArgumentError, "Missing the required parameter 'productcode' when calling AccountApi.create_account_attribute"
      end
      ...
      if @api_client.config.client_side_validation && update_account_attribute_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_account_attribute_request' when calling AccountApi.create_account_attribute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_account_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_account_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_bank_account_balance_with_http_info(bankid, accountid, create_bank_account_balance_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_bank_account_balance ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_bank_account_balance"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_bank_account_balance"
      end
      ...
      if @api_client.config.client_side_validation && create_bank_account_balance_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_bank_account_balance_request' when calling AccountApi.create_bank_account_balance"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_bank_account_balance",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_bank_account_balance\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_counterparty_with_http_info(bankid, accountid, viewid, create_counterparty_for_any_account_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_counterparty ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_counterparty"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_counterparty"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.create_counterparty"
      end
      ...
      if @api_client.config.client_side_validation && create_counterparty_for_any_account_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_counterparty_for_any_account_request' when calling AccountApi.create_counterparty"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_counterparty",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_counterparty\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_counterparty_for_any_account_with_http_info(bankid, accountid, viewid, create_counterparty_for_any_account_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_counterparty_for_any_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_counterparty_for_any_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_counterparty_for_any_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.create_counterparty_for_any_account"
      end
      # verify the required parameter 'create_counterparty_for_any_account_request' is set
      if @api_client.config.client_side_validation && create_counterparty_for_any_account_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_counterparty_for_any_account_request' when calling AccountApi.create_counterparty_for_any_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_counterparty_for_any_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_counterparty_for_any_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param accountid [String] The ACCOUNTID identifier
    # @param viewid [String] The VIEWID identifier
    # @param create_custom_view_request [CreateCustomViewRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [CreateCustomView200Response]
    def create_custom_view(bankid, accountid, viewid, create_custom_view_request, opts = {})
      data, _status_code, _headers = create_custom_view_with_http_info(bankid, accountid, viewid, create_custom_view_request, opts)
      data
    end
    ...
    # @param create_custom_view_request [CreateCustomViewRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateCustomView200Response, Integer, Hash)>] CreateCustomView200Response data, response status code and response headers
    def create_custom_view_with_http_info(bankid, accountid, viewid, create_custom_view_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_custom_view ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_custom_view"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_custom_view"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.create_custom_view"
      end
      # verify the required parameter 'create_custom_view_request' is set
      if @api_client.config.client_side_validation && create_custom_view_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_custom_view_request' when calling AccountApi.create_custom_view"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_custom_view_request)

      # return_type
      return_type = opts[:debug_return_type] || 'CreateCustomView200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.create_custom_view",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_custom_view\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param bankid [String] The BANKID identifier
    # @param accountid [String] The ACCOUNTID identifier
    # @param create_custom_view_management_request [CreateCustomViewManagementRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [CreateUserWithAccountAccessById200ResponseHead]
    def create_custom_view_management(bankid, accountid, create_custom_view_management_request, opts = {})
      data, _status_code, _headers = create_custom_view_management_with_http_info(bankid, accountid, create_custom_view_management_request, opts)
      data
    end
    ...
    def create_custom_view_management_with_http_info(bankid, accountid, create_custom_view_management_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_custom_view_management ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_custom_view_management"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_custom_view_management"
      end
      # verify the required parameter 'create_custom_view_management_request' is set
      if @api_client.config.client_side_validation && create_custom_view_management_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_custom_view_management_request' when calling AccountApi.create_custom_view_management"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_custom_view_management_request)
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_custom_view_management",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_custom_view_management\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param bankid [String] The BANKID identifier
    # @param create_customer_account_link_request [CreateCustomerAccountLinkRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [GetCustomerAccountLinksByCustomerId200ResponseLinksInner]
    def create_customer_account_link(bankid, create_customer_account_link_request, opts = {})
      data, _status_code, _headers = create_customer_account_link_with_http_info(bankid, create_customer_account_link_request, opts)
      data
    end
    ...
    # @param create_customer_account_link_request [CreateCustomerAccountLinkRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetCustomerAccountLinksByCustomerId200ResponseLinksInner, Integer, Hash)>] GetCustomerAccountLinksByCustomerId200ResponseLinksInner data, response status code and response headers
    def create_customer_account_link_with_http_info(bankid, create_customer_account_link_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_customer_account_link ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_customer_account_link"
      end
      # verify the required parameter 'create_customer_account_link_request' is set
      if @api_client.config.client_side_validation && create_customer_account_link_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_customer_account_link_request' when calling AccountApi.create_customer_account_link"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_customer_account_link_request)

      # return_type
      return_type = opts[:debug_return_type] || 'GetCustomerAccountLinksByCustomerId200ResponseLinksInner'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.create_customer_account_link",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_customer_account_link\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param accountid [String] The ACCOUNTID identifier
    # @param viewid [String] The VIEWID identifier
    # @param create_direct_debit_request [CreateDirectDebitRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [CreateDirectDebit200Response]
    def create_direct_debit(bankid, accountid, viewid, create_direct_debit_request, opts = {})
      data, _status_code, _headers = create_direct_debit_with_http_info(bankid, accountid, viewid, create_direct_debit_request, opts)
      data
    end
    ...
    # @param create_direct_debit_request [CreateDirectDebitRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateDirectDebit200Response, Integer, Hash)>] CreateDirectDebit200Response data, response status code and response headers
    def create_direct_debit_with_http_info(bankid, accountid, viewid, create_direct_debit_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_direct_debit ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_direct_debit"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_direct_debit"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.create_direct_debit"
      end
      # verify the required parameter 'create_direct_debit_request' is set
      if @api_client.config.client_side_validation && create_direct_debit_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_direct_debit_request' when calling AccountApi.create_direct_debit"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_direct_debit_request)

      # return_type
      return_type = opts[:debug_return_type] || 'CreateDirectDebit200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.create_direct_debit",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_direct_debit\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [CreateDirectDebit200Response]
    def create_direct_debit_management(bankid, accountid, create_direct_debit_request, opts = {})
      data, _status_code, _headers = create_direct_debit_management_with_http_info(bankid, accountid, create_direct_debit_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateDirectDebit200Response, Integer, Hash)>] CreateDirectDebit200Response data, response status code and response headers
    def create_direct_debit_management_with_http_info(bankid, accountid, create_direct_debit_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_direct_debit_management ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_direct_debit_management"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_direct_debit_management"
      end
      # verify the required parameter 'create_direct_debit_request' is set
      if @api_client.config.client_side_validation && create_direct_debit_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_direct_debit_request' when calling AccountApi.create_direct_debit_management"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_direct_debit_management",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_direct_debit_management\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_or_update_account_attribute_definition_with_http_info(bankid, create_or_update_transaction_request_attribute_definition_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_or_update_account_attribute_definition ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_or_update_account_attribute_definition"
      end
      ...
      if @api_client.config.client_side_validation && create_or_update_transaction_request_attribute_definition_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_or_update_transaction_request_attribute_definition_request' when calling AccountApi.create_or_update_account_attribute_definition"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_or_update_account_attribute_definition",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_or_update_account_attribute_definition\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_standing_order_with_http_info(bankid, accountid, viewid, create_standing_order_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_standing_order ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_standing_order"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_standing_order"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.create_standing_order"
      end
      ...
      if @api_client.config.client_side_validation && create_standing_order_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_standing_order_request' when calling AccountApi.create_standing_order"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_standing_order",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_standing_order\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_standing_order_management_with_http_info(bankid, accountid, create_standing_order_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_standing_order_management ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_standing_order_management"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_standing_order_management"
      end
      # verify the required parameter 'create_standing_order_request' is set
      if @api_client.config.client_side_validation && create_standing_order_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_standing_order_request' when calling AccountApi.create_standing_order_management"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_standing_order_management",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_standing_order_management\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_user_with_account_access_by_id_with_http_info(bankid, accountid, viewid, create_user_with_account_access_by_id_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_user_with_account_access_by_id ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_user_with_account_access_by_id"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_user_with_account_access_by_id"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.create_user_with_account_access_by_id"
      end
      ...
      if @api_client.config.client_side_validation && create_user_with_account_access_by_id_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_user_with_account_access_by_id_request' when calling AccountApi.create_user_with_account_access_by_id"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_user_with_account_access_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_user_with_account_access_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [CreateUserWithAccountAccessById200ResponseHead]
    def create_view_for_bank_account(bankid, accountid, create_custom_view_management_request, opts = {})
      data, _status_code, _headers = create_view_for_bank_account_with_http_info(bankid, accountid, create_custom_view_management_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateUserWithAccountAccessById200ResponseHead, Integer, Hash)>] CreateUserWithAccountAccessById200ResponseHead data, response status code and response headers
    def create_view_for_bank_account_with_http_info(bankid, accountid, create_custom_view_management_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.create_view_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.create_view_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.create_view_for_bank_account"
      end
      # verify the required parameter 'create_custom_view_management_request' is set
      if @api_client.config.client_side_validation && create_custom_view_management_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_custom_view_management_request' when calling AccountApi.create_view_for_bank_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.create_view_for_bank_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#create_view_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_account_attribute_definition_with_http_info(bankid, attributedefinitionid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.delete_account_attribute_definition ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.delete_account_attribute_definition"
      end
      ...
      if @api_client.config.client_side_validation && attributedefinitionid.nil?
        fail ArgumentError, "Missing the required parameter 'attributedefinitionid' when calling AccountApi.delete_account_attribute_definition"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.delete_account_attribute_definition",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#delete_account_attribute_definition\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_account_cascade(bankid, accountid, opts = {})
      delete_account_cascade_with_http_info(bankid, accountid, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_account_cascade_with_http_info(bankid, accountid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.delete_account_cascade ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.delete_account_cascade"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.delete_account_cascade"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.delete_account_cascade",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#delete_account_cascade\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_bank_account_balance_with_http_info(bankid, accountid, balanceid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.delete_bank_account_balance ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.delete_bank_account_balance"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.delete_bank_account_balance"
      end
      # verify the required parameter 'balanceid' is set
      if @api_client.config.client_side_validation && balanceid.nil?
        fail ArgumentError, "Missing the required parameter 'balanceid' when calling AccountApi.delete_bank_account_balance"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.delete_bank_account_balance",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#delete_bank_account_balance\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_counterparty_for_any_account_with_http_info(bankid, accountid, viewid, counterpartyid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.delete_counterparty_for_any_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.delete_counterparty_for_any_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.delete_counterparty_for_any_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.delete_counterparty_for_any_account"
      end
      # verify the required parameter 'counterpartyid' is set
      if @api_client.config.client_side_validation && counterpartyid.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyid' when calling AccountApi.delete_counterparty_for_any_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.delete_counterparty_for_any_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#delete_counterparty_for_any_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_custom_view(bankid, accountid, viewid, targetviewid, opts = {})
      delete_custom_view_with_http_info(bankid, accountid, viewid, targetviewid, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_custom_view_with_http_info(bankid, accountid, viewid, targetviewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.delete_custom_view ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.delete_custom_view"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.delete_custom_view"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.delete_custom_view"
      end
      # verify the required parameter 'targetviewid' is set
      if @api_client.config.client_side_validation && targetviewid.nil?
        fail ArgumentError, "Missing the required parameter 'targetviewid' when calling AccountApi.delete_custom_view"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.delete_custom_view",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#delete_custom_view\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_explicit_counterparty_with_http_info(bankid, accountid, viewid, counterpartyid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.delete_explicit_counterparty ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.delete_explicit_counterparty"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.delete_explicit_counterparty"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.delete_explicit_counterparty"
      end
      # verify the required parameter 'counterpartyid' is set
      if @api_client.config.client_side_validation && counterpartyid.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyid' when calling AccountApi.delete_explicit_counterparty"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.delete_explicit_counterparty",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#delete_explicit_counterparty\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_tag_for_view_on_account_with_http_info(bankid, accountid, viewid, tagid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.delete_tag_for_view_on_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.delete_tag_for_view_on_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.delete_tag_for_view_on_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.delete_tag_for_view_on_account"
      end
      # verify the required parameter 'tagid' is set
      if @api_client.config.client_side_validation && tagid.nil?
        fail ArgumentError, "Missing the required parameter 'tagid' when calling AccountApi.delete_tag_for_view_on_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.delete_tag_for_view_on_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#delete_tag_for_view_on_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_view_for_bank_account(bankid, accountid, viewid, opts = {})
      delete_view_for_bank_account_with_http_info(bankid, accountid, viewid, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_view_for_bank_account_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.delete_view_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.delete_view_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.delete_view_for_bank_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.delete_view_for_bank_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.delete_view_for_bank_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#delete_view_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_account_access_by_user_id(userid, opts = {})
      data, _status_code, _headers = get_account_access_by_user_id_with_http_info(userid, opts)
      data
    end
    ...
    # @param userid [String] The USERID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetApiTags200Response, Integer, Hash)>] GetApiTags200Response data, response status code and response headers
    def get_account_access_by_user_id_with_http_info(userid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_account_access_by_user_id ...'
      end
      # verify the required parameter 'userid' is set
      if @api_client.config.client_side_validation && userid.nil?
        fail ArgumentError, "Missing the required parameter 'userid' when calling AccountApi.get_account_access_by_user_id"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetApiTags200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_account_access_by_user_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_account_access_by_user_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_account_application_with_http_info(bankid, accountapplicationid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_account_application ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_account_application"
      end
      ...
      if @api_client.config.client_side_validation && accountapplicationid.nil?
        fail ArgumentError, "Missing the required parameter 'accountapplicationid' when calling AccountApi.get_account_application"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_account_application",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_account_application\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_account_applications_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_account_applications ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_account_applications"
      end
      # resource path
      local_var_path = '/obp/v3.1.0/banks/{bankid}/account-applications'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_account_applications",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_account_applications\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_account_attribute_definition_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_account_attribute_definition ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_account_attribute_definition"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/banks/{bankid}/attribute-definitions/account'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_account_attribute_definition",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_account_attribute_definition\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param get_accounts_by_account_routing_regex_request [GetAccountsByAccountRoutingRegexRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [GetAccountsByAccountRoutingRegex200ResponseAccountsInner]
    def get_account_by_account_routing(get_accounts_by_account_routing_regex_request, opts = {})
      data, _status_code, _headers = get_account_by_account_routing_with_http_info(get_accounts_by_account_routing_regex_request, opts)
      data
    end
    ...
    # @param get_accounts_by_account_routing_regex_request [GetAccountsByAccountRoutingRegexRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAccountsByAccountRoutingRegex200ResponseAccountsInner, Integer, Hash)>] GetAccountsByAccountRoutingRegex200ResponseAccountsInner data, response status code and response headers
    def get_account_by_account_routing_with_http_info(get_accounts_by_account_routing_regex_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_account_by_account_routing ...'
      end
      # verify the required parameter 'get_accounts_by_account_routing_regex_request' is set
      if @api_client.config.client_side_validation && get_accounts_by_account_routing_regex_request.nil?
        fail ArgumentError, "Missing the required parameter 'get_accounts_by_account_routing_regex_request' when calling AccountApi.get_account_by_account_routing"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(get_accounts_by_account_routing_regex_request)

      # return_type
      return_type = opts[:debug_return_type] || 'GetAccountsByAccountRoutingRegex200ResponseAccountsInner'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_account_by_account_routing",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_account_by_account_routing\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_account_directory(bankid, opts = {})
      data, _status_code, _headers = get_account_directory_with_http_info(bankid, opts)
      data
    end
    ...
    # @param bankid [String] The BANKID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAccountDirectory200Response, Integer, Hash)>] GetAccountDirectory200Response data, response status code and response headers
    def get_account_directory_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_account_directory ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_account_directory"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetAccountDirectory200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_account_directory",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_account_directory\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_accounts_at_bank(bankid, opts = {})
      data, _status_code, _headers = get_accounts_at_bank_with_http_info(bankid, opts)
      data
    end
    ...
    # @param bankid [String] The BANKID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAccountsAtBank200Response, Integer, Hash)>] GetAccountsAtBank200Response data, response status code and response headers
    def get_accounts_at_bank_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_accounts_at_bank ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_accounts_at_bank"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetAccountsAtBank200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_accounts_at_bank",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_accounts_at_bank\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_accounts_by_account_routing_regex(get_accounts_by_account_routing_regex_request, opts = {})
      data, _status_code, _headers = get_accounts_by_account_routing_regex_with_http_info(get_accounts_by_account_routing_regex_request, opts)
      data
    end
    ...
    # @param get_accounts_by_account_routing_regex_request [GetAccountsByAccountRoutingRegexRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAccountsByAccountRoutingRegex200Response, Integer, Hash)>] GetAccountsByAccountRoutingRegex200Response data, response status code and response headers
    def get_accounts_by_account_routing_regex_with_http_info(get_accounts_by_account_routing_regex_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_accounts_by_account_routing_regex ...'
      end
      # verify the required parameter 'get_accounts_by_account_routing_regex_request' is set
      if @api_client.config.client_side_validation && get_accounts_by_account_routing_regex_request.nil?
        fail ArgumentError, "Missing the required parameter 'get_accounts_by_account_routing_regex_request' when calling AccountApi.get_accounts_by_account_routing_regex"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetAccountsByAccountRoutingRegex200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_accounts_by_account_routing_regex",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_accounts_by_account_routing_regex\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_accounts_held(bankid, opts = {})
      data, _status_code, _headers = get_accounts_held_with_http_info(bankid, opts)
      data
    end
    ...
    # @param bankid [String] The BANKID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAccountsHeldByUserAtBank200Response, Integer, Hash)>] GetAccountsHeldByUserAtBank200Response data, response status code and response headers
    def get_accounts_held_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_accounts_held ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_accounts_held"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetAccountsHeldByUserAtBank200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_accounts_held",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_accounts_held\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetAccountsHeldByUserAtBank200Response]
    def get_accounts_held_by_user(userid, opts = {})
      data, _status_code, _headers = get_accounts_held_by_user_with_http_info(userid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAccountsHeldByUserAtBank200Response, Integer, Hash)>] GetAccountsHeldByUserAtBank200Response data, response status code and response headers
    def get_accounts_held_by_user_with_http_info(userid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_accounts_held_by_user ...'
      end
      # verify the required parameter 'userid' is set
      if @api_client.config.client_side_validation && userid.nil?
        fail ArgumentError, "Missing the required parameter 'userid' when calling AccountApi.get_accounts_held_by_user"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_accounts_held_by_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_accounts_held_by_user\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetAccountsHeldByUserAtBank200Response]
    def get_accounts_held_by_user_at_bank(userid, bankid, opts = {})
      data, _status_code, _headers = get_accounts_held_by_user_at_bank_with_http_info(userid, bankid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAccountsHeldByUserAtBank200Response, Integer, Hash)>] GetAccountsHeldByUserAtBank200Response data, response status code and response headers
    def get_accounts_held_by_user_at_bank_with_http_info(userid, bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_accounts_held_by_user_at_bank ...'
      end
      # verify the required parameter 'userid' is set
      if @api_client.config.client_side_validation && userid.nil?
        fail ArgumentError, "Missing the required parameter 'userid' when calling AccountApi.get_accounts_held_by_user_at_bank"
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_accounts_held_by_user_at_bank"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_accounts_held_by_user_at_bank",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_accounts_held_by_user_at_bank\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetApiTags200Response]
    def get_accounts_minimal_by_customer_id(customerid, opts = {})
      data, _status_code, _headers = get_accounts_minimal_by_customer_id_with_http_info(customerid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetApiTags200Response, Integer, Hash)>] GetApiTags200Response data, response status code and response headers
    def get_accounts_minimal_by_customer_id_with_http_info(customerid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_accounts_minimal_by_customer_id ...'
      end
      # verify the required parameter 'customerid' is set
      if @api_client.config.client_side_validation && customerid.nil?
        fail ArgumentError, "Missing the required parameter 'customerid' when calling AccountApi.get_accounts_minimal_by_customer_id"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_accounts_minimal_by_customer_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_accounts_minimal_by_customer_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_agent(bankid, agentid, opts = {})
      data, _status_code, _headers = get_agent_with_http_info(bankid, agentid, opts)
      data
    end
    ...
    def get_agent_with_http_info(bankid, agentid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_agent ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_agent"
      end
      # verify the required parameter 'agentid' is set
      if @api_client.config.client_side_validation && agentid.nil?
        fail ArgumentError, "Missing the required parameter 'agentid' when calling AccountApi.get_agent"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_agent",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_agent\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_agents(bankid, opts = {})
      data, _status_code, _headers = get_agents_with_http_info(bankid, opts)
      data
    end
    ...
    def get_agents_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_agents ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_agents"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_agents",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_agents\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_all_bank_account_balances_with_http_info(bankid, accountid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_all_bank_account_balances ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_all_bank_account_balances"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_all_bank_account_balances"
      end
      # resource path
      local_var_path = '/obp/v5.1.0/banks/{bankid}/accounts/{accountid}/balances'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_all_bank_account_balances",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_all_bank_account_balances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_bank_account_balance_by_id_with_http_info(bankid, accountid, balanceid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_bank_account_balance_by_id ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_bank_account_balance_by_id"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_bank_account_balance_by_id"
      end
      # verify the required parameter 'balanceid' is set
      if @api_client.config.client_side_validation && balanceid.nil?
        fail ArgumentError, "Missing the required parameter 'balanceid' when calling AccountApi.get_bank_account_balance_by_id"
      end
      # resource path
      local_var_path = '/obp/v5.1.0/banks/{bankid}/accounts/{accountid}/balances/{balanceid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'balanceid' + '}', CGI.escape(balanceid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_bank_account_balance_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_bank_account_balance_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_bank_account_balances(bankid, accountid, viewid, opts = {})
      data, _status_code, _headers = get_bank_account_balances_with_http_info(bankid, accountid, viewid, opts)
      data
    end
    ...
    # @param viewid [String] The VIEWID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetBankAccountsBalances200ResponseAccountsInner, Integer, Hash)>] GetBankAccountsBalances200ResponseAccountsInner data, response status code and response headers
    def get_bank_account_balances_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_bank_account_balances ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_bank_account_balances"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_bank_account_balances"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_bank_account_balances"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetBankAccountsBalances200ResponseAccountsInner'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_bank_account_balances",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_bank_account_balances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_bank_accounts_balances(bankid, opts = {})
      data, _status_code, _headers = get_bank_accounts_balances_with_http_info(bankid, opts)
      data
    end
    ...
    # @param bankid [String] The BANKID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetBankAccountsBalances200Response, Integer, Hash)>] GetBankAccountsBalances200Response data, response status code and response headers
    def get_bank_accounts_balances_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_bank_accounts_balances ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_bank_accounts_balances"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetBankAccountsBalances200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_bank_accounts_balances",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_bank_accounts_balances\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetBankAccountsBalances200Response]
    def get_bank_accounts_balances_through_view(bankid, viewid, opts = {})
      data, _status_code, _headers = get_bank_accounts_balances_through_view_with_http_info(bankid, viewid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetBankAccountsBalances200Response, Integer, Hash)>] GetBankAccountsBalances200Response data, response status code and response headers
    def get_bank_accounts_balances_through_view_with_http_info(bankid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_bank_accounts_balances_through_view ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_bank_accounts_balances_through_view"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_bank_accounts_balances_through_view"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_bank_accounts_balances_through_view",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_bank_accounts_balances_through_view\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_checkbook_orders(bankid, accountid, viewid, opts = {})
      data, _status_code, _headers = get_checkbook_orders_with_http_info(bankid, accountid, viewid, opts)
      data
    end
    ...
    # @param viewid [String] The VIEWID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetCheckbookOrders200Response, Integer, Hash)>] GetCheckbookOrders200Response data, response status code and response headers
    def get_checkbook_orders_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_checkbook_orders ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_checkbook_orders"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_checkbook_orders"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_checkbook_orders"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetCheckbookOrders200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_checkbook_orders",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_checkbook_orders\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_core_account_by_id_through_view(bankid, accountid, viewid, opts = {})
      data, _status_code, _headers = get_core_account_by_id_through_view_with_http_info(bankid, accountid, viewid, opts)
      data
    end
    ...
    # @param viewid [String] The VIEWID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetCoreAccountByIdThroughView200Response, Integer, Hash)>] GetCoreAccountByIdThroughView200Response data, response status code and response headers
    def get_core_account_by_id_through_view_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_core_account_by_id_through_view ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_core_account_by_id_through_view"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_core_account_by_id_through_view"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_core_account_by_id_through_view"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetCoreAccountByIdThroughView200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_core_account_by_id_through_view",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_core_account_by_id_through_view\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_core_account_by_id_v600(bankid, accountid, opts = {})
      data, _status_code, _headers = get_core_account_by_id_v600_with_http_info(bankid, accountid, opts)
      data
    end
    ...
    # @param accountid [String] The ACCOUNTID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetCoreAccountByIdV600200Response, Integer, Hash)>] GetCoreAccountByIdV600200Response data, response status code and response headers
    def get_core_account_by_id_v600_with_http_info(bankid, accountid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_core_account_by_id_v600 ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_core_account_by_id_v600"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_core_account_by_id_v600"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetCoreAccountByIdV600200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_core_account_by_id_v600",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_core_account_by_id_v600\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_core_transactions_for_bank_account_with_http_info(bankid, accountid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_core_transactions_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_core_transactions_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_core_transactions_for_bank_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_core_transactions_for_bank_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_core_transactions_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_counterparties_for_any_account_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_counterparties_for_any_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_counterparties_for_any_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_counterparties_for_any_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_counterparties_for_any_account"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/management/banks/{bankid}/accounts/{accountid}/{viewid}/counterparties'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'viewid' + '}', CGI.escape(viewid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_counterparties_for_any_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_counterparties_for_any_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_counterparty_by_id_for_any_account_with_http_info(bankid, accountid, viewid, counterpartyid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_counterparty_by_id_for_any_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_counterparty_by_id_for_any_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_counterparty_by_id_for_any_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_counterparty_by_id_for_any_account"
      end
      # verify the required parameter 'counterpartyid' is set
      if @api_client.config.client_side_validation && counterpartyid.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyid' when calling AccountApi.get_counterparty_by_id_for_any_account"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/management/banks/{bankid}/accounts/{accountid}/{viewid}/counterparties/{counterpartyid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'viewid' + '}', CGI.escape(viewid.to_s)).sub('{' + 'counterpartyid' + '}', CGI.escape(counterpartyid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_counterparty_by_id_for_any_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_counterparty_by_id_for_any_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_counterparty_by_name_for_any_account_with_http_info(bankid, accountid, viewid, counterpartyname, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_counterparty_by_name_for_any_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_counterparty_by_name_for_any_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_counterparty_by_name_for_any_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_counterparty_by_name_for_any_account"
      end
      # verify the required parameter 'counterpartyname' is set
      if @api_client.config.client_side_validation && counterpartyname.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyname' when calling AccountApi.get_counterparty_by_name_for_any_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_counterparty_by_name_for_any_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_counterparty_by_name_for_any_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [CreateCustomView200Response]
    def get_custom_view(bankid, accountid, viewid, targetviewid, opts = {})
      data, _status_code, _headers = get_custom_view_with_http_info(bankid, accountid, viewid, targetviewid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateCustomView200Response, Integer, Hash)>] CreateCustomView200Response data, response status code and response headers
    def get_custom_view_with_http_info(bankid, accountid, viewid, targetviewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_custom_view ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_custom_view"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_custom_view"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_custom_view"
      end
      # verify the required parameter 'targetviewid' is set
      if @api_client.config.client_side_validation && targetviewid.nil?
        fail ArgumentError, "Missing the required parameter 'targetviewid' when calling AccountApi.get_custom_view"
      end
      # resource path
      local_var_path = '/obp/v5.1.0/banks/{bankid}/accounts/{accountid}/views/{viewid}/target-views/{targetviewid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'viewid' + '}', CGI.escape(viewid.to_s)).sub('{' + 'targetviewid' + '}', CGI.escape(targetviewid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_custom_view",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_custom_view\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_explicit_counterparties_for_account_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_explicit_counterparties_for_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_explicit_counterparties_for_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_explicit_counterparties_for_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_explicit_counterparties_for_account"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/counterparties'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'viewid' + '}', CGI.escape(viewid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_explicit_counterparties_for_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_explicit_counterparties_for_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_fast_firehose_accounts_at_one_bank(bankid, opts = {})
      data, _status_code, _headers = get_fast_firehose_accounts_at_one_bank_with_http_info(bankid, opts)
      data
    end
    ...
    # @param bankid [String] The BANKID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetFastFirehoseAccountsAtOneBank200Response, Integer, Hash)>] GetFastFirehoseAccountsAtOneBank200Response data, response status code and response headers
    def get_fast_firehose_accounts_at_one_bank_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_fast_firehose_accounts_at_one_bank ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_fast_firehose_accounts_at_one_bank"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetFastFirehoseAccountsAtOneBank200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_fast_firehose_accounts_at_one_bank",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_fast_firehose_accounts_at_one_bank\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_firehose_accounts_at_one_bank(bankid, viewid, opts = {})
      data, _status_code, _headers = get_firehose_accounts_at_one_bank_with_http_info(bankid, viewid, opts)
      data
    end
    ...
    # @param viewid [String] The VIEWID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetFirehoseAccountsAtOneBank200Response, Integer, Hash)>] GetFirehoseAccountsAtOneBank200Response data, response status code and response headers
    def get_firehose_accounts_at_one_bank_with_http_info(bankid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_firehose_accounts_at_one_bank ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_firehose_accounts_at_one_bank"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_firehose_accounts_at_one_bank"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetFirehoseAccountsAtOneBank200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_firehose_accounts_at_one_bank",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_firehose_accounts_at_one_bank\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_holding_account_by_releaser(bankid, accountid, viewid, opts = {})
      data, _status_code, _headers = get_holding_account_by_releaser_with_http_info(bankid, accountid, viewid, opts)
      data
    end
    ...
    # @param viewid [String] The VIEWID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetHoldingAccountByReleaser200Response, Integer, Hash)>] GetHoldingAccountByReleaser200Response data, response status code and response headers
    def get_holding_account_by_releaser_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_holding_account_by_releaser ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_holding_account_by_releaser"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_holding_account_by_releaser"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_holding_account_by_releaser"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetHoldingAccountByReleaser200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_holding_account_by_releaser",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_holding_account_by_releaser\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_other_account_by_id_for_bank_account_with_http_info(bankid, accountid, viewid, otheraccountid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_other_account_by_id_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_other_account_by_id_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_other_account_by_id_for_bank_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_other_account_by_id_for_bank_account"
      end
      # verify the required parameter 'otheraccountid' is set
      if @api_client.config.client_side_validation && otheraccountid.nil?
        fail ArgumentError, "Missing the required parameter 'otheraccountid' when calling AccountApi.get_other_account_by_id_for_bank_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_other_account_by_id_for_bank_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_other_account_by_id_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_other_accounts_for_bank_account_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_other_accounts_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_other_accounts_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_other_accounts_for_bank_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_other_accounts_for_bank_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_other_accounts_for_bank_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_other_accounts_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_permission_for_user_for_bank_account_with_http_info(bankid, accountid, provider, providerid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_permission_for_user_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_permission_for_user_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_permission_for_user_for_bank_account"
      end
      # verify the required parameter 'provider' is set
      if @api_client.config.client_side_validation && provider.nil?
        fail ArgumentError, "Missing the required parameter 'provider' when calling AccountApi.get_permission_for_user_for_bank_account"
      end
      # verify the required parameter 'providerid' is set
      if @api_client.config.client_side_validation && providerid.nil?
        fail ArgumentError, "Missing the required parameter 'providerid' when calling AccountApi.get_permission_for_user_for_bank_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_permission_for_user_for_bank_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_permission_for_user_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_permissions_for_bank_account_with_http_info(bankid, accountid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_permissions_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_permissions_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_permissions_for_bank_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_permissions_for_bank_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_permissions_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_private_account_by_id_full(bankid, accountid, viewid, opts = {})
      data, _status_code, _headers = get_private_account_by_id_full_with_http_info(bankid, accountid, viewid, opts)
      data
    end
    ...
    # @param viewid [String] The VIEWID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetPrivateAccountByIdFull200Response, Integer, Hash)>] GetPrivateAccountByIdFull200Response data, response status code and response headers
    def get_private_account_by_id_full_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_private_account_by_id_full ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_private_account_by_id_full"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_private_account_by_id_full"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_private_account_by_id_full"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/account'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'viewid' + '}', CGI.escape(viewid.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetPrivateAccountByIdFull200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_private_account_by_id_full",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_private_account_by_id_full\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_private_account_idsby_bank_id(bankid, opts = {})
      data, _status_code, _headers = get_private_account_idsby_bank_id_with_http_info(bankid, opts)
      data
    end
    ...
    # @param bankid [String] The BANKID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetPrivateAccountIdsbyBankId200Response, Integer, Hash)>] GetPrivateAccountIdsbyBankId200Response data, response status code and response headers
    def get_private_account_idsby_bank_id_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_private_account_idsby_bank_id ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_private_account_idsby_bank_id"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetPrivateAccountIdsbyBankId200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_private_account_idsby_bank_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_private_account_idsby_bank_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_public_account_by_id(bankid, accountid, viewid, opts = {})
      data, _status_code, _headers = get_public_account_by_id_with_http_info(bankid, accountid, viewid, opts)
      data
    end
    ...
    # @param viewid [String] The VIEWID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetPublicAccountById200Response, Integer, Hash)>] GetPublicAccountById200Response data, response status code and response headers
    def get_public_account_by_id_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_public_account_by_id ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_public_account_by_id"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_public_account_by_id"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_public_account_by_id"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetPublicAccountById200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AccountApi.get_public_account_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_public_account_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_tags_for_view_on_account_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_tags_for_view_on_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_tags_for_view_on_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_tags_for_view_on_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_tags_for_view_on_account"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/metadata/tags'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'viewid' + '}', CGI.escape(viewid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_tags_for_view_on_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_tags_for_view_on_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_transactions_for_bank_account_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_transactions_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_transactions_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_transactions_for_bank_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_transactions_for_bank_account"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.get_transactions_for_bank_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_transactions_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_users_with_account_access(bankid, accountid, viewid, opts = {})
      data, _status_code, _headers = get_users_with_account_access_with_http_info(bankid, accountid, viewid, opts)
      data
    end
    ...
    # @param viewid [String] The VIEWID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetUsersWithAccountAccess200Response, Integer, Hash)>] GetUsersWithAccountAccess200Response data, response status code and response headers
    def get_users_with_account_access_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_users_with_account_access ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_users_with_account_access"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_users_with_account_access"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.get_users_with_account_access"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/banks/{bankid}/accounts/{accountid}/views/{viewid}/users-with-access'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'viewid' + '}', CGI.escape(viewid.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetUsersWithAccountAccess200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_users_with_account_access",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_users_with_account_access\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_views_for_bank_account(bankid, accountid, opts = {})
      data, _status_code, _headers = get_views_for_bank_account_with_http_info(bankid, accountid, opts)
      data
    end
    ...
    # @param accountid [String] The ACCOUNTID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetViewsForBankAccount200Response, Integer, Hash)>] GetViewsForBankAccount200Response data, response status code and response headers
    def get_views_for_bank_account_with_http_info(bankid, accountid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.get_views_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.get_views_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.get_views_for_bank_account"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetViewsForBankAccount200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.get_views_for_bank_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#get_views_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def grant_user_access_to_view_by_id_with_http_info(bankid, accountid, viewid, revoke_user_access_to_view_by_id_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.grant_user_access_to_view_by_id ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.grant_user_access_to_view_by_id"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.grant_user_access_to_view_by_id"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.grant_user_access_to_view_by_id"
      end
      ...
      if @api_client.config.client_side_validation && revoke_user_access_to_view_by_id_request.nil?
        fail ArgumentError, "Missing the required parameter 'revoke_user_access_to_view_by_id_request' when calling AccountApi.grant_user_access_to_view_by_id"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.grant_user_access_to_view_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#grant_user_access_to_view_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def has_account_access(bankid, accountid, viewid, opts = {})
      data, _status_code, _headers = has_account_access_with_http_info(bankid, accountid, viewid, opts)
      data
    end
    ...
    # @param viewid [String] The VIEWID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(HasAccountAccess200Response, Integer, Hash)>] HasAccountAccess200Response data, response status code and response headers
    def has_account_access_with_http_info(bankid, accountid, viewid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.has_account_access ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.has_account_access"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.has_account_access"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.has_account_access"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'HasAccountAccess200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"AccountApi.has_account_access",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#has_account_access\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param iban_checker_request [IbanCheckerRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [IbanChecker200Response]
    def iban_checker(iban_checker_request, opts = {})
      data, _status_code, _headers = iban_checker_with_http_info(iban_checker_request, opts)
      data
    end
    ...
    # @param iban_checker_request [IbanCheckerRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(IbanChecker200Response, Integer, Hash)>] IbanChecker200Response data, response status code and response headers
    def iban_checker_with_http_info(iban_checker_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.iban_checker ...'
      end
      # verify the required parameter 'iban_checker_request' is set
      if @api_client.config.client_side_validation && iban_checker_request.nil?
        fail ArgumentError, "Missing the required parameter 'iban_checker_request' when calling AccountApi.iban_checker"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(iban_checker_request)

      # return_type
      return_type = opts[:debug_return_type] || 'IbanChecker200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AccountApi.iban_checker",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#iban_checker\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [PrivateAccountsAtOneBank200Response]
    def private_accounts_at_one_bank(bankid, opts = {})
      data, _status_code, _headers = private_accounts_at_one_bank_with_http_info(bankid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PrivateAccountsAtOneBank200Response, Integer, Hash)>] PrivateAccountsAtOneBank200Response data, response status code and response headers
    def private_accounts_at_one_bank_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.private_accounts_at_one_bank ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.private_accounts_at_one_bank"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.private_accounts_at_one_bank",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#private_accounts_at_one_bank\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def public_accounts_all_banks(opts = {})
      data, _status_code, _headers = public_accounts_all_banks_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get public accounts at all banks (Anonymous access).&lt;br /&gt; Returns accounts that contain at least one public view (a view where is_public is true)&lt;br /&gt; For each account the API returns the ID and the available views.&lt;/p&gt; &lt;p&gt;User Authentication is Optional. The User need not be logged in.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#accounts\&quot;&gt;&lt;strong&gt;accounts&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;bank_id&lt;/strong&gt;&lt;/a&gt;: gh.29.uk&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#id\&quot;&gt;&lt;strong&gt;id&lt;/strong&gt;&lt;/a&gt;: d8839721-ad8f-45dd-9f78-2080414b93f9&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#is_public\&quot;&gt;&lt;strong&gt;is_public&lt;/strong&gt;&lt;/a&gt;: false&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;label&lt;/strong&gt;&lt;/a&gt;: My Account&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#short_name\&quot;&gt;&lt;strong&gt;short_name&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#views_available\&quot;&gt;&lt;strong&gt;views_available&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PublicAccountsAllBanks200Response, Integer, Hash)>] PublicAccountsAllBanks200Response data, response status code and response headers
    def public_accounts_all_banks_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.public_accounts_all_banks ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PublicAccountsAllBanks200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"AccountApi.public_accounts_all_banks",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#public_accounts_all_banks\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [PublicAccountsAllBanks200Response]
    def public_accounts_at_one_bank(bankid, opts = {})
      data, _status_code, _headers = public_accounts_at_one_bank_with_http_info(bankid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PublicAccountsAllBanks200Response, Integer, Hash)>] PublicAccountsAllBanks200Response data, response status code and response headers
    def public_accounts_at_one_bank_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.public_accounts_at_one_bank ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.public_accounts_at_one_bank"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.public_accounts_at_one_bank",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#public_accounts_at_one_bank\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def revoke_user_access_to_view_by_id_with_http_info(bankid, accountid, viewid, revoke_user_access_to_view_by_id_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.revoke_user_access_to_view_by_id ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.revoke_user_access_to_view_by_id"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.revoke_user_access_to_view_by_id"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.revoke_user_access_to_view_by_id"
      end
      # verify the required parameter 'revoke_user_access_to_view_by_id_request' is set
      if @api_client.config.client_side_validation && revoke_user_access_to_view_by_id_request.nil?
        fail ArgumentError, "Missing the required parameter 'revoke_user_access_to_view_by_id_request' when calling AccountApi.revoke_user_access_to_view_by_id"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.revoke_user_access_to_view_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#revoke_user_access_to_view_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param bankid [String] The BANKID identifier
    # @param accountid [String] The ACCOUNTID identifier
    # @param update_account_request [UpdateAccountRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [UpdateAccount200Response]
    def update_account(bankid, accountid, update_account_request, opts = {})
      data, _status_code, _headers = update_account_with_http_info(bankid, accountid, update_account_request, opts)
      data
    end
    ...
    def update_account_with_http_info(bankid, accountid, update_account_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.update_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.update_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.update_account"
      end
      ...
      if @api_client.config.client_side_validation && update_account_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_account_request' when calling AccountApi.update_account"
      end
      # resource path
    ...
    def update_account_application_status_with_http_info(bankid, accountapplicationid, update_transaction_request_status_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.update_account_application_status ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.update_account_application_status"
      end
      # verify the required parameter 'accountapplicationid' is set
      if @api_client.config.client_side_validation && accountapplicationid.nil?
        fail ArgumentError, "Missing the required parameter 'accountapplicationid' when calling AccountApi.update_account_application_status"
      end
      ...
      if @api_client.config.client_side_validation && update_transaction_request_status_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_transaction_request_status_request' when calling AccountApi.update_account_application_status"
      end
      # resource path
      local_var_path = '/obp/v3.1.0/banks/{bankid}/account-applications/{accountapplicationid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountapplicationid' + '}', CGI.escape(accountapplicationid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.update_account_application_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#update_account_application_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_account_attribute_with_http_info(bankid, accountid, productcode, accountattributeid, update_account_attribute_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.update_account_attribute ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.update_account_attribute"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.update_account_attribute"
      end
      # verify the required parameter 'productcode' is set
      if @api_client.config.client_side_validation && productcode.nil?
        fail ArgumentError, "Missing the required parameter 'productcode' when calling AccountApi.update_account_attribute"
      end
      ...
      if @api_client.config.client_side_validation && accountattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'accountattributeid' when calling AccountApi.update_account_attribute"
      end
      # verify the required parameter 'update_account_attribute_request' is set
      if @api_client.config.client_side_validation && update_account_attribute_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_account_attribute_request' when calling AccountApi.update_account_attribute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.update_account_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#update_account_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param bankid [String] The BANKID identifier
    # @param accountid [String] The ACCOUNTID identifier
    # @param update_account_label_request [UpdateAccountLabelRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [UpdateTransactionNarrative200Response]
    def update_account_label(bankid, accountid, update_account_label_request, opts = {})
      data, _status_code, _headers = update_account_label_with_http_info(bankid, accountid, update_account_label_request, opts)
      data
    end
    ...
    def update_account_label_with_http_info(bankid, accountid, update_account_label_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.update_account_label ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.update_account_label"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.update_account_label"
      end
      # verify the required parameter 'update_account_label_request' is set
      if @api_client.config.client_side_validation && update_account_label_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_account_label_request' when calling AccountApi.update_account_label"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_account_label_request)
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.update_account_label",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#update_account_label\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_bank_account_balance_with_http_info(bankid, accountid, balanceid, create_bank_account_balance_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.update_bank_account_balance ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.update_bank_account_balance"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.update_bank_account_balance"
      end
      # verify the required parameter 'balanceid' is set
      if @api_client.config.client_side_validation && balanceid.nil?
        fail ArgumentError, "Missing the required parameter 'balanceid' when calling AccountApi.update_bank_account_balance"
      end
      # verify the required parameter 'create_bank_account_balance_request' is set
      if @api_client.config.client_side_validation && create_bank_account_balance_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_bank_account_balance_request' when calling AccountApi.update_bank_account_balance"
      end
      # resource path
      local_var_path = '/obp/v5.1.0/banks/{bankid}/accounts/{accountid}/balances/{balanceid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'balanceid' + '}', CGI.escape(balanceid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.update_bank_account_balance",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#update_bank_account_balance\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param viewid [String] The VIEWID identifier
    # @param targetviewid [String] The TARGETVIEWID identifier
    # @param update_custom_view_request [UpdateCustomViewRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [CreateCustomView200Response]
    def update_custom_view(bankid, accountid, viewid, targetviewid, update_custom_view_request, opts = {})
      data, _status_code, _headers = update_custom_view_with_http_info(bankid, accountid, viewid, targetviewid, update_custom_view_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateCustomView200Response, Integer, Hash)>] CreateCustomView200Response data, response status code and response headers
    def update_custom_view_with_http_info(bankid, accountid, viewid, targetviewid, update_custom_view_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.update_custom_view ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.update_custom_view"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.update_custom_view"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.update_custom_view"
      end
      # verify the required parameter 'targetviewid' is set
      if @api_client.config.client_side_validation && targetviewid.nil?
        fail ArgumentError, "Missing the required parameter 'targetviewid' when calling AccountApi.update_custom_view"
      end
      # verify the required parameter 'update_custom_view_request' is set
      if @api_client.config.client_side_validation && update_custom_view_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_custom_view_request' when calling AccountApi.update_custom_view"
      end
      # resource path
      local_var_path = '/obp/v5.1.0/banks/{bankid}/accounts/{accountid}/views/{viewid}/target-views/{targetviewid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'viewid' + '}', CGI.escape(viewid.to_s)).sub('{' + 'targetviewid' + '}', CGI.escape(targetviewid.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_custom_view_request)
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.update_custom_view",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#update_custom_view\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param accountid [String] The ACCOUNTID identifier
    # @param viewid [String] The VIEWID identifier
    # @param update_view_for_bank_account_request [UpdateViewForBankAccountRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [CreateUserWithAccountAccessById200ResponseHead]
    def update_view_for_bank_account(bankid, accountid, viewid, update_view_for_bank_account_request, opts = {})
      data, _status_code, _headers = update_view_for_bank_account_with_http_info(bankid, accountid, viewid, update_view_for_bank_account_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateUserWithAccountAccessById200ResponseHead, Integer, Hash)>] CreateUserWithAccountAccessById200ResponseHead data, response status code and response headers
    def update_view_for_bank_account_with_http_info(bankid, accountid, viewid, update_view_for_bank_account_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AccountApi.update_view_for_bank_account ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling AccountApi.update_view_for_bank_account"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling AccountApi.update_view_for_bank_account"
      end
      # verify the required parameter 'viewid' is set
      if @api_client.config.client_side_validation && viewid.nil?
        fail ArgumentError, "Missing the required parameter 'viewid' when calling AccountApi.update_view_for_bank_account"
      end
      # verify the required parameter 'update_view_for_bank_account_request' is set
      if @api_client.config.client_side_validation && update_view_for_bank_account_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_view_for_bank_account_request' when calling AccountApi.update_view_for_bank_account"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_view_for_bank_account_request)
      ...
      new_options = opts.merge(
        :operation => :"AccountApi.update_view_for_bank_account",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AccountApi#update_view_for_bank_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
