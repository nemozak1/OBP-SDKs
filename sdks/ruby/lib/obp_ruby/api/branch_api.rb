...
module OpenBankProject
  class BranchApi
    ...
    # @param get_branches200_response_branches_inner [GetBranches200ResponseBranchesInner] Request body
    # @param [Hash] opts the optional parameters
    # @return [GetBranches200ResponseBranchesInner]
    def create_branch(bankid, get_branches200_response_branches_inner, opts = {})
      data, _status_code, _headers = create_branch_with_http_info(bankid, get_branches200_response_branches_inner, opts)
      data
    end
    ...
    def create_branch_with_http_info(bankid, get_branches200_response_branches_inner, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BranchApi.create_branch ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling BranchApi.create_branch"
      end
      # verify the required parameter 'get_branches200_response_branches_inner' is set
      if @api_client.config.client_side_validation && get_branches200_response_branches_inner.nil?
        fail ArgumentError, "Missing the required parameter 'get_branches200_response_branches_inner' when calling BranchApi.create_branch"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(get_branches200_response_branches_inner)
      ...
      new_options = opts.merge(
        :operation => :"BranchApi.create_branch",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BranchApi#create_branch\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_branch(bankid, branchid, opts = {})
      delete_branch_with_http_info(bankid, branchid, opts)
      nil
    end
    ...
    def delete_branch_with_http_info(bankid, branchid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BranchApi.delete_branch ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling BranchApi.delete_branch"
      end
      # verify the required parameter 'branchid' is set
      if @api_client.config.client_side_validation && branchid.nil?
        fail ArgumentError, "Missing the required parameter 'branchid' when calling BranchApi.delete_branch"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"BranchApi.delete_branch",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BranchApi#delete_branch\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_branch_with_http_info(bankid, branchid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BranchApi.get_branch ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling BranchApi.get_branch"
      end
      # verify the required parameter 'branchid' is set
      if @api_client.config.client_side_validation && branchid.nil?
        fail ArgumentError, "Missing the required parameter 'branchid' when calling BranchApi.get_branch"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"BranchApi.get_branch",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BranchApi#get_branch\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_branches_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BranchApi.get_branches ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling BranchApi.get_branches"
      end
      # resource path
      local_var_path = '/obp/v3.0.0/banks/{bankid}/branches'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"BranchApi.get_branches",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BranchApi#get_branches\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
