  ...
  class VRPApi
    ...
    def create_consent_by_consent_request_id_email_with_http_info(consentrequestid, email, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VRPApi.create_consent_by_consent_request_id_email ...'
      end
      # verify the required parameter 'consentrequestid' is set
      if @api_client.config.client_side_validation && consentrequestid.nil?
        fail ArgumentError, "Missing the required parameter 'consentrequestid' when calling VRPApi.create_consent_by_consent_request_id_email"
      end
      # verify the required parameter 'email' is set
      if @api_client.config.client_side_validation && email.nil?
        fail ArgumentError, "Missing the required parameter 'email' when calling VRPApi.create_consent_by_consent_request_id_email"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"VRPApi.create_consent_by_consent_request_id_email",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VRPApi#create_consent_by_consent_request_id_email\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_vrp_consent_request_with_http_info(create_vrp_consent_request_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: VRPApi.create_vrp_consent_request ...'
      end
      ...
      if @api_client.config.client_side_validation && create_vrp_consent_request_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_vrp_consent_request_request' when calling VRPApi.create_vrp_consent_request"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"VRPApi.create_vrp_consent_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: VRPApi#create_vrp_consent_request\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
