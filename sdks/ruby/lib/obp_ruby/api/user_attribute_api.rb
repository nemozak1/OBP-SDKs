  ...
  class UserAttributeApi
    ...
    def create_personal_data_field_with_http_info(create_personal_data_field_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAttributeApi.create_personal_data_field ...'
      end
      ...
      if @api_client.config.client_side_validation && create_personal_data_field_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_personal_data_field_request' when calling UserAttributeApi.create_personal_data_field"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserAttributeApi.create_personal_data_field",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAttributeApi#create_personal_data_field\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_user_attribute_with_http_info(userid, create_personal_data_field_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAttributeApi.create_user_attribute ...'
      end
      # verify the required parameter 'userid' is set
      if @api_client.config.client_side_validation && userid.nil?
        fail ArgumentError, "Missing the required parameter 'userid' when calling UserAttributeApi.create_user_attribute"
      end
      # verify the required parameter 'create_personal_data_field_request' is set
      if @api_client.config.client_side_validation && create_personal_data_field_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_personal_data_field_request' when calling UserAttributeApi.create_user_attribute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserAttributeApi.create_user_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAttributeApi#create_user_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_personal_data_field_with_http_info(userattributeid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAttributeApi.delete_personal_data_field ...'
      end
      # verify the required parameter 'userattributeid' is set
      if @api_client.config.client_side_validation && userattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'userattributeid' when calling UserAttributeApi.delete_personal_data_field"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserAttributeApi.delete_personal_data_field",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAttributeApi#delete_personal_data_field\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_user_attribute_with_http_info(userid, userattributeid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAttributeApi.delete_user_attribute ...'
      end
      # verify the required parameter 'userid' is set
      if @api_client.config.client_side_validation && userid.nil?
        fail ArgumentError, "Missing the required parameter 'userid' when calling UserAttributeApi.delete_user_attribute"
      end
      # verify the required parameter 'userattributeid' is set
      if @api_client.config.client_side_validation && userattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'userattributeid' when calling UserAttributeApi.delete_user_attribute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UserAttributeApi.delete_user_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAttributeApi#delete_user_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_personal_data_field_by_id_with_http_info(userattributeid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAttributeApi.get_personal_data_field_by_id ...'
      end
      # verify the required parameter 'userattributeid' is set
      if @api_client.config.client_side_validation && userattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'userattributeid' when calling UserAttributeApi.get_personal_data_field_by_id"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/my/personal-data-fields/{userattributeid}'.sub('{' + 'userattributeid' + '}', CGI.escape(userattributeid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"UserAttributeApi.get_personal_data_field_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAttributeApi#get_personal_data_field_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_personal_data_fields_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAttributeApi.get_personal_data_fields ...'
      end
      # resource path
      local_var_path = '/obp/v6.0.0/my/personal-data-fields'
      ...
      new_options = opts.merge(
        :operation => :"UserAttributeApi.get_personal_data_fields",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAttributeApi#get_personal_data_fields\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_user_attribute_by_id_with_http_info(userid, userattributeid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAttributeApi.get_user_attribute_by_id ...'
      end
      # verify the required parameter 'userid' is set
      if @api_client.config.client_side_validation && userid.nil?
        fail ArgumentError, "Missing the required parameter 'userid' when calling UserAttributeApi.get_user_attribute_by_id"
      end
      # verify the required parameter 'userattributeid' is set
      if @api_client.config.client_side_validation && userattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'userattributeid' when calling UserAttributeApi.get_user_attribute_by_id"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/users/{userid}/attributes/{userattributeid}'.sub('{' + 'userid' + '}', CGI.escape(userid.to_s)).sub('{' + 'userattributeid' + '}', CGI.escape(userattributeid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"UserAttributeApi.get_user_attribute_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAttributeApi#get_user_attribute_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_user_attributes_with_http_info(userid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAttributeApi.get_user_attributes ...'
      end
      # verify the required parameter 'userid' is set
      if @api_client.config.client_side_validation && userid.nil?
        fail ArgumentError, "Missing the required parameter 'userid' when calling UserAttributeApi.get_user_attributes"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/users/{userid}/attributes'.sub('{' + 'userid' + '}', CGI.escape(userid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"UserAttributeApi.get_user_attributes",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAttributeApi#get_user_attributes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_personal_data_field_with_http_info(userattributeid, create_personal_data_field_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAttributeApi.update_personal_data_field ...'
      end
      # verify the required parameter 'userattributeid' is set
      if @api_client.config.client_side_validation && userattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'userattributeid' when calling UserAttributeApi.update_personal_data_field"
      end
      # verify the required parameter 'create_personal_data_field_request' is set
      if @api_client.config.client_side_validation && create_personal_data_field_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_personal_data_field_request' when calling UserAttributeApi.update_personal_data_field"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/my/personal-data-fields/{userattributeid}'.sub('{' + 'userattributeid' + '}', CGI.escape(userattributeid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"UserAttributeApi.update_personal_data_field",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAttributeApi#update_personal_data_field\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_user_attribute_with_http_info(userid, userattributeid, create_personal_data_field_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UserAttributeApi.update_user_attribute ...'
      end
      # verify the required parameter 'userid' is set
      if @api_client.config.client_side_validation && userid.nil?
        fail ArgumentError, "Missing the required parameter 'userid' when calling UserAttributeApi.update_user_attribute"
      end
      # verify the required parameter 'userattributeid' is set
      if @api_client.config.client_side_validation && userattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'userattributeid' when calling UserAttributeApi.update_user_attribute"
      end
      # verify the required parameter 'create_personal_data_field_request' is set
      if @api_client.config.client_side_validation && create_personal_data_field_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_personal_data_field_request' when calling UserAttributeApi.update_user_attribute"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/users/{userid}/attributes/{userattributeid}'.sub('{' + 'userid' + '}', CGI.escape(userid.to_s)).sub('{' + 'userattributeid' + '}', CGI.escape(userattributeid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"UserAttributeApi.update_user_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserAttributeApi#update_user_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
