  ...
  class APIApi
    ...
    def backup_bank_level_dynamic_entity_with_http_info(bankid, dynamicentityid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.backup_bank_level_dynamic_entity ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.backup_bank_level_dynamic_entity"
      end
      # verify the required parameter 'dynamicentityid' is set
      if @api_client.config.client_side_validation && dynamicentityid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicentityid' when calling APIApi.backup_bank_level_dynamic_entity"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.backup_bank_level_dynamic_entity",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#backup_bank_level_dynamic_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def backup_system_dynamic_entity_with_http_info(dynamicentityid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.backup_system_dynamic_entity ...'
      end
      # verify the required parameter 'dynamicentityid' is set
      if @api_client.config.client_side_validation && dynamicentityid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicentityid' when calling APIApi.backup_system_dynamic_entity"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.backup_system_dynamic_entity",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#backup_system_dynamic_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def cleanup_orphaned_dynamic_entity_records(opts = {})
      data, _status_code, _headers = cleanup_orphaned_dynamic_entity_records_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Delete orphaned dynamic entity data records.&lt;/p&gt; &lt;p&gt;Orphaned records are rows in the DynamicData table whose entityName/bankId combination&lt;br /&gt; has no matching Dynamic Entity definition. These can accumulate when entity definitions&lt;br /&gt; are deleted but their data records are not cleaned up.&lt;/p&gt; &lt;p&gt;This endpoint first identifies all orphaned records (using the same detection logic as&lt;br /&gt; GET /management/diagnostics/dynamic-entities), then deletes them.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Response Format:&lt;/strong&gt;&lt;br /&gt; * &lt;code&gt;deleted_orphaned_entities&lt;/code&gt; - List of orphaned entity groups that were deleted, each with:&lt;br /&gt; * &lt;code&gt;entity_name&lt;/code&gt; - Name of the orphaned entity&lt;br /&gt; * &lt;code&gt;bank_id&lt;/code&gt; - Bank ID (or empty string for system-level)&lt;br /&gt; * &lt;code&gt;record_count&lt;/code&gt; - Number of records that were deleted for this entity group&lt;br /&gt; * &lt;code&gt;total_records_deleted&lt;/code&gt; - Total count of all deleted records&lt;/p&gt; &lt;p&gt;Authentication is Required&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Required Role:&lt;/strong&gt; &lt;code&gt;CanCleanupOrphanedDynamicEntityRecords&lt;/code&gt;&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CleanupOrphanedDynamicEntityRecords200Response, Integer, Hash)>] CleanupOrphanedDynamicEntityRecords200Response data, response status code and response headers
    def cleanup_orphaned_dynamic_entity_records_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.cleanup_orphaned_dynamic_entity_records ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CleanupOrphanedDynamicEntityRecords200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.cleanup_orphaned_dynamic_entity_records",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#cleanup_orphaned_dynamic_entity_records\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def config(opts = {})
      data, _status_code, _headers = config_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Returns information about:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;The default bank_id&lt;/li&gt; &lt;li&gt;Akka configuration&lt;/li&gt; &lt;li&gt;Elastic Search configuration&lt;/li&gt; &lt;li&gt;Cached functions&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#akka\&quot;&gt;&lt;strong&gt;akka&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#cache\&quot;&gt;&lt;strong&gt;cache&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#elastic_search\&quot;&gt;&lt;strong&gt;elastic_search&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#function_name\&quot;&gt;&lt;strong&gt;function_name&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#log_level\&quot;&gt;&lt;strong&gt;log_level&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#metrics\&quot;&gt;&lt;strong&gt;metrics&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#ports\&quot;&gt;&lt;strong&gt;ports&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#property\&quot;&gt;&lt;strong&gt;property&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#require_scopes_for_all_roles\&quot;&gt;&lt;strong&gt;require_scopes_for_all_roles&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#require_scopes_for_listed_roles\&quot;&gt;&lt;strong&gt;require_scopes_for_listed_roles&lt;/strong&gt;&lt;/a&gt;: false&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#scopes\&quot;&gt;&lt;strong&gt;scopes&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#ttl_in_seconds\&quot;&gt;&lt;strong&gt;ttl_in_seconds&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;value&lt;/strong&gt;&lt;/a&gt;: 5987953&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#warehouse\&quot;&gt;&lt;strong&gt;warehouse&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;remote_data_secret_matched&lt;/a&gt;: remote_data_secret_matched&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(Config200Response, Integer, Hash)>] Config200Response data, response status code and response headers
    def config_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.config ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Config200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.config",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_api_product_with_http_info(bankid, apiproductcode, create_or_update_api_product_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_api_product ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.create_api_product"
      end
      # verify the required parameter 'apiproductcode' is set
      if @api_client.config.client_side_validation && apiproductcode.nil?
        fail ArgumentError, "Missing the required parameter 'apiproductcode' when calling APIApi.create_api_product"
      end
      ...
      if @api_client.config.client_side_validation && create_or_update_api_product_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_or_update_api_product_request' when calling APIApi.create_api_product"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.create_api_product",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_api_product\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_api_product_attribute(bankid, apiproductcode, update_atm_attribute_request, opts = {})
      data, _status_code, _headers = create_api_product_attribute_with_http_info(bankid, apiproductcode, update_atm_attribute_request, opts)
      data
    end
    ...
    # @param update_atm_attribute_request [UpdateAtmAttributeRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateApiProductAttribute200Response, Integer, Hash)>] CreateApiProductAttribute200Response data, response status code and response headers
    def create_api_product_attribute_with_http_info(bankid, apiproductcode, update_atm_attribute_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_api_product_attribute ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.create_api_product_attribute"
      end
      # verify the required parameter 'apiproductcode' is set
      if @api_client.config.client_side_validation && apiproductcode.nil?
        fail ArgumentError, "Missing the required parameter 'apiproductcode' when calling APIApi.create_api_product_attribute"
      end
      ...
      if @api_client.config.client_side_validation && update_atm_attribute_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_atm_attribute_request' when calling APIApi.create_api_product_attribute"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateApiProductAttribute200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.create_api_product_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_api_product_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_bank_level_dynamic_endpoint_with_http_info(bankid, get_dynamic_endpoints200_response_dynamic_endpoints_inner_swagger_string, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_bank_level_dynamic_endpoint ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.create_bank_level_dynamic_endpoint"
      end
      ...
      if @api_client.config.client_side_validation && get_dynamic_endpoints200_response_dynamic_endpoints_inner_swagger_string.nil?
        fail ArgumentError, "Missing the required parameter 'get_dynamic_endpoints200_response_dynamic_endpoints_inner_swagger_string' when calling APIApi.create_bank_level_dynamic_endpoint"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.create_bank_level_dynamic_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_bank_level_dynamic_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_bank_level_dynamic_entity_with_http_info(bankid, create_system_dynamic_entity_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_bank_level_dynamic_entity ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.create_bank_level_dynamic_entity"
      end
      ...
      if @api_client.config.client_side_validation && create_system_dynamic_entity_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_system_dynamic_entity_request' when calling APIApi.create_bank_level_dynamic_entity"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.create_bank_level_dynamic_entity",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_bank_level_dynamic_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param update_system_level_endpoint_tag_request [UpdateSystemLevelEndpointTagRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [UpdateSystemLevelEndpointTag200Response]
    def create_bank_level_endpoint_tag(bankid, operationid, update_system_level_endpoint_tag_request, opts = {})
      data, _status_code, _headers = create_bank_level_endpoint_tag_with_http_info(bankid, operationid, update_system_level_endpoint_tag_request, opts)
      data
    end
    ...
    # @param update_system_level_endpoint_tag_request [UpdateSystemLevelEndpointTagRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateSystemLevelEndpointTag200Response, Integer, Hash)>] UpdateSystemLevelEndpointTag200Response data, response status code and response headers
    def create_bank_level_endpoint_tag_with_http_info(bankid, operationid, update_system_level_endpoint_tag_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_bank_level_endpoint_tag ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.create_bank_level_endpoint_tag"
      end
      # verify the required parameter 'operationid' is set
      if @api_client.config.client_side_validation && operationid.nil?
        fail ArgumentError, "Missing the required parameter 'operationid' when calling APIApi.create_bank_level_endpoint_tag"
      end
      # verify the required parameter 'update_system_level_endpoint_tag_request' is set
      if @api_client.config.client_side_validation && update_system_level_endpoint_tag_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_system_level_endpoint_tag_request' when calling APIApi.create_bank_level_endpoint_tag"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_system_level_endpoint_tag_request)

      # return_type
      return_type = opts[:debug_return_type] || 'UpdateSystemLevelEndpointTag200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.create_bank_level_endpoint_tag",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_bank_level_endpoint_tag\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_counterparty_attribute_with_http_info(bankid, accountid, counterpartyid, create_counterparty_attribute_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_counterparty_attribute ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.create_counterparty_attribute"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling APIApi.create_counterparty_attribute"
      end
      # verify the required parameter 'counterpartyid' is set
      if @api_client.config.client_side_validation && counterpartyid.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyid' when calling APIApi.create_counterparty_attribute"
      end
      ...
      if @api_client.config.client_side_validation && create_counterparty_attribute_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_counterparty_attribute_request' when calling APIApi.create_counterparty_attribute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.create_counterparty_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_counterparty_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_dynamic_endpoint_with_http_info(get_dynamic_endpoints200_response_dynamic_endpoints_inner_swagger_string, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_dynamic_endpoint ...'
      end
      # verify the required parameter 'get_dynamic_endpoints200_response_dynamic_endpoints_inner_swagger_string' is set
      if @api_client.config.client_side_validation && get_dynamic_endpoints200_response_dynamic_endpoints_inner_swagger_string.nil?
        fail ArgumentError, "Missing the required parameter 'get_dynamic_endpoints200_response_dynamic_endpoints_inner_swagger_string' when calling APIApi.create_dynamic_endpoint"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.create_dynamic_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_dynamic_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param create_featured_api_collection_request [CreateFeaturedApiCollectionRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [GetFeaturedApiCollectionsAdmin200ResponseFeaturedApiCollectionsInner]
    def create_featured_api_collection(create_featured_api_collection_request, opts = {})
      data, _status_code, _headers = create_featured_api_collection_with_http_info(create_featured_api_collection_request, opts)
      data
    end
    ...
    # @param create_featured_api_collection_request [CreateFeaturedApiCollectionRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetFeaturedApiCollectionsAdmin200ResponseFeaturedApiCollectionsInner, Integer, Hash)>] GetFeaturedApiCollectionsAdmin200ResponseFeaturedApiCollectionsInner data, response status code and response headers
    def create_featured_api_collection_with_http_info(create_featured_api_collection_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_featured_api_collection ...'
      end
      # verify the required parameter 'create_featured_api_collection_request' is set
      if @api_client.config.client_side_validation && create_featured_api_collection_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_featured_api_collection_request' when calling APIApi.create_featured_api_collection"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_featured_api_collection_request)

      # return_type
      return_type = opts[:debug_return_type] || 'GetFeaturedApiCollectionsAdmin200ResponseFeaturedApiCollectionsInner'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.create_featured_api_collection",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_featured_api_collection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param create_method_routing_request [CreateMethodRoutingRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [GetMethodRoutings200ResponseMethodRoutingsInner]
    def create_method_routing(create_method_routing_request, opts = {})
      data, _status_code, _headers = create_method_routing_with_http_info(create_method_routing_request, opts)
      data
    end
    ...
    # @param create_method_routing_request [CreateMethodRoutingRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetMethodRoutings200ResponseMethodRoutingsInner, Integer, Hash)>] GetMethodRoutings200ResponseMethodRoutingsInner data, response status code and response headers
    def create_method_routing_with_http_info(create_method_routing_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_method_routing ...'
      end
      # verify the required parameter 'create_method_routing_request' is set
      if @api_client.config.client_side_validation && create_method_routing_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_method_routing_request' when calling APIApi.create_method_routing"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_method_routing_request)

      # return_type
      return_type = opts[:debug_return_type] || 'GetMethodRoutings200ResponseMethodRoutingsInner'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.create_method_routing",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_method_routing\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_or_update_api_product_with_http_info(bankid, apiproductcode, create_or_update_api_product_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_or_update_api_product ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.create_or_update_api_product"
      end
      # verify the required parameter 'apiproductcode' is set
      if @api_client.config.client_side_validation && apiproductcode.nil?
        fail ArgumentError, "Missing the required parameter 'apiproductcode' when calling APIApi.create_or_update_api_product"
      end
      # verify the required parameter 'create_or_update_api_product_request' is set
      if @api_client.config.client_side_validation && create_or_update_api_product_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_or_update_api_product_request' when calling APIApi.create_or_update_api_product"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/banks/{bankid}/api-products/{apiproductcode}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'apiproductcode' + '}', CGI.escape(apiproductcode.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.create_or_update_api_product",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_or_update_api_product\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param create_regulated_entity_request [CreateRegulatedEntityRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [GetRegulatedEntityById200Response]
    def create_regulated_entity(create_regulated_entity_request, opts = {})
      data, _status_code, _headers = create_regulated_entity_with_http_info(create_regulated_entity_request, opts)
      data
    end
    ...
    # @param create_regulated_entity_request [CreateRegulatedEntityRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetRegulatedEntityById200Response, Integer, Hash)>] GetRegulatedEntityById200Response data, response status code and response headers
    def create_regulated_entity_with_http_info(create_regulated_entity_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_regulated_entity ...'
      end
      # verify the required parameter 'create_regulated_entity_request' is set
      if @api_client.config.client_side_validation && create_regulated_entity_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_regulated_entity_request' when calling APIApi.create_regulated_entity"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_regulated_entity_request)

      # return_type
      return_type = opts[:debug_return_type] || 'GetRegulatedEntityById200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.create_regulated_entity",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_regulated_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_regulated_entity_attribute(regulatedentityid, create_counterparty_attribute_request, opts = {})
      data, _status_code, _headers = create_regulated_entity_attribute_with_http_info(regulatedentityid, create_counterparty_attribute_request, opts)
      data
    end
    ...
    # @param create_counterparty_attribute_request [CreateCounterpartyAttributeRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetRegulatedEntityAttributeById200Response, Integer, Hash)>] GetRegulatedEntityAttributeById200Response data, response status code and response headers
    def create_regulated_entity_attribute_with_http_info(regulatedentityid, create_counterparty_attribute_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_regulated_entity_attribute ...'
      end
      # verify the required parameter 'regulatedentityid' is set
      if @api_client.config.client_side_validation && regulatedentityid.nil?
        fail ArgumentError, "Missing the required parameter 'regulatedentityid' when calling APIApi.create_regulated_entity_attribute"
      end
      # verify the required parameter 'create_counterparty_attribute_request' is set
      if @api_client.config.client_side_validation && create_counterparty_attribute_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_counterparty_attribute_request' when calling APIApi.create_regulated_entity_attribute"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetRegulatedEntityAttributeById200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.create_regulated_entity_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_regulated_entity_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_system_dynamic_entity_with_http_info(create_system_dynamic_entity_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_system_dynamic_entity ...'
      end
      # verify the required parameter 'create_system_dynamic_entity_request' is set
      if @api_client.config.client_side_validation && create_system_dynamic_entity_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_system_dynamic_entity_request' when calling APIApi.create_system_dynamic_entity"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.create_system_dynamic_entity",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_system_dynamic_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [UpdateSystemLevelEndpointTag200Response]
    def create_system_level_endpoint_tag(operationid, update_system_level_endpoint_tag_request, opts = {})
      data, _status_code, _headers = create_system_level_endpoint_tag_with_http_info(operationid, update_system_level_endpoint_tag_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateSystemLevelEndpointTag200Response, Integer, Hash)>] UpdateSystemLevelEndpointTag200Response data, response status code and response headers
    def create_system_level_endpoint_tag_with_http_info(operationid, update_system_level_endpoint_tag_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.create_system_level_endpoint_tag ...'
      end
      # verify the required parameter 'operationid' is set
      if @api_client.config.client_side_validation && operationid.nil?
        fail ArgumentError, "Missing the required parameter 'operationid' when calling APIApi.create_system_level_endpoint_tag"
      end
      # verify the required parameter 'update_system_level_endpoint_tag_request' is set
      if @api_client.config.client_side_validation && update_system_level_endpoint_tag_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_system_level_endpoint_tag_request' when calling APIApi.create_system_level_endpoint_tag"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.create_system_level_endpoint_tag",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#create_system_level_endpoint_tag\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_api_product_with_http_info(bankid, apiproductcode, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_api_product ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.delete_api_product"
      end
      # verify the required parameter 'apiproductcode' is set
      if @api_client.config.client_side_validation && apiproductcode.nil?
        fail ArgumentError, "Missing the required parameter 'apiproductcode' when calling APIApi.delete_api_product"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/banks/{bankid}/api-products/{apiproductcode}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'apiproductcode' + '}', CGI.escape(apiproductcode.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_api_product",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_api_product\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_api_product_attribute(bankid, apiproductcode, apiproductattributeid, opts = {})
      delete_api_product_attribute_with_http_info(bankid, apiproductcode, apiproductattributeid, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_api_product_attribute_with_http_info(bankid, apiproductcode, apiproductattributeid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_api_product_attribute ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.delete_api_product_attribute"
      end
      # verify the required parameter 'apiproductcode' is set
      if @api_client.config.client_side_validation && apiproductcode.nil?
        fail ArgumentError, "Missing the required parameter 'apiproductcode' when calling APIApi.delete_api_product_attribute"
      end
      ...
      if @api_client.config.client_side_validation && apiproductattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'apiproductattributeid' when calling APIApi.delete_api_product_attribute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_api_product_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_api_product_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_bank_level_dynamic_endpoint_with_http_info(bankid, dynamicendpointid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_bank_level_dynamic_endpoint ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.delete_bank_level_dynamic_endpoint"
      end
      # verify the required parameter 'dynamicendpointid' is set
      if @api_client.config.client_side_validation && dynamicendpointid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicendpointid' when calling APIApi.delete_bank_level_dynamic_endpoint"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_bank_level_dynamic_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_bank_level_dynamic_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_bank_level_dynamic_entity_with_http_info(bankid, dynamicentityid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_bank_level_dynamic_entity ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.delete_bank_level_dynamic_entity"
      end
      # verify the required parameter 'dynamicentityid' is set
      if @api_client.config.client_side_validation && dynamicentityid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicentityid' when calling APIApi.delete_bank_level_dynamic_entity"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_bank_level_dynamic_entity",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_bank_level_dynamic_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_bank_level_endpoint_tag(bankid, operationid, endpointtagid, opts = {})
      data, _status_code, _headers = delete_bank_level_endpoint_tag_with_http_info(bankid, operationid, endpointtagid, opts)
      data
    end
    ...
    def delete_bank_level_endpoint_tag_with_http_info(bankid, operationid, endpointtagid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_bank_level_endpoint_tag ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.delete_bank_level_endpoint_tag"
      end
      # verify the required parameter 'operationid' is set
      if @api_client.config.client_side_validation && operationid.nil?
        fail ArgumentError, "Missing the required parameter 'operationid' when calling APIApi.delete_bank_level_endpoint_tag"
      end
      # verify the required parameter 'endpointtagid' is set
      if @api_client.config.client_side_validation && endpointtagid.nil?
        fail ArgumentError, "Missing the required parameter 'endpointtagid' when calling APIApi.delete_bank_level_endpoint_tag"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_bank_level_endpoint_tag",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_bank_level_endpoint_tag\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_counterparty_attribute_with_http_info(bankid, accountid, counterpartyid, counterpartyattributeid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_counterparty_attribute ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.delete_counterparty_attribute"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling APIApi.delete_counterparty_attribute"
      end
      # verify the required parameter 'counterpartyid' is set
      if @api_client.config.client_side_validation && counterpartyid.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyid' when calling APIApi.delete_counterparty_attribute"
      end
      ...
      if @api_client.config.client_side_validation && counterpartyattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyattributeid' when calling APIApi.delete_counterparty_attribute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_counterparty_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_counterparty_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_dynamic_endpoint_with_http_info(dynamicendpointid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_dynamic_endpoint ...'
      end
      # verify the required parameter 'dynamicendpointid' is set
      if @api_client.config.client_side_validation && dynamicendpointid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicendpointid' when calling APIApi.delete_dynamic_endpoint"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_dynamic_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_dynamic_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_featured_api_collection(apicollectionid, opts = {})
      delete_featured_api_collection_with_http_info(apicollectionid, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_featured_api_collection_with_http_info(apicollectionid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_featured_api_collection ...'
      end
      # verify the required parameter 'apicollectionid' is set
      if @api_client.config.client_side_validation && apicollectionid.nil?
        fail ArgumentError, "Missing the required parameter 'apicollectionid' when calling APIApi.delete_featured_api_collection"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_featured_api_collection",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_featured_api_collection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_method_routing(methodroutingid, opts = {})
      delete_method_routing_with_http_info(methodroutingid, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_method_routing_with_http_info(methodroutingid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_method_routing ...'
      end
      # verify the required parameter 'methodroutingid' is set
      if @api_client.config.client_side_validation && methodroutingid.nil?
        fail ArgumentError, "Missing the required parameter 'methodroutingid' when calling APIApi.delete_method_routing"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_method_routing",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_method_routing\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_my_dynamic_endpoint_with_http_info(dynamicendpointid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_my_dynamic_endpoint ...'
      end
      # verify the required parameter 'dynamicendpointid' is set
      if @api_client.config.client_side_validation && dynamicendpointid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicendpointid' when calling APIApi.delete_my_dynamic_endpoint"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_my_dynamic_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_my_dynamic_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_my_dynamic_entity_with_http_info(dynamicentityid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_my_dynamic_entity ...'
      end
      # verify the required parameter 'dynamicentityid' is set
      if @api_client.config.client_side_validation && dynamicentityid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicentityid' when calling APIApi.delete_my_dynamic_entity"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_my_dynamic_entity",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_my_dynamic_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_regulated_entity(regulatedentityid, opts = {})
      delete_regulated_entity_with_http_info(regulatedentityid, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_regulated_entity_with_http_info(regulatedentityid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_regulated_entity ...'
      end
      # verify the required parameter 'regulatedentityid' is set
      if @api_client.config.client_side_validation && regulatedentityid.nil?
        fail ArgumentError, "Missing the required parameter 'regulatedentityid' when calling APIApi.delete_regulated_entity"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_regulated_entity",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_regulated_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_regulated_entity_attribute(regulatedentityid, regulatedentityattributeid, opts = {})
      delete_regulated_entity_attribute_with_http_info(regulatedentityid, regulatedentityattributeid, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_regulated_entity_attribute_with_http_info(regulatedentityid, regulatedentityattributeid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_regulated_entity_attribute ...'
      end
      # verify the required parameter 'regulatedentityid' is set
      if @api_client.config.client_side_validation && regulatedentityid.nil?
        fail ArgumentError, "Missing the required parameter 'regulatedentityid' when calling APIApi.delete_regulated_entity_attribute"
      end
      ...
      if @api_client.config.client_side_validation && regulatedentityattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'regulatedentityattributeid' when calling APIApi.delete_regulated_entity_attribute"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_regulated_entity_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_regulated_entity_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_system_dynamic_entity_with_http_info(dynamicentityid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_system_dynamic_entity ...'
      end
      # verify the required parameter 'dynamicentityid' is set
      if @api_client.config.client_side_validation && dynamicentityid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicentityid' when calling APIApi.delete_system_dynamic_entity"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_system_dynamic_entity",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_system_dynamic_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_system_dynamic_entity_cascade_with_http_info(dynamicentityid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_system_dynamic_entity_cascade ...'
      end
      # verify the required parameter 'dynamicentityid' is set
      if @api_client.config.client_side_validation && dynamicentityid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicentityid' when calling APIApi.delete_system_dynamic_entity_cascade"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_system_dynamic_entity_cascade",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_system_dynamic_entity_cascade\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [DeleteSystemLevelEndpointTag200Response]
    def delete_system_level_endpoint_tag(operationid, endpointtagid, opts = {})
      data, _status_code, _headers = delete_system_level_endpoint_tag_with_http_info(operationid, endpointtagid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(DeleteSystemLevelEndpointTag200Response, Integer, Hash)>] DeleteSystemLevelEndpointTag200Response data, response status code and response headers
    def delete_system_level_endpoint_tag_with_http_info(operationid, endpointtagid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.delete_system_level_endpoint_tag ...'
      end
      # verify the required parameter 'operationid' is set
      if @api_client.config.client_side_validation && operationid.nil?
        fail ArgumentError, "Missing the required parameter 'operationid' when calling APIApi.delete_system_level_endpoint_tag"
      end
      # verify the required parameter 'endpointtagid' is set
      if @api_client.config.client_side_validation && endpointtagid.nil?
        fail ArgumentError, "Missing the required parameter 'endpointtagid' when calling APIApi.delete_system_level_endpoint_tag"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.delete_system_level_endpoint_tag",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#delete_system_level_endpoint_tag\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def elastic_search_metrics_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.elastic_search_metrics ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.elastic_search_metrics",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#elastic_search_metrics\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_adapter_info(opts = {})
      data, _status_code, _headers = get_adapter_info_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get basic information about the Adapter.&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;backend_messages&lt;/strong&gt;&lt;/a&gt;: backend_messages&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;date&lt;/strong&gt;&lt;/a&gt;: 2020-01-27&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#errorCode\&quot;&gt;&lt;strong&gt;errorCode&lt;/strong&gt;&lt;/a&gt;: errorCode&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;git_commit&lt;/strong&gt;&lt;/a&gt;: 59623811dd8a41f6ffe67be46954eee11913dc28&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#name\&quot;&gt;&lt;strong&gt;name&lt;/strong&gt;&lt;/a&gt;: ACCOUNT_MANAGEMENT_FEE&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;source&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#status\&quot;&gt;&lt;strong&gt;status&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#text\&quot;&gt;&lt;strong&gt;text&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;total_duration&lt;/strong&gt;&lt;/a&gt;: total_duration&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#version\&quot;&gt;&lt;strong&gt;version&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#duration\&quot;&gt;duration&lt;/a&gt;: 5.123&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAdapterInfo200Response, Integer, Hash)>] GetAdapterInfo200Response data, response status code and response headers
    def get_adapter_info_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_adapter_info ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetAdapterInfo200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_adapter_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_adapter_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_adapter_info_for_bank(bankid, opts = {})
      data, _status_code, _headers = get_adapter_info_for_bank_with_http_info(bankid, opts)
      data
    end
    ...
    # @param bankid [String] The BANKID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetMapperDatabaseInfo200Response, Integer, Hash)>] GetMapperDatabaseInfo200Response data, response status code and response headers
    def get_adapter_info_for_bank_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_adapter_info_for_bank ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_adapter_info_for_bank"
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetMapperDatabaseInfo200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_adapter_info_for_bank",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_adapter_info_for_bank\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_all_counterparty_attributes_with_http_info(bankid, accountid, counterpartyid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_all_counterparty_attributes ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_all_counterparty_attributes"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling APIApi.get_all_counterparty_attributes"
      end
      # verify the required parameter 'counterpartyid' is set
      if @api_client.config.client_side_validation && counterpartyid.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyid' when calling APIApi.get_all_counterparty_attributes"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/banks/{bankid}/accounts/{accountid}/counterparties/{counterpartyid}/attributes'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'counterpartyid' + '}', CGI.escape(counterpartyid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_all_counterparty_attributes",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_all_counterparty_attributes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_all_regulated_entity_attributes(regulatedentityid, opts = {})
      data, _status_code, _headers = get_all_regulated_entity_attributes_with_http_info(regulatedentityid, opts)
      data
    end
    ...
    # @param regulatedentityid [String] The REGULATEDENTITYID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAllRegulatedEntityAttributes200Response, Integer, Hash)>] GetAllRegulatedEntityAttributes200Response data, response status code and response headers
    def get_all_regulated_entity_attributes_with_http_info(regulatedentityid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_all_regulated_entity_attributes ...'
      end
      # verify the required parameter 'regulatedentityid' is set
      if @api_client.config.client_side_validation && regulatedentityid.nil?
        fail ArgumentError, "Missing the required parameter 'regulatedentityid' when calling APIApi.get_all_regulated_entity_attributes"
      end
      # resource path
      local_var_path = '/obp/v5.1.0/regulated-entities/{regulatedentityid}/attributes'.sub('{' + 'regulatedentityid' + '}', CGI.escape(regulatedentityid.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetAllRegulatedEntityAttributes200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_all_regulated_entity_attributes",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_all_regulated_entity_attributes\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_api_product_with_http_info(bankid, apiproductcode, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_api_product ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_api_product"
      end
      # verify the required parameter 'apiproductcode' is set
      if @api_client.config.client_side_validation && apiproductcode.nil?
        fail ArgumentError, "Missing the required parameter 'apiproductcode' when calling APIApi.get_api_product"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/banks/{bankid}/api-products/{apiproductcode}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'apiproductcode' + '}', CGI.escape(apiproductcode.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_api_product",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_api_product\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [CreateApiProductAttribute200Response]
    def get_api_product_attribute(bankid, apiproductcode, apiproductattributeid, opts = {})
      data, _status_code, _headers = get_api_product_attribute_with_http_info(bankid, apiproductcode, apiproductattributeid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateApiProductAttribute200Response, Integer, Hash)>] CreateApiProductAttribute200Response data, response status code and response headers
    def get_api_product_attribute_with_http_info(bankid, apiproductcode, apiproductattributeid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_api_product_attribute ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_api_product_attribute"
      end
      # verify the required parameter 'apiproductcode' is set
      if @api_client.config.client_side_validation && apiproductcode.nil?
        fail ArgumentError, "Missing the required parameter 'apiproductcode' when calling APIApi.get_api_product_attribute"
      end
      # verify the required parameter 'apiproductattributeid' is set
      if @api_client.config.client_side_validation && apiproductattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'apiproductattributeid' when calling APIApi.get_api_product_attribute"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/banks/{bankid}/api-products/{apiproductcode}/attributes/{apiproductattributeid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'apiproductcode' + '}', CGI.escape(apiproductcode.to_s)).sub('{' + 'apiproductattributeid' + '}', CGI.escape(apiproductattributeid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_api_product_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_api_product_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_api_products_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_api_products ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_api_products"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_api_products",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_api_products\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_api_tags(opts = {})
      data, _status_code, _headers = get_api_tags_with_http_info(opts)
      data
    end
    ...
    def get_api_tags_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_api_tags ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_api_tags\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_app_directory(opts = {})
      data, _status_code, _headers = get_app_directory_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get connectivity information for apps in the OBP ecosystem.&lt;/p&gt; &lt;p&gt;Returns configuration properties that apps (Portal, API Explorer, API Manager,&lt;br /&gt; Sandbox Populator, OIDC, Keycloak, Hola, MCP, Opey) and agents can use to discover&lt;br /&gt; endpoints in the OBP ecosystem.&lt;/p&gt; &lt;p&gt;Any props starting with public_ and ending with _url are included automatically.&lt;/p&gt; &lt;p&gt;Known public app URL props:&lt;br /&gt; public_keycloak_url, public_obp_api_explorer_url, public_obp_api_manager_url, public_obp_api_url, public_obp_hola_url, public_obp_mcp_url, public_obp_oidc_url, public_obp_opey_url, public_obp_portal_url, public_obp_sandbox_populator_url, public_rabbit_cats_adapter_url&lt;/p&gt; &lt;p&gt;Empty (unconfigured) values are excluded from the response.&lt;/p&gt; &lt;p&gt;Authentication is NOT Required.&lt;/p&gt; &lt;p&gt;User Authentication is Optional. The User need not be logged in.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#name\&quot;&gt;&lt;strong&gt;name&lt;/strong&gt;&lt;/a&gt;: ACCOUNT_MANAGEMENT_FEE&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;value&lt;/strong&gt;&lt;/a&gt;: 5987953&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetAppDirectory200Response, Integer, Hash)>] GetAppDirectory200Response data, response status code and response headers
    def get_app_directory_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_app_directory ...'
      end
      # resource path
      local_var_path = '/obp/v6.0.0/app-directory'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetAppDirectory200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_app_directory",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_app_directory\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_available_personal_dynamic_entities_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_available_personal_dynamic_entities ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_available_personal_dynamic_entities",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_available_personal_dynamic_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_bank_level_dynamic_endpoint_with_http_info(bankid, dynamicendpointid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_bank_level_dynamic_endpoint ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_bank_level_dynamic_endpoint"
      end
      # verify the required parameter 'dynamicendpointid' is set
      if @api_client.config.client_side_validation && dynamicendpointid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicendpointid' when calling APIApi.get_bank_level_dynamic_endpoint"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/management/banks/{bankid}/dynamic-endpoints/{dynamicendpointid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'dynamicendpointid' + '}', CGI.escape(dynamicendpointid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_bank_level_dynamic_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_bank_level_dynamic_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_bank_level_dynamic_endpoints_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_bank_level_dynamic_endpoints ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_bank_level_dynamic_endpoints"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/management/banks/{bankid}/dynamic-endpoints'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_bank_level_dynamic_endpoints",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_bank_level_dynamic_endpoints\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_bank_level_dynamic_entities_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_bank_level_dynamic_entities ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_bank_level_dynamic_entities"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/management/banks/{bankid}/dynamic-entities'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_bank_level_dynamic_entities",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_bank_level_dynamic_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def get_bank_level_dynamic_resource_docs_obp(bankid, apiversion, opts = {})
      get_bank_level_dynamic_resource_docs_obp_with_http_info(bankid, apiversion, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def get_bank_level_dynamic_resource_docs_obp_with_http_info(bankid, apiversion, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_bank_level_dynamic_resource_docs_obp ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_bank_level_dynamic_resource_docs_obp"
      end
      # verify the required parameter 'apiversion' is set
      if @api_client.config.client_side_validation && apiversion.nil?
        fail ArgumentError, "Missing the required parameter 'apiversion' when calling APIApi.get_bank_level_dynamic_resource_docs_obp"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_bank_level_dynamic_resource_docs_obp",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_bank_level_dynamic_resource_docs_obp\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_bank_level_endpoint_tags(bankid, operationid, opts = {})
      data, _status_code, _headers = get_bank_level_endpoint_tags_with_http_info(bankid, operationid, opts)
      data
    end
    ...
    # @param operationid [String] The OPERATIONID identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetBankLevelEndpointTags200Response, Integer, Hash)>] GetBankLevelEndpointTags200Response data, response status code and response headers
    def get_bank_level_endpoint_tags_with_http_info(bankid, operationid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_bank_level_endpoint_tags ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_bank_level_endpoint_tags"
      end
      # verify the required parameter 'operationid' is set
      if @api_client.config.client_side_validation && operationid.nil?
        fail ArgumentError, "Missing the required parameter 'operationid' when calling APIApi.get_bank_level_endpoint_tags"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/management/banks/{bankid}/endpoints/{operationid}/tags'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'operationid' + '}', CGI.escape(operationid.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetBankLevelEndpointTags200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_bank_level_endpoint_tags",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_bank_level_endpoint_tags\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_cache_config(opts = {})
      data, _status_code, _headers = get_cache_config_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Returns cache configuration information including:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;Redis status: availability, connection details (URL, port, SSL)&lt;/li&gt; &lt;li&gt;In-memory cache status: availability and current size&lt;/li&gt; &lt;li&gt;Instance ID and environment&lt;/li&gt; &lt;li&gt;Global cache namespace prefix&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;This helps understand what cache backend is being used and how it&#39;s configured.&lt;/p&gt; &lt;p&gt;Authentication is Required&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;available&lt;/strong&gt;&lt;/a&gt;: available&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;current_size&lt;/strong&gt;&lt;/a&gt;: current_size&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;environment&lt;/strong&gt;&lt;/a&gt;: environment&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;global_prefix&lt;/strong&gt;&lt;/a&gt;: global_prefix&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;in_memory_status&lt;/strong&gt;&lt;/a&gt;: in_memory_status&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;instance_id&lt;/strong&gt;&lt;/a&gt;: instance_id&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;port&lt;/strong&gt;&lt;/a&gt;: port&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;redis_status&lt;/strong&gt;&lt;/a&gt;: redis_status&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;url&lt;/strong&gt;&lt;/a&gt;: &lt;a href&#x3D;\&quot;http://www.example.com/id-docs/123/image.png\&quot;&gt;http://www.example.com/id-docs/123/image.png&lt;/a&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;use_ssl&lt;/strong&gt;&lt;/a&gt;: use_ssl&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetCacheConfig200Response, Integer, Hash)>] GetCacheConfig200Response data, response status code and response headers
    def get_cache_config_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_cache_config ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetCacheConfig200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_cache_config",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_cache_config\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_cache_info(opts = {})
      data, _status_code, _headers = get_cache_info_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Returns detailed cache information for all namespaces:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;Namespace ID and versioned prefix&lt;/li&gt; &lt;li&gt;Current version counter&lt;/li&gt; &lt;li&gt;Number of keys in each namespace&lt;/li&gt; &lt;li&gt;Description and category&lt;/li&gt; &lt;li&gt;Storage location (redis, memory, both, or unknown)&lt;/li&gt; &lt;li&gt;&amp;quot;redis&amp;quot;: Keys stored in Redis&lt;/li&gt; &lt;li&gt;&amp;quot;memory&amp;quot;: Keys stored in in-memory cache&lt;/li&gt; &lt;li&gt;&amp;quot;both&amp;quot;: Keys in both locations (indicates a BUG - should never happen)&lt;/li&gt; &lt;li&gt;&amp;quot;unknown&amp;quot;: No keys found, storage location cannot be determined&lt;/li&gt; &lt;li&gt;TTL info: Sampled TTL information from actual keys&lt;/li&gt; &lt;li&gt;Shows actual TTL values from up to 5 sample keys&lt;/li&gt; &lt;li&gt;Format: &amp;quot;123s&amp;quot; (fixed), &amp;quot;range 60s to 3600s (avg 1800s)&amp;quot; (variable), &amp;quot;no expiry&amp;quot; (persistent)&lt;/li&gt; &lt;li&gt;Total key count across all namespaces&lt;/li&gt; &lt;li&gt;Redis availability status&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;This endpoint helps monitor cache usage and identify which namespaces contain the most data.&lt;/p&gt; &lt;p&gt;Authentication is Required&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#category\&quot;&gt;&lt;strong&gt;category&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;current_version&lt;/strong&gt;&lt;/a&gt;: current_version&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#description\&quot;&gt;&lt;strong&gt;description&lt;/strong&gt;&lt;/a&gt;: Description of the object. Maximum length is 2000. It can be any characters here.&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;key_count&lt;/strong&gt;&lt;/a&gt;: key_count&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;namespace_id&lt;/strong&gt;&lt;/a&gt;: namespace_id&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;namespaces&lt;/strong&gt;&lt;/a&gt;: namespaces&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;prefix&lt;/strong&gt;&lt;/a&gt;: prefix&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;redis_available&lt;/strong&gt;&lt;/a&gt;: redis_available&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;storage_location&lt;/strong&gt;&lt;/a&gt;: storage_location&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;total_keys&lt;/strong&gt;&lt;/a&gt;: total_keys&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;ttl_info&lt;/strong&gt;&lt;/a&gt;: ttl_info&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetCacheInfo200Response, Integer, Hash)>] GetCacheInfo200Response data, response status code and response headers
    def get_cache_info_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_cache_info ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetCacheInfo200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_cache_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_cache_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_cache_namespaces(opts = {})
      data, _status_code, _headers = get_cache_namespaces_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Returns information about all cache namespaces in the system.&lt;/p&gt; &lt;p&gt;This endpoint provides visibility into:&lt;br /&gt; * Cache namespace prefixes and their purposes&lt;br /&gt; * Number of keys in each namespace&lt;br /&gt; * TTL configurations&lt;br /&gt; * Example keys for each namespace&lt;/p&gt; &lt;p&gt;This is useful for:&lt;br /&gt; * Monitoring cache usage&lt;br /&gt; * Understanding cache structure&lt;br /&gt; * Debugging cache-related issues&lt;br /&gt; * Planning cache management operations&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#category\&quot;&gt;&lt;strong&gt;category&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#description\&quot;&gt;&lt;strong&gt;description&lt;/strong&gt;&lt;/a&gt;: Description of the object. Maximum length is 2000. It can be any characters here.&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;example_key&lt;/strong&gt;&lt;/a&gt;: example_key&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;key_count&lt;/strong&gt;&lt;/a&gt;: key_count&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;namespaces&lt;/strong&gt;&lt;/a&gt;: namespaces&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;prefix&lt;/strong&gt;&lt;/a&gt;: prefix&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;ttl_seconds&lt;/strong&gt;&lt;/a&gt;: ttl_seconds&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetCacheNamespaces200Response, Integer, Hash)>] GetCacheNamespaces200Response data, response status code and response headers
    def get_cache_namespaces_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_cache_namespaces ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetCacheNamespaces200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_cache_namespaces",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_cache_namespaces\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def get_call_context(opts = {})
      get_call_context_with_http_info(opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def get_call_context_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_call_context ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_call_context",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_call_context\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_config_props(opts = {})
      data, _status_code, _headers = get_config_props_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get the active configuration properties and their runtime values.&lt;/p&gt; &lt;p&gt;This endpoint uses a self-registration mechanism: each time the code calls&lt;br /&gt; getPropsValue, getPropsAsBoolValue, getPropsAsIntValue, or getPropsAsLongValue&lt;br /&gt; with a default value, that property key is registered.&lt;/p&gt; &lt;p&gt;Only registered properties are returned. The list grows as more code paths are&lt;br /&gt; exercised. Most properties are registered at startup.&lt;/p&gt; &lt;p&gt;For each property, the value shown is the actual runtime value. If the property&lt;br /&gt; is not explicitly set, the code-defined default is shown.&lt;/p&gt; &lt;p&gt;The response includes both regular and webui_ properties, sorted alphabetically by key.&lt;/p&gt; &lt;p&gt;Properties with sensitive keys or values (containing password, secret, passphrase, credential, token, key, authorization, jdbc)&lt;br /&gt; are excluded from the response entirely.&lt;/p&gt; &lt;p&gt;Authentication is Required.&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#name\&quot;&gt;&lt;strong&gt;name&lt;/strong&gt;&lt;/a&gt;: ACCOUNT_MANAGEMENT_FEE&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;value&lt;/strong&gt;&lt;/a&gt;: 5987953&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetConfigProps200Response, Integer, Hash)>] GetConfigProps200Response data, response status code and response headers
    def get_config_props_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_config_props ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetConfigProps200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_config_props",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_config_props\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_connector_call_counts_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_connector_call_counts ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_connector_call_counts",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_connector_call_counts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_connector_method_names(opts = {})
      data, _status_code, _headers = get_connector_method_names_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get the list of all available connector method names.&lt;/p&gt; &lt;p&gt;These are the method names that can be used in Method Routing configuration.&lt;/p&gt; &lt;h2&gt;&lt;a href&#x3D;\&quot;#data-source\&quot; id&#x3D;\&quot;data-source\&quot;&gt;Data Source&lt;/a&gt;&lt;/h2&gt; &lt;p&gt;The data comes from &lt;strong&gt;scanning the actual Scala connector code at runtime&lt;/strong&gt; using reflection, NOT from a database or configuration file.&lt;/p&gt; &lt;p&gt;The endpoint:&lt;br /&gt; 1. Reads the connector name from props (e.g., &lt;code&gt;connector&#x3D;mapped&lt;/code&gt;)&lt;br /&gt; 2. Gets the connector instance (e.g., LocalMappedConnector, KafkaConnector, StarConnector)&lt;br /&gt; 3. Uses Scala reflection to scan all public methods that override the base Connector trait&lt;br /&gt; 4. Filters for valid connector methods (public, has parameters, overrides base trait)&lt;br /&gt; 5. Returns the method names as a sorted list&lt;/p&gt; &lt;h2&gt;&lt;a href&#x3D;\&quot;#which-connector\&quot; id&#x3D;\&quot;which-connector\&quot;&gt;Which Connector?&lt;/a&gt;&lt;/h2&gt; &lt;p&gt;Depends on your &lt;code&gt;connector&lt;/code&gt; property:&lt;br /&gt; * &lt;code&gt;connector&#x3D;mapped&lt;/code&gt; → Returns methods from LocalMappedConnector&lt;br /&gt; * &lt;code&gt;connector&#x3D;kafka_vSept2018&lt;/code&gt; → Returns methods from KafkaConnector&lt;br /&gt; * &lt;code&gt;connector&#x3D;star&lt;/code&gt; → Returns methods from StarConnector&lt;br /&gt; * &lt;code&gt;connector&#x3D;rest_vMar2019&lt;/code&gt; → Returns methods from RestConnector&lt;/p&gt; &lt;h2&gt;&lt;a href&#x3D;\&quot;#when-does-it-change\&quot; id&#x3D;\&quot;when-does-it-change\&quot;&gt;When Does It Change?&lt;/a&gt;&lt;/h2&gt; &lt;p&gt;The list only changes when:&lt;br /&gt; * Code is deployed with new/modified connector methods&lt;br /&gt; * The &lt;code&gt;connector&lt;/code&gt; property is changed to point to a different connector&lt;/p&gt; &lt;h2&gt;&lt;a href&#x3D;\&quot;#performance\&quot; id&#x3D;\&quot;performance\&quot;&gt;Performance&lt;/a&gt;&lt;/h2&gt; &lt;p&gt;This endpoint uses caching (default: 1 hour) because Scala reflection is expensive.&lt;br /&gt; Configure via: &lt;code&gt;getConnectorMethodNames.cache.ttl.seconds&#x3D;3600&lt;/code&gt;&lt;/p&gt; &lt;h2&gt;&lt;a href&#x3D;\&quot;#use-case\&quot; id&#x3D;\&quot;use-case\&quot;&gt;Use Case&lt;/a&gt;&lt;/h2&gt; &lt;p&gt;Use this endpoint to discover which connector methods are available when configuring Method Routing.&lt;br /&gt; These method names are different from API endpoint operation IDs (which you get from /resource-docs).&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;CanGetSystemConnectorMethodNames entitlement is required.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;connector_method_names&lt;/strong&gt;&lt;/a&gt;: connector_method_names&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetConnectorMethodNames200Response, Integer, Hash)>] GetConnectorMethodNames200Response data, response status code and response headers
    def get_connector_method_names_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_connector_method_names ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetConnectorMethodNames200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_connector_method_names",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_connector_method_names\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_connector_metrics_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_connector_metrics ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_connector_metrics",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_connector_metrics\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_connector_traces_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_connector_traces ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_connector_traces",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_connector_traces\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # &lt;p&gt;Get the list of connectors and their availability for method routing.&lt;/p&gt; &lt;p&gt;Returns a sorted list of all connectors with their availability status for use in Method Routing.&lt;/p&gt; &lt;h2&gt;&lt;a href&#x3D;\&quot;#response-fields\&quot; id&#x3D;\&quot;response-fields\&quot;&gt;Response Fields&lt;/a&gt;&lt;/h2&gt; &lt;ul&gt; &lt;li&gt;&lt;strong&gt;connector_name&lt;/strong&gt; - The name of the connector&lt;/li&gt; &lt;li&gt;&lt;strong&gt;is_available_in_method_routing&lt;/strong&gt; - Whether this connector can be used in Method Routing configuration.&lt;br /&gt; This depends on the &lt;code&gt;connector&lt;/code&gt; and &lt;code&gt;starConnector_supported_types&lt;/code&gt; props settings.&lt;/li&gt; &lt;/ul&gt; &lt;h2&gt;&lt;a href&#x3D;\&quot;#available-connectors\&quot; id&#x3D;\&quot;available-connectors\&quot;&gt;Available Connectors&lt;/a&gt;&lt;/h2&gt; &lt;p&gt;The OBP-API supports multiple connectors for accessing banking data:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;&lt;strong&gt;mapped&lt;/strong&gt; - Local database connector using Lift Mapper ORM&lt;/li&gt; &lt;li&gt;&lt;strong&gt;akka_vDec2018&lt;/strong&gt; - Akka-based connector for remote banking systems&lt;/li&gt; &lt;li&gt;&lt;strong&gt;rest_vMar2019&lt;/strong&gt; - REST connector for external APIs&lt;/li&gt; &lt;li&gt;&lt;strong&gt;stored_procedure_vDec2019&lt;/strong&gt; - Stored procedure connector for database-native operations&lt;/li&gt; &lt;li&gt;&lt;strong&gt;rabbitmq_vOct2024&lt;/strong&gt; - RabbitMQ message queue connector&lt;/li&gt; &lt;li&gt;&lt;strong&gt;cardano_vJun2025&lt;/strong&gt; - Cardano blockchain connector&lt;/li&gt; &lt;li&gt;&lt;strong&gt;ethereum_vSept2025&lt;/strong&gt; - Ethereum blockchain connector&lt;/li&gt; &lt;li&gt;&lt;strong&gt;star&lt;/strong&gt; - Star connector (special routing connector)&lt;/li&gt; &lt;li&gt;&lt;strong&gt;proxy&lt;/strong&gt; - Proxy connector (for testing)&lt;/li&gt; &lt;li&gt;&lt;strong&gt;internal&lt;/strong&gt; - Internal dynamic connector&lt;/li&gt; &lt;/ul&gt; &lt;h2&gt;&lt;a href&#x3D;\&quot;#use-case\&quot; id&#x3D;\&quot;use-case\&quot;&gt;Use Case&lt;/a&gt;&lt;/h2&gt; &lt;p&gt;Use this endpoint to discover which connectors are available when configuring Method Routing.&lt;br /&gt; A connector is available for method routing if it matches the &lt;code&gt;connector&lt;/code&gt; prop setting,&lt;br /&gt; or if &lt;code&gt;connector&#x3D;star&lt;/code&gt; and the connector is listed in &lt;code&gt;starConnector_supported_types&lt;/code&gt;.&lt;/p&gt; &lt;p&gt;Authentication is Optional.&lt;/p&gt; &lt;p&gt;User Authentication is Optional. The User need not be logged in.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#connector_name\&quot;&gt;&lt;strong&gt;connector_name&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;connectors&lt;/strong&gt;&lt;/a&gt;: connectors&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;is_available_in_method_routing&lt;/strong&gt;&lt;/a&gt;: is_available_in_method_routing&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetConnectors200Response, Integer, Hash)>] GetConnectors200Response data, response status code and response headers
    def get_connectors_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_connectors ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetConnectors200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"APIApi.get_connectors",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_connectors\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_counterparty_attribute_by_id_with_http_info(bankid, accountid, counterpartyid, counterpartyattributeid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_counterparty_attribute_by_id ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_counterparty_attribute_by_id"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling APIApi.get_counterparty_attribute_by_id"
      end
      # verify the required parameter 'counterpartyid' is set
      if @api_client.config.client_side_validation && counterpartyid.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyid' when calling APIApi.get_counterparty_attribute_by_id"
      end
      # verify the required parameter 'counterpartyattributeid' is set
      if @api_client.config.client_side_validation && counterpartyattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyattributeid' when calling APIApi.get_counterparty_attribute_by_id"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/banks/{bankid}/accounts/{accountid}/counterparties/{counterpartyid}/attributes/{counterpartyattributeid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'counterpartyid' + '}', CGI.escape(counterpartyid.to_s)).sub('{' + 'counterpartyattributeid' + '}', CGI.escape(counterpartyattributeid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_counterparty_attribute_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_counterparty_attribute_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_current_consumer(opts = {})
      data, _status_code, _headers = get_current_consumer_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Returns the consumer_id of the current authenticated consumer.&lt;/p&gt; &lt;p&gt;This endpoint requires authentication via:&lt;br /&gt; * User authentication (OAuth, DirectLogin, etc.) - returns the consumer associated with the user&#39;s session&lt;br /&gt; * Consumer/Client authentication - returns the consumer credentials being used&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;active_at_date&lt;/strong&gt;&lt;/a&gt;: active_at_date&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;active_per_day_rate_limit&lt;/strong&gt;&lt;/a&gt;: active_per_day_rate_limit&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;active_per_hour_rate_limit&lt;/strong&gt;&lt;/a&gt;: active_per_hour_rate_limit&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;active_per_minute_rate_limit&lt;/strong&gt;&lt;/a&gt;: active_per_minute_rate_limit&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;active_per_month_rate_limit&lt;/strong&gt;&lt;/a&gt;: active_per_month_rate_limit&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;active_per_second_rate_limit&lt;/strong&gt;&lt;/a&gt;: active_per_second_rate_limit&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;active_per_week_rate_limit&lt;/strong&gt;&lt;/a&gt;: active_per_week_rate_limit&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;active_rate_limits&lt;/strong&gt;&lt;/a&gt;: active_rate_limits&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#app_name\&quot;&gt;&lt;strong&gt;app_name&lt;/strong&gt;&lt;/a&gt;: appNameBank&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#app_type\&quot;&gt;&lt;strong&gt;app_type&lt;/strong&gt;&lt;/a&gt;: Web&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;call_counters&lt;/strong&gt;&lt;/a&gt;: call_counters&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;considered_rate_limit_ids&lt;/strong&gt;&lt;/a&gt;: considered_rate_limit_ids&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;consumer_id&lt;/strong&gt;&lt;/a&gt;: 7uy8a7e4-6d02-40e3-a129-0b2bf89de8uh&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#description\&quot;&gt;&lt;strong&gt;description&lt;/strong&gt;&lt;/a&gt;: Description of the object. Maximum length is 2000. It can be any characters here.&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#per_day\&quot;&gt;&lt;strong&gt;per_day&lt;/strong&gt;&lt;/a&gt;: 4000&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#per_hour\&quot;&gt;&lt;strong&gt;per_hour&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#per_minute\&quot;&gt;&lt;strong&gt;per_minute&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#per_month\&quot;&gt;&lt;strong&gt;per_month&lt;/strong&gt;&lt;/a&gt;: 500&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#per_second\&quot;&gt;&lt;strong&gt;per_second&lt;/strong&gt;&lt;/a&gt;: 1000&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#per_week\&quot;&gt;&lt;strong&gt;per_week&lt;/strong&gt;&lt;/a&gt;: 50000&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#status\&quot;&gt;&lt;strong&gt;status&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#calls_made\&quot;&gt;calls_made&lt;/a&gt;: 50&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#reset_in_seconds\&quot;&gt;reset_in_seconds&lt;/a&gt;:&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetCurrentConsumer200Response, Integer, Hash)>] GetCurrentConsumer200Response data, response status code and response headers
    def get_current_consumer_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_current_consumer ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetCurrentConsumer200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_current_consumer",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_current_consumer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_database_pool_info(opts = {})
      data, _status_code, _headers = get_database_pool_info_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Returns HikariCP connection pool information including:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;Pool name&lt;/li&gt; &lt;li&gt;Active connections: currently in use&lt;/li&gt; &lt;li&gt;Idle connections: available in pool&lt;/li&gt; &lt;li&gt;Total connections: active + idle&lt;/li&gt; &lt;li&gt;Threads awaiting connection: requests waiting for a connection&lt;/li&gt; &lt;li&gt;Configuration: max pool size, min idle, timeouts&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;This helps diagnose connection pool issues such as connection leaks or pool exhaustion.&lt;/p&gt; &lt;p&gt;Authentication is Required&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;active_connections&lt;/strong&gt;&lt;/a&gt;: active_connections&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;connection_timeout_ms&lt;/strong&gt;&lt;/a&gt;: connection_timeout_ms&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;idle_connections&lt;/strong&gt;&lt;/a&gt;: idle_connections&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;idle_timeout_ms&lt;/strong&gt;&lt;/a&gt;: idle_timeout_ms&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;keepalive_time_ms&lt;/strong&gt;&lt;/a&gt;: keepalive_time_ms&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;max_lifetime_ms&lt;/strong&gt;&lt;/a&gt;: max_lifetime_ms&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;maximum_pool_size&lt;/strong&gt;&lt;/a&gt;: maximum_pool_size&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;minimum_idle&lt;/strong&gt;&lt;/a&gt;: minimum_idle&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;pool_name&lt;/strong&gt;&lt;/a&gt;: pool_name&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;threads_awaiting_connection&lt;/strong&gt;&lt;/a&gt;: threads_awaiting_connection&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;total_connections&lt;/strong&gt;&lt;/a&gt;: total_connections&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDatabasePoolInfo200Response, Integer, Hash)>] GetDatabasePoolInfo200Response data, response status code and response headers
    def get_database_pool_info_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_database_pool_info ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetDatabasePoolInfo200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_database_pool_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_database_pool_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_dynamic_endpoint_with_http_info(dynamicendpointid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_dynamic_endpoint ...'
      end
      # verify the required parameter 'dynamicendpointid' is set
      if @api_client.config.client_side_validation && dynamicendpointid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicendpointid' when calling APIApi.get_dynamic_endpoint"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/management/dynamic-endpoints/{dynamicendpointid}'.sub('{' + 'dynamicendpointid' + '}', CGI.escape(dynamicendpointid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_dynamic_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_dynamic_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_dynamic_endpoints_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_dynamic_endpoints ...'
      end
      # resource path
      local_var_path = '/obp/v4.0.0/management/dynamic-endpoints'
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_dynamic_endpoints",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_dynamic_endpoints\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_dynamic_entity_diagnostics(opts = {})
      data, _status_code, _headers = get_dynamic_entity_diagnostics_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get diagnostic information about Dynamic Entities to help troubleshoot Swagger generation issues.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Use Case:&lt;/strong&gt;&lt;br /&gt; This endpoint is particularly useful when:&lt;br /&gt; * The Swagger endpoint (&lt;code&gt;/obp/v6.0.0/resource-docs/OBPv6.0.0/swagger?content&#x3D;dynamic&lt;/code&gt;) fails with errors like &amp;quot;expected boolean&amp;quot;&lt;br /&gt; * The OBP endpoint (&lt;code&gt;/obp/v6.0.0/resource-docs/OBPv6.0.0/obp?content&#x3D;dynamic&lt;/code&gt;) works fine&lt;br /&gt; * You need to identify which dynamic entity has malformed field definitions&lt;/p&gt; &lt;p&gt;&lt;strong&gt;What It Checks:&lt;/strong&gt;&lt;br /&gt; This endpoint analyzes all dynamic entities (both system and bank level) for:&lt;br /&gt; * Boolean fields with invalid example values (e.g., actual JSON booleans or invalid strings instead of &lt;code&gt;&amp;quot;true&amp;quot;&lt;/code&gt; or &lt;code&gt;&amp;quot;false&amp;quot;&lt;/code&gt;)&lt;br /&gt; * Malformed JSON in field definitions&lt;br /&gt; * Fields that cannot be converted to their declared types&lt;br /&gt; * Other validation issues that cause Swagger generation to fail&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Response Format:&lt;/strong&gt;&lt;br /&gt; The response contains:&lt;br /&gt; * &lt;code&gt;issues&lt;/code&gt; - List of issues found, each with:&lt;br /&gt; * &lt;code&gt;entity_name&lt;/code&gt; - Name of the problematic entity&lt;br /&gt; * &lt;code&gt;bank_id&lt;/code&gt; - Bank ID (or &amp;quot;SYSTEM_LEVEL&amp;quot; for system entities)&lt;br /&gt; * &lt;code&gt;field_name&lt;/code&gt; - Name of the problematic field&lt;br /&gt; * &lt;code&gt;example_value&lt;/code&gt; - The current (invalid) example value&lt;br /&gt; * &lt;code&gt;error_message&lt;/code&gt; - Description of what&#39;s wrong and how to fix it&lt;br /&gt; * &lt;code&gt;total_issues&lt;/code&gt; - Count of total issues found&lt;br /&gt; * &lt;code&gt;scanned_entities&lt;/code&gt; - List of all dynamic entities that were scanned (format: &amp;quot;EntityName (BANK_ID)&amp;quot; or &amp;quot;EntityName (SYSTEM)&amp;quot;)&lt;/p&gt; &lt;p&gt;&lt;strong&gt;How to Fix Issues:&lt;/strong&gt;&lt;br /&gt; 1. Identify the problematic entity from the diagnostic output&lt;br /&gt; 2. Update the entity definition using PUT &lt;code&gt;/management/system-dynamic-entities/DYNAMIC_ENTITY_ID&lt;/code&gt; or PUT &lt;code&gt;/management/banks/BANK_ID/dynamic-entities/DYNAMIC_ENTITY_ID&lt;/code&gt;&lt;br /&gt; 3. For boolean fields, ensure the example value is either &lt;code&gt;&amp;quot;true&amp;quot;&lt;/code&gt; or &lt;code&gt;&amp;quot;false&amp;quot;&lt;/code&gt; (as strings)&lt;br /&gt; 4. Re-run this diagnostic to verify the fix&lt;br /&gt; 5. Check that the Swagger endpoint now works&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Example Issue:&lt;/strong&gt;&lt;/p&gt; &lt;pre&gt;&lt;code&gt;{   &amp;quot;entity_name&amp;quot;: &amp;quot;Customer&amp;quot;,   &amp;quot;bank_id&amp;quot;: &amp;quot;gh.29.uk&amp;quot;,   &amp;quot;field_name&amp;quot;: &amp;quot;is_active&amp;quot;,   &amp;quot;example_value&amp;quot;: &amp;quot;malformed_value&amp;quot;,   &amp;quot;error_message&amp;quot;: &amp;quot;Boolean field has invalid example value. Expected &#39;true&#39; or &#39;false&#39;, got: &#39;malformed_value&#39;&amp;quot; } &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Required Role:&lt;/strong&gt; &lt;code&gt;CanGetDynamicEntityDiagnostics&lt;/code&gt;&lt;/p&gt; &lt;p&gt;If no issues are found, the response will contain an empty issues list with &lt;code&gt;total_issues: 0&lt;/code&gt;, but &lt;code&gt;scanned_entities&lt;/code&gt; will show which entities were checked.&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetDynamicEntityDiagnostics200Response, Integer, Hash)>] GetDynamicEntityDiagnostics200Response data, response status code and response headers
    def get_dynamic_entity_diagnostics_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_dynamic_entity_diagnostics ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetDynamicEntityDiagnostics200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_dynamic_entity_diagnostics",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_dynamic_entity_diagnostics\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_featured_api_collections_admin(opts = {})
      data, _status_code, _headers = get_featured_api_collections_admin_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get all featured API collections with their sort order (admin view).&lt;/p&gt; &lt;p&gt;This endpoint returns the featured collections stored in the database with their sort order.&lt;br /&gt; It is intended for administrators to manage the featured list.&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;api_collection_id&lt;/strong&gt;&lt;/a&gt;: 7uy8a7e4-6d02-40e3-a129-0b2bf89de8uh&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;featured_api_collection_id&lt;/strong&gt;&lt;/a&gt;: 9uy8a7e4-6d02-40e3-a129-0b2bf89de8uh&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;featured_api_collections&lt;/strong&gt;&lt;/a&gt;: featured_api_collections&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;sort_order&lt;/strong&gt;&lt;/a&gt;: 1&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetFeaturedApiCollectionsAdmin200Response, Integer, Hash)>] GetFeaturedApiCollectionsAdmin200Response data, response status code and response headers
    def get_featured_api_collections_admin_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_featured_api_collections_admin ...'
      end
      # resource path
      local_var_path = '/obp/v6.0.0/management/api-collections/featured'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetFeaturedApiCollectionsAdmin200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_featured_api_collections_admin",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_featured_api_collections_admin\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # &lt;p&gt;Returns information about the features enabled on this OBP instance.&lt;/p&gt; &lt;p&gt;No Authentication is Required.&lt;/p&gt; &lt;p&gt;User Authentication is Optional. The User need not be logged in.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_abac_account_access&lt;/strong&gt;&lt;/a&gt;: allow_abac_account_access&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_account_deletion&lt;/strong&gt;&lt;/a&gt;: allow_account_deletion&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_account_firehose&lt;/strong&gt;&lt;/a&gt;: allow_account_firehose&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_customer_firehose&lt;/strong&gt;&lt;/a&gt;: allow_customer_firehose&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_dauth&lt;/strong&gt;&lt;/a&gt;: allow_dauth&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_direct_login&lt;/strong&gt;&lt;/a&gt;: allow_direct_login&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_gateway_login&lt;/strong&gt;&lt;/a&gt;: allow_gateway_login&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_just_in_time_entitlements&lt;/strong&gt;&lt;/a&gt;: allow_just_in_time_entitlements&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_oauth2_login&lt;/strong&gt;&lt;/a&gt;: allow_oauth2_login&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_public_views&lt;/strong&gt;&lt;/a&gt;: allow_public_views&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_sandbox_account_creation&lt;/strong&gt;&lt;/a&gt;: allow_sandbox_account_creation&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;allow_sandbox_data_import&lt;/strong&gt;&lt;/a&gt;: allow_sandbox_data_import&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetFeatures200Response, Integer, Hash)>] GetFeatures200Response data, response status code and response headers
    def get_features_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_features ...'
      end
      # resource path
      local_var_path = '/obp/v6.0.0/features'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetFeatures200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_features",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_features\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetMapperDatabaseInfo200Response]
    def get_mapper_database_info(opts = {})
      data, _status_code, _headers = get_mapper_database_info_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetMapperDatabaseInfo200Response, Integer, Hash)>] GetMapperDatabaseInfo200Response data, response status code and response headers
    def get_mapper_database_info_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_mapper_database_info ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_mapper_database_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_mapper_database_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_message_docs_with_http_info(connector, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_message_docs ...'
      end
      # verify the required parameter 'connector' is set
      if @api_client.config.client_side_validation && connector.nil?
        fail ArgumentError, "Missing the required parameter 'connector' when calling APIApi.get_message_docs"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_message_docs",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_message_docs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_message_docs_json_schema_with_http_info(connector, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_message_docs_json_schema ...'
      end
      # verify the required parameter 'connector' is set
      if @api_client.config.client_side_validation && connector.nil?
        fail ArgumentError, "Missing the required parameter 'connector' when calling APIApi.get_message_docs_json_schema"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_message_docs_json_schema",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_message_docs_json_schema\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_message_docs_swagger_with_http_info(connector, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_message_docs_swagger ...'
      end
      # verify the required parameter 'connector' is set
      if @api_client.config.client_side_validation && connector.nil?
        fail ArgumentError, "Missing the required parameter 'connector' when calling APIApi.get_message_docs_swagger"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_message_docs_swagger",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_message_docs_swagger\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_method_routings(opts = {})
      data, _status_code, _headers = get_method_routings_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get the all MethodRoutings.&lt;/p&gt; &lt;p&gt;Query url parameters:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;method_name: filter with method_name&lt;/li&gt; &lt;li&gt;active: if active &#x3D; true, it will show all the webui_ props. Even if they are set yet, we will return all the default webui_ props&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;eg:&lt;br /&gt; &lt;a href&#x3D;\&quot;http://127.0.0.1:8080/obp/v3.1.0/management/method_routings?active&#x3D;true\&quot;&gt;http://127.0.0.1:8080/obp/v3.1.0/management/method_routings?active&#x3D;true&lt;/a&gt;&lt;br /&gt; &lt;a href&#x3D;\&quot;http://127.0.0.1:8080/obp/v3.1.0/management/method_routings?method_name&#x3D;getBank\&quot;&gt;http://127.0.0.1:8080/obp/v3.1.0/management/method_routings?method_name&#x3D;getBank&lt;/a&gt;&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;key&lt;/strong&gt;&lt;/a&gt;: CustomerNumber&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#parameters\&quot;&gt;&lt;strong&gt;parameters&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;value&lt;/strong&gt;&lt;/a&gt;: 5987953&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetMethodRoutings200Response, Integer, Hash)>] GetMethodRoutings200Response data, response status code and response headers
    def get_method_routings_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_method_routings ...'
      end
      # resource path
      local_var_path = '/obp/v3.1.0/management/method_routings'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetMethodRoutings200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_method_routings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_method_routings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_metrics_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_metrics ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_metrics\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_metrics_at_bank_with_http_info(bankid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_metrics_at_bank ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.get_metrics_at_bank"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_metrics_at_bank",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_metrics_at_bank\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_migrations(opts = {})
      data, _status_code, _headers = get_migrations_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get all database migration script logs.&lt;/p&gt; &lt;p&gt;This endpoint returns information about all migration scripts that have been executed or attempted.&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;CanGetMigrations entitlement is required.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;commit_id&lt;/strong&gt;&lt;/a&gt;: commit_id&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;created_at&lt;/strong&gt;&lt;/a&gt;: created_at&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;duration_in_ms&lt;/strong&gt;&lt;/a&gt;: duration_in_ms&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#end_date\&quot;&gt;&lt;strong&gt;end_date&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;is_successful&lt;/strong&gt;&lt;/a&gt;: is_successful&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;migration_script_log_id&lt;/strong&gt;&lt;/a&gt;: migration_script_log_id&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;migration_script_logs&lt;/strong&gt;&lt;/a&gt;: migration_script_logs&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#name\&quot;&gt;&lt;strong&gt;name&lt;/strong&gt;&lt;/a&gt;: ACCOUNT_MANAGEMENT_FEE&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;remark&lt;/strong&gt;&lt;/a&gt;: remark&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;start_date&lt;/strong&gt;&lt;/a&gt;: 2020-01-27&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;updated_at&lt;/strong&gt;&lt;/a&gt;: updated_at&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetMigrations200Response, Integer, Hash)>] GetMigrations200Response data, response status code and response headers
    def get_migrations_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_migrations ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetMigrations200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_migrations",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_migrations\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_my_dynamic_endpoints_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_my_dynamic_endpoints ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_my_dynamic_endpoints",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_my_dynamic_endpoints\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_my_dynamic_entities_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_my_dynamic_entities ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_my_dynamic_entities",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_my_dynamic_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_o_auth2_server_jwks_uris_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_o_auth2_server_jwks_uris ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_o_auth2_server_jwks_uris",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_o_auth2_server_jwks_uris\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetOAuth2ServerJWKsURIs200Response]
    def get_o_auth2_server_well_known(opts = {})
      data, _status_code, _headers = get_o_auth2_server_well_known_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetOAuth2ServerJWKsURIs200Response, Integer, Hash)>] GetOAuth2ServerJWKsURIs200Response data, response status code and response headers
    def get_o_auth2_server_well_known_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_o_auth2_server_well_known ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_o_auth2_server_well_known",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_o_auth2_server_well_known\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_obp_connector_loopback_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_obp_connector_loopback ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_obp_connector_loopback",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_obp_connector_loopback\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_popular_apis_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_popular_apis ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_popular_apis",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_popular_apis\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_rate_limiting_info(opts = {})
      data, _status_code, _headers = get_rate_limiting_info_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get information about the Rate Limiting setup on this OBP Instance such as:&lt;/p&gt; &lt;p&gt;Is rate limiting enabled and active?&lt;br /&gt; What backend is used to keep track of the API calls (e.g. REDIS).&lt;/p&gt; &lt;p&gt;Note: Rate limiting can be set at the Consumer level and also for anonymous calls.&lt;/p&gt; &lt;p&gt;See the consumer rate limits / call limits endpoints.&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#enabled\&quot;&gt;&lt;strong&gt;enabled&lt;/strong&gt;&lt;/a&gt;: false&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#is_active\&quot;&gt;&lt;strong&gt;is_active&lt;/strong&gt;&lt;/a&gt;: false&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#service_available\&quot;&gt;&lt;strong&gt;service_available&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#technology\&quot;&gt;&lt;strong&gt;technology&lt;/strong&gt;&lt;/a&gt;: technology1&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetRateLimitingInfo200Response, Integer, Hash)>] GetRateLimitingInfo200Response data, response status code and response headers
    def get_rate_limiting_info_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_rate_limiting_info ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetRateLimitingInfo200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_rate_limiting_info",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_rate_limiting_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_reference_types(opts = {})
      data, _status_code, _headers = get_reference_types_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get a list of all available reference types that can be used in Dynamic Entity field definitions.&lt;/p&gt; &lt;p&gt;Reference types allow Dynamic Entity fields to reference other entities (similar to foreign keys).&lt;br /&gt; This endpoint returns both:&lt;br /&gt; * &lt;strong&gt;Static reference types&lt;/strong&gt; - Built-in reference types for core OBP entities (e.g., Customer, Account, Transaction)&lt;br /&gt; * &lt;strong&gt;Dynamic reference types&lt;/strong&gt; - Reference types for Dynamic Entities that have been created&lt;/p&gt; &lt;p&gt;Each reference type includes:&lt;br /&gt; * &lt;code&gt;type_name&lt;/code&gt; - The full reference type string to use in entity definitions (e.g., &amp;quot;reference:Customer&amp;quot;)&lt;br /&gt; * &lt;code&gt;example_value&lt;/code&gt; - An example value showing the correct format&lt;br /&gt; * &lt;code&gt;description&lt;/code&gt; - Description of what the reference type represents&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Use Case:&lt;/strong&gt;&lt;br /&gt; When creating a Dynamic Entity with a field that references another entity, you need to know:&lt;br /&gt; 1. What reference types are available&lt;br /&gt; 2. The correct format for the type name&lt;br /&gt; 3. The correct format for example values&lt;/p&gt; &lt;p&gt;This endpoint provides all that information.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Example Usage:&lt;/strong&gt;&lt;br /&gt; If you want to create a Dynamic Entity with a field that references a Customer, you would:&lt;br /&gt; 1. Call this endpoint to see that &amp;quot;reference:Customer&amp;quot; is available&lt;br /&gt; 2. Use it in your entity definition like:&lt;/p&gt; &lt;pre&gt;&lt;code class&#x3D;\&quot;language-json\&quot;&gt;{   &amp;quot;customer_id&amp;quot;: {     &amp;quot;type&amp;quot;: &amp;quot;reference:Customer&amp;quot;,     &amp;quot;example&amp;quot;: &amp;quot;a8770fca-3d1d-47af-b6d0-7a6c3f124388&amp;quot;   } } &lt;/code&gt;&lt;/pre&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Required Role:&lt;/strong&gt; &lt;code&gt;CanGetDynamicEntityReferenceTypes&lt;/code&gt;&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetReferenceTypes200Response, Integer, Hash)>] GetReferenceTypes200Response data, response status code and response headers
    def get_reference_types_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_reference_types ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetReferenceTypes200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_reference_types",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_reference_types\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetRegulatedEntityAttributeById200Response]
    def get_regulated_entity_attribute_by_id(regulatedentityid, regulatedentityattributeid, opts = {})
      data, _status_code, _headers = get_regulated_entity_attribute_by_id_with_http_info(regulatedentityid, regulatedentityattributeid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetRegulatedEntityAttributeById200Response, Integer, Hash)>] GetRegulatedEntityAttributeById200Response data, response status code and response headers
    def get_regulated_entity_attribute_by_id_with_http_info(regulatedentityid, regulatedentityattributeid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_regulated_entity_attribute_by_id ...'
      end
      # verify the required parameter 'regulatedentityid' is set
      if @api_client.config.client_side_validation && regulatedentityid.nil?
        fail ArgumentError, "Missing the required parameter 'regulatedentityid' when calling APIApi.get_regulated_entity_attribute_by_id"
      end
      # verify the required parameter 'regulatedentityattributeid' is set
      if @api_client.config.client_side_validation && regulatedentityattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'regulatedentityattributeid' when calling APIApi.get_regulated_entity_attribute_by_id"
      end
      # resource path
      local_var_path = '/obp/v5.1.0/regulated-entities/{regulatedentityid}/attributes/{regulatedentityattributeid}'.sub('{' + 'regulatedentityid' + '}', CGI.escape(regulatedentityid.to_s)).sub('{' + 'regulatedentityattributeid' + '}', CGI.escape(regulatedentityattributeid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_regulated_entity_attribute_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_regulated_entity_attribute_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetRegulatedEntityById200Response]
    def get_regulated_entity_by_id(regulatedentityid, opts = {})
      data, _status_code, _headers = get_regulated_entity_by_id_with_http_info(regulatedentityid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetRegulatedEntityById200Response, Integer, Hash)>] GetRegulatedEntityById200Response data, response status code and response headers
    def get_regulated_entity_by_id_with_http_info(regulatedentityid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_regulated_entity_by_id ...'
      end
      # verify the required parameter 'regulatedentityid' is set
      if @api_client.config.client_side_validation && regulatedentityid.nil?
        fail ArgumentError, "Missing the required parameter 'regulatedentityid' when calling APIApi.get_regulated_entity_by_id"
      end
      # resource path
      local_var_path = '/obp/v5.1.0/regulated-entities/{regulatedentityid}'.sub('{' + 'regulatedentityid' + '}', CGI.escape(regulatedentityid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_regulated_entity_by_id",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_regulated_entity_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def get_resource_docs_obp(apiversion, opts = {})
      get_resource_docs_obp_with_http_info(apiversion, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def get_resource_docs_obp_with_http_info(apiversion, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_resource_docs_obp ...'
      end
      # verify the required parameter 'apiversion' is set
      if @api_client.config.client_side_validation && apiversion.nil?
        fail ArgumentError, "Missing the required parameter 'apiversion' when calling APIApi.get_resource_docs_obp"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_resource_docs_obp",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_resource_docs_obp\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def get_resource_docs_open_api31(apiversion, opts = {})
      get_resource_docs_open_api31_with_http_info(apiversion, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def get_resource_docs_open_api31_with_http_info(apiversion, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_resource_docs_open_api31 ...'
      end
      # verify the required parameter 'apiversion' is set
      if @api_client.config.client_side_validation && apiversion.nil?
        fail ArgumentError, "Missing the required parameter 'apiversion' when calling APIApi.get_resource_docs_open_api31"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_resource_docs_open_api31",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_resource_docs_open_api31\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def get_resource_docs_swagger(apiversion, opts = {})
      get_resource_docs_swagger_with_http_info(apiversion, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def get_resource_docs_swagger_with_http_info(apiversion, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_resource_docs_swagger ...'
      end
      # verify the required parameter 'apiversion' is set
      if @api_client.config.client_side_validation && apiversion.nil?
        fail ArgumentError, "Missing the required parameter 'apiversion' when calling APIApi.get_resource_docs_swagger"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_resource_docs_swagger",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_resource_docs_swagger\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_scanned_api_versions(opts = {})
      data, _status_code, _headers = get_scanned_api_versions_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get all scanned API versions available in this codebase.&lt;/p&gt; &lt;p&gt;This endpoint returns all API versions that have been discovered/scanned, along with their active status.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;Response Fields:&lt;/strong&gt;&lt;/p&gt; &lt;ul&gt; &lt;li&gt;&lt;code&gt;url_prefix&lt;/code&gt;: The URL prefix for the version (e.g., &amp;quot;obp&amp;quot;, &amp;quot;berlin-group&amp;quot;, &amp;quot;open-banking&amp;quot;)&lt;/li&gt; &lt;li&gt;&lt;code&gt;api_standard&lt;/code&gt;: The API standard name (e.g., &amp;quot;OBP&amp;quot;, &amp;quot;BG&amp;quot;, &amp;quot;UK&amp;quot;, &amp;quot;STET&amp;quot;)&lt;/li&gt; &lt;li&gt;&lt;code&gt;api_short_version&lt;/code&gt;: The version number (e.g., &amp;quot;v4.0.0&amp;quot;, &amp;quot;v1.3&amp;quot;)&lt;/li&gt; &lt;li&gt;&lt;code&gt;fully_qualified_version&lt;/code&gt;: The fully qualified version combining standard and version (e.g., &amp;quot;OBPv4.0.0&amp;quot;, &amp;quot;BGv1.3&amp;quot;)&lt;/li&gt; &lt;li&gt;&lt;code&gt;is_active&lt;/code&gt;: Boolean indicating if the version is currently enabled and accessible&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;&lt;strong&gt;Active Status:&lt;/strong&gt;&lt;/p&gt; &lt;ul&gt; &lt;li&gt;&lt;code&gt;is_active&#x3D;true&lt;/code&gt;: Version is enabled and can be accessed via its URL prefix&lt;/li&gt; &lt;li&gt;&lt;code&gt;is_active&#x3D;false&lt;/code&gt;: Version is scanned but disabled (via &lt;code&gt;api_disabled_versions&lt;/code&gt; props)&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;&lt;strong&gt;Use Cases:&lt;/strong&gt;&lt;/p&gt; &lt;ul&gt; &lt;li&gt;Discover what API versions are available in the codebase&lt;/li&gt; &lt;li&gt;Check which versions are currently enabled&lt;/li&gt; &lt;li&gt;Verify that disabled versions configuration is working correctly&lt;/li&gt; &lt;li&gt;API documentation and discovery&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;&lt;strong&gt;Note:&lt;/strong&gt; This differs from v4.0.0&#39;s &lt;code&gt;/api/versions&lt;/code&gt; endpoint which shows all scanned versions without is_active status.&lt;/p&gt; &lt;p&gt;User Authentication is Optional. The User need not be logged in.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;api_short_version&lt;/strong&gt;&lt;/a&gt;: api_short_version&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;api_standard&lt;/strong&gt;&lt;/a&gt;: api_standard&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;fully_qualified_version&lt;/strong&gt;&lt;/a&gt;: fully_qualified_version&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#is_active\&quot;&gt;&lt;strong&gt;is_active&lt;/strong&gt;&lt;/a&gt;: false&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;url_prefix&lt;/strong&gt;&lt;/a&gt;: url_prefix&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetScannedApiVersions200Response, Integer, Hash)>] GetScannedApiVersions200Response data, response status code and response headers
    def get_scanned_api_versions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_scanned_api_versions ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetScannedApiVersions200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_scanned_api_versions",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_scanned_api_versions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_server_jwk(opts = {})
      data, _status_code, _headers = get_server_jwk_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Get the server&#39;s public JSON Web Key (JWK) set and certificate chain.&lt;br /&gt; It is required by client applications to validate ID tokens, self-contained access tokens and other issued objects.&lt;/p&gt; &lt;p&gt;User Authentication is Optional. The User need not be logged in.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#e\&quot;&gt;&lt;strong&gt;e&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#kid\&quot;&gt;&lt;strong&gt;kid&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#kty\&quot;&gt;&lt;strong&gt;kty&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#n\&quot;&gt;&lt;strong&gt;n&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#use\&quot;&gt;&lt;strong&gt;use&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetServerJWK200Response, Integer, Hash)>] GetServerJWK200Response data, response status code and response headers
    def get_server_jwk_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_server_jwk ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetServerJWK200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"APIApi.get_server_jwk",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_server_jwk\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_stored_procedure_connector_health(opts = {})
      data, _status_code, _headers = get_stored_procedure_connector_health_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Returns health status of the stored procedure connector including:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;Connection status (ok/error)&lt;/li&gt; &lt;li&gt;Database server name: identifies which backend node handled the request (useful for load balancer diagnostics)&lt;/li&gt; &lt;li&gt;Server IP address&lt;/li&gt; &lt;li&gt;Database name&lt;/li&gt; &lt;li&gt;Response time in milliseconds&lt;/li&gt; &lt;li&gt;Error message (if any)&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;Supports database-specific queries for: SQL Server, PostgreSQL, Oracle, and MySQL/MariaDB.&lt;/p&gt; &lt;p&gt;This endpoint is useful for diagnosing connectivity issues, especially when the database is behind a load balancer&lt;br /&gt; and you need to identify which node is responding or experiencing SSL certificate issues.&lt;/p&gt; &lt;p&gt;Note: This endpoint may take a long time to respond if the database connection is slow or experiencing issues.&lt;br /&gt; The response time depends on the connection pool timeout and JDBC driver settings.&lt;/p&gt; &lt;p&gt;Authentication is Required&lt;/p&gt; &lt;p&gt;User Authentication is Required. The User must be logged in. The Application must also be authenticated.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;response_time_ms&lt;/strong&gt;&lt;/a&gt;: response_time_ms&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#status\&quot;&gt;&lt;strong&gt;status&lt;/strong&gt;&lt;/a&gt;:&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;database_name&lt;/a&gt;: database_name&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;error_message&lt;/a&gt;: error_message&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;server_ip&lt;/a&gt;: server_ip&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;server_name&lt;/a&gt;: server_name&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetStoredProcedureConnectorHealth200Response, Integer, Hash)>] GetStoredProcedureConnectorHealth200Response data, response status code and response headers
    def get_stored_procedure_connector_health_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_stored_procedure_connector_health ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetStoredProcedureConnectorHealth200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.get_stored_procedure_connector_health",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_stored_procedure_connector_health\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_system_dynamic_entities_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_system_dynamic_entities ...'
      end
      # resource path
      local_var_path = '/obp/v6.0.0/management/system-dynamic-entities'
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_system_dynamic_entities",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_system_dynamic_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetBankLevelEndpointTags200Response]
    def get_system_level_endpoint_tags(operationid, opts = {})
      data, _status_code, _headers = get_system_level_endpoint_tags_with_http_info(operationid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetBankLevelEndpointTags200Response, Integer, Hash)>] GetBankLevelEndpointTags200Response data, response status code and response headers
    def get_system_level_endpoint_tags_with_http_info(operationid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_system_level_endpoint_tags ...'
      end
      # verify the required parameter 'operationid' is set
      if @api_client.config.client_side_validation && operationid.nil?
        fail ArgumentError, "Missing the required parameter 'operationid' when calling APIApi.get_system_level_endpoint_tags"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/management/endpoints/{operationid}/tags'.sub('{' + 'operationid' + '}', CGI.escape(operationid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.get_system_level_endpoint_tags",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_system_level_endpoint_tags\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_top_apis_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.get_top_apis ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#get_top_apis\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param invalidate_cache_namespace_request [InvalidateCacheNamespaceRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [InvalidateCacheNamespace200Response]
    def invalidate_cache_namespace(invalidate_cache_namespace_request, opts = {})
      data, _status_code, _headers = invalidate_cache_namespace_with_http_info(invalidate_cache_namespace_request, opts)
      data
    end
    ...
    # @param invalidate_cache_namespace_request [InvalidateCacheNamespaceRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [Array<(InvalidateCacheNamespace200Response, Integer, Hash)>] InvalidateCacheNamespace200Response data, response status code and response headers
    def invalidate_cache_namespace_with_http_info(invalidate_cache_namespace_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.invalidate_cache_namespace ...'
      end
      # verify the required parameter 'invalidate_cache_namespace_request' is set
      if @api_client.config.client_side_validation && invalidate_cache_namespace_request.nil?
        fail ArgumentError, "Missing the required parameter 'invalidate_cache_namespace_request' when calling APIApi.invalidate_cache_namespace"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(invalidate_cache_namespace_request)

      # return_type
      return_type = opts[:debug_return_type] || 'InvalidateCacheNamespace200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2', 'GatewayLogin', 'DirectLogin']

      new_options = opts.merge(
        :operation => :"APIApi.invalidate_cache_namespace",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#invalidate_cache_namespace\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def log_cache_all_endpoint_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.log_cache_all_endpoint ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.log_cache_all_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#log_cache_all_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def log_cache_debug_endpoint_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.log_cache_debug_endpoint ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.log_cache_debug_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#log_cache_debug_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def log_cache_error_endpoint_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.log_cache_error_endpoint ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.log_cache_error_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#log_cache_error_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def log_cache_info_endpoint_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.log_cache_info_endpoint ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.log_cache_info_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#log_cache_info_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def log_cache_trace_endpoint_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.log_cache_trace_endpoint ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.log_cache_trace_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#log_cache_trace_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def log_cache_warning_endpoint_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.log_cache_warning_endpoint ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.log_cache_warning_endpoint",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#log_cache_warning_endpoint\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def regulated_entities(opts = {})
      data, _status_code, _headers = regulated_entities_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Returns information about:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;Regulated Entities&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;User Authentication is Optional. The User need not be logged in.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;attributeType&lt;/strong&gt;&lt;/a&gt;: attributeType&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#certificate_authority_ca_owner_id\&quot;&gt;&lt;strong&gt;certificate_authority_ca_owner_id&lt;/strong&gt;&lt;/a&gt;: CY_CBC&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;entities&lt;/strong&gt;&lt;/a&gt;: entities&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#entity_address\&quot;&gt;&lt;strong&gt;entity_address&lt;/strong&gt;&lt;/a&gt;: EXAMPLE COMPANY LTD, 5 SOME STREET&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#entity_certificate_public_key\&quot;&gt;&lt;strong&gt;entity_certificate_public_key&lt;/strong&gt;&lt;/a&gt;: &#x3D;&#x3D;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#entity_code\&quot;&gt;&lt;strong&gt;entity_code&lt;/strong&gt;&lt;/a&gt;: PSD_PICY_CBC!12345&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#entity_country\&quot;&gt;&lt;strong&gt;entity_country&lt;/strong&gt;&lt;/a&gt;: CY&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#entity_id\&quot;&gt;&lt;strong&gt;entity_id&lt;/strong&gt;&lt;/a&gt;: 0af807d7-3c39-43ef-9712-82bcfde1b9ca&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#entity_name\&quot;&gt;&lt;strong&gt;entity_name&lt;/strong&gt;&lt;/a&gt;: EXAMPLE COMPANY LTD&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#entity_post_code\&quot;&gt;&lt;strong&gt;entity_post_code&lt;/strong&gt;&lt;/a&gt;: 1060&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#entity_town_city\&quot;&gt;&lt;strong&gt;entity_town_city&lt;/strong&gt;&lt;/a&gt;: SOME CITY&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#entity_type\&quot;&gt;&lt;strong&gt;entity_type&lt;/strong&gt;&lt;/a&gt;: PSD_PI&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#entity_web_site\&quot;&gt;&lt;strong&gt;entity_web_site&lt;/strong&gt;&lt;/a&gt;: &lt;a href&#x3D;\&quot;http://www.example.com\&quot;&gt;www.example.com&lt;/a&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#name\&quot;&gt;&lt;strong&gt;name&lt;/strong&gt;&lt;/a&gt;: ACCOUNT_MANAGEMENT_FEE&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#services\&quot;&gt;&lt;strong&gt;services&lt;/strong&gt;&lt;/a&gt;: [{&amp;quot;CY&amp;quot;:[&amp;quot;PS_010&amp;quot;,&amp;quot;PS_020&amp;quot;,&amp;quot;PS_03C&amp;quot;,&amp;quot;PS_04C&amp;quot;]}]&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;value&lt;/strong&gt;&lt;/a&gt;: 5987953&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#attributes\&quot;&gt;attributes&lt;/a&gt;: attribute value in form of (name, value)&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(RegulatedEntities200Response, Integer, Hash)>] RegulatedEntities200Response data, response status code and response headers
    def regulated_entities_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.regulated_entities ...'
      end
      # resource path
      local_var_path = '/obp/v5.1.0/regulated-entities'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RegulatedEntities200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"APIApi.regulated_entities",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#regulated_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def root_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.root ...'
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#root\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def suggested_session_timeout(opts = {})
      data, _status_code, _headers = suggested_session_timeout_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Returns information about:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;Suggested session timeout in case of a user inactivity&lt;/li&gt; &lt;/ul&gt; &lt;p&gt;User Authentication is Optional. The User need not be logged in.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;timeout_in_seconds&lt;/strong&gt;&lt;/a&gt;: timeout_in_seconds&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(SuggestedSessionTimeout200Response, Integer, Hash)>] SuggestedSessionTimeout200Response data, response status code and response headers
    def suggested_session_timeout_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.suggested_session_timeout ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SuggestedSessionTimeout200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"APIApi.suggested_session_timeout",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#suggested_session_timeout\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [CreateApiProductAttribute200Response]
    def update_api_product_attribute(bankid, apiproductcode, apiproductattributeid, update_atm_attribute_request, opts = {})
      data, _status_code, _headers = update_api_product_attribute_with_http_info(bankid, apiproductcode, apiproductattributeid, update_atm_attribute_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateApiProductAttribute200Response, Integer, Hash)>] CreateApiProductAttribute200Response data, response status code and response headers
    def update_api_product_attribute_with_http_info(bankid, apiproductcode, apiproductattributeid, update_atm_attribute_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_api_product_attribute ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.update_api_product_attribute"
      end
      # verify the required parameter 'apiproductcode' is set
      if @api_client.config.client_side_validation && apiproductcode.nil?
        fail ArgumentError, "Missing the required parameter 'apiproductcode' when calling APIApi.update_api_product_attribute"
      end
      # verify the required parameter 'apiproductattributeid' is set
      if @api_client.config.client_side_validation && apiproductattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'apiproductattributeid' when calling APIApi.update_api_product_attribute"
      end
      # verify the required parameter 'update_atm_attribute_request' is set
      if @api_client.config.client_side_validation && update_atm_attribute_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_atm_attribute_request' when calling APIApi.update_api_product_attribute"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/banks/{bankid}/api-products/{apiproductcode}/attributes/{apiproductattributeid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'apiproductcode' + '}', CGI.escape(apiproductcode.to_s)).sub('{' + 'apiproductattributeid' + '}', CGI.escape(apiproductattributeid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_api_product_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_api_product_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_bank_level_dynamic_endpoint_host_with_http_info(bankid, dynamicendpointid, update_bank_level_dynamic_endpoint_host_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_bank_level_dynamic_endpoint_host ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.update_bank_level_dynamic_endpoint_host"
      end
      # verify the required parameter 'dynamicendpointid' is set
      if @api_client.config.client_side_validation && dynamicendpointid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicendpointid' when calling APIApi.update_bank_level_dynamic_endpoint_host"
      end
      ...
      if @api_client.config.client_side_validation && update_bank_level_dynamic_endpoint_host_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_bank_level_dynamic_endpoint_host_request' when calling APIApi.update_bank_level_dynamic_endpoint_host"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_bank_level_dynamic_endpoint_host",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_bank_level_dynamic_endpoint_host\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_bank_level_dynamic_entity_with_http_info(bankid, dynamicentityid, update_system_dynamic_entity_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_bank_level_dynamic_entity ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.update_bank_level_dynamic_entity"
      end
      # verify the required parameter 'dynamicentityid' is set
      if @api_client.config.client_side_validation && dynamicentityid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicentityid' when calling APIApi.update_bank_level_dynamic_entity"
      end
      ...
      if @api_client.config.client_side_validation && update_system_dynamic_entity_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_system_dynamic_entity_request' when calling APIApi.update_bank_level_dynamic_entity"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_bank_level_dynamic_entity",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_bank_level_dynamic_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [UpdateSystemLevelEndpointTag200Response]
    def update_bank_level_endpoint_tag(bankid, operationid, endpointtagid, update_system_level_endpoint_tag_request, opts = {})
      data, _status_code, _headers = update_bank_level_endpoint_tag_with_http_info(bankid, operationid, endpointtagid, update_system_level_endpoint_tag_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateSystemLevelEndpointTag200Response, Integer, Hash)>] UpdateSystemLevelEndpointTag200Response data, response status code and response headers
    def update_bank_level_endpoint_tag_with_http_info(bankid, operationid, endpointtagid, update_system_level_endpoint_tag_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_bank_level_endpoint_tag ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.update_bank_level_endpoint_tag"
      end
      # verify the required parameter 'operationid' is set
      if @api_client.config.client_side_validation && operationid.nil?
        fail ArgumentError, "Missing the required parameter 'operationid' when calling APIApi.update_bank_level_endpoint_tag"
      end
      # verify the required parameter 'endpointtagid' is set
      if @api_client.config.client_side_validation && endpointtagid.nil?
        fail ArgumentError, "Missing the required parameter 'endpointtagid' when calling APIApi.update_bank_level_endpoint_tag"
      end
      # verify the required parameter 'update_system_level_endpoint_tag_request' is set
      if @api_client.config.client_side_validation && update_system_level_endpoint_tag_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_system_level_endpoint_tag_request' when calling APIApi.update_bank_level_endpoint_tag"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/management/banks/{bankid}/endpoints/{operationid}/tags/{endpointtagid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'operationid' + '}', CGI.escape(operationid.to_s)).sub('{' + 'endpointtagid' + '}', CGI.escape(endpointtagid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_bank_level_endpoint_tag",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_bank_level_endpoint_tag\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_counterparty_attribute_with_http_info(bankid, accountid, counterpartyid, counterpartyattributeid, create_counterparty_attribute_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_counterparty_attribute ...'
      end
      # verify the required parameter 'bankid' is set
      if @api_client.config.client_side_validation && bankid.nil?
        fail ArgumentError, "Missing the required parameter 'bankid' when calling APIApi.update_counterparty_attribute"
      end
      # verify the required parameter 'accountid' is set
      if @api_client.config.client_side_validation && accountid.nil?
        fail ArgumentError, "Missing the required parameter 'accountid' when calling APIApi.update_counterparty_attribute"
      end
      # verify the required parameter 'counterpartyid' is set
      if @api_client.config.client_side_validation && counterpartyid.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyid' when calling APIApi.update_counterparty_attribute"
      end
      # verify the required parameter 'counterpartyattributeid' is set
      if @api_client.config.client_side_validation && counterpartyattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'counterpartyattributeid' when calling APIApi.update_counterparty_attribute"
      end
      # verify the required parameter 'create_counterparty_attribute_request' is set
      if @api_client.config.client_side_validation && create_counterparty_attribute_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_counterparty_attribute_request' when calling APIApi.update_counterparty_attribute"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/banks/{bankid}/accounts/{accountid}/counterparties/{counterpartyid}/attributes/{counterpartyattributeid}'.sub('{' + 'bankid' + '}', CGI.escape(bankid.to_s)).sub('{' + 'accountid' + '}', CGI.escape(accountid.to_s)).sub('{' + 'counterpartyid' + '}', CGI.escape(counterpartyid.to_s)).sub('{' + 'counterpartyattributeid' + '}', CGI.escape(counterpartyattributeid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_counterparty_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_counterparty_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_dynamic_endpoint_host_with_http_info(dynamicendpointid, update_bank_level_dynamic_endpoint_host_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_dynamic_endpoint_host ...'
      end
      # verify the required parameter 'dynamicendpointid' is set
      if @api_client.config.client_side_validation && dynamicendpointid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicendpointid' when calling APIApi.update_dynamic_endpoint_host"
      end
      # verify the required parameter 'update_bank_level_dynamic_endpoint_host_request' is set
      if @api_client.config.client_side_validation && update_bank_level_dynamic_endpoint_host_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_bank_level_dynamic_endpoint_host_request' when calling APIApi.update_dynamic_endpoint_host"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_dynamic_endpoint_host",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_dynamic_endpoint_host\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param apicollectionid [String] The APICOLLECTIONID identifier
    # @param update_featured_api_collection_request [UpdateFeaturedApiCollectionRequest] Request body
    # @param [Hash] opts the optional parameters
    # @return [GetFeaturedApiCollectionsAdmin200ResponseFeaturedApiCollectionsInner]
    def update_featured_api_collection(apicollectionid, update_featured_api_collection_request, opts = {})
      data, _status_code, _headers = update_featured_api_collection_with_http_info(apicollectionid, update_featured_api_collection_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetFeaturedApiCollectionsAdmin200ResponseFeaturedApiCollectionsInner, Integer, Hash)>] GetFeaturedApiCollectionsAdmin200ResponseFeaturedApiCollectionsInner data, response status code and response headers
    def update_featured_api_collection_with_http_info(apicollectionid, update_featured_api_collection_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_featured_api_collection ...'
      end
      # verify the required parameter 'apicollectionid' is set
      if @api_client.config.client_side_validation && apicollectionid.nil?
        fail ArgumentError, "Missing the required parameter 'apicollectionid' when calling APIApi.update_featured_api_collection"
      end
      # verify the required parameter 'update_featured_api_collection_request' is set
      if @api_client.config.client_side_validation && update_featured_api_collection_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_featured_api_collection_request' when calling APIApi.update_featured_api_collection"
      end
      # resource path
      local_var_path = '/obp/v6.0.0/management/api-collections/featured/{apicollectionid}'.sub('{' + 'apicollectionid' + '}', CGI.escape(apicollectionid.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_featured_api_collection_request)
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_featured_api_collection",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_featured_api_collection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetMethodRoutings200ResponseMethodRoutingsInner]
    def update_method_routing(methodroutingid, create_method_routing_request, opts = {})
      data, _status_code, _headers = update_method_routing_with_http_info(methodroutingid, create_method_routing_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetMethodRoutings200ResponseMethodRoutingsInner, Integer, Hash)>] GetMethodRoutings200ResponseMethodRoutingsInner data, response status code and response headers
    def update_method_routing_with_http_info(methodroutingid, create_method_routing_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_method_routing ...'
      end
      # verify the required parameter 'methodroutingid' is set
      if @api_client.config.client_side_validation && methodroutingid.nil?
        fail ArgumentError, "Missing the required parameter 'methodroutingid' when calling APIApi.update_method_routing"
      end
      # verify the required parameter 'create_method_routing_request' is set
      if @api_client.config.client_side_validation && create_method_routing_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_method_routing_request' when calling APIApi.update_method_routing"
      end
      # resource path
      local_var_path = '/obp/v3.1.0/management/method_routings/{methodroutingid}'.sub('{' + 'methodroutingid' + '}', CGI.escape(methodroutingid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_method_routing",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_method_routing\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_my_dynamic_entity_with_http_info(dynamicentityid, update_system_dynamic_entity_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_my_dynamic_entity ...'
      end
      # verify the required parameter 'dynamicentityid' is set
      if @api_client.config.client_side_validation && dynamicentityid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicentityid' when calling APIApi.update_my_dynamic_entity"
      end
      # verify the required parameter 'update_system_dynamic_entity_request' is set
      if @api_client.config.client_side_validation && update_system_dynamic_entity_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_system_dynamic_entity_request' when calling APIApi.update_my_dynamic_entity"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_my_dynamic_entity",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_my_dynamic_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [GetRegulatedEntityAttributeById200Response]
    def update_regulated_entity_attribute(regulatedentityid, regulatedentityattributeid, create_counterparty_attribute_request, opts = {})
      data, _status_code, _headers = update_regulated_entity_attribute_with_http_info(regulatedentityid, regulatedentityattributeid, create_counterparty_attribute_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetRegulatedEntityAttributeById200Response, Integer, Hash)>] GetRegulatedEntityAttributeById200Response data, response status code and response headers
    def update_regulated_entity_attribute_with_http_info(regulatedentityid, regulatedentityattributeid, create_counterparty_attribute_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_regulated_entity_attribute ...'
      end
      # verify the required parameter 'regulatedentityid' is set
      if @api_client.config.client_side_validation && regulatedentityid.nil?
        fail ArgumentError, "Missing the required parameter 'regulatedentityid' when calling APIApi.update_regulated_entity_attribute"
      end
      # verify the required parameter 'regulatedentityattributeid' is set
      if @api_client.config.client_side_validation && regulatedentityattributeid.nil?
        fail ArgumentError, "Missing the required parameter 'regulatedentityattributeid' when calling APIApi.update_regulated_entity_attribute"
      end
      # verify the required parameter 'create_counterparty_attribute_request' is set
      if @api_client.config.client_side_validation && create_counterparty_attribute_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_counterparty_attribute_request' when calling APIApi.update_regulated_entity_attribute"
      end
      # resource path
      local_var_path = '/obp/v5.1.0/regulated-entities/{regulatedentityid}/attributes/{regulatedentityattributeid}'.sub('{' + 'regulatedentityid' + '}', CGI.escape(regulatedentityid.to_s)).sub('{' + 'regulatedentityattributeid' + '}', CGI.escape(regulatedentityattributeid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_regulated_entity_attribute",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_regulated_entity_attribute\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_system_dynamic_entity_with_http_info(dynamicentityid, update_system_dynamic_entity_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_system_dynamic_entity ...'
      end
      # verify the required parameter 'dynamicentityid' is set
      if @api_client.config.client_side_validation && dynamicentityid.nil?
        fail ArgumentError, "Missing the required parameter 'dynamicentityid' when calling APIApi.update_system_dynamic_entity"
      end
      # verify the required parameter 'update_system_dynamic_entity_request' is set
      if @api_client.config.client_side_validation && update_system_dynamic_entity_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_system_dynamic_entity_request' when calling APIApi.update_system_dynamic_entity"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_system_dynamic_entity",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_system_dynamic_entity\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [UpdateSystemLevelEndpointTag200Response]
    def update_system_level_endpoint_tag(operationid, endpointtagid, update_system_level_endpoint_tag_request, opts = {})
      data, _status_code, _headers = update_system_level_endpoint_tag_with_http_info(operationid, endpointtagid, update_system_level_endpoint_tag_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateSystemLevelEndpointTag200Response, Integer, Hash)>] UpdateSystemLevelEndpointTag200Response data, response status code and response headers
    def update_system_level_endpoint_tag_with_http_info(operationid, endpointtagid, update_system_level_endpoint_tag_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.update_system_level_endpoint_tag ...'
      end
      # verify the required parameter 'operationid' is set
      if @api_client.config.client_side_validation && operationid.nil?
        fail ArgumentError, "Missing the required parameter 'operationid' when calling APIApi.update_system_level_endpoint_tag"
      end
      # verify the required parameter 'endpointtagid' is set
      if @api_client.config.client_side_validation && endpointtagid.nil?
        fail ArgumentError, "Missing the required parameter 'endpointtagid' when calling APIApi.update_system_level_endpoint_tag"
      end
      # verify the required parameter 'update_system_level_endpoint_tag_request' is set
      if @api_client.config.client_side_validation && update_system_level_endpoint_tag_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_system_level_endpoint_tag_request' when calling APIApi.update_system_level_endpoint_tag"
      end
      # resource path
      local_var_path = '/obp/v4.0.0/management/endpoints/{operationid}/tags/{endpointtagid}'.sub('{' + 'operationid' + '}', CGI.escape(operationid.to_s)).sub('{' + 'endpointtagid' + '}', CGI.escape(endpointtagid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"APIApi.update_system_level_endpoint_tag",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#update_system_level_endpoint_tag\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def verify_request_sign_response(opts = {})
      verify_request_sign_response_with_http_info(opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def verify_request_sign_response_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.verify_request_sign_response ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"APIApi.verify_request_sign_response",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#verify_request_sign_response\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def waiting_for_godot(opts = {})
      data, _status_code, _headers = waiting_for_godot_with_http_info(opts)
      data
    end
    ...
    # &lt;p&gt;Waiting For Godot&lt;/p&gt; &lt;p&gt;Uses query parameter &amp;quot;sleep&amp;quot; in milliseconds.&lt;br /&gt; For instance: .../waiting-for-godot?sleep&#x3D;50 means postpone response in 50 milliseconds.&lt;/p&gt; &lt;p&gt;User Authentication is Optional. The User need not be logged in.&lt;/p&gt; &lt;p&gt;&lt;strong&gt;JSON response body fields:&lt;/strong&gt;&lt;/p&gt; &lt;p&gt;&lt;a href&#x3D;\&quot;/glossary#\&quot;&gt;&lt;strong&gt;sleep_in_milliseconds&lt;/strong&gt;&lt;/a&gt;: sleep_in_milliseconds&lt;/p&gt; 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WaitingForGodot200Response, Integer, Hash)>] WaitingForGodot200Response data, response status code and response headers
    def waiting_for_godot_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: APIApi.waiting_for_godot ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'WaitingForGodot200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"APIApi.waiting_for_godot",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: APIApi#waiting_for_godot\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
