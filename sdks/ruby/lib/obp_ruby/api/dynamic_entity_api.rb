  ...
  class DynamicEntityApi
    ...
    def cleanup_orphaned_dynamic_entity_records_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DynamicEntityApi.cleanup_orphaned_dynamic_entity_records ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DynamicEntityApi.cleanup_orphaned_dynamic_entity_records",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DynamicEntityApi#cleanup_orphaned_dynamic_entity_records\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_available_personal_dynamic_entities_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DynamicEntityApi.get_available_personal_dynamic_entities ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DynamicEntityApi.get_available_personal_dynamic_entities",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DynamicEntityApi#get_available_personal_dynamic_entities\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_dynamic_entity_diagnostics_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DynamicEntityApi.get_dynamic_entity_diagnostics ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DynamicEntityApi.get_dynamic_entity_diagnostics",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DynamicEntityApi#get_dynamic_entity_diagnostics\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_reference_types_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DynamicEntityApi.get_reference_types ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DynamicEntityApi.get_reference_types",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DynamicEntityApi#get_reference_types\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
