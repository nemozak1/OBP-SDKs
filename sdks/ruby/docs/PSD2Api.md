...
| ------ | ------------ | ----------- |
| [**answer_consent_challenge**](PSD2Api.md#answer_consent_challenge) | **POST** /obp/v3.1.0/banks/{bankid}/consents/{consentid}/challenge | Answer Consent Challenge |
| [**answer_transaction_request_challenge**](PSD2Api.md#answer_transaction_request_challenge) | **POST** /obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/transaction-request-types/{transactionrequesttype}/transaction-requests/{transactionrequestid}/challenge | Answer Transaction Request Challenge |
| [**check_funds_available**](PSD2Api.md#check_funds_available) | **GET** /obp/v3.1.0/banks/{bankid}/accounts/{accountid}/{viewid}/funds-available | Check Available Funds |
| [**core_private_accounts_all_banks**](PSD2Api.md#core_private_accounts_all_banks) | **GET** /obp/v3.0.0/my/accounts | Get Accounts at all Banks (private) |
| [**create_consent_by_consent_request_id_email**](PSD2Api.md#create_consent_by_consent_request_id_email) | **POST** /obp/v5.0.0/consumer/consent-requests/{consentrequestid}/{email}/consents | Create Consent By CONSENT_REQUEST_ID (EMAIL) |
| [**create_consent_by_consent_request_id_implicit**](PSD2Api.md#create_consent_by_consent_request_id_implicit) | **POST** /obp/v5.0.0/consumer/consent-requests/{consentrequestid}/{implicit}/consents | Create Consent By CONSENT_REQUEST_ID (IMPLICIT) |
| [**create_consent_by_consent_request_id_sms**](PSD2Api.md#create_consent_by_consent_request_id_sms) | **POST** /obp/v5.0.0/consumer/consent-requests/{consentrequestid}/{sms}/consents | Create Consent By CONSENT_REQUEST_ID (SMS) |
| [**create_consent_email**](PSD2Api.md#create_consent_email) | **POST** /obp/v3.1.0/banks/{bankid}/my/consents/{email} | Create Consent (EMAIL) |
| [**create_consent_implicit**](PSD2Api.md#create_consent_implicit) | **POST** /obp/v5.1.0/my/consents/{implicit} | Create Consent (IMPLICIT) |
| [**create_consent_request**](PSD2Api.md#create_consent_request) | **POST** /obp/v5.0.0/consumer/consent-requests | Create Consent Request |
| [**create_consent_sms**](PSD2Api.md#create_consent_sms) | **POST** /obp/v3.1.0/banks/{bankid}/my/consents/{sms} | Create Consent (SMS) |
| [**create_transaction_request_account**](PSD2Api.md#create_transaction_request_account) | **POST** /obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/transaction-request-types/{account}/transaction-requests | Create Transaction Request (ACCOUNT) |
| [**create_transaction_request_account_otp**](PSD2Api.md#create_transaction_request_account_otp) | **POST** /obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/transaction-request-types/{accountotp}/transaction-requests | Create Transaction Request (ACCOUNT_OTP) |
| [**create_transaction_request_agent_cash_with_drawal**](PSD2Api.md#create_transaction_request_agent_cash_with_drawal) | **POST** /obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/transaction-request-types/{agentcashwithdrawal}/transaction-requests | Create Transaction Request (AGENT_CASH_WITHDRAWAL) |
| [**create_transaction_request_card**](PSD2Api.md#create_transaction_request_card) | **POST** /obp/v4.0.0/transaction-request-types/{card}/transaction-requests | Create Transaction Request (CARD) |
| [**create_transaction_request_cardano**](PSD2Api.md#create_transaction_request_cardano) | **POST** /obp/v6.0.0/banks/{bankid}/accounts/{accountid}/owner/transaction-request-types/{cardano}/transaction-requests | Create Transaction Request (CARDANO) |
| [**create_transaction_request_counterparty**](PSD2Api.md#create_transaction_request_counterparty) | **POST** /obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/transaction-request-types/{counterparty}/transaction-requests | Create Transaction Request (COUNTERPARTY) |
| [**create_transaction_request_eth_send_raw_transaction**](PSD2Api.md#create_transaction_request_eth_send_raw_transaction) | **POST** /obp/v6.0.0/banks/{bankid}/accounts/{accountid}/owner/transaction-request-types/{ethsendrawtransaction}/transaction-requests | CREATE TRANSACTION REQUEST (ETH_SEND_RAW_TRANSACTION ) |
| [**create_transaction_request_ethereume_send_transaction**](PSD2Api.md#create_transaction_request_ethereume_send_transaction) | **POST** /obp/v6.0.0/banks/{bankid}/accounts/{accountid}/owner/transaction-request-types/{ethsendtransaction}/transaction-requests | Create Transaction Request (ETH_SEND_TRANSACTION) |
| [**create_transaction_request_hold**](PSD2Api.md#create_transaction_request_hold) | **POST** /obp/v6.0.0/banks/{bankid}/accounts/{accountid}/owner/transaction-request-types/{hold}/transaction-requests | Create Transaction Request (HOLD) |
| [**create_transaction_request_refund**](PSD2Api.md#create_transaction_request_refund) | **POST** /obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/transaction-request-types/{refund}/transaction-requests | Create Transaction Request (REFUND) |
| [**create_transaction_request_sandbox_tan**](PSD2Api.md#create_transaction_request_sandbox_tan) | **POST** /obp/v2.1.0/banks/{bankid}/accounts/{accountid}/{viewid}/transaction-request-types/{sandboxtan}/transaction-requests | Create Transaction Request (SANDBOX_TAN) |
| [**create_transaction_request_sepa**](PSD2Api.md#create_transaction_request_sepa) | **POST** /obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/transaction-request-types/{sepa}/transaction-requests | Create Transaction Request (SEPA) |
| [**create_transaction_request_simple**](PSD2Api.md#create_transaction_request_simple) | **POST** /obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/transaction-request-types/{simple}/transaction-requests | Create Transaction Request (SIMPLE) |
| [**get_accounts_held**](PSD2Api.md#get_accounts_held) | **GET** /obp/v3.0.0/banks/{bankid}/accounts-held | Get Accounts Held |
| [**get_bank**](PSD2Api.md#get_bank) | **GET** /obp/v6.0.0/banks/{bankid} | Get Bank |
| [**get_bank_account_balances**](PSD2Api.md#get_bank_account_balances) | **GET** /obp/v5.1.0/banks/{bankid}/accounts/{accountid}/views/{viewid}/balances | Get Account Balances by BANK_ID and ACCOUNT_ID through the VIEW_ID |
| [**get_bank_accounts_balances**](PSD2Api.md#get_bank_accounts_balances) | **GET** /obp/v5.1.0/banks/{bankid}/balances | Get Account Balances by BANK_ID |
| [**get_bank_accounts_balances_through_view**](PSD2Api.md#get_bank_accounts_balances_through_view) | **GET** /obp/v5.1.0/banks/{bankid}/views/{viewid}/balances | Get Account Balances by BANK_ID through the VIEW_ID |
| [**get_banks**](PSD2Api.md#get_banks) | **GET** /obp/v6.0.0/banks | Get Banks |
| [**get_consent_by_consent_id**](PSD2Api.md#get_consent_by_consent_id) | **GET** /obp/v5.1.0/user/current/consents/{consentid} | Get Consent By Consent Id via User |
| [**get_consent_by_consent_id_via_consumer**](PSD2Api.md#get_consent_by_consent_id_via_consumer) | **GET** /obp/v5.1.0/consumer/current/consents/{consentid} | Get Consent By Consent Id via Consumer |
| [**get_consent_by_consent_request_id**](PSD2Api.md#get_consent_by_consent_request_id) | **GET** /obp/v5.0.0/consumer/consent-requests/{consentrequestid}/consents | Get Consent By Consent Request Id via Consumer |
| [**get_consent_infos**](PSD2Api.md#get_consent_infos) | **GET** /obp/v4.0.0/my/consent-infos | Get My Consents Info |
| [**get_consent_infos_by_bank**](PSD2Api.md#get_consent_infos_by_bank) | **GET** /obp/v4.0.0/banks/{bankid}/my/consent-infos | Get My Consents Info At Bank |
| [**get_consent_request**](PSD2Api.md#get_consent_request) | **GET** /obp/v5.0.0/consumer/consent-requests/{consentrequestid} | Get Consent Request |
| [**get_consents**](PSD2Api.md#get_consents) | **GET** /obp/v5.1.0/management/consents | Get Consents |
| [**get_consents_at_bank**](PSD2Api.md#get_consents_at_bank) | **GET** /obp/v5.1.0/management/consents/banks/{bankid} | Get Consents at Bank |
| [**get_core_account_by_id_through_view**](PSD2Api.md#get_core_account_by_id_through_view) | **GET** /obp/v5.1.0/banks/{bankid}/accounts/{accountid}/views/{viewid} | Get Account by Id (Core) through the VIEW_ID |
| [**get_core_account_by_id_v600**](PSD2Api.md#get_core_account_by_id_v600) | **GET** /obp/v6.0.0/my/banks/{bankid}/accounts/{accountid}/account | Get Account by Id (Core) |
| [**get_core_transactions_for_bank_account**](PSD2Api.md#get_core_transactions_for_bank_account) | **GET** /obp/v3.0.0/my/banks/{bankid}/accounts/{accountid}/transactions | Get Transactions for Account (Core) |
| [**get_counterparties_for_any_account**](PSD2Api.md#get_counterparties_for_any_account) | **GET** /obp/v4.0.0/management/banks/{bankid}/accounts/{accountid}/{viewid}/counterparties | Get Counterparties for any account (Explicit) |
| [**get_explicit_counterparties_for_account**](PSD2Api.md#get_explicit_counterparties_for_account) | **GET** /obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/counterparties | Get Counterparties (Explicit) |
| [**get_explicit_counterparty_by_id**](PSD2Api.md#get_explicit_counterparty_by_id) | **GET** /obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/counterparties/{counterpartyid} | Get Counterparty by Id (Explicit) |
| [**get_my_consents**](PSD2Api.md#get_my_consents) | **GET** /obp/v5.1.0/my/consents | Get My Consents |
| [**get_my_consents_by_bank**](PSD2Api.md#get_my_consents_by_bank) | **GET** /obp/v5.1.0/banks/{bankid}/my/consents | Get My Consents at Bank |
| [**get_private_account_idsby_bank_id**](PSD2Api.md#get_private_account_idsby_bank_id) | **GET** /obp/v3.0.0/banks/{bankid}/accounts/account_ids/private | Get Accounts at Bank (IDs only) |
| [**get_server_jwk**](PSD2Api.md#get_server_jwk) | **GET** /obp/v3.1.0/certs | Get JSON Web Key (JWK) |
| [**get_settlement_accounts**](PSD2Api.md#get_settlement_accounts) | **GET** /obp/v4.0.0/banks/{bankid}/settlement-accounts | Get Settlement accounts at Bank |
| [**get_transaction_request**](PSD2Api.md#get_transaction_request) | **GET** /obp/v4.0.0/banks/{bankid}/accounts/{accountid}/{viewid}/transaction-requests/{transactionrequestid} | Get Transaction Request |
| [**get_transaction_request_by_id**](PSD2Api.md#get_transaction_request_by_id) | **GET** /obp/v5.1.0/management/transaction-requests/{transactionrequestid} | Get Transaction Request by ID |
| [**get_transaction_request_types**](PSD2Api.md#get_transaction_request_types) | **GET** /obp/v1.4.0/banks/{bankid}/accounts/{accountid}/{viewid}/transaction-request-types | Get Transaction Request Types for Account |
| [**get_transaction_types**](PSD2Api.md#get_transaction_types) | **GET** /obp/v2.0.0/banks/{bankid}/transaction-types | Get Transaction Types at Bank |
| [**mtls_client_certificate_info**](PSD2Api.md#mtls_client_certificate_info) | **GET** /obp/v5.1.0/my/mtls/certificate/current | Provide client&#39;s certificate info of a current call |
| [**private_accounts_at_one_bank**](PSD2Api.md#private_accounts_at_one_bank) | **GET** /obp/v3.0.0/banks/{bankid}/accounts/private | Get Accounts at Bank (Minimal) |
| [**revoke_consent_at_bank**](PSD2Api.md#revoke_consent_at_bank) | **DELETE** /obp/v5.1.0/banks/{bankid}/consents/{consentid} | Revoke Consent at Bank |
| [**revoke_my_consent**](PSD2Api.md#revoke_my_consent) | **DELETE** /obp/v5.1.0/my/consents/{consentid} | Revoke My Consent |
| [**self_revoke_consent**](PSD2Api.md#self_revoke_consent) | **DELETE** /obp/v5.1.0/my/consent/current | Revoke Consent used in the Current Call |
...
begin
  ...
  puts "Error when calling PSD2Api->answer_consent_challenge: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->answer_consent_challenge_with_http_info: #{e}"
end
```
...
answer_transaction_request_challenge_request = OpenBankProject::AnswerTransactionRequestChallengeRequest.new # AnswerTransactionRequestChallengeRequest | Request body

begin
  # Answer Transaction Request Challenge
  result = api_instance.answer_transaction_request_challenge(bankid, accountid, viewid, transactionrequesttype, transactionrequestid, answer_transaction_request_challenge_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->answer_transaction_request_challenge: #{e}"
end
```

#### Using the answer_transaction_request_challenge_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetTransactionRequestById200Response>, Integer, Hash)> answer_transaction_request_challenge_with_http_info(bankid, accountid, viewid, transactionrequesttype, transactionrequestid, answer_transaction_request_challenge_request)

```ruby
begin
  # Answer Transaction Request Challenge
  data, status_code, headers = api_instance.answer_transaction_request_challenge_with_http_info(bankid, accountid, viewid, transactionrequesttype, transactionrequestid, answer_transaction_request_challenge_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetTransactionRequestById200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->answer_transaction_request_challenge_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->check_funds_available: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->check_funds_available_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->core_private_accounts_all_banks: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->core_private_accounts_all_banks_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_by_consent_request_id_email: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_by_consent_request_id_email_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_by_consent_request_id_implicit: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_by_consent_request_id_implicit_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_by_consent_request_id_sms: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_by_consent_request_id_sms_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_email: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_email_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_implicit: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_implicit_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_request: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_request_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_sms: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->create_consent_sms_with_http_info: #{e}"
end
```
...
create_transaction_request_account_request = OpenBankProject::CreateTransactionRequestAccountRequest.new # CreateTransactionRequestAccountRequest | Request body

begin
  # Create Transaction Request (ACCOUNT)
  result = api_instance.create_transaction_request_account(bankid, accountid, viewid, account, create_transaction_request_account_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_account: #{e}"
end
```

#### Using the create_transaction_request_account_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_account_with_http_info(bankid, accountid, viewid, account, create_transaction_request_account_request)

```ruby
begin
  # Create Transaction Request (ACCOUNT)
  data, status_code, headers = api_instance.create_transaction_request_account_with_http_info(bankid, accountid, viewid, account, create_transaction_request_account_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_account_with_http_info: #{e}"
end
```
...
begin
  # Create Transaction Request (ACCOUNT_OTP)
  result = api_instance.create_transaction_request_account_otp(bankid, accountid, viewid, accountotp, create_transaction_request_account_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_account_otp: #{e}"
end
```

#### Using the create_transaction_request_account_otp_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_account_otp_with_http_info(bankid, accountid, viewid, accountotp, create_transaction_request_account_request)

```ruby
begin
  # Create Transaction Request (ACCOUNT_OTP)
  data, status_code, headers = api_instance.create_transaction_request_account_otp_with_http_info(bankid, accountid, viewid, accountotp, create_transaction_request_account_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_account_otp_with_http_info: #{e}"
end
```
...
create_transaction_request_agent_cash_with_drawal_request = OpenBankProject::CreateTransactionRequestAgentCashWithDrawalRequest.new # CreateTransactionRequestAgentCashWithDrawalRequest | Request body

begin
  # Create Transaction Request (AGENT_CASH_WITHDRAWAL)
  result = api_instance.create_transaction_request_agent_cash_with_drawal(bankid, accountid, viewid, agentcashwithdrawal, create_transaction_request_agent_cash_with_drawal_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_agent_cash_with_drawal: #{e}"
end
```

#### Using the create_transaction_request_agent_cash_with_drawal_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_agent_cash_with_drawal_with_http_info(bankid, accountid, viewid, agentcashwithdrawal, create_transaction_request_agent_cash_with_drawal_request)

```ruby
begin
  # Create Transaction Request (AGENT_CASH_WITHDRAWAL)
  data, status_code, headers = api_instance.create_transaction_request_agent_cash_with_drawal_with_http_info(bankid, accountid, viewid, agentcashwithdrawal, create_transaction_request_agent_cash_with_drawal_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_agent_cash_with_drawal_with_http_info: #{e}"
end
```
...
create_transaction_request_card_request = OpenBankProject::CreateTransactionRequestCardRequest.new # CreateTransactionRequestCardRequest | Request body

begin
  # Create Transaction Request (CARD)
  result = api_instance.create_transaction_request_card(card, create_transaction_request_card_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_card: #{e}"
end
```

#### Using the create_transaction_request_card_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_card_with_http_info(card, create_transaction_request_card_request)

```ruby
begin
  # Create Transaction Request (CARD)
  data, status_code, headers = api_instance.create_transaction_request_card_with_http_info(card, create_transaction_request_card_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_card_with_http_info: #{e}"
end
```
...
create_transaction_request_cardano_request = OpenBankProject::CreateTransactionRequestCardanoRequest.new # CreateTransactionRequestCardanoRequest | Request body

begin
  # Create Transaction Request (CARDANO)
  result = api_instance.create_transaction_request_cardano(bankid, accountid, cardano, create_transaction_request_cardano_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_cardano: #{e}"
end
```

#### Using the create_transaction_request_cardano_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_cardano_with_http_info(bankid, accountid, cardano, create_transaction_request_cardano_request)

```ruby
begin
  # Create Transaction Request (CARDANO)
  data, status_code, headers = api_instance.create_transaction_request_cardano_with_http_info(bankid, accountid, cardano, create_transaction_request_cardano_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_cardano_with_http_info: #{e}"
end
```
...
create_transaction_request_counterparty_request = OpenBankProject::CreateTransactionRequestCounterpartyRequest.new # CreateTransactionRequestCounterpartyRequest | Request body

begin
  # Create Transaction Request (COUNTERPARTY)
  result = api_instance.create_transaction_request_counterparty(bankid, accountid, viewid, counterparty, create_transaction_request_counterparty_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_counterparty: #{e}"
end
```

#### Using the create_transaction_request_counterparty_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_counterparty_with_http_info(bankid, accountid, viewid, counterparty, create_transaction_request_counterparty_request)

```ruby
begin
  # Create Transaction Request (COUNTERPARTY)
  data, status_code, headers = api_instance.create_transaction_request_counterparty_with_http_info(bankid, accountid, viewid, counterparty, create_transaction_request_counterparty_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_counterparty_with_http_info: #{e}"
end
```
...
create_transaction_request_eth_send_raw_transaction_request = OpenBankProject::CreateTransactionRequestEthSendRawTransactionRequest.new # CreateTransactionRequestEthSendRawTransactionRequest | Request body

begin
  # CREATE TRANSACTION REQUEST (ETH_SEND_RAW_TRANSACTION )
  result = api_instance.create_transaction_request_eth_send_raw_transaction(bankid, accountid, ethsendrawtransaction, create_transaction_request_eth_send_raw_transaction_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_eth_send_raw_transaction: #{e}"
end
```

#### Using the create_transaction_request_eth_send_raw_transaction_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_eth_send_raw_transaction_with_http_info(bankid, accountid, ethsendrawtransaction, create_transaction_request_eth_send_raw_transaction_request)

```ruby
begin
  # CREATE TRANSACTION REQUEST (ETH_SEND_RAW_TRANSACTION )
  data, status_code, headers = api_instance.create_transaction_request_eth_send_raw_transaction_with_http_info(bankid, accountid, ethsendrawtransaction, create_transaction_request_eth_send_raw_transaction_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_eth_send_raw_transaction_with_http_info: #{e}"
end
```
...
create_transaction_request_ethereume_send_transaction_request = OpenBankProject::CreateTransactionRequestEthereumeSendTransactionRequest.new # CreateTransactionRequestEthereumeSendTransactionRequest | Request body

begin
  # Create Transaction Request (ETH_SEND_TRANSACTION)
  result = api_instance.create_transaction_request_ethereume_send_transaction(bankid, accountid, ethsendtransaction, create_transaction_request_ethereume_send_transaction_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_ethereume_send_transaction: #{e}"
end
```

#### Using the create_transaction_request_ethereume_send_transaction_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_ethereume_send_transaction_with_http_info(bankid, accountid, ethsendtransaction, create_transaction_request_ethereume_send_transaction_request)

```ruby
begin
  # Create Transaction Request (ETH_SEND_TRANSACTION)
  data, status_code, headers = api_instance.create_transaction_request_ethereume_send_transaction_with_http_info(bankid, accountid, ethsendtransaction, create_transaction_request_ethereume_send_transaction_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_ethereume_send_transaction_with_http_info: #{e}"
end
```
...
create_transaction_request_free_form_request = OpenBankProject::CreateTransactionRequestFreeFormRequest.new # CreateTransactionRequestFreeFormRequest | Request body

begin
  # Create Transaction Request (HOLD)
  result = api_instance.create_transaction_request_hold(bankid, accountid, hold, create_transaction_request_free_form_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_hold: #{e}"
end
```

#### Using the create_transaction_request_hold_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_hold_with_http_info(bankid, accountid, hold, create_transaction_request_free_form_request)

```ruby
begin
  # Create Transaction Request (HOLD)
  data, status_code, headers = api_instance.create_transaction_request_hold_with_http_info(bankid, accountid, hold, create_transaction_request_free_form_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_hold_with_http_info: #{e}"
end
```
...
create_transaction_request_refund_request = OpenBankProject::CreateTransactionRequestRefundRequest.new # CreateTransactionRequestRefundRequest | Request body

begin
  # Create Transaction Request (REFUND)
  result = api_instance.create_transaction_request_refund(bankid, accountid, viewid, refund, create_transaction_request_refund_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_refund: #{e}"
end
```

#### Using the create_transaction_request_refund_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_refund_with_http_info(bankid, accountid, viewid, refund, create_transaction_request_refund_request)

```ruby
begin
  # Create Transaction Request (REFUND)
  data, status_code, headers = api_instance.create_transaction_request_refund_with_http_info(bankid, accountid, viewid, refund, create_transaction_request_refund_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_refund_with_http_info: #{e}"
end
```
...
begin
  # Create Transaction Request (SANDBOX_TAN)
  result = api_instance.create_transaction_request_sandbox_tan(bankid, accountid, viewid, sandboxtan, create_transaction_request_account_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_sandbox_tan: #{e}"
end
```

#### Using the create_transaction_request_sandbox_tan_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetTransactionRequestById200Response>, Integer, Hash)> create_transaction_request_sandbox_tan_with_http_info(bankid, accountid, viewid, sandboxtan, create_transaction_request_account_request)

```ruby
begin
  # Create Transaction Request (SANDBOX_TAN)
  data, status_code, headers = api_instance.create_transaction_request_sandbox_tan_with_http_info(bankid, accountid, viewid, sandboxtan, create_transaction_request_account_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetTransactionRequestById200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_sandbox_tan_with_http_info: #{e}"
end
```
...
create_transaction_request_sepa_request = OpenBankProject::CreateTransactionRequestSepaRequest.new # CreateTransactionRequestSepaRequest | Request body

begin
  # Create Transaction Request (SEPA)
  result = api_instance.create_transaction_request_sepa(bankid, accountid, viewid, sepa, create_transaction_request_sepa_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_sepa: #{e}"
end
```

#### Using the create_transaction_request_sepa_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_sepa_with_http_info(bankid, accountid, viewid, sepa, create_transaction_request_sepa_request)

```ruby
begin
  # Create Transaction Request (SEPA)
  data, status_code, headers = api_instance.create_transaction_request_sepa_with_http_info(bankid, accountid, viewid, sepa, create_transaction_request_sepa_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_sepa_with_http_info: #{e}"
end
```
...
create_transaction_request_simple_request = OpenBankProject::CreateTransactionRequestSimpleRequest.new # CreateTransactionRequestSimpleRequest | Request body

begin
  # Create Transaction Request (SIMPLE)
  result = api_instance.create_transaction_request_simple(bankid, accountid, viewid, simple, create_transaction_request_simple_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_simple: #{e}"
end
```

#### Using the create_transaction_request_simple_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateTransactionRequestCounterparty200Response>, Integer, Hash)> create_transaction_request_simple_with_http_info(bankid, accountid, viewid, simple, create_transaction_request_simple_request)

```ruby
begin
  # Create Transaction Request (SIMPLE)
  data, status_code, headers = api_instance.create_transaction_request_simple_with_http_info(bankid, accountid, viewid, simple, create_transaction_request_simple_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateTransactionRequestCounterparty200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->create_transaction_request_simple_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_accounts_held: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_accounts_held_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_bank_with_http_info: #{e}"
end
```
...
begin
  # Get Account Balances by BANK_ID and ACCOUNT_ID through the VIEW_ID
  result = api_instance.get_bank_account_balances(bankid, accountid, viewid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_bank_account_balances: #{e}"
end
```

#### Using the get_bank_account_balances_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetBankAccountsBalances200ResponseAccountsInner>, Integer, Hash)> get_bank_account_balances_with_http_info(bankid, accountid, viewid)

```ruby
begin
  # Get Account Balances by BANK_ID and ACCOUNT_ID through the VIEW_ID
  data, status_code, headers = api_instance.get_bank_account_balances_with_http_info(bankid, accountid, viewid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetBankAccountsBalances200ResponseAccountsInner>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_bank_account_balances_with_http_info: #{e}"
end
```
...
begin
  # Get Account Balances by BANK_ID
  result = api_instance.get_bank_accounts_balances(bankid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_bank_accounts_balances: #{e}"
end
```

#### Using the get_bank_accounts_balances_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetBankAccountsBalances200Response>, Integer, Hash)> get_bank_accounts_balances_with_http_info(bankid)

```ruby
begin
  # Get Account Balances by BANK_ID
  data, status_code, headers = api_instance.get_bank_accounts_balances_with_http_info(bankid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetBankAccountsBalances200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_bank_accounts_balances_with_http_info: #{e}"
end
```
...
begin
  # Get Account Balances by BANK_ID through the VIEW_ID
  result = api_instance.get_bank_accounts_balances_through_view(bankid, viewid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_bank_accounts_balances_through_view: #{e}"
end
```

#### Using the get_bank_accounts_balances_through_view_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetBankAccountsBalances200Response>, Integer, Hash)> get_bank_accounts_balances_through_view_with_http_info(bankid, viewid)

```ruby
begin
  # Get Account Balances by BANK_ID through the VIEW_ID
  data, status_code, headers = api_instance.get_bank_accounts_balances_through_view_with_http_info(bankid, viewid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetBankAccountsBalances200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_bank_accounts_balances_through_view_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_banks: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_banks_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_by_consent_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_by_consent_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_by_consent_id_via_consumer: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_by_consent_id_via_consumer_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_by_consent_request_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_by_consent_request_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_infos: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_infos_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_infos_by_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_infos_by_bank_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_request: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consent_request_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consents: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consents_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consents_at_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_consents_at_bank_with_http_info: #{e}"
end
```
...
begin
  # Get Account by Id (Core) through the VIEW_ID
  result = api_instance.get_core_account_by_id_through_view(bankid, accountid, viewid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_core_account_by_id_through_view: #{e}"
end
```

#### Using the get_core_account_by_id_through_view_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetCoreAccountByIdThroughView200Response>, Integer, Hash)> get_core_account_by_id_through_view_with_http_info(bankid, accountid, viewid)

```ruby
begin
  # Get Account by Id (Core) through the VIEW_ID
  data, status_code, headers = api_instance.get_core_account_by_id_through_view_with_http_info(bankid, accountid, viewid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetCoreAccountByIdThroughView200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_core_account_by_id_through_view_with_http_info: #{e}"
end
```
...
begin
  # Get Account by Id (Core)
  result = api_instance.get_core_account_by_id_v600(bankid, accountid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_core_account_by_id_v600: #{e}"
end
```

#### Using the get_core_account_by_id_v600_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetCoreAccountByIdV600200Response>, Integer, Hash)> get_core_account_by_id_v600_with_http_info(bankid, accountid)

```ruby
begin
  # Get Account by Id (Core)
  data, status_code, headers = api_instance.get_core_account_by_id_v600_with_http_info(bankid, accountid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetCoreAccountByIdV600200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_core_account_by_id_v600_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_core_transactions_for_bank_account: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_core_transactions_for_bank_account_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_counterparties_for_any_account: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_counterparties_for_any_account_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_explicit_counterparties_for_account: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_explicit_counterparties_for_account_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_explicit_counterparty_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_explicit_counterparty_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_my_consents: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_my_consents_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_my_consents_by_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_my_consents_by_bank_with_http_info: #{e}"
end
```
...
begin
  # Get Accounts at Bank (IDs only)
  result = api_instance.get_private_account_idsby_bank_id(bankid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_private_account_idsby_bank_id: #{e}"
end
```

#### Using the get_private_account_idsby_bank_id_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetPrivateAccountIdsbyBankId200Response>, Integer, Hash)> get_private_account_idsby_bank_id_with_http_info(bankid)

```ruby
begin
  # Get Accounts at Bank (IDs only)
  data, status_code, headers = api_instance.get_private_account_idsby_bank_id_with_http_info(bankid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetPrivateAccountIdsbyBankId200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_private_account_idsby_bank_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_server_jwk: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_server_jwk_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_settlement_accounts: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_settlement_accounts_with_http_info: #{e}"
end
```
...
begin
  # Get Transaction Request
  result = api_instance.get_transaction_request(bankid, accountid, viewid, transactionrequestid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_transaction_request: #{e}"
end
```

#### Using the get_transaction_request_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetTransactionRequestById200Response>, Integer, Hash)> get_transaction_request_with_http_info(bankid, accountid, viewid, transactionrequestid)

```ruby
begin
  # Get Transaction Request
  data, status_code, headers = api_instance.get_transaction_request_with_http_info(bankid, accountid, viewid, transactionrequestid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetTransactionRequestById200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_transaction_request_with_http_info: #{e}"
end
```
...
begin
  # Get Transaction Request by ID
  result = api_instance.get_transaction_request_by_id(transactionrequestid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_transaction_request_by_id: #{e}"
end
```

#### Using the get_transaction_request_by_id_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetTransactionRequestById200Response>, Integer, Hash)> get_transaction_request_by_id_with_http_info(transactionrequestid)

```ruby
begin
  # Get Transaction Request by ID
  data, status_code, headers = api_instance.get_transaction_request_by_id_with_http_info(transactionrequestid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetTransactionRequestById200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_transaction_request_by_id_with_http_info: #{e}"
end
```
...
begin
  # Get Transaction Request Types for Account
  result = api_instance.get_transaction_request_types(bankid, accountid, viewid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_transaction_request_types: #{e}"
end
```

#### Using the get_transaction_request_types_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetTransactionRequestTypes200Response>, Integer, Hash)> get_transaction_request_types_with_http_info(bankid, accountid, viewid)

```ruby
begin
  # Get Transaction Request Types for Account
  data, status_code, headers = api_instance.get_transaction_request_types_with_http_info(bankid, accountid, viewid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetTransactionRequestTypes200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->get_transaction_request_types_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_transaction_types: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->get_transaction_types_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->mtls_client_certificate_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->mtls_client_certificate_info_with_http_info: #{e}"
end
```
...
begin
  # Get Accounts at Bank (Minimal)
  result = api_instance.private_accounts_at_one_bank(bankid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->private_accounts_at_one_bank: #{e}"
end
```

#### Using the private_accounts_at_one_bank_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<PrivateAccountsAtOneBank200Response>, Integer, Hash)> private_accounts_at_one_bank_with_http_info(bankid)

```ruby
begin
  # Get Accounts at Bank (Minimal)
  data, status_code, headers = api_instance.private_accounts_at_one_bank_with_http_info(bankid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <PrivateAccountsAtOneBank200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling PSD2Api->private_accounts_at_one_bank_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->revoke_consent_at_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->revoke_consent_at_bank_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->revoke_my_consent: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->revoke_my_consent_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->self_revoke_consent: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PSD2Api->self_revoke_consent_with_http_info: #{e}"
end
```
