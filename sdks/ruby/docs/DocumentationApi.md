...
begin
  # Get Glossary of the API
  result = api_instance.get_api_glossary
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling DocumentationApi->get_api_glossary: #{e}"
end
```

#### Using the get_api_glossary_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetApiGlossary200Response>, Integer, Hash)> get_api_glossary_with_http_info

```ruby
begin
  # Get Glossary of the API
  data, status_code, headers = api_instance.get_api_glossary_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetApiGlossary200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling DocumentationApi->get_api_glossary_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_bank_level_dynamic_resource_docs_obp: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_bank_level_dynamic_resource_docs_obp_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_message_docs: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_message_docs_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_message_docs_json_schema: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_message_docs_json_schema_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_message_docs_swagger: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_message_docs_swagger_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_resource_docs_obp: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_resource_docs_obp_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_resource_docs_open_api31: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_resource_docs_open_api31_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_resource_docs_swagger: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_resource_docs_swagger_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_scanned_api_versions: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DocumentationApi->get_scanned_api_versions_with_http_info: #{e}"
end
```
