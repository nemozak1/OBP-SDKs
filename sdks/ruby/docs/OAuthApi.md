...
| ------ | ------------ | ----------- |
| [**get_o_auth2_server_jwks_uris**](OAuthApi.md#get_o_auth2_server_jwks_uris) | **GET** /obp/v3.1.0/jwks-uris | Get JSON Web Key (JWK) URIs |
| [**get_obp_connector_loopback**](OAuthApi.md#get_obp_connector_loopback) | **GET** /obp/v3.1.0/connector/loopback | Get Connector Status (Loopback) |
| [**get_oidc_client**](OAuthApi.md#get_oidc_client) | **GET** /obp/v6.0.0/oidc/clients/{clientid} | Get OIDC Client |
| [**verify_oidc_client**](OAuthApi.md#verify_oidc_client) | **POST** /obp/v6.0.0/oidc/clients/verify | Verify OIDC Client |
...
begin
  ...
  puts "Error when calling OAuthApi->get_o_auth2_server_jwks_uris: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OAuthApi->get_o_auth2_server_jwks_uris_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OAuthApi->get_obp_connector_loopback: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OAuthApi->get_obp_connector_loopback_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OAuthApi->get_oidc_client: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OAuthApi->get_oidc_client_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OAuthApi->verify_oidc_client: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OAuthApi->verify_oidc_client_with_http_info: #{e}"
end
```
