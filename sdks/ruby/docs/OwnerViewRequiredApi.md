...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->create_user_with_account_access_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->create_user_with_account_access_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->grant_user_access_to_view_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->grant_user_access_to_view_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->revoke_user_access_to_view_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling OwnerViewRequiredApi->revoke_user_access_to_view_by_id_with_http_info: #{e}"
end
```
