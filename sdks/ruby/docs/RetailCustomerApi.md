...
begin
  ...
  puts "Error when calling RetailCustomerApi->create_retail_customer: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RetailCustomerApi->create_retail_customer_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RetailCustomerApi->get_retail_customer_by_customer_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RetailCustomerApi->get_retail_customer_by_customer_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RetailCustomerApi->get_retail_customers_at_one_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling RetailCustomerApi->get_retail_customers_at_one_bank_with_http_info: #{e}"
end
```
