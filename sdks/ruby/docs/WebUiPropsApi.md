...
begin
  # Create or Update WebUiProps
  result = api_instance.create_or_update_web_ui_props(webuipropname, get_transaction_types200_response_transaction_types_inner_id)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling WebUiPropsApi->create_or_update_web_ui_props: #{e}"
end
```

#### Using the create_or_update_web_ui_props_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateWebUiProps200Response>, Integer, Hash)> create_or_update_web_ui_props_with_http_info(webuipropname, get_transaction_types200_response_transaction_types_inner_id)

```ruby
begin
  # Create or Update WebUiProps
  data, status_code, headers = api_instance.create_or_update_web_ui_props_with_http_info(webuipropname, get_transaction_types200_response_transaction_types_inner_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateWebUiProps200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling WebUiPropsApi->create_or_update_web_ui_props_with_http_info: #{e}"
end
```
...
api_instance = OpenBankProject::WebUiPropsApi.new
create_transaction_request_counterparty200_response_attributes_inner = OpenBankProject::CreateTransactionRequestCounterparty200ResponseAttributesInner.new # CreateTransactionRequestCounterparty200ResponseAttributesInner | Request body

begin
  # Create WebUiProps
  result = api_instance.create_web_ui_props(create_transaction_request_counterparty200_response_attributes_inner)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling WebUiPropsApi->create_web_ui_props: #{e}"
end
```

#### Using the create_web_ui_props_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CreateWebUiProps200Response>, Integer, Hash)> create_web_ui_props_with_http_info(create_transaction_request_counterparty200_response_attributes_inner)

```ruby
begin
  # Create WebUiProps
  data, status_code, headers = api_instance.create_web_ui_props_with_http_info(create_transaction_request_counterparty200_response_attributes_inner)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CreateWebUiProps200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling WebUiPropsApi->create_web_ui_props_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling WebUiPropsApi->delete_web_ui_props: #{e}"
end
```

#### Using the delete_web_ui_props_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> delete_web_ui_props_with_http_info(webuipropname)

```ruby
begin
  # Delete WebUiProps
  data, status_code, headers = api_instance.delete_web_ui_props_with_http_info(webuipropname)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue OpenBankProject::ApiError => e
  puts "Error when calling WebUiPropsApi->delete_web_ui_props_with_http_info: #{e}"
end
```
...
begin
  # Get WebUiProp by Name
  result = api_instance.get_web_ui_prop(webuipropname)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling WebUiPropsApi->get_web_ui_prop: #{e}"
end
```

#### Using the get_web_ui_prop_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetWebUiProps200ResponseWebuiPropsInner>, Integer, Hash)> get_web_ui_prop_with_http_info(webuipropname)

```ruby
begin
  # Get WebUiProp by Name
  data, status_code, headers = api_instance.get_web_ui_prop_with_http_info(webuipropname)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetWebUiProps200ResponseWebuiPropsInner>
rescue OpenBankProject::ApiError => e
  puts "Error when calling WebUiPropsApi->get_web_ui_prop_with_http_info: #{e}"
end
```
...
begin
  # Get WebUiProps
  result = api_instance.get_web_ui_props
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling WebUiPropsApi->get_web_ui_props: #{e}"
end
```

#### Using the get_web_ui_props_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetWebUiProps200Response>, Integer, Hash)> get_web_ui_props_with_http_info

```ruby
begin
  # Get WebUiProps
  data, status_code, headers = api_instance.get_web_ui_props_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetWebUiProps200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling WebUiPropsApi->get_web_ui_props_with_http_info: #{e}"
end
```
