...
begin
  ...
  puts "Error when calling MethodRoutingApi->create_method_routing: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MethodRoutingApi->create_method_routing_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MethodRoutingApi->delete_method_routing: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MethodRoutingApi->delete_method_routing_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MethodRoutingApi->get_connector_method_names: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MethodRoutingApi->get_connector_method_names_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MethodRoutingApi->get_method_routings: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MethodRoutingApi->get_method_routings_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MethodRoutingApi->update_method_routing: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MethodRoutingApi->update_method_routing_with_http_info: #{e}"
end
```
