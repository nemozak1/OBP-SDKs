...
api_instance = OpenBankProject::DAuthApi.new
...
begin
  ...
  puts "Error when calling DAuthApi->create_user_with_account_access_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DAuthApi->create_user_with_account_access_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DAuthApi->create_user_with_roles: #{e}"
end
```
...
begin
  ...
  puts "Error when calling DAuthApi->create_user_with_roles_with_http_info: #{e}"
end
```
