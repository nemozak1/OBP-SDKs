...
create_atm_request = OpenBankProject::CreateAtmRequest.new # CreateAtmRequest | Request body

begin
  # Create ATM
  result = api_instance.create_atm(bankid, create_atm_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->create_atm: #{e}"
end
```

#### Using the create_atm_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetAtm200Response>, Integer, Hash)> create_atm_with_http_info(bankid, create_atm_request)

```ruby
begin
  # Create ATM
  data, status_code, headers = api_instance.create_atm_with_http_info(bankid, create_atm_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetAtm200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->create_atm_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ATMApi->create_atm_attribute: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ATMApi->create_atm_attribute_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ATMApi->delete_atm: #{e}"
end
```

#### Using the delete_atm_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> delete_atm_with_http_info(bankid, atmid)

```ruby
begin
  # Delete ATM
  data, status_code, headers = api_instance.delete_atm_with_http_info(bankid, atmid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->delete_atm_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ATMApi->delete_atm_attribute: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ATMApi->delete_atm_attribute_with_http_info: #{e}"
end
```
...
begin
  # Get Bank ATM
  result = api_instance.get_atm(bankid, atmid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->get_atm: #{e}"
end
```

#### Using the get_atm_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetAtm200Response>, Integer, Hash)> get_atm_with_http_info(bankid, atmid)

```ruby
begin
  # Get Bank ATM
  data, status_code, headers = api_instance.get_atm_with_http_info(bankid, atmid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetAtm200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->get_atm_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ATMApi->get_atm_attribute: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ATMApi->get_atm_attribute_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ATMApi->get_atm_attributes: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ATMApi->get_atm_attributes_with_http_info: #{e}"
end
```
...
begin
  # Get Bank ATMS
  result = api_instance.get_atms(bankid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->get_atms: #{e}"
end
```

#### Using the get_atms_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetAtms200Response>, Integer, Hash)> get_atms_with_http_info(bankid)

```ruby
begin
  # Get Bank ATMS
  data, status_code, headers = api_instance.get_atms_with_http_info(bankid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetAtms200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->get_atms_with_http_info: #{e}"
end
```
...
begin
  # Head Bank ATMS
  result = api_instance.head_atms(bankid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->head_atms: #{e}"
end
```

#### Using the head_atms_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<HeadAtms200Response>, Integer, Hash)> head_atms_with_http_info(bankid)

```ruby
begin
  # Head Bank ATMS
  data, status_code, headers = api_instance.head_atms_with_http_info(bankid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <HeadAtms200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->head_atms_with_http_info: #{e}"
end
```
...
bankid = 'bankid_example' # String | The BANKID identifier
atmid = 'atmid_example' # String | The ATMID identifier
update_atm_request = OpenBankProject::UpdateAtmRequest.new # UpdateAtmRequest | Request body

begin
  # UPDATE ATM
  result = api_instance.update_atm(bankid, atmid, update_atm_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm: #{e}"
end
```

#### Using the update_atm_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetAtm200Response>, Integer, Hash)> update_atm_with_http_info(bankid, atmid, update_atm_request)

```ruby
begin
  # UPDATE ATM
  data, status_code, headers = api_instance.update_atm_with_http_info(bankid, atmid, update_atm_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetAtm200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_with_http_info: #{e}"
end
```
...
bankid = 'bankid_example' # String | The BANKID identifier
atmid = 'atmid_example' # String | The ATMID identifier
update_atm_accessibility_features_request = OpenBankProject::UpdateAtmAccessibilityFeaturesRequest.new # UpdateAtmAccessibilityFeaturesRequest | Request body

begin
  # Update ATM Accessibility Features
  result = api_instance.update_atm_accessibility_features(bankid, atmid, update_atm_accessibility_features_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_accessibility_features: #{e}"
end
```

#### Using the update_atm_accessibility_features_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<UpdateAtmAccessibilityFeatures200Response>, Integer, Hash)> update_atm_accessibility_features_with_http_info(bankid, atmid, update_atm_accessibility_features_request)

```ruby
begin
  # Update ATM Accessibility Features
  data, status_code, headers = api_instance.update_atm_accessibility_features_with_http_info(bankid, atmid, update_atm_accessibility_features_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <UpdateAtmAccessibilityFeatures200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_accessibility_features_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ATMApi->update_atm_attribute: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ATMApi->update_atm_attribute_with_http_info: #{e}"
end
```
...
bankid = 'bankid_example' # String | The BANKID identifier
atmid = 'atmid_example' # String | The ATMID identifier
update_atm_location_categories_request = OpenBankProject::UpdateAtmLocationCategoriesRequest.new # UpdateAtmLocationCategoriesRequest | Request body

begin
  # Update ATM Location Categories
  result = api_instance.update_atm_location_categories(bankid, atmid, update_atm_location_categories_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_location_categories: #{e}"
end
```

#### Using the update_atm_location_categories_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<UpdateAtmLocationCategories200Response>, Integer, Hash)> update_atm_location_categories_with_http_info(bankid, atmid, update_atm_location_categories_request)

```ruby
begin
  # Update ATM Location Categories
  data, status_code, headers = api_instance.update_atm_location_categories_with_http_info(bankid, atmid, update_atm_location_categories_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <UpdateAtmLocationCategories200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_location_categories_with_http_info: #{e}"
end
```
...
bankid = 'bankid_example' # String | The BANKID identifier
atmid = 'atmid_example' # String | The ATMID identifier
update_atm_notes_request = OpenBankProject::UpdateAtmNotesRequest.new # UpdateAtmNotesRequest | Request body

begin
  # Update ATM Notes
  result = api_instance.update_atm_notes(bankid, atmid, update_atm_notes_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_notes: #{e}"
end
```

#### Using the update_atm_notes_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<UpdateAtmNotes200Response>, Integer, Hash)> update_atm_notes_with_http_info(bankid, atmid, update_atm_notes_request)

```ruby
begin
  # Update ATM Notes
  data, status_code, headers = api_instance.update_atm_notes_with_http_info(bankid, atmid, update_atm_notes_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <UpdateAtmNotes200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_notes_with_http_info: #{e}"
end
```
...
bankid = 'bankid_example' # String | The BANKID identifier
atmid = 'atmid_example' # String | The ATMID identifier
update_atm_services_request = OpenBankProject::UpdateAtmServicesRequest.new # UpdateAtmServicesRequest | Request body

begin
  # Update ATM Services
  result = api_instance.update_atm_services(bankid, atmid, update_atm_services_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_services: #{e}"
end
```

#### Using the update_atm_services_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<UpdateAtmServices200Response>, Integer, Hash)> update_atm_services_with_http_info(bankid, atmid, update_atm_services_request)

```ruby
begin
  # Update ATM Services
  data, status_code, headers = api_instance.update_atm_services_with_http_info(bankid, atmid, update_atm_services_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <UpdateAtmServices200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_services_with_http_info: #{e}"
end
```
...
bankid = 'bankid_example' # String | The BANKID identifier
atmid = 'atmid_example' # String | The ATMID identifier
update_atm_supported_currencies_request = OpenBankProject::UpdateAtmSupportedCurrenciesRequest.new # UpdateAtmSupportedCurrenciesRequest | Request body

begin
  # Update ATM Supported Currencies
  result = api_instance.update_atm_supported_currencies(bankid, atmid, update_atm_supported_currencies_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_supported_currencies: #{e}"
end
```

#### Using the update_atm_supported_currencies_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<UpdateAtmSupportedCurrencies200Response>, Integer, Hash)> update_atm_supported_currencies_with_http_info(bankid, atmid, update_atm_supported_currencies_request)

```ruby
begin
  # Update ATM Supported Currencies
  data, status_code, headers = api_instance.update_atm_supported_currencies_with_http_info(bankid, atmid, update_atm_supported_currencies_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <UpdateAtmSupportedCurrencies200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_supported_currencies_with_http_info: #{e}"
end
```
...
bankid = 'bankid_example' # String | The BANKID identifier
atmid = 'atmid_example' # String | The ATMID identifier
update_atm_supported_languages_request = OpenBankProject::UpdateAtmSupportedLanguagesRequest.new # UpdateAtmSupportedLanguagesRequest | Request body

begin
  # Update ATM Supported Languages
  result = api_instance.update_atm_supported_languages(bankid, atmid, update_atm_supported_languages_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_supported_languages: #{e}"
end
```

#### Using the update_atm_supported_languages_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<UpdateAtmSupportedLanguages200Response>, Integer, Hash)> update_atm_supported_languages_with_http_info(bankid, atmid, update_atm_supported_languages_request)

```ruby
begin
  # Update ATM Supported Languages
  data, status_code, headers = api_instance.update_atm_supported_languages_with_http_info(bankid, atmid, update_atm_supported_languages_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <UpdateAtmSupportedLanguages200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling ATMApi->update_atm_supported_languages_with_http_info: #{e}"
end
```
