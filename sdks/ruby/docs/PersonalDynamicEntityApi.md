...
begin
  ...
  puts "Error when calling PersonalDynamicEntityApi->get_available_personal_dynamic_entities: #{e}"
end
```
...
begin
  ...
  puts "Error when calling PersonalDynamicEntityApi->get_available_personal_dynamic_entities_with_http_info: #{e}"
end
```
