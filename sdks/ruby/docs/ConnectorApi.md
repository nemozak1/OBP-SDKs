...
begin
  ...
  puts "Error when calling ConnectorApi->get_connectors: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ConnectorApi->get_connectors_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ConnectorApi->get_stored_procedure_connector_health: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ConnectorApi->get_stored_procedure_connector_health_with_http_info: #{e}"
end
```
