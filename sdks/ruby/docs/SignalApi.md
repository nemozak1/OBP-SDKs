...
begin
  ...
  puts "Error when calling SignalApi->delete_signal_channel: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->delete_signal_channel_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->get_signal_channel_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->get_signal_channel_info_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->get_signal_channels: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->get_signal_channels_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->get_signal_messages: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->get_signal_messages_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->get_signal_stats: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->get_signal_stats_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->publish_signal_message: #{e}"
end
```
...
begin
  ...
  puts "Error when calling SignalApi->publish_signal_message_with_http_info: #{e}"
end
```
