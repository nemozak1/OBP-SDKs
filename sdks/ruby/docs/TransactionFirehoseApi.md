...
begin
  ...
  puts "Error when calling TransactionFirehoseApi->get_firehose_transactions_for_bank_account: #{e}"
end
```
...
begin
  ...
  puts "Error when calling TransactionFirehoseApi->get_firehose_transactions_for_bank_account_with_http_info: #{e}"
end
```
