...
begin
  ...
  puts "Error when calling FirehoseDataApi->get_fast_firehose_accounts_at_one_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling FirehoseDataApi->get_fast_firehose_accounts_at_one_bank_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling FirehoseDataApi->get_firehose_accounts_at_one_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling FirehoseDataApi->get_firehose_accounts_at_one_bank_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling FirehoseDataApi->get_firehose_customers: #{e}"
end
```
...
begin
  ...
  puts "Error when calling FirehoseDataApi->get_firehose_customers_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling FirehoseDataApi->get_firehose_transactions_for_bank_account: #{e}"
end
```
...
begin
  ...
  puts "Error when calling FirehoseDataApi->get_firehose_transactions_for_bank_account_with_http_info: #{e}"
end
```
