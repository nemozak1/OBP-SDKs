...
begin
  ...
  puts "Error when calling VRPApi->create_consent_by_consent_request_id_email: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VRPApi->create_consent_by_consent_request_id_email_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VRPApi->create_vrp_consent_request: #{e}"
end
```
...
begin
  ...
  puts "Error when calling VRPApi->create_vrp_consent_request_with_http_info: #{e}"
end
```
