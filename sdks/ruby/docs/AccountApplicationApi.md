...
begin
  ...
  puts "Error when calling AccountApplicationApi->create_account_application: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AccountApplicationApi->create_account_application_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AccountApplicationApi->get_account_application: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AccountApplicationApi->get_account_application_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AccountApplicationApi->get_account_applications: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AccountApplicationApi->get_account_applications_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AccountApplicationApi->update_account_application_status: #{e}"
end
```
...
begin
  ...
  puts "Error when calling AccountApplicationApi->update_account_application_status_with_http_info: #{e}"
end
```
