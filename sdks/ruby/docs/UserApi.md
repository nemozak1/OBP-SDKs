...
begin
  ...
  puts "Error when calling UserApi->add_entitlement: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->add_entitlement_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->add_entitlement_request: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->add_entitlement_request_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->add_user_to_group: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->add_user_to_group_with_http_info: #{e}"
end
```
...
begin
  # Answer User Auth Context Update Challenge
  result = api_instance.answer_user_auth_context_update_challenge(bankid, authcontextupdateid, answer_consent_challenge_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->answer_user_auth_context_update_challenge: #{e}"
end
```

#### Using the answer_user_auth_context_update_challenge_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<AnswerUserAuthContextUpdateChallenge200Response>, Integer, Hash)> answer_user_auth_context_update_challenge_with_http_info(bankid, authcontextupdateid, answer_consent_challenge_request)

```ruby
begin
  # Answer User Auth Context Update Challenge
  data, status_code, headers = api_instance.answer_user_auth_context_update_challenge_with_http_info(bankid, authcontextupdateid, answer_consent_challenge_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <AnswerUserAuthContextUpdateChallenge200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->answer_user_auth_context_update_challenge_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->create_personal_data_field: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->create_personal_data_field_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->create_user_attribute: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->create_user_attribute_with_http_info: #{e}"
end
```
...
api_instance = OpenBankProject::UserApi.new
userid = 'userid_example' # String | The USERID identifier
get_explicit_counterparty_by_id200_response_bespoke_inner = OpenBankProject::GetExplicitCounterpartyById200ResponseBespokeInner.new # GetExplicitCounterpartyById200ResponseBespokeInner | Request body

begin
  # Create User Auth Context
  result = api_instance.create_user_auth_context(userid, get_explicit_counterparty_by_id200_response_bespoke_inner)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->create_user_auth_context: #{e}"
end
```

#### Using the create_user_auth_context_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetUserAuthContexts200Response>, Integer, Hash)> create_user_auth_context_with_http_info(userid, get_explicit_counterparty_by_id200_response_bespoke_inner)

```ruby
begin
  # Create User Auth Context
  data, status_code, headers = api_instance.create_user_auth_context_with_http_info(userid, get_explicit_counterparty_by_id200_response_bespoke_inner)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetUserAuthContexts200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->create_user_auth_context_with_http_info: #{e}"
end
```
...
begin
  # Create User Auth Context Update Request
  result = api_instance.create_user_auth_context_update_request(bankid, scamethod, get_explicit_counterparty_by_id200_response_bespoke_inner)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->create_user_auth_context_update_request: #{e}"
end
```

#### Using the create_user_auth_context_update_request_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<AnswerUserAuthContextUpdateChallenge200Response>, Integer, Hash)> create_user_auth_context_update_request_with_http_info(bankid, scamethod, get_explicit_counterparty_by_id200_response_bespoke_inner)

```ruby
begin
  # Create User Auth Context Update Request
  data, status_code, headers = api_instance.create_user_auth_context_update_request_with_http_info(bankid, scamethod, get_explicit_counterparty_by_id200_response_bespoke_inner)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <AnswerUserAuthContextUpdateChallenge200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->create_user_auth_context_update_request_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->create_user_customer_links: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->create_user_customer_links_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->create_user_with_account_access_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->create_user_with_account_access_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->create_user_with_roles: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->create_user_with_roles_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->delete_entitlement: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->delete_entitlement_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->delete_entitlement_request: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->delete_entitlement_request_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->delete_personal_data_field: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->delete_personal_data_field_with_http_info: #{e}"
end
```
...
> <Array(nil, Integer, Hash)> delete_user_with_http_info(userid)

```ruby
begin
  # Delete a User
  data, status_code, headers = api_instance.delete_user_with_http_info(userid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue OpenBankProject::ApiError => e
...
begin
  ...
  puts "Error when calling UserApi->delete_user_attribute: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->delete_user_attribute_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->delete_user_auth_context_by_id: #{e}"
end
```

#### Using the delete_user_auth_context_by_id_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> delete_user_auth_context_by_id_with_http_info(userid, userauthcontextid)

```ruby
begin
  # Delete User Auth Context
  data, status_code, headers = api_instance.delete_user_auth_context_by_id_with_http_info(userid, userauthcontextid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->delete_user_auth_context_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->delete_user_auth_contexts: #{e}"
end
```

#### Using the delete_user_auth_contexts_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> delete_user_auth_contexts_with_http_info(userid)

```ruby
begin
  # Delete User's Auth Contexts
  data, status_code, headers = api_instance.delete_user_auth_contexts_with_http_info(userid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->delete_user_auth_contexts_with_http_info: #{e}"
end
```
...
begin
  # Direct Login
  result = api_instance.direct_login_endpoint
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->direct_login_endpoint: #{e}"
end
```

#### Using the direct_login_endpoint_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ValidateUserEmailRequest>, Integer, Hash)> direct_login_endpoint_with_http_info

```ruby
begin
  # Direct Login
  data, status_code, headers = api_instance.direct_login_endpoint_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ValidateUserEmailRequest>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->direct_login_endpoint_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_all_entitlement_requests: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_all_entitlement_requests_with_http_info: #{e}"
end
```
...
> <Array(<GetEntitlementsAndPermissions200Response>, Integer, Hash)> get_current_user_with_http_info
...
begin
  # Get User Id (Current)
  result = api_instance.get_current_user_id
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_current_user_id: #{e}"
end
```

#### Using the get_current_user_id_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<AddConsentUserRequest>, Integer, Hash)> get_current_user_id_with_http_info

```ruby
begin
  # Get User Id (Current)
  data, status_code, headers = api_instance.get_current_user_id_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <AddConsentUserRequest>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_current_user_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_at_all_banks: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_at_all_banks_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_at_one_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_at_one_bank_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_for_user: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_for_user_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_for_user_ids_only: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_for_user_ids_only_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_minimal_at_any_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_minimal_at_any_bank_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_minimal_at_one_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_customers_minimal_at_one_bank_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlement_requests: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlement_requests_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlement_requests_for_current_user: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlement_requests_for_current_user_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlements: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlements_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlements_and_permissions: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlements_and_permissions_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlements_by_bank_and_user: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlements_by_bank_and_user_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlements_for_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlements_for_bank_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlements_for_current_user: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_entitlements_for_current_user_with_http_info: #{e}"
end
```
...
begin
  # Get Logout Link
  result = api_instance.get_logout_link
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_logout_link: #{e}"
end
```

#### Using the get_logout_link_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetLogoutLink200Response>, Integer, Hash)> get_logout_link_with_http_info

```ruby
begin
  # Get Logout Link
  data, status_code, headers = api_instance.get_logout_link_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetLogoutLink200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_logout_link_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_my_customers_at_any_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_my_customers_at_any_bank_with_http_info: #{e}"
end
```
...
begin
  # Get My Spaces
  result = api_instance.get_my_spaces
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_my_spaces: #{e}"
end
```

#### Using the get_my_spaces_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetMySpaces200Response>, Integer, Hash)> get_my_spaces_with_http_info

```ruby
begin
  # Get My Spaces
  data, status_code, headers = api_instance.get_my_spaces_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetMySpaces200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_my_spaces_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_permission_for_user_for_bank_account: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_permission_for_user_for_bank_account_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_permissions_for_bank_account: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_permissions_for_bank_account_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_personal_data_field_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_personal_data_field_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_personal_data_fields: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_personal_data_fields_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_providers: #{e}"
end
```
...
> <Array(<GetProviders200Response>, Integer, Hash)> get_providers_with_http_info

```ruby
begin
  # Get Providers
  data, status_code, headers = api_instance.get_providers_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetProviders200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_providers_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_user_attribute_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_user_attribute_by_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_user_attributes: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_user_attributes_with_http_info: #{e}"
end
```
...
begin
  # Get User Auth Contexts
  result = api_instance.get_user_auth_contexts(userid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_user_auth_contexts: #{e}"
end
```

#### Using the get_user_auth_contexts_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetUserAuthContexts200Response>, Integer, Hash)> get_user_auth_contexts_with_http_info(userid)

```ruby
begin
  # Get User Auth Contexts
  data, status_code, headers = api_instance.get_user_auth_contexts_with_http_info(userid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetUserAuthContexts200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_user_auth_contexts_with_http_info: #{e}"
end
```
...
begin
  # Get User by USERNAME
  result = api_instance.get_user_by_provider_and_username(provider, username)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_user_by_provider_and_username: #{e}"
end
```

#### Using the get_user_by_provider_and_username_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetUserByProviderAndUsername200Response>, Integer, Hash)> get_user_by_provider_and_username_with_http_info(provider, username)

```ruby
begin
  # Get User by USERNAME
  data, status_code, headers = api_instance.get_user_by_provider_and_username_with_http_info(provider, username)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetUserByProviderAndUsername200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_user_by_provider_and_username_with_http_info: #{e}"
end
```
...
begin
  # Get User by USER_ID
  result = api_instance.get_user_by_user_id(userid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_user_by_user_id: #{e}"
end
```

#### Using the get_user_by_user_id_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetUsers200ResponseUsersInner>, Integer, Hash)> get_user_by_user_id_with_http_info(userid)

```ruby
begin
  # Get User by USER_ID
  data, status_code, headers = api_instance.get_user_by_user_id_with_http_info(userid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetUsers200ResponseUsersInner>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_user_by_user_id_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_user_group_memberships: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->get_user_group_memberships_with_http_info: #{e}"
end
```
...
begin
  # Get User Lock Status
  result = api_instance.get_user_lock_status(provider, username)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_user_lock_status: #{e}"
end
```

#### Using the get_user_lock_status_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetUserLockStatus200Response>, Integer, Hash)> get_user_lock_status_with_http_info(provider, username)

```ruby
begin
  # Get User Lock Status
  data, status_code, headers = api_instance.get_user_lock_status_with_http_info(provider, username)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetUserLockStatus200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_user_lock_status_with_http_info: #{e}"
end
```
...
> <Array(<GetUsers200Response>, Integer, Hash)> get_users_with_http_info
...
begin
  # Get Users by Email Address
  result = api_instance.get_users_by_email(email)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_users_by_email: #{e}"
end
```

#### Using the get_users_by_email_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetUsersByEmail200Response>, Integer, Hash)> get_users_by_email_with_http_info(email)

```ruby
begin
  # Get Users by Email Address
  data, status_code, headers = api_instance.get_users_by_email_with_http_info(email)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetUsersByEmail200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->get_users_by_email_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->grant_user_access_to_view_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->grant_user_access_to_view_by_id_with_http_info: #{e}"
end
```
...
begin
  # Lock the user
  result = api_instance.lock_user_by_provider_and_username(provider, username)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->lock_user_by_provider_and_username: #{e}"
end
```

#### Using the lock_user_by_provider_and_username_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<LockUserByProviderAndUsername200Response>, Integer, Hash)> lock_user_by_provider_and_username_with_http_info(provider, username)

```ruby
begin
  # Lock the user
  data, status_code, headers = api_instance.lock_user_by_provider_and_username_with_http_info(provider, username)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <LockUserByProviderAndUsername200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->lock_user_by_provider_and_username_with_http_info: #{e}"
end
```
...
begin
  # Refresh User
  result = api_instance.refresh_user(userid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->refresh_user: #{e}"
end
```

#### Using the refresh_user_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<RefreshUser200Response>, Integer, Hash)> refresh_user_with_http_info(userid)

```ruby
begin
  # Refresh User
  data, status_code, headers = api_instance.refresh_user_with_http_info(userid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <RefreshUser200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->refresh_user_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->remove_user_from_group: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->remove_user_from_group_with_http_info: #{e}"
end
```
...
api_instance = OpenBankProject::UserApi.new
reset_password_complete_request = OpenBankProject::ResetPasswordCompleteRequest.new # ResetPasswordCompleteRequest | Request body

begin
  # Complete Password Reset
  result = api_instance.reset_password_complete(reset_password_complete_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->reset_password_complete: #{e}"
end
```

#### Using the reset_password_complete_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ResetPasswordComplete200Response>, Integer, Hash)> reset_password_complete_with_http_info(reset_password_complete_request)

```ruby
begin
  # Complete Password Reset
  data, status_code, headers = api_instance.reset_password_complete_with_http_info(reset_password_complete_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ResetPasswordComplete200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->reset_password_complete_with_http_info: #{e}"
end
```
...
api_instance = OpenBankProject::UserApi.new
reset_password_url_request = OpenBankProject::ResetPasswordUrlRequest.new # ResetPasswordUrlRequest | Request body

begin
  # Create Password Reset URL and Send Email
  result = api_instance.reset_password_url(reset_password_url_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->reset_password_url: #{e}"
end
```

#### Using the reset_password_url_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ResetPasswordUrl200Response>, Integer, Hash)> reset_password_url_with_http_info(reset_password_url_request)

```ruby
begin
  # Create Password Reset URL and Send Email
  data, status_code, headers = api_instance.reset_password_url_with_http_info(reset_password_url_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ResetPasswordUrl200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->reset_password_url_with_http_info: #{e}"
end
```
...
api_instance = OpenBankProject::UserApi.new
reset_password_url_anonymous_request = OpenBankProject::ResetPasswordUrlAnonymousRequest.new # ResetPasswordUrlAnonymousRequest | Request body

begin
  # Request Password Reset Email
  result = api_instance.reset_password_url_anonymous(reset_password_url_anonymous_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->reset_password_url_anonymous: #{e}"
end
```

#### Using the reset_password_url_anonymous_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ResetPasswordComplete200Response>, Integer, Hash)> reset_password_url_anonymous_with_http_info(reset_password_url_anonymous_request)

```ruby
begin
  # Request Password Reset Email
  data, status_code, headers = api_instance.reset_password_url_anonymous_with_http_info(reset_password_url_anonymous_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ResetPasswordComplete200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->reset_password_url_anonymous_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->revoke_user_access_to_view_by_id: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->revoke_user_access_to_view_by_id_with_http_info: #{e}"
end
```
...
begin
  # Sync User
  result = api_instance.sync_external_user(provider, providerid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->sync_external_user: #{e}"
end
```

#### Using the sync_external_user_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<RefreshUser200Response>, Integer, Hash)> sync_external_user_with_http_info(provider, providerid)

```ruby
begin
  # Sync User
  data, status_code, headers = api_instance.sync_external_user_with_http_info(provider, providerid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <RefreshUser200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->sync_external_user_with_http_info: #{e}"
end
```
...
begin
  # Unlock the user
  result = api_instance.unlock_user_by_provider_and_username(provider, username)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->unlock_user_by_provider_and_username: #{e}"
end
```

#### Using the unlock_user_by_provider_and_username_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetUserLockStatus200Response>, Integer, Hash)> unlock_user_by_provider_and_username_with_http_info(provider, username)

```ruby
begin
  # Unlock the user
  data, status_code, headers = api_instance.unlock_user_by_provider_and_username_with_http_info(provider, username)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetUserLockStatus200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->unlock_user_by_provider_and_username_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->update_personal_data_field: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->update_personal_data_field_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->update_user_attribute: #{e}"
end
```
...
begin
  ...
  puts "Error when calling UserApi->update_user_attribute_with_http_info: #{e}"
end
```
...
begin
  # Validate a user
  result = api_instance.validate_user_by_user_id(userid)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->validate_user_by_user_id: #{e}"
end
```

#### Using the validate_user_by_user_id_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ValidateUserByUserId200Response>, Integer, Hash)> validate_user_by_user_id_with_http_info(userid)

```ruby
begin
  # Validate a user
  data, status_code, headers = api_instance.validate_user_by_user_id_with_http_info(userid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ValidateUserByUserId200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->validate_user_by_user_id_with_http_info: #{e}"
end
```
...
api_instance = OpenBankProject::UserApi.new
validate_user_email_request = OpenBankProject::ValidateUserEmailRequest.new # ValidateUserEmailRequest | Request body

begin
  # Validate User Email
  result = api_instance.validate_user_email(validate_user_email_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->validate_user_email: #{e}"
end
```

#### Using the validate_user_email_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ValidateUserEmail200Response>, Integer, Hash)> validate_user_email_with_http_info(validate_user_email_request)

```ruby
begin
  # Validate User Email
  data, status_code, headers = api_instance.validate_user_email_with_http_info(validate_user_email_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ValidateUserEmail200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->validate_user_email_with_http_info: #{e}"
end
```
...
api_instance = OpenBankProject::UserApi.new
verify_user_credentials_request = OpenBankProject::VerifyUserCredentialsRequest.new # VerifyUserCredentialsRequest | Request body

begin
  # Verify User Credentials
  result = api_instance.verify_user_credentials(verify_user_credentials_request)
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->verify_user_credentials: #{e}"
end
```

#### Using the verify_user_credentials_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<VerifyUserCredentials200Response>, Integer, Hash)> verify_user_credentials_with_http_info(verify_user_credentials_request)

```ruby
begin
  # Verify User Credentials
  data, status_code, headers = api_instance.verify_user_credentials_with_http_info(verify_user_credentials_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <VerifyUserCredentials200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling UserApi->verify_user_credentials_with_http_info: #{e}"
end
```
