...
begin
  ...
  puts "Error when calling MetricApi->elastic_search_metrics: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->elastic_search_metrics_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_aggregate_metrics: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_aggregate_metrics_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_connector_call_counts: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_connector_call_counts_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_connector_metrics: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_connector_metrics_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_connector_traces: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_connector_traces_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_metrics: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_metrics_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_metrics_at_bank: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_metrics_at_bank_with_http_info: #{e}"
end
```
...
begin
  # Get Top Consumers
  result = api_instance.get_metrics_top_consumers
  p result
rescue OpenBankProject::ApiError => e
  puts "Error when calling MetricApi->get_metrics_top_consumers: #{e}"
end
```

#### Using the get_metrics_top_consumers_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetMetricsTopConsumers200Response>, Integer, Hash)> get_metrics_top_consumers_with_http_info

```ruby
begin
  # Get Top Consumers
  data, status_code, headers = api_instance.get_metrics_top_consumers_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetMetricsTopConsumers200Response>
rescue OpenBankProject::ApiError => e
  puts "Error when calling MetricApi->get_metrics_top_consumers_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_popular_apis: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_popular_apis_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_top_apis: #{e}"
end
```
...
begin
  ...
  puts "Error when calling MetricApi->get_top_apis_with_http_info: #{e}"
end
```
