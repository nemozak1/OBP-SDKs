...
| ------ | ------------ | ----------- |
| [**create_meeting**](ExperimentalApi.md#create_meeting) | **POST** /obp/v3.1.0/banks/{bankid}/meetings | Create Meeting (video conference/call) |
| [**get_meeting**](ExperimentalApi.md#get_meeting) | **GET** /obp/v3.1.0/banks/{bankid}/meetings/{meetingid} | Get Meeting |
| [**get_meetings**](ExperimentalApi.md#get_meetings) | **GET** /obp/v3.1.0/banks/{bankid}/meetings | Get Meetings |
...
begin
  ...
  puts "Error when calling ExperimentalApi->create_meeting: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExperimentalApi->create_meeting_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExperimentalApi->get_meeting: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExperimentalApi->get_meeting_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExperimentalApi->get_meetings: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ExperimentalApi->get_meetings_with_http_info: #{e}"
end
```
