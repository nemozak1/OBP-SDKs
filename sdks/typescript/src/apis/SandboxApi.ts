...
import {
    SandboxDataImportRequestFromJSON,
    SandboxDataImportRequestToJSON,
    UpdateTransactionNarrative200ResponseFromJSON,
    UpdateTransactionNarrative200ResponseToJSON,
} from '../models/index';

export interface SandboxDataImportOperationRequest {
...
export class SandboxApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for sandboxDataImport without sending the request
     */
    async sandboxDataImportRequestOpts(requestParameters: SandboxDataImportOperationRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['sandboxDataImportRequest'] == null) {
            throw new runtime.RequiredError(
                'sandboxDataImportRequest',
                'Required parameter "sandboxDataImportRequest" was null or undefined when calling sandboxDataImport().'
            );
        }
        ...
        return {
            ...
            body: SandboxDataImportRequestToJSON(requestParameters['sandboxDataImportRequest']),
        };
    }
     ...
     * Create sandbox
     */
    async sandboxDataImportRaw(requestParameters: SandboxDataImportOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UpdateTransactionNarrative200Response>> {
        const requestOptions = await this.sandboxDataImportRequestOpts(requestParameters);
     ...
     * Create sandbox
     */
    async sandboxDataImport(requestParameters: SandboxDataImportOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UpdateTransactionNarrative200Response> {
        const response = await this.sandboxDataImportRaw(requestParameters, initOverrides);
