...
import {
    GetAggregateMetrics200ResponseFromJSON,
    GetAggregateMetrics200ResponseToJSON,
    ...
    GetMetricsTopConsumers200ResponseFromJSON,
    GetMetricsTopConsumers200ResponseToJSON,
...
export class MetricApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for getAggregateMetrics without sending the request
     */
    async getAggregateMetricsRequestOpts(): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
     ...
     */
    async getAggregateMetricsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAggregateMetrics200Response>> {
        const requestOptions = await this.getAggregateMetricsRequestOpts();
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => GetAggregateMetrics200ResponseFromJSON(jsonValue));
    }
     ...
     * Get Aggregate Metrics
     */
    async getAggregateMetrics(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetAggregateMetrics200Response> {
        const response = await this.getAggregateMetricsRaw(initOverrides);
        return await response.value();
    }
    ...
    /**
     * Creates request options for getMetricsTopConsumers without sending the request
     */
    async getMetricsTopConsumersRequestOpts(): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
     ...
     * Get Top Consumers
     */
    async getMetricsTopConsumersRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetMetricsTopConsumers200Response>> {
        const requestOptions = await this.getMetricsTopConsumersRequestOpts();
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => GetMetricsTopConsumers200ResponseFromJSON(jsonValue));
    }
     ...
     * Get Top Consumers
     */
    async getMetricsTopConsumers(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetMetricsTopConsumers200Response> {
        const response = await this.getMetricsTopConsumersRaw(initOverrides);
        return await response.value();
    }
