...
|------------- | ------------- | -------------|
| [**addKycCheck**](KYCApi.md#addkyccheckoperation) | **PUT** /obp/v2.0.0/banks/{bankid}/customers/{customerid}/kyc_check/{kyccheckid} | Add KYC Check |
| [**addKycDocument**](KYCApi.md#addkycdocumentoperation) | **PUT** /obp/v2.0.0/banks/{bankid}/customers/{customerid}/kyc_documents/{kycdocumentid} | Add KYC Document |
| [**addKycMedia**](KYCApi.md#addkycmediaoperation) | **PUT** /obp/v2.0.0/banks/{bankid}/customers/{customerid}/kyc_media/{kycmediaid} | Add KYC Media |
| [**addKycStatus**](KYCApi.md#addkycstatusoperation) | **PUT** /obp/v2.0.0/banks/{bankid}/customers/{customerid}/kyc_statuses | Add KYC Status |
| [**createTaxResidence**](KYCApi.md#createtaxresidenceoperation) | **POST** /obp/v3.1.0/banks/{bankid}/customers/{customerid}/tax-residence | Create Tax Residence |
| [**createUserInvitation**](KYCApi.md#createuserinvitationoperation) | **POST** /obp/v4.0.0/banks/{bankid}/user-invitation | Create User Invitation |
...
| [**getCustomerOverviewFlat**](KYCApi.md#getcustomeroverviewflatoperation) | **POST** /obp/v5.0.0/banks/{bankid}/customers/customer-number-query/overview-flat | Get Customer Overview Flat |
...
| [**getCustomersByLegalName**](KYCApi.md#getcustomersbylegalnameoperation) | **POST** /obp/v6.0.0/banks/{bankid}/customers/legal-name | Get Customers by Legal Name |
...
| [**getUserInvitationAnonymous**](KYCApi.md#getuserinvitationanonymousoperation) | **POST** /obp/v4.0.0/banks/{bankid}/user-invitations | Get User Invitation Information |
...
import type { AddKycCheckOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // AddKycCheckRequest | Request body
    addKycCheckRequest: {"type":"object","properties":{"customer_number":{"type":"string"},"staff_user_id":{"type":"string"},"date":{"type":"string","format":"date-time"},"staff_name":{"type":"string"},"comments":{"type":"string"},"how":{"type":"string"},"satisfied":{"type":"boolean"}}},
  } satisfies AddKycCheckOperationRequest;

  try {
    const data = await api.addKycCheck(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { AddKycDocumentOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // AddKycDocumentRequest | Request body
    addKycDocumentRequest: {"type":"object","properties":{"issue_place":{"type":"string"},"issue_date":{"type":"string","format":"date-time"},"expiry_date":{"type":"string","format":"date-time"},"customer_number":{"type":"string"},"type":{"type":"string"},"number":{"type":"string"}}},
  } satisfies AddKycDocumentOperationRequest;

  try {
    const data = await api.addKycDocument(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { AddKycMediaOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // AddKycMediaRequest | Request body
    addKycMediaRequest: {"type":"object","properties":{"url":{"type":"string"},"customer_number":{"type":"string"},"relates_to_kyc_check_id":{"type":"string"},"date":{"type":"string","format":"date-time"},"relates_to_kyc_document_id":{"type":"string"},"type":{"type":"string"}}},
  } satisfies AddKycMediaOperationRequest;

  try {
    const data = await api.addKycMedia(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { AddKycStatusOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The CUSTOMERID identifier
    customerid: customerid_example,
    // AddKycStatusRequest | Request body
    addKycStatusRequest: {"type":"object","properties":{"customer_number":{"type":"string"},"ok":{"type":"boolean"},"date":{"type":"string","format":"date-time"}}},
  } satisfies AddKycStatusOperationRequest;

  try {
    const data = await api.addKycStatus(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateTaxResidenceOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The CUSTOMERID identifier
    customerid: customerid_example,
    // CreateTaxResidenceRequest | Request body
    createTaxResidenceRequest: {"type":"object","properties":{"tax_number":{"type":"string"},"domain":{"type":"string"}}},
  } satisfies CreateTaxResidenceOperationRequest;

  try {
    const data = await api.createTaxResidence(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DeleteCustomerAddressRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies DeleteCustomerAddressRequest;

  try {
    const data = await api.deleteCustomerAddress(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DeleteTaxResidenceRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies DeleteTaxResidenceRequest;

  try {
    const data = await api.deleteTaxResidence(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetCustomerAddressesRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The CUSTOMERID identifier
    customerid: customerid_example,
  } satisfies GetCustomerAddressesRequest;

  try {
    const data = await api.getCustomerAddresses(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetCustomerByCustomerNumberRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The BANKID identifier
    bankid: bankid_example,
    // GetCustomerOverviewFlatRequest | Request body
    getCustomerOverviewFlatRequest: {type=object, properties={customer_number={type=string}}},
  } satisfies GetCustomerByCustomerNumberRequest;

  try {
    const data = await api.getCustomerByCustomerNumber(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetCustomerOverviewRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // GetCustomerOverviewFlatRequest | Request body
    getCustomerOverviewFlatRequest: {type=object, properties={customer_number={type=string}}},
  } satisfies GetCustomerOverviewRequest;

  try {
    const data = await api.getCustomerOverview(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetCustomerOverviewFlatOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // GetCustomerOverviewFlatRequest | Request body
    getCustomerOverviewFlatRequest: {"type":"object","properties":{"customer_number":{"type":"string"}}},
  } satisfies GetCustomerOverviewFlatOperationRequest;

  try {
    const data = await api.getCustomerOverviewFlat(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetCustomersByCustomerPhoneNumberRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The BANKID identifier
    bankid: bankid_example,
    // CreateTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo | Request body
    createTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo: {"type":"object","properties":{"mobile_phone_number":{"type":"string"}}},
  } satisfies GetCustomersByCustomerPhoneNumberRequest;

  try {
    const data = await api.getCustomersByCustomerPhoneNumber(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetCustomersByLegalNameOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The BANKID identifier
    bankid: bankid_example,
    // GetCustomersByLegalNameRequest | Request body
    getCustomersByLegalNameRequest: {"type":"object","properties":{"legal_name":{"type":"string"}}},
  } satisfies GetCustomersByLegalNameOperationRequest;

  try {
    const data = await api.getCustomersByLegalName(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetKycChecksRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The CUSTOMERID identifier
    customerid: customerid_example,
  } satisfies GetKycChecksRequest;

  try {
    const data = await api.getKycChecks(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetKycDocumentsRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The CUSTOMERID identifier
    customerid: customerid_example,
  } satisfies GetKycDocumentsRequest;

  try {
    const data = await api.getKycDocuments(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetKycMediaRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The CUSTOMERID identifier
    customerid: customerid_example,
  } satisfies GetKycMediaRequest;

  try {
    const data = await api.getKycMedia(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetKycStatusesRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The CUSTOMERID identifier
    customerid: customerid_example,
  } satisfies GetKycStatusesRequest;

  try {
    const data = await api.getKycStatuses(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetTaxResidenceRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The CUSTOMERID identifier
    customerid: customerid_example,
  } satisfies GetTaxResidenceRequest;

  try {
    const data = await api.getTaxResidence(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
