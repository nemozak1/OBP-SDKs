...
```typescript
import type { AddAccount200Response } from 'obp-typescript'
...
const example = {
  ...
  "productCode": null,
  "accountId": null,
} satisfies AddAccount200Response
...
const exampleParsed = JSON.parse(exampleJSON) as AddAccount200Response
