...
```typescript
import type { CreateConsentImplicitRequest } from 'obp-typescript'
...
const example = {
  ...
  "views": null,
  "entitlements": null,
} satisfies CreateConsentImplicitRequest
...
const exampleParsed = JSON.parse(exampleJSON) as CreateConsentImplicitRequest
