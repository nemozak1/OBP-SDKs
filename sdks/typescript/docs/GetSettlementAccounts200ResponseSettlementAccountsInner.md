...
```typescript
import type { GetSettlementAccounts200ResponseSettlementAccountsInner } from 'obp-typescript'
...
const example = {
  ...
  "paymentSystem": null,
  "accountId": null,
} satisfies GetSettlementAccounts200ResponseSettlementAccountsInner
...
const exampleParsed = JSON.parse(exampleJSON) as GetSettlementAccounts200ResponseSettlementAccountsInner
