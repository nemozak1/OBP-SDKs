...
```typescript
import type { AddCardForBank200Response } from 'obp-typescript'
...
const example = {
  ...
  "cardType": null,
  "onHotList": null,
} satisfies AddCardForBank200Response
...
const exampleParsed = JSON.parse(exampleJSON) as AddCardForBank200Response
