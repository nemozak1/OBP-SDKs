...
|------------- | ------------- | -------------|
| [**createAccountWebhook**](WebhookApi.md#createaccountwebhookoperation) | **POST** /obp/v3.1.0/banks/{bankid}/account-web-hooks | Create an Account Webhook |
...
| [**createSystemAccountNotificationWebhook**](WebhookApi.md#createsystemaccountnotificationwebhookoperation) | **POST** /obp/v4.0.0/web-hooks/account/notifications/on-create-transaction | Create system level Account Notification Webhook |
| [**enableDisableAccountWebhook**](WebhookApi.md#enabledisableaccountwebhookoperation) | **PUT** /obp/v3.1.0/banks/{bankid}/account-web-hooks | Enable/Disable an Account Webhook |
