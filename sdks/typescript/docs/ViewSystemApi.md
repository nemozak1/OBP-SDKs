...
|------------- | ------------- | -------------|
| [**addSystemViewPermission**](ViewSystemApi.md#addsystemviewpermissionoperation) | **POST** /obp/v5.1.0/system-views/{viewid}/permissions | Add Permission to a System View |
| [**createSystemView**](ViewSystemApi.md#createsystemviewoperation) | **POST** /obp/v5.0.0/system-views | Create System View |
...
| [**updateSystemView**](ViewSystemApi.md#updatesystemviewoperation) | **PUT** /obp/v6.0.0/system-views/{viewid} | Update System View |
...
import type { AddSystemViewPermissionOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // AddSystemViewPermissionRequest | Request body
    addSystemViewPermissionRequest: {"type":"object","properties":{"extra_data":{"type":"array","items":{"type":"string"}},"permission_name":{"type":"string"}}},
  } satisfies AddSystemViewPermissionOperationRequest;

  try {
    const data = await api.addSystemViewPermission(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateSystemViewOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // CreateSystemViewRequest | Request body
    createSystemViewRequest: {"type":"object","properties":{"hide_metadata_if_alias_used":{"type":"boolean"},"description":{"type":"string"},"is_public":{"type":"boolean"},"which_alias_to_use":{"type":"string"},"can_revoke_access_to_views":{"type":"array","items":{"type":"string"}},"can_grant_access_to_views":{"type":"array","items":{"type":"string"}},"name":{"type":"string"},"allowed_actions":{"type":"array","items":{"type":"string"}},"metadata_view":{"type":"string"}}},
  } satisfies CreateSystemViewOperationRequest;

  try {
    const data = await api.createSystemView(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DeleteSystemViewRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The VIEWID identifier
    viewid: viewid_example,
  } satisfies DeleteSystemViewRequest;

  try {
    const data = await api.deleteSystemView(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DeleteSystemViewPermissionRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies DeleteSystemViewPermissionRequest;

  try {
    const data = await api.deleteSystemViewPermission(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetSystemViewRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The VIEWID identifier
    viewid: viewid_example,
  } satisfies GetSystemViewRequest;

  try {
    const data = await api.getSystemView(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetSystemViewsIdsRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.getSystemViewsIds();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
