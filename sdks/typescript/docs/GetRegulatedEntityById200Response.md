...
```typescript
import type { GetRegulatedEntityById200Response } from 'obp-typescript'
...
} satisfies GetRegulatedEntityById200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetRegulatedEntityById200Response
