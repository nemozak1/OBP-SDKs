...
```typescript
import type { GetTransactionByIdForBankAccount200ResponseOtherAccount } from 'obp-typescript'
...
const example = {
  ...
  "metadata": null,
  "bankRouting": null,
} satisfies GetTransactionByIdForBankAccount200ResponseOtherAccount
...
const exampleParsed = JSON.parse(exampleJSON) as GetTransactionByIdForBankAccount200ResponseOtherAccount
