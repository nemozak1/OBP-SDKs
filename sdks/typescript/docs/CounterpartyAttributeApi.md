...
|------------- | ------------- | -------------|
| [**createCounterpartyAttribute**](CounterpartyAttributeApi.md#createcounterpartyattributeoperation) | **POST** /obp/v6.0.0/banks/{bankid}/accounts/{accountid}/counterparties/{counterpartyid}/attributes | Create Counterparty Attribute |
...
async function example() {
  ...
  const api = new CounterpartyAttributeApi(config);
