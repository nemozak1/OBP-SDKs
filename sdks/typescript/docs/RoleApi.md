...
| [**createUserWithRoles**](RoleApi.md#createuserwithrolesoperation) | **POST** /obp/v4.0.0/user-entitlements | Create (DAuth) User with Roles |
...
import type { GetRolesRequest } from 'obp-typescript';
