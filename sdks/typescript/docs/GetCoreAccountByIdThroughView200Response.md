...
```typescript
import type { GetCoreAccountByIdThroughView200Response } from 'obp-typescript'
...
const example = {
  ...
  "bankId": null,
  "id": null,
} satisfies GetCoreAccountByIdThroughView200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetCoreAccountByIdThroughView200Response
