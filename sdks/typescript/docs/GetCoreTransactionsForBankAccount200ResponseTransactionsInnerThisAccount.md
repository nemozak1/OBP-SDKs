...
```typescript
import type { GetCoreTransactionsForBankAccount200ResponseTransactionsInnerThisAccount } from 'obp-typescript'
...
const example = {
  ...
  "holders": null,
  "id": null,
} satisfies GetCoreTransactionsForBankAccount200ResponseTransactionsInnerThisAccount
...
const exampleParsed = JSON.parse(exampleJSON) as GetCoreTransactionsForBankAccount200ResponseTransactionsInnerThisAccount
