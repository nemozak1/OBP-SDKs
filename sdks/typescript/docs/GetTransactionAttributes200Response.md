...
```typescript
import type { GetTransactionAttributes200Response } from 'obp-typescript'

// TODO: Update the object below with actual values
const example = {
  "transactionAttributes": null,
} satisfies GetTransactionAttributes200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetTransactionAttributes200Response
