...
```typescript
import type { CreateSystemDynamicEntity200Response } from 'obp-typescript'
...
} satisfies CreateSystemDynamicEntity200Response
...
const exampleParsed = JSON.parse(exampleJSON) as CreateSystemDynamicEntity200Response
