...
```typescript
import type { GetBankLevelDynamicEntities200ResponseDynamicEntitiesInner } from 'obp-typescript'
...
} satisfies GetBankLevelDynamicEntities200ResponseDynamicEntitiesInner
...
const exampleParsed = JSON.parse(exampleJSON) as GetBankLevelDynamicEntities200ResponseDynamicEntitiesInner
