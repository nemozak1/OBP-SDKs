...
`moreInfoUrl` | string
`attributes` | [Array&lt;CreateApiProductAttribute200Response&gt;](CreateApiProductAttribute200Response.md)
...
```typescript
import type { GetApiProducts200ResponseApiProductsInner } from 'obp-typescript'
...
} satisfies GetApiProducts200ResponseApiProductsInner
...
const exampleParsed = JSON.parse(exampleJSON) as GetApiProducts200ResponseApiProductsInner
