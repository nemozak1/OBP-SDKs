...
```typescript
import type { GetCustomerChildren200ResponseCustomersInner } from 'obp-typescript'
...
const example = {
  ...
  "kycStatus": null,
} satisfies GetCustomerChildren200ResponseCustomersInner
...
const exampleParsed = JSON.parse(exampleJSON) as GetCustomerChildren200ResponseCustomersInner
