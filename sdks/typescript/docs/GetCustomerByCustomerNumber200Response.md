...
```typescript
import type { GetCustomerByCustomerNumber200Response } from 'obp-typescript'
...
const example = {
  ...
  "kycStatus": null,
} satisfies GetCustomerByCustomerNumber200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetCustomerByCustomerNumber200Response
