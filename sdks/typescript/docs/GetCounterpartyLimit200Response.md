...
```typescript
import type { GetCounterpartyLimit200Response } from 'obp-typescript'
...
const example = {
  ...
  "counterpartyId": null,
  "maxTotalAmount": null,
} satisfies GetCounterpartyLimit200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetCounterpartyLimit200Response
