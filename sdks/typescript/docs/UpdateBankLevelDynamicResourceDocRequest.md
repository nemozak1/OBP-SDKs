...
```typescript
import type { UpdateBankLevelDynamicResourceDocRequest } from 'obp-typescript'
...
const example = {
  ...
  "bankId": null,
  "roles": null,
  "partialFunctionName": null,
  "methodBody": null,
  "summary": null,
} satisfies UpdateBankLevelDynamicResourceDocRequest
...
const exampleParsed = JSON.parse(exampleJSON) as UpdateBankLevelDynamicResourceDocRequest
