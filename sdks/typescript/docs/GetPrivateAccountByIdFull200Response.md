...
`viewsAvailable` | [Array&lt;GetSystemViewById200Response&gt;](GetSystemViewById200Response.md)
...
```typescript
import type { GetPrivateAccountByIdFull200Response } from 'obp-typescript'
...
const example = {
  ...
  "bankId": null,
  "id": null,
} satisfies GetPrivateAccountByIdFull200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetPrivateAccountByIdFull200Response
