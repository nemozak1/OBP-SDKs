...
| [**createProduct**](ProductApi.md#createproductoperation) | **PUT** /obp/v5.0.0/banks/{bankid}/products/{productcode} | Create Product |
...
| [**createProductCollection**](ProductApi.md#createproductcollectionoperation) | **PUT** /obp/v3.1.0/banks/{bankid}/product-collections/{collectioncode} | Create Product Collection |
...
| [**updateProductFee**](ProductApi.md#updateproductfeeoperation) | **PUT** /obp/v4.0.0/banks/{bankid}/products/{productcode}/fees/{productfeeid} | Update Product Fee |
...
import type { CreateOrUpdateProductAttributeDefinitionRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies CreateOrUpdateProductAttributeDefinitionRequest;

  try {
    const data = await api.createOrUpdateProductAttributeDefinition(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateProductOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    createProductRequest: {"type":"object","properties":{"description":{"type":"string"},"more_info_url":{"type":"string"},"terms_and_conditions_url":{"type":"string"},"parent_product_code":{"type":"string"},"meta":{"type":"object","properties":{"license":{"type":"object","properties":{"name":{"type":"string"},"id":{"type":"string"}}}}},"name":{"type":"string"}}},
...
import type { CreateProductAttributeRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies CreateProductAttributeRequest;

  try {
    const data = await api.createProductAttribute(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateProductFeeRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The PRODUCTCODE identifier
    productcode: productcode_example,
    // UpdateProductFeeRequest | Request body
    updateProductFeeRequest: {type=object, properties={is_active={type=boolean}, name={type=string}, more_info={type=string}, value={type=object, properties={type={type=string}, currency={type=string}, frequency={type=string}, amount={type=number}}}}},
  } satisfies CreateProductFeeRequest;

  try {
    const data = await api.createProductFee(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DeleteProductAttributeRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies DeleteProductAttributeRequest;

  try {
    const data = await api.deleteProductAttribute(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DeleteProductAttributeDefinitionRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies DeleteProductAttributeDefinitionRequest;

  try {
    const data = await api.deleteProductAttributeDefinition(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DeleteProductCascadeRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The PRODUCTCODE identifier
    productcode: productcode_example,
  } satisfies DeleteProductCascadeRequest;

  try {
    const data = await api.deleteProductCascade(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DeleteProductFeeRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies DeleteProductFeeRequest;

  try {
    const data = await api.deleteProductFee(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetProductRequest } from 'obp-typescript';
...
import type { GetProductAttributeRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The PRODUCTATTRIBUTEID identifier
    productattributeid: productattributeid_example,
  } satisfies GetProductAttributeRequest;

  try {
    const data = await api.getProductAttribute(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetProductAttributeDefinitionRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The BANKID identifier
    bankid: bankid_example,
  } satisfies GetProductAttributeDefinitionRequest;

  try {
    const data = await api.getProductAttributeDefinition(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetProductFeeRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The PRODUCTFEEID identifier
    productfeeid: productfeeid_example,
  } satisfies GetProductFeeRequest;

  try {
    const data = await api.getProductFee(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetProductFeesRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The PRODUCTCODE identifier
    productcode: productcode_example,
  } satisfies GetProductFeesRequest;

  try {
    const data = await api.getProductFees(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetProductTreeRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The PRODUCTCODE identifier
    productcode: productcode_example,
  } satisfies GetProductTreeRequest;

  try {
    const data = await api.getProductTree(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetProductsRequest } from 'obp-typescript';
...
import type { UpdateProductAttributeRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // UpdateAtmAttributeRequest | Request body
    updateAtmAttributeRequest: {type=object, properties={name={type=string}, value={type=string}, is_active={type=boolean}, type={type=string}}},
  } satisfies UpdateProductAttributeRequest;

  try {
    const data = await api.updateProductAttribute(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateProductFeeOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // UpdateProductFeeRequest | Request body
    updateProductFeeRequest: {"type":"object","properties":{"is_active":{"type":"boolean"},"name":{"type":"string"},"more_info":{"type":"string"},"value":{"type":"object","properties":{"type":{"type":"string"},"currency":{"type":"string"},"frequency":{"type":"string"},"amount":{"type":"number"}}}}},
  } satisfies UpdateProductFeeOperationRequest;

  try {
    const data = await api.updateProductFee(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
