...
|------------- | ------------- | -------------|
| [**addConsentUser**](AccountInformationServiceAISApi.md#addconsentuseroperation) | **PUT** /obp/v4.0.0/banks/{bankid}/consents/{consentid}/user-update-request | Add User to a Consent |
| [**answerConsentChallenge**](AccountInformationServiceAISApi.md#answerconsentchallengeoperation) | **POST** /obp/v3.1.0/banks/{bankid}/consents/{consentid}/challenge | Answer Consent Challenge |
...
| [**createConsentEmail**](AccountInformationServiceAISApi.md#createconsentemailoperation) | **POST** /obp/v3.1.0/banks/{bankid}/my/consents/{email} | Create Consent (EMAIL) |
| [**createConsentImplicit**](AccountInformationServiceAISApi.md#createconsentimplicitoperation) | **POST** /obp/v5.1.0/my/consents/{implicit} | Create Consent (IMPLICIT) |
| [**createConsentRequest**](AccountInformationServiceAISApi.md#createconsentrequestoperation) | **POST** /obp/v5.0.0/consumer/consent-requests | Create Consent Request |
| [**createConsentSms**](AccountInformationServiceAISApi.md#createconsentsmsoperation) | **POST** /obp/v3.1.0/banks/{bankid}/my/consents/{sms} | Create Consent (SMS) |
...
| [**updateConsentAccountAccessByConsentId**](AccountInformationServiceAISApi.md#updateconsentaccountaccessbyconsentidoperation) | **PUT** /obp/v5.1.0/management/banks/{bankid}/consents/{consentid}/account-access | Update Consent Account Access by CONSENT_ID |
...
import type { AddConsentUserOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    addConsentUserRequest: {"type":"object","properties":{"user_id":{"type":"string"}}},
  } satisfies AddConsentUserOperationRequest;

  try {
    const data = await api.addConsentUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateConsentAccountAccessByConsentIdOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    updateConsentAccountAccessByConsentIdRequest: {"type":"object","properties":{"access":{"type":"object","properties":{"accounts":{"type":"array","items":{"type":"object","properties":{"iban":{"type":"string"}}}}}}}},
  } satisfies UpdateConsentAccountAccessByConsentIdOperationRequest;

  try {
    const data = await api.updateConsentAccountAccessByConsentId(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateConsentStatusRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies UpdateConsentStatusRequest;

  try {
    const data = await api.updateConsentStatus(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateConsentStatusByConsentRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // UpdateTransactionRequestStatusRequest | Request body
    updateTransactionRequestStatusRequest: {type=object, properties={status={type=string}}},
  } satisfies UpdateConsentStatusByConsentRequest;

  try {
    const data = await api.updateConsentStatusByConsent(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateConsentUserIdByConsentIdRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // AddConsentUserRequest | Request body
    addConsentUserRequest: {type=object, properties={user_id={type=string}}},
  } satisfies UpdateConsentUserIdByConsentIdRequest;

  try {
    const data = await api.updateConsentUserIdByConsentId(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
