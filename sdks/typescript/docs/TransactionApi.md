...
| [**addImageForViewOnTransaction**](TransactionApi.md#addimageforviewontransactionoperation) | **POST** /obp/v1.2.1/banks/{bankid}/accounts/{accountid}/{viewid}/transactions/{transactionid}/metadata/images | Add a Transaction Image |
...
| [**updateWhereTagForViewOnTransaction**](TransactionApi.md#updatewheretagforviewontransactionoperation) | **PUT** /obp/v1.2.1/banks/{bankid}/accounts/{accountid}/{viewid}/transactions/{transactionid}/metadata/where | Update a Transaction where Tag |
...
import type { CreateOrUpdateTransactionAttributeDefinitionRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies CreateOrUpdateTransactionAttributeDefinitionRequest;

  try {
    const data = await api.createOrUpdateTransactionAttributeDefinition(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { CreateTransactionAttributeRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies CreateTransactionAttributeRequest;

  try {
    const data = await api.createTransactionAttribute(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DeleteTransactionAttributeDefinitionRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies DeleteTransactionAttributeDefinitionRequest;

  try {
    const data = await api.deleteTransactionAttributeDefinition(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DeleteTransactionCascadeRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The TRANSACTIONID identifier
    transactionid: transactionid_example,
  } satisfies DeleteTransactionCascadeRequest;

  try {
    const data = await api.deleteTransactionCascade(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetBalancingTransactionRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The TRANSACTIONID identifier
    transactionid: transactionid_example,
  } satisfies GetBalancingTransactionRequest;

  try {
    const data = await api.getBalancingTransaction(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetDoubleEntryTransactionRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The TRANSACTIONID identifier
    transactionid: transactionid_example,
  } satisfies GetDoubleEntryTransactionRequest;

  try {
    const data = await api.getDoubleEntryTransaction(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetTransactionAttributeByIdRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies GetTransactionAttributeByIdRequest;

  try {
    const data = await api.getTransactionAttributeById(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetTransactionAttributeDefinitionRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The BANKID identifier
    bankid: bankid_example,
  } satisfies GetTransactionAttributeDefinitionRequest;

  try {
    const data = await api.getTransactionAttributeDefinition(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetTransactionAttributesRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The TRANSACTIONID identifier
    transactionid: transactionid_example,
  } satisfies GetTransactionAttributesRequest;

  try {
    const data = await api.getTransactionAttributes(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetTransactionByIdForBankAccountRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The TRANSACTIONID identifier
    transactionid: transactionid_example,
  } satisfies GetTransactionByIdForBankAccountRequest;

  try {
    const data = await api.getTransactionByIdForBankAccount(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdateTransactionAttributeRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // CreatePersonalDataFieldRequest | Request body
    createPersonalDataFieldRequest: {type=object, properties={name={type=string}, type={type=string}, value={type=string}}},
  } satisfies UpdateTransactionAttributeRequest;

  try {
    const data = await api.updateTransactionAttribute(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
