...
| [**addUserToGroup**](EntitlementApi.md#addusertogroupoperation) | **POST** /obp/v6.0.0/users/{userid}/group-entitlements | Grant User Membership to Group Entitlements |
| [**createUserWithRoles**](EntitlementApi.md#createuserwithrolesoperation) | **POST** /obp/v4.0.0/user-entitlements | Create (DAuth) User with Roles |
...
import type { GetAllEntitlementsRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.getAllEntitlements();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetRolesWithEntitlementCountsAtAllBanksRequest } from 'obp-typescript';
...
async function example() {
  ...
  try {
    const data = await api.getRolesWithEntitlementCountsAtAllBanks();
    console.log(data);
  } catch (error) {
    console.error(error);
  }
