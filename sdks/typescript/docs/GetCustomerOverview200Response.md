...
`kycStatus` | boolean
`accounts` | [Array&lt;GetCustomerOverview200ResponseAccountsInner&gt;](GetCustomerOverview200ResponseAccountsInner.md)

## Example

```typescript
import type { GetCustomerOverview200Response } from 'obp-typescript'
...
const example = {
  ...
  "kycStatus": null,
  "accounts": null,
} satisfies GetCustomerOverview200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetCustomerOverview200Response
