...
|------------- | ------------- | -------------|
| [**addCardForBank**](CardApi.md#addcardforbankoperation) | **POST** /obp/v5.0.0/management/banks/{bankid}/cards | Create Card |
...
| [**updatedCardForBank**](CardApi.md#updatedcardforbankoperation) | **PUT** /obp/v3.1.0/management/banks/{bankid}/cards/{cardid} | Update Card |
...
import type { AddCardForBankOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    addCardForBankRequest: {"type":"object","properties":{"card_number":{"type":"string"},"enabled":{"type":"boolean"},"expires_date":{"type":"string","format":"date-time"},"allows":{"type":"array","items":{"type":"string"}},"technology":{"type":"string"},"valid_from_date":{"type":"string","format":"date-time"},"card_type":{"type":"string"},"name_on_card":{"type":"string"},"pin_reset":{"type":"array","items":{"type":"object","properties":{"requested_date":{"type":"string","format":"date-time"},"reason_requested":{"type":"string"}}}},"customer_id":{"type":"string"},"brand":{"type":"string"},"collected":{"type":"string","format":"date-time"},"issue_number":{"type":"string"},"serial_number":{"type":"string"},"networks":{"type":"array","items":{"type":"string"}},"replacement":{"type":"object","properties":{"requested_date":{"type":"string","format":"date-time"},"reason_requested":{"type":"string"}}},"posted":{"type":"string","format":"date-time"},"account_id":{"type":"string"}}},
  } satisfies AddCardForBankOperationRequest;

  try {
    const data = await api.addCardForBank(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { DeleteCardForBankRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The CARDID identifier
    cardid: cardid_example,
  } satisfies DeleteCardForBankRequest;

  try {
    const data = await api.deleteCardForBank(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetCardForBankRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    // string | The CARDID identifier
    cardid: cardid_example,
  } satisfies GetCardForBankRequest;

  try {
    const data = await api.getCardForBank(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetCardsRequest } from 'obp-typescript';
...
import type { GetCardsForBankRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    // string | The BANKID identifier
    bankid: bankid_example,
  } satisfies GetCardsForBankRequest;

  try {
    const data = await api.getCardsForBank(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetStatusOfCreditCardOrderRequest } from 'obp-typescript';
...
async function example() {
  ...
  } satisfies GetStatusOfCreditCardOrderRequest;

  try {
    const data = await api.getStatusOfCreditCardOrder(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { UpdatedCardForBankOperationRequest } from 'obp-typescript';
...
async function example() {
  ...
  const body = {
    ...
    updatedCardForBankRequest: {"type":"object","properties":{"enabled":{"type":"boolean"},"expires_date":{"type":"string","format":"date-time"},"allows":{"type":"array","items":{"type":"string"}},"replacement":{"type":"object","properties":{"requested_date":{"type":"string","format":"date-time"},"reason_requested":{"type":"string"}}},"collected":{"type":"string","format":"date-time"},"technology":{"type":"string"},"valid_from_date":{"type":"string","format":"date-time"},"card_type":{"type":"string"},"name_on_card":{"type":"string"},"pin_reset":{"type":"array","items":{"type":"object","properties":{"requested_date":{"type":"string","format":"date-time"},"reason_requested":{"type":"string"}}}},"customer_id":{"type":"string"},"networks":{"type":"array","items":{"type":"string"}},"issue_number":{"type":"string"},"posted":{"type":"string","format":"date-time"},"serial_number":{"type":"string"},"account_id":{"type":"string"}}},
  } satisfies UpdatedCardForBankOperationRequest;

  try {
    const data = await api.updatedCardForBank(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
