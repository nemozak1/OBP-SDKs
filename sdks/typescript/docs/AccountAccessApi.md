...
|------------- | ------------- | -------------|
| [**createUserWithAccountAccessById**](AccountAccessApi.md#createuserwithaccountaccessbyidoperation) | **POST** /obp/v5.1.0/banks/{bankid}/accounts/{accountid}/views/{viewid}/user-account-access | Create (DAuth) User with Account Access |
...
| [**revokeUserAccessToViewById**](AccountAccessApi.md#revokeuseraccesstoviewbyidoperation) | **POST** /obp/v5.1.0/banks/{bankid}/accounts/{accountid}/views/{viewid}/account-access/revoke | Revoke User access to View |
