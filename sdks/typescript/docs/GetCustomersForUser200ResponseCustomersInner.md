...
```typescript
import type { GetCustomersForUser200ResponseCustomersInner } from 'obp-typescript'
...
const example = {
  ...
  "kycStatus": null,
} satisfies GetCustomersForUser200ResponseCustomersInner
...
const exampleParsed = JSON.parse(exampleJSON) as GetCustomersForUser200ResponseCustomersInner
