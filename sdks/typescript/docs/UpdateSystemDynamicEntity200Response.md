...
```typescript
import type { UpdateSystemDynamicEntity200Response } from 'obp-typescript'
...
} satisfies UpdateSystemDynamicEntity200Response
...
const exampleParsed = JSON.parse(exampleJSON) as UpdateSystemDynamicEntity200Response
