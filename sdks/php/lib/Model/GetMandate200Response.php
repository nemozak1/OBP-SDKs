...
/**
 * GetMandate200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenBankProject
 * @author   OpenAPI Generator team
 ...
 */
class GetMandate200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getMandate_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'mandate_id' => '\DateTime',
        'valid_to' => 'string',
        'mandate_reference' => '\DateTime',
        'mandate_name' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'valid_to' => null,
        'mandate_reference' => 'date-time',
        'mandate_name' => 'date-time'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mandate_name', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param \DateTime|null $mandate_reference mandate_reference
     *
     * @return self
     */
    ...
    {
        return $this->container['mandate_name'];
    }

    /**
     * Sets mandate_name
     *
     * @param \DateTime|null $mandate_name mandate_name
     *
     * @return self
     */
    public function setMandateName($mandate_name)
    {
        if (is_null($mandate_name)) {
            throw new \InvalidArgumentException('non-nullable mandate_name cannot be null');
        }
        $this->container['mandate_name'] = $mandate_name;
