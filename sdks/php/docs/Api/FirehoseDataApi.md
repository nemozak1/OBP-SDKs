...
try {
    ...
    echo 'Exception when calling FirehoseDataApi->getFastFirehoseAccountsAtOneBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FirehoseDataApi->getFirehoseAccountsAtOneBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FirehoseDataApi->getFirehoseCustomers: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling FirehoseDataApi->getFirehoseTransactionsForBankAccount: ', $e->getMessage(), PHP_EOL;
}
```
