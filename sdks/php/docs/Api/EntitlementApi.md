...
try {
    ...
    echo 'Exception when calling EntitlementApi->addEntitlement: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->addEntitlementRequest: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->addUserToGroup: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->createUserWithRoles: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->deleteEntitlementRequest: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->getAllEntitlementRequests: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getAllEntitlements(): \OpenBankProject\Model\GetAllEntitlements200Response
```
...
try {
    $result = $apiInstance->getAllEntitlements();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EntitlementApi->getAllEntitlements: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\GetAllEntitlements200Response**](../Model/GetAllEntitlements200Response.md)
...
try {
    ...
    echo 'Exception when calling EntitlementApi->getEntitlementRequests: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->getEntitlementRequestsForCurrentUser: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->getEntitlementsAndPermissions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->getEntitlementsByBankAndUser: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->getEntitlementsForBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->getEntitlementsForCurrentUser: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->getGroupEntitlements: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->getPermissionsForBankAccount: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getRolesWithEntitlementCountsAtAllBanks(): \OpenBankProject\Model\GetRolesWithEntitlementCountsAtAllBanks200Response
```
...
try {
    $result = $apiInstance->getRolesWithEntitlementCountsAtAllBanks();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EntitlementApi->getRolesWithEntitlementCountsAtAllBanks: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\GetRolesWithEntitlementCountsAtAllBanks200Response**](../Model/GetRolesWithEntitlementCountsAtAllBanks200Response.md)
...
try {
    ...
    echo 'Exception when calling EntitlementApi->getUserGroupMemberships: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling EntitlementApi->removeUserFromGroup: ', $e->getMessage(), PHP_EOL;
}
```
