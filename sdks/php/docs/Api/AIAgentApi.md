...
try {
    ...
    echo 'Exception when calling AIAgentApi->deleteSignalChannel: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AIAgentApi->getSignalChannelInfo: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AIAgentApi->getSignalChannels: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AIAgentApi->getSignalMessages: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AIAgentApi->getSignalStats: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AIAgentApi->publishSignalMessage: ', $e->getMessage(), PHP_EOL;
}
```
