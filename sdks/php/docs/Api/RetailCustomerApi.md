...
try {
    ...
    echo 'Exception when calling RetailCustomerApi->createRetailCustomer: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RetailCustomerApi->getRetailCustomerByCustomerId: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RetailCustomerApi->getRetailCustomersAtOneBank: ', $e->getMessage(), PHP_EOL;
}
```
