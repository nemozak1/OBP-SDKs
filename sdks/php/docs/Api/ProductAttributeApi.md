...
try {
    ...
    echo 'Exception when calling ProductAttributeApi->createOrUpdateProductAttributeDefinition: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ProductAttributeApi->deleteProductAttributeDefinition: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ProductAttributeApi->getProductAttributeDefinition: ', $e->getMessage(), PHP_EOL;
}
```
