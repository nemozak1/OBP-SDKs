...
```php
addCardForBank($bankid, $add_card_for_bank_request): \OpenBankProject\Model\AddCardForBank200Response
```
...
$add_card_for_bank_request = {"type":"object","properties":{"card_number":{"type":"string"},"enabled":{"type":"boolean"},"expires_date":{"type":"string","format":"date-time"},"allows":{"type":"array","items":{"type":"string"}},"technology":{"type":"string"},"valid_from_date":{"type":"string","format":"date-time"},"card_type":{"type":"string"},"name_on_card":{"type":"string"},"pin_reset":{"type":"array","items":{"type":"object","properties":{"requested_date":{"type":"string","format":"date-time"},"reason_requested":{"type":"string"}}}},"customer_id":{"type":"string"},"brand":{"type":"string"},"collected":{"type":"string","format":"date-time"},"issue_number":{"type":"string"},"serial_number":{"type":"string"},"networks":{"type":"array","items":{"type":"string"}},"replacement":{"type":"object","properties":{"requested_date":{"type":"string","format":"date-time"},"reason_requested":{"type":"string"}}},"posted":{"type":"string","format":"date-time"},"account_id":{"type":"string"}}}; // \OpenBankProject\Model\AddCardForBankRequest | Request body

try {
    $result = $apiInstance->addCardForBank($bankid, $add_card_for_bank_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CardApi->addCardForBank: ', $e->getMessage(), PHP_EOL;
}
```
...
| **add_card_for_bank_request** | [**\OpenBankProject\Model\AddCardForBankRequest**](../Model/AddCardForBankRequest.md)| Request body | |

### Return type

[**\OpenBankProject\Model\AddCardForBank200Response**](../Model/AddCardForBank200Response.md)
...
try {
    ...
    echo 'Exception when calling CardApi->createCardAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CardApi->createOrUpdateCardAttributeDefinition: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CardApi->deleteCardAttributeDefinition: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deleteCardForBank($bankid, $cardid)
```
...
try {
    $apiInstance->deleteCardForBank($bankid, $cardid);
} catch (Exception $e) {
    echo 'Exception when calling CardApi->deleteCardForBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling CardApi->getCardAttributeDefinition: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getCardForBank($bankid, $cardid): \OpenBankProject\Model\GetCardForBank200Response
```
...
try {
    $result = $apiInstance->getCardForBank($bankid, $cardid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CardApi->getCardForBank: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\GetCardForBank200Response**](../Model/GetCardForBank200Response.md)
...
```php
getCards(): \OpenBankProject\Model\GetCards200Response
```
...
try {
    $result = $apiInstance->getCards();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CardApi->getCards: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\GetCards200Response**](../Model/GetCards200Response.md)
...
```php
getCardsForBank($bankid): \OpenBankProject\Model\GetCardsForBank200Response
```
...
try {
    $result = $apiInstance->getCardsForBank($bankid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CardApi->getCardsForBank: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\GetCardsForBank200Response**](../Model/GetCardsForBank200Response.md)
...
```php
getStatusOfCreditCardOrder($bankid, $accountid, $viewid): \OpenBankProject\Model\GetStatusOfCreditCardOrder200Response
```
...
try {
    $result = $apiInstance->getStatusOfCreditCardOrder($bankid, $accountid, $viewid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CardApi->getStatusOfCreditCardOrder: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\GetStatusOfCreditCardOrder200Response**](../Model/GetStatusOfCreditCardOrder200Response.md)
...
try {
    ...
    echo 'Exception when calling CardApi->updateCardAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updatedCardForBank($bankid, $cardid, $updated_card_for_bank_request): \OpenBankProject\Model\GetCardsForBank200ResponseCardsInner
```
...
$bankid = 'bankid_example'; // string | The BANKID identifier
$cardid = 'cardid_example'; // string | The CARDID identifier
$updated_card_for_bank_request = {"type":"object","properties":{"enabled":{"type":"boolean"},"expires_date":{"type":"string","format":"date-time"},"allows":{"type":"array","items":{"type":"string"}},"replacement":{"type":"object","properties":{"requested_date":{"type":"string","format":"date-time"},"reason_requested":{"type":"string"}}},"collected":{"type":"string","format":"date-time"},"technology":{"type":"string"},"valid_from_date":{"type":"string","format":"date-time"},"card_type":{"type":"string"},"name_on_card":{"type":"string"},"pin_reset":{"type":"array","items":{"type":"object","properties":{"requested_date":{"type":"string","format":"date-time"},"reason_requested":{"type":"string"}}}},"customer_id":{"type":"string"},"networks":{"type":"array","items":{"type":"string"}},"issue_number":{"type":"string"},"posted":{"type":"string","format":"date-time"},"serial_number":{"type":"string"},"account_id":{"type":"string"}}}; // \OpenBankProject\Model\UpdatedCardForBankRequest | Request body

try {
    $result = $apiInstance->updatedCardForBank($bankid, $cardid, $updated_card_for_bank_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CardApi->updatedCardForBank: ', $e->getMessage(), PHP_EOL;
}
```
...
| **bankid** | **string**| The BANKID identifier | |
| **cardid** | **string**| The CARDID identifier | |
| **updated_card_for_bank_request** | [**\OpenBankProject\Model\UpdatedCardForBankRequest**](../Model/UpdatedCardForBankRequest.md)| Request body | |

### Return type

[**\OpenBankProject\Model\GetCardsForBank200ResponseCardsInner**](../Model/GetCardsForBank200ResponseCardsInner.md)
