...
try {
    ...
    echo 'Exception when calling OAuthApi->getOAuth2ServerJWKsURIs: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling OAuthApi->getObpConnectorLoopback: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling OAuthApi->getOidcClient: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling OAuthApi->verifyOidcClient: ', $e->getMessage(), PHP_EOL;
}
```
