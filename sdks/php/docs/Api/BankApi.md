...
try {
    ...
    echo 'Exception when calling BankApi->createAccountWebhook: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createBank($create_bank_request): \OpenBankProject\Model\GetBank200Response
```
...
$create_bank_request = {"type":"object","properties":{"bank_id":{"type":"string"},"full_name":{"type":"string"},"logo":{"type":"string"},"bank_code":{"type":"string"},"website":{"type":"string"},"bank_routings":{"type":"array","items":{"type":"object","properties":{"address":{"type":"string"},"scheme":{"type":"string"}}}}}}; // \OpenBankProject\Model\CreateBankRequest | Request body

try {
    $result = $apiInstance->createBank($create_bank_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BankApi->createBank: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **create_bank_request** | [**\OpenBankProject\Model\CreateBankRequest**](../Model/CreateBankRequest.md)| Request body | |
...
try {
    ...
    echo 'Exception when calling BankApi->createBankAccountNotificationWebhook: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createBankAttribute($bankid, $update_atm_attribute_request): \OpenBankProject\Model\GetBankAttributes200ResponseBankAttributesInner
```
...
try {
    $result = $apiInstance->createBankAttribute($bankid, $update_atm_attribute_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BankApi->createBankAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\GetBankAttributes200ResponseBankAttributesInner**](../Model/GetBankAttributes200ResponseBankAttributesInner.md)
...
```php
createOrUpdateBankAttributeDefinition($bankid, $create_or_update_transaction_request_attribute_definition_request): \OpenBankProject\Model\GetTransactionRequestAttributeDefinition200ResponseAttributesInner
```
...
try {
    $result = $apiInstance->createOrUpdateBankAttributeDefinition($bankid, $create_or_update_transaction_request_attribute_definition_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BankApi->createOrUpdateBankAttributeDefinition: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createSettlementAccount($bankid, $create_settlement_account_request): \OpenBankProject\Model\CreateSettlementAccount200Response
```
...
$bankid = 'bankid_example'; // string | The BANKID identifier
$create_settlement_account_request = {"type":"object","properties":{"account_routings":{"type":"array","items":{"type":"object","properties":{"address":{"type":"string"},"scheme":{"type":"string"}}}},"payment_system":{"type":"string"},"label":{"type":"string"},"balance":{"type":"object","properties":{"currency":{"type":"string"},"amount":{"type":"string"}}},"branch_id":{"type":"string"},"user_id":{"type":"string"}}}; // \OpenBankProject\Model\CreateSettlementAccountRequest | Request body

try {
    $result = $apiInstance->createSettlementAccount($bankid, $create_settlement_account_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BankApi->createSettlementAccount: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **bankid** | **string**| The BANKID identifier | |
| **create_settlement_account_request** | [**\OpenBankProject\Model\CreateSettlementAccountRequest**](../Model/CreateSettlementAccountRequest.md)| Request body | |

### Return type

[**\OpenBankProject\Model\CreateSettlementAccount200Response**](../Model/CreateSettlementAccount200Response.md)
...
try {
    ...
    echo 'Exception when calling BankApi->createSystemAccountNotificationWebhook: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createTransactionType($bankid, $get_transaction_types200_response_transaction_types_inner): \OpenBankProject\Model\CreateTransactionType200Response
```
...
$bankid = 'bankid_example'; // string | The BANKID identifier
$get_transaction_types200_response_transaction_types_inner = {"type":"object","properties":{"description":{"type":"string"},"short_code":{"type":"string"},"bank_id":{"type":"string"},"summary":{"type":"string"},"charge":{"type":"object","properties":{"currency":{"type":"string"},"amount":{"type":"string"}}},"id":{"type":"object","properties":{"value":{"type":"string"}}}}}; // \OpenBankProject\Model\GetTransactionTypes200ResponseTransactionTypesInner | Request body

try {
    $result = $apiInstance->createTransactionType($bankid, $get_transaction_types200_response_transaction_types_inner);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BankApi->createTransactionType: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **bankid** | **string**| The BANKID identifier | |
| **get_transaction_types200_response_transaction_types_inner** | [**\OpenBankProject\Model\GetTransactionTypes200ResponseTransactionTypesInner**](../Model/GetTransactionTypes200ResponseTransactionTypesInner.md)| Request body | |

### Return type

[**\OpenBankProject\Model\CreateTransactionType200Response**](../Model/CreateTransactionType200Response.md)
...
try {
    ...
    echo 'Exception when calling BankApi->deleteBankAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling BankApi->deleteBankCascade: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling BankApi->enableDisableAccountWebhook: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling BankApi->getAccountWebhooks: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling BankApi->getBank: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getBankAttribute($bankid, $bankattributeid): \OpenBankProject\Model\GetBankAttributes200ResponseBankAttributesInner
```
...
try {
    $result = $apiInstance->getBankAttribute($bankid, $bankattributeid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BankApi->getBankAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getBankAttributes($bankid): \OpenBankProject\Model\GetBankAttributes200Response
```
...
try {
    $result = $apiInstance->getBankAttributes($bankid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BankApi->getBankAttributes: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\GetBankAttributes200Response**](../Model/GetBankAttributes200Response.md)
...
try {
    ...
    echo 'Exception when calling BankApi->getBanks: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling BankApi->getBranch: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling BankApi->getBranches: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling BankApi->getSettlementAccounts: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling BankApi->getTransactionRequestTypesSupportedByBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling BankApi->getTransactionTypes: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateBank($update_bank_request): \OpenBankProject\Model\UpdateBank200Response
```
...
$update_bank_request = {"type":"object","properties":{"full_name":{"type":"string"},"logo":{"type":"string"},"id":{"type":"string"},"bank_code":{"type":"string"},"website":{"type":"string"},"bank_routings":{"type":"array","items":{"type":"object","properties":{"address":{"type":"string"},"scheme":{"type":"string"}}}}}}; // \OpenBankProject\Model\UpdateBankRequest | Request body

try {
    $result = $apiInstance->updateBank($update_bank_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BankApi->updateBank: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **update_bank_request** | [**\OpenBankProject\Model\UpdateBankRequest**](../Model/UpdateBankRequest.md)| Request body | |

### Return type

[**\OpenBankProject\Model\UpdateBank200Response**](../Model/UpdateBank200Response.md)
...
```php
updateBankAttribute($bankid, $bankattributeid, $update_atm_attribute_request): \OpenBankProject\Model\CreateOrUpdateTransactionRequestAttributeDefinitionRequest
```
...
try {
    $result = $apiInstance->updateBankAttribute($bankid, $bankattributeid, $update_atm_attribute_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BankApi->updateBankAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\CreateOrUpdateTransactionRequestAttributeDefinitionRequest**](../Model/CreateOrUpdateTransactionRequestAttributeDefinitionRequest.md)
