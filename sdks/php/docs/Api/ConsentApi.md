...
```php
addConsentUser($bankid, $consentid, $add_consent_user_request): \OpenBankProject\Model\CreateConsentImplicit200Response
```
...
$add_consent_user_request = {"type":"object","properties":{"user_id":{"type":"string"}}}; // \OpenBankProject\Model\AddConsentUserRequest | Request body

try {
    $result = $apiInstance->addConsentUser($bankid, $consentid, $add_consent_user_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConsentApi->addConsentUser: ', $e->getMessage(), PHP_EOL;
}
```
...
| **add_consent_user_request** | [**\OpenBankProject\Model\AddConsentUserRequest**](../Model/AddConsentUserRequest.md)| Request body | |
...
try {
    ...
    echo 'Exception when calling ConsentApi->answerConsentChallenge: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->createConsentByConsentRequestIdEmail: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->createConsentByConsentRequestIdImplicit: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->createConsentByConsentRequestIdSms: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->createConsentEmail: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->createConsentImplicit: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->createConsentRequest: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->createConsentSms: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->createVRPConsentRequest: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->getConsentByConsentId: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->getConsentByConsentIdViaConsumer: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->getConsentByConsentRequestId: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->getConsentInfos: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->getConsentInfosByBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->getConsentRequest: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->getConsents: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->getConsentsAtBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->getMyConsents: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->getMyConsentsByBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->mtlsClientCertificateInfo: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->revokeConsentAtBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->revokeMyConsent: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ConsentApi->selfRevokeConsent: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateConsentAccountAccessByConsentId($bankid, $consentid, $update_consent_account_access_by_consent_id_request): \OpenBankProject\Model\CreateConsentImplicit200Response
```
...
$bankid = 'bankid_example'; // string | The BANKID identifier
$consentid = 'consentid_example'; // string | The CONSENTID identifier
$update_consent_account_access_by_consent_id_request = {"type":"object","properties":{"access":{"type":"object","properties":{"accounts":{"type":"array","items":{"type":"object","properties":{"iban":{"type":"string"}}}}}}}}; // \OpenBankProject\Model\UpdateConsentAccountAccessByConsentIdRequest | Request body

try {
    $result = $apiInstance->updateConsentAccountAccessByConsentId($bankid, $consentid, $update_consent_account_access_by_consent_id_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConsentApi->updateConsentAccountAccessByConsentId: ', $e->getMessage(), PHP_EOL;
}
```
...
| **bankid** | **string**| The BANKID identifier | |
| **consentid** | **string**| The CONSENTID identifier | |
| **update_consent_account_access_by_consent_id_request** | [**\OpenBankProject\Model\UpdateConsentAccountAccessByConsentIdRequest**](../Model/UpdateConsentAccountAccessByConsentIdRequest.md)| Request body | |
...
```php
updateConsentStatus($bankid, $consentid, $update_transaction_request_status_request): \OpenBankProject\Model\CreateConsentImplicit200Response
```
...
try {
    $result = $apiInstance->updateConsentStatus($bankid, $consentid, $update_transaction_request_status_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConsentApi->updateConsentStatus: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateConsentStatusByConsent($bankid, $consentid, $update_transaction_request_status_request): \OpenBankProject\Model\CreateConsentImplicit200Response
```
...
try {
    $result = $apiInstance->updateConsentStatusByConsent($bankid, $consentid, $update_transaction_request_status_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConsentApi->updateConsentStatusByConsent: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateConsentUserIdByConsentId($bankid, $consentid, $add_consent_user_request): \OpenBankProject\Model\CreateConsentImplicit200Response
```
...
try {
    $result = $apiInstance->updateConsentUserIdByConsentId($bankid, $consentid, $add_consent_user_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ConsentApi->updateConsentUserIdByConsentId: ', $e->getMessage(), PHP_EOL;
}
```
