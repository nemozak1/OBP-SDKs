...
```php
sandboxDataImport($sandbox_data_import_request): \OpenBankProject\Model\UpdateTransactionNarrative200Response
```
...
| ------------- | ------------- | ------------- | ------------- |
| **sandbox_data_import_request** | [**\OpenBankProject\Model\SandboxDataImportRequest**](../Model/SandboxDataImportRequest.md)| Request body | |
