...
try {
    ...
    echo 'Exception when calling StandingOrderApi->createStandingOrder: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling StandingOrderApi->createStandingOrderManagement: ', $e->getMessage(), PHP_EOL;
}
```
