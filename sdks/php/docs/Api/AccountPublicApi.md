...
try {
    ...
    echo 'Exception when calling AccountPublicApi->getPublicAccountById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AccountPublicApi->publicAccountsAllBanks: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AccountPublicApi->publicAccountsAtOneBank: ', $e->getMessage(), PHP_EOL;
}
```
