...
try {
    ...
    echo 'Exception when calling AccountAccessApi->createUserWithAccountAccessById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AccountAccessApi->grantUserAccessToViewById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AccountAccessApi->revokeUserAccessToViewById: ', $e->getMessage(), PHP_EOL;
}
```
