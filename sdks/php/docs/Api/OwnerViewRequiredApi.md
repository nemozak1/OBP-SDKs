...
try {
    ...
    echo 'Exception when calling OwnerViewRequiredApi->createUserWithAccountAccessById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling OwnerViewRequiredApi->grantUserAccessToViewById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling OwnerViewRequiredApi->revokeUserAccessToViewById: ', $e->getMessage(), PHP_EOL;
}
```
