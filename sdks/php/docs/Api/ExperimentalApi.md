...
try {
    ...
    echo 'Exception when calling ExperimentalApi->createMeeting: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExperimentalApi->getMeeting: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling ExperimentalApi->getMeetings: ', $e->getMessage(), PHP_EOL;
}
```
