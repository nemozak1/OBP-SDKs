...
```php
getApiGlossary(): \OpenBankProject\Model\GetApiGlossary200Response
```
...
try {
    $result = $apiInstance->getApiGlossary();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling DocumentationApi->getApiGlossary: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\GetApiGlossary200Response**](../Model/GetApiGlossary200Response.md)
...
try {
    ...
    echo 'Exception when calling DocumentationApi->getBankLevelDynamicResourceDocsObp: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->getMessageDocs: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->getMessageDocsJsonSchema: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->getMessageDocsSwagger: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->getResourceDocsObp: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->getResourceDocsOpenAPI31: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->getResourceDocsSwagger: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DocumentationApi->getScannedApiVersions: ', $e->getMessage(), PHP_EOL;
}
```
