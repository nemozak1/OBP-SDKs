...
try {
    ...
    echo 'Exception when calling RoleApi->addEntitlement: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->addEntitlementRequest: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->createUserWithRoles: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->deleteEntitlement: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->deleteEntitlementRequest: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->getAllEntitlementRequests: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->getAllEntitlements: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->getEntitlementRequests: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->getEntitlementRequestsForCurrentUser: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->getEntitlements: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->getEntitlementsAndPermissions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->getEntitlementsByBankAndUser: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->getEntitlementsForBank: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling RoleApi->getEntitlementsForCurrentUser: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getRoles(): \OpenBankProject\Model\GetRoles200Response
```
...
try {
    ...
    echo 'Exception when calling RoleApi->getRoles: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenBankProject\Model\GetRoles200Response**](../Model/GetRoles200Response.md)
...
try {
    ...
    echo 'Exception when calling RoleApi->getRolesWithEntitlementCountsAtAllBanks: ', $e->getMessage(), PHP_EOL;
}
```
