...
try {
    ...
    echo 'Exception when calling MessageDocApi->getMessageDocs: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling MessageDocApi->getMessageDocsJsonSchema: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling MessageDocApi->getMessageDocsSwagger: ', $e->getMessage(), PHP_EOL;
}
```
