...
try {
    ...
    echo 'Exception when calling PersonApi->addCustomerMessage: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling PersonApi->createAgent: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling PersonApi->createCustomer: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling PersonApi->createCustomerMessage: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling PersonApi->updateAgentStatus: ', $e->getMessage(), PHP_EOL;
}
```
