...
try {
    ...
    echo 'Exception when calling DirectoryApi->createConsumerDynamicRegistration: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->createRegulatedEntity: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->createRegulatedEntityAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->deleteRegulatedEntity: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->deleteRegulatedEntityAttribute: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->getAllRegulatedEntityAttributes: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->getRegulatedEntityAttributeById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->getRegulatedEntityById: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->regulatedEntities: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling DirectoryApi->updateRegulatedEntityAttribute: ', $e->getMessage(), PHP_EOL;
}
```
