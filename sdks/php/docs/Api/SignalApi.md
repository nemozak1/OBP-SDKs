...
try {
    ...
    echo 'Exception when calling SignalApi->deleteSignalChannel: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SignalApi->getSignalChannelInfo: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SignalApi->getSignalChannels: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SignalApi->getSignalMessages: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SignalApi->getSignalStats: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling SignalApi->publishSignalMessage: ', $e->getMessage(), PHP_EOL;
}
```
