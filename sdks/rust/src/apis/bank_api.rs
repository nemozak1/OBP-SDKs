...
/// struct for typed errors of method [`create_account_webhook`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateAccountWebhookError {
    Status500(),
...
/// struct for typed errors of method [`create_bank_account_notification_webhook`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateBankAccountNotificationWebhookError {
    Status404(),
    Status500(),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`create_settlement_account`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateSettlementAccountError {
    Status404(),
    Status500(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`create_system_account_notification_webhook`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateSystemAccountNotificationWebhookError {
    Status500(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`create_transaction_type`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateTransactionTypeError {
    Status400(),
    Status404(),
    Status500(),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method [`delete_bank_cascade`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteBankCascadeError {
    Status404(),
    Status500(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`enable_disable_account_webhook`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum EnableDisableAccountWebhookError {
    Status500(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_account_webhooks`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetAccountWebhooksError {
    Status500(),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_account_webhook(configuration: &configuration::Configuration, bankid: &str, create_account_webhook_request: models::CreateAccountWebhookRequest) -> Result<models::EnableDisableAccountWebhook200Response, Error<CreateAccountWebhookError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    let p_body_create_account_webhook_request = create_account_webhook_request;
    ...
    req_builder = req_builder.json(&p_body_create_account_webhook_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::EnableDisableAccountWebhook200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::EnableDisableAccountWebhook200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateAccountWebhookError> = serde_json::from_str(&content).ok();
...
pub async fn create_bank(configuration: &configuration::Configuration, create_bank_request: models::CreateBankRequest) -> Result<models::GetBank200Response, Error<CreateBankError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_create_bank_request = create_bank_request;
    ...
    req_builder = req_builder.json(&p_body_create_bank_request);
...
pub async fn create_bank_account_notification_webhook(configuration: &configuration::Configuration, bankid: &str, create_system_account_notification_webhook_request: models::CreateSystemAccountNotificationWebhookRequest) -> Result<models::CreateBankAccountNotificationWebhook200Response, Error<CreateBankAccountNotificationWebhookError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    let p_body_create_system_account_notification_webhook_request = create_system_account_notification_webhook_request;
    ...
    req_builder = req_builder.json(&p_body_create_system_account_notification_webhook_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CreateBankAccountNotificationWebhook200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CreateBankAccountNotificationWebhook200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateBankAccountNotificationWebhookError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn create_settlement_account(configuration: &configuration::Configuration, bankid: &str, create_settlement_account_request: models::CreateSettlementAccountRequest) -> Result<models::CreateSettlementAccount200Response, Error<CreateSettlementAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    let p_body_create_settlement_account_request = create_settlement_account_request;
    ...
    req_builder = req_builder.json(&p_body_create_settlement_account_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CreateSettlementAccount200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CreateSettlementAccount200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateSettlementAccountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn create_system_account_notification_webhook(configuration: &configuration::Configuration, create_system_account_notification_webhook_request: models::CreateSystemAccountNotificationWebhookRequest) -> Result<models::CreateSystemAccountNotificationWebhook200Response, Error<CreateSystemAccountNotificationWebhookError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_create_system_account_notification_webhook_request = create_system_account_notification_webhook_request;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CreateSystemAccountNotificationWebhook200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CreateSystemAccountNotificationWebhook200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateSystemAccountNotificationWebhookError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn create_transaction_type(configuration: &configuration::Configuration, bankid: &str, get_transaction_types200_response_transaction_types_inner: models::GetTransactionTypes200ResponseTransactionTypesInner) -> Result<models::CreateTransactionType200Response, Error<CreateTransactionTypeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    let p_body_get_transaction_types200_response_transaction_types_inner = get_transaction_types200_response_transaction_types_inner;
    ...
    req_builder = req_builder.json(&p_body_get_transaction_types200_response_transaction_types_inner);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CreateTransactionType200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CreateTransactionType200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateTransactionTypeError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn delete_bank_cascade(configuration: &configuration::Configuration, bankid: &str) -> Result<(), Error<DeleteBankCascadeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteBankCascadeError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn enable_disable_account_webhook(configuration: &configuration::Configuration, bankid: &str, enable_disable_account_webhook_request: models::EnableDisableAccountWebhookRequest) -> Result<models::EnableDisableAccountWebhook200Response, Error<EnableDisableAccountWebhookError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    let p_body_enable_disable_account_webhook_request = enable_disable_account_webhook_request;
    ...
    req_builder = req_builder.json(&p_body_enable_disable_account_webhook_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<EnableDisableAccountWebhookError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_account_webhooks(configuration: &configuration::Configuration, bankid: &str) -> Result<models::GetAccountWebhooks200Response, Error<GetAccountWebhooksError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetAccountWebhooks200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetAccountWebhooks200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetAccountWebhooksError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_branch(configuration: &configuration::Configuration, bankid: &str, branchid: &str) -> Result<models::GetBranches200ResponseBranchesInner, Error<GetBranchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetBranches200ResponseBranchesInner`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetBranches200ResponseBranchesInner`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_branches(configuration: &configuration::Configuration, bankid: &str) -> Result<models::GetBranches200Response, Error<GetBranchesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetBranches200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetBranches200Response`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn update_bank(configuration: &configuration::Configuration, update_bank_request: models::UpdateBankRequest) -> Result<models::UpdateBank200Response, Error<UpdateBankError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_update_bank_request = update_bank_request;
    ...
    req_builder = req_builder.json(&p_body_update_bank_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UpdateBank200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UpdateBank200Response`")))),
        }
    } else {
        let content = resp.text().await?;
