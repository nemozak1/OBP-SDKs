...
/// struct for typed errors of method [`create_historical_transaction_at_bank`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateHistoricalTransactionAtBankError {
    Status400(),
    Status404(),
    Status500(),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method [`create_transaction_request_free_form`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateTransactionRequestFreeFormError {
    Status400(),
    Status404(),
    Status500(),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method [`create_vrp_consent_request`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateVrpConsentRequestError {
    Status500(),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`get_transaction_request_types_supported_by_bank`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetTransactionRequestTypesSupportedByBankError {
    Status500(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_transaction_requests`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetTransactionRequestsError {
    Status404(),
    Status500(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`save_historical_transaction`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SaveHistoricalTransactionError {
    Status400(),
    Status404(),
    Status500(),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method [`update_transaction_request_status`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateTransactionRequestStatusError {
    Status404(),
    Status500(),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_historical_transaction_at_bank(configuration: &configuration::Configuration, bankid: &str, create_historical_transaction_at_bank_request: models::CreateHistoricalTransactionAtBankRequest) -> Result<models::SaveHistoricalTransaction200Response, Error<CreateHistoricalTransactionAtBankError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    let p_body_create_historical_transaction_at_bank_request = create_historical_transaction_at_bank_request;
    ...
    req_builder = req_builder.json(&p_body_create_historical_transaction_at_bank_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SaveHistoricalTransaction200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SaveHistoricalTransaction200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateHistoricalTransactionAtBankError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn create_transaction_request_free_form(configuration: &configuration::Configuration, bankid: &str, accountid: &str, viewid: &str, freeform: &str, create_transaction_request_free_form_request: models::CreateTransactionRequestFreeFormRequest) -> Result<models::CreateTransactionRequestCounterparty200Response, Error<CreateTransactionRequestFreeFormError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    let p_path_accountid = accountid;
    let p_path_viewid = viewid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateTransactionRequestFreeFormError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn create_vrp_consent_request(configuration: &configuration::Configuration, create_vrp_consent_request_request: models::CreateVrpConsentRequestRequest) -> Result<models::CreateVrpConsentRequest200Response, Error<CreateVrpConsentRequestError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_create_vrp_consent_request_request = create_vrp_consent_request_request;
    ...
    req_builder = req_builder.json(&p_body_create_vrp_consent_request_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CreateVrpConsentRequest200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CreateVrpConsentRequest200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateVrpConsentRequestError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_transaction_request_types_supported_by_bank(configuration: &configuration::Configuration, bankid: &str) -> Result<models::GetTransactionRequestTypesSupportedByBank200Response, Error<GetTransactionRequestTypesSupportedByBankError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetTransactionRequestTypesSupportedByBank200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetTransactionRequestTypesSupportedByBank200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetTransactionRequestTypesSupportedByBankError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_transaction_requests(configuration: &configuration::Configuration, bankid: &str, accountid: &str, viewid: &str) -> Result<models::GetTransactionRequests200Response, Error<GetTransactionRequestsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    let p_path_accountid = accountid;
    let p_path_viewid = viewid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetTransactionRequests200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetTransactionRequests200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetTransactionRequestsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn save_historical_transaction(configuration: &configuration::Configuration, save_historical_transaction_request: models::SaveHistoricalTransactionRequest) -> Result<models::SaveHistoricalTransaction200Response, Error<SaveHistoricalTransactionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_save_historical_transaction_request = save_historical_transaction_request;
    ...
    req_builder = req_builder.json(&p_body_save_historical_transaction_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SaveHistoricalTransactionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn update_transaction_request_status(configuration: &configuration::Configuration, transactionrequestid: &str, update_transaction_request_status_request: models::UpdateTransactionRequestStatusRequest) -> Result<models::UpdateTransactionRequestStatusRequest, Error<UpdateTransactionRequestStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_transactionrequestid = transactionrequestid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UpdateTransactionRequestStatusRequest`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UpdateTransactionRequestStatusRequest`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<UpdateTransactionRequestStatusError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
