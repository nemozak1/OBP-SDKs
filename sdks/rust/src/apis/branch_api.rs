...
pub async fn create_branch(configuration: &configuration::Configuration, bankid: &str, get_branches200_response_branches_inner: models::GetBranches200ResponseBranchesInner) -> Result<models::GetBranches200ResponseBranchesInner, Error<CreateBranchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
    let p_body_get_branches200_response_branches_inner = get_branches200_response_branches_inner;
    ...
    req_builder = req_builder.json(&p_body_get_branches200_response_branches_inner);
...
pub async fn delete_branch(configuration: &configuration::Configuration, bankid: &str, branchid: &str) -> Result<(), Error<DeleteBranchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_bankid = bankid;
