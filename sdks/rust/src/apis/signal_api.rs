...
/// struct for typed errors of method [`delete_signal_channel`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteSignalChannelError {
    Status500(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_signal_channel_info`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSignalChannelInfoError {
    Status500(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_signal_channels`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSignalChannelsError {
    Status500(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_signal_messages`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSignalMessagesError {
    Status500(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_signal_stats`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetSignalStatsError {
    Status500(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`publish_signal_message`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PublishSignalMessageError {
    Status500(),
    UnknownValue(serde_json::Value),
}
...
pub async fn delete_signal_channel(configuration: &configuration::Configuration, channelname: &str) -> Result<models::DeleteSignalChannel200Response, Error<DeleteSignalChannelError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DeleteSignalChannel200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DeleteSignalChannel200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<DeleteSignalChannelError> = serde_json::from_str(&content).ok();
...
pub async fn get_signal_channel_info(configuration: &configuration::Configuration, channelname: &str) -> Result<models::GetSignalChannelInfo200Response, Error<GetSignalChannelInfoError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_channelname = channelname;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetSignalChannelInfo200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetSignalChannelInfo200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetSignalChannelInfoError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_signal_channels(configuration: &configuration::Configuration, ) -> Result<models::GetSignalChannels200Response, Error<GetSignalChannelsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetSignalChannels200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetSignalChannels200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetSignalChannelsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_signal_messages(configuration: &configuration::Configuration, channelname: &str) -> Result<models::GetSignalMessages200Response, Error<GetSignalMessagesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_channelname = channelname;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetSignalMessages200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetSignalMessages200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetSignalMessagesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_signal_stats(configuration: &configuration::Configuration, ) -> Result<models::GetSignalStats200Response, Error<GetSignalStatsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetSignalStats200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetSignalStats200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetSignalStatsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn publish_signal_message(configuration: &configuration::Configuration, channelname: &str, publish_signal_message_request: models::PublishSignalMessageRequest) -> Result<models::PublishSignalMessage200Response, Error<PublishSignalMessageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_channelname = channelname;
    let p_body_publish_signal_message_request = publish_signal_message_request;
    ...
    req_builder = req_builder.json(&p_body_publish_signal_message_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PublishSignalMessage200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PublishSignalMessage200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<PublishSignalMessageError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
