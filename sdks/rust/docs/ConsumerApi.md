...
> models::UpdateRateLimitsRequest calls_limit(consumerid, update_rate_limits_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**consumerid** | **String** | The CONSUMERID identifier | [required] |
**update_rate_limits_request** | [**UpdateRateLimitsRequest**](UpdateRateLimitsRequest.md) | Request body | [required] |

### Return type

[**models::UpdateRateLimitsRequest**](updateRateLimits_request.md)
...
> models::CreateCallLimits200Response create_call_limits(consumerid, create_call_limits_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**consumerid** | **String** | The CONSUMERID identifier | [required] |
**create_call_limits_request** | [**CreateCallLimitsRequest**](CreateCallLimitsRequest.md) | Request body | [required] |

### Return type

[**models::CreateCallLimits200Response**](createCallLimits_200_response.md)
...
> models::CreateConsumer200Response create_consumer(create_consumer_request)
Create a Consumer
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**create_consumer_request** | [**CreateConsumerRequest**](CreateConsumerRequest.md) | Request body | [required] |

### Return type

[**models::CreateConsumer200Response**](createConsumer_200_response.md)
...
> models::UpdateConsumerName200Response create_consumer_dynamic_registration(create_consumer_dynamic_registration_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**create_consumer_dynamic_registration_request** | [**CreateConsumerDynamicRegistrationRequest**](CreateConsumerDynamicRegistrationRequest.md) | Request body | [required] |

### Return type

[**models::UpdateConsumerName200Response**](updateConsumerName_200_response.md)
...
> models::UpdateConsumerName200Response create_my_consumer(create_consumer_request)
Create a Consumer
...
> models::EnableDisableConsumersRequest enable_disable_consumers(consumerid, enable_disable_consumers_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**consumerid** | **String** | The CONSUMERID identifier | [required] |
**enable_disable_consumers_request** | [**EnableDisableConsumersRequest**](EnableDisableConsumersRequest.md) | Request body | [required] |

### Return type

[**models::EnableDisableConsumersRequest**](enableDisableConsumers_request.md)
...
> models::GetActiveRateLimitsAtDate200Response get_active_rate_limits_at_date(consumerid, datewithhour)
...
[**models::GetActiveRateLimitsAtDate200Response**](getActiveRateLimitsAtDate_200_response.md)
...
> models::GetActiveRateLimitsAtDate200Response get_active_rate_limits_now(consumerid)
...
> models::GetCallsLimit200Response get_calls_limit(consumerid)
...
[**models::GetCallsLimit200Response**](getCallsLimit_200_response.md)
...
> models::GetConsumer200Response get_consumer(consumerid)
Get Consumer
...
[**models::GetConsumer200Response**](getConsumer_200_response.md)
...
> models::GetCurrentConsumer200ResponseCallCounters get_consumer_call_counters(consumerid)
...
[**models::GetCurrentConsumer200ResponseCallCounters**](getCurrentConsumer_200_response_call_counters.md)
...
> models::GetConsumers200Response get_consumers()
Get Consumers
...
[**models::GetConsumers200Response**](getConsumers_200_response.md)
...
> models::GetConsumersForCurrentUser200Response get_consumers_for_current_user()
...
[**models::GetConsumersForCurrentUser200Response**](getConsumersForCurrentUser_200_response.md)
...
> models::UpdateConsumerName200Response update_consumer_certificate(consumerid, update_consumer_certificate_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**consumerid** | **String** | The CONSUMERID identifier | [required] |
**update_consumer_certificate_request** | [**UpdateConsumerCertificateRequest**](UpdateConsumerCertificateRequest.md) | Request body | [required] |
...
> models::UpdateConsumerName200Response update_consumer_logo_url(consumerid, update_consumer_logo_url_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**consumerid** | **String** | The CONSUMERID identifier | [required] |
**update_consumer_logo_url_request** | [**UpdateConsumerLogoUrlRequest**](UpdateConsumerLogoUrlRequest.md) | Request body | [required] |
...
> models::UpdateConsumerName200Response update_consumer_name(consumerid, update_consumer_name_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**consumerid** | **String** | The CONSUMERID identifier | [required] |
**update_consumer_name_request** | [**UpdateConsumerNameRequest**](UpdateConsumerNameRequest.md) | Request body | [required] |
...
> models::UpdateConsumerRedirectUrl200Response update_consumer_redirect_url(consumerid, update_consumer_redirect_url_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**consumerid** | **String** | The CONSUMERID identifier | [required] |
**update_consumer_redirect_url_request** | [**UpdateConsumerRedirectUrlRequest**](UpdateConsumerRedirectUrlRequest.md) | Request body | [required] |

### Return type

[**models::UpdateConsumerRedirectUrl200Response**](updateConsumerRedirectURL_200_response.md)
...
> models::UpdateRateLimitsRequest update_rate_limits(consumerid, ratelimitingid, update_rate_limits_request)
Set Rate Limits / Call Limits per Consumer
