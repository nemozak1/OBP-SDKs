...
> models::GetAllConnectorMethods200ResponseConnectorsMethodsInner create_connector_method(create_connector_method_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**create_connector_method_request** | [**CreateConnectorMethodRequest**](CreateConnectorMethodRequest.md) | Request body | [required] |

### Return type

[**models::GetAllConnectorMethods200ResponseConnectorsMethodsInner**](getAllConnectorMethods_200_response_connectors_methods_inner.md)
...
> models::GetAllConnectorMethods200Response get_all_connector_methods()
...
[**models::GetAllConnectorMethods200Response**](getAllConnectorMethods_200_response.md)
...
> models::GetAllConnectorMethods200ResponseConnectorsMethodsInner get_connector_method(connectormethodid)
...
> models::GetAllConnectorMethods200ResponseConnectorsMethodsInner update_connector_method(connectormethodid, update_connector_method_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**connectormethodid** | **String** | The CONNECTORMETHODID identifier | [required] |
**update_connector_method_request** | [**UpdateConnectorMethodRequest**](UpdateConnectorMethodRequest.md) | Request body | [required] |
