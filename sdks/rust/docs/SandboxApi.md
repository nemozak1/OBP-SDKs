...
> models::UpdateTransactionNarrative200Response sandbox_data_import(sandbox_data_import_request)
Create sandbox
...
------------- | ------------- | ------------- | ------------- | -------------
**sandbox_data_import_request** | [**SandboxDataImportRequest**](SandboxDataImportRequest.md) | Request body | [required] |
