...
> models::CreateFxRequest create_fx(bankid, create_fx_request)
Create Fx
...
**create_fx_request** | [**CreateFxRequest**](CreateFxRequest.md) | Request body | [required] |

### Return type

[**models::CreateFxRequest**](createFx_request.md)
...
> models::GetCurrenciesAtBank200Response get_currencies_at_bank(bankid)
...
[**models::GetCurrenciesAtBank200Response**](getCurrenciesAtBank_200_response.md)
...
> models::CreateFxRequest get_current_fx_rate(bankid, fromcurrencycode, tocurrencycode)
Get Current FxRate
