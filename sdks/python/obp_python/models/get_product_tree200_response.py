...
class GetProductTree200Response(BaseModel):
    """
    GetProductTree200Response
    """ # noqa: E501
    name: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    parent_product: Optional[GetProductTree200ResponseParentProduct] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent_product": GetProductTree200ResponseParentProduct.from_dict(obj["parent_product"]) if obj.get("parent_product") is not None else None,
