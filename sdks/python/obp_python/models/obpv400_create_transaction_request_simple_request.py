...
class OBPv400CreateTransactionRequestSimpleRequest(BaseModel):
    ...
    to: Optional[OBPv400CreateTransactionRequestSimpleRequestTo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "to": OBPv400CreateTransactionRequestSimpleRequestTo.from_dict(obj["to"]) if obj.get("to") is not None else None,
