...
class OBPv600GetAllCounterpartyAttributes200ResponseAttributesInner(BaseModel):
    """
    ...
    counterparty_attribute_id: Optional[StrictStr] = None
    counterparty_id: Optional[StrictStr] = None
    value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "is_active", "attribute_type", "counterparty_attribute_id", "counterparty_id", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "counterparty_attribute_id": obj.get("counterparty_attribute_id"),
