...
class EnableDisableAccountWebhook200Response(BaseModel):
    """
    ...
    trigger_name: Optional[StrictStr] = None
    http_protocol: Optional[StrictStr] = None
    account_webhook_id: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "http_protocol": obj.get("http_protocol"),
            "account_webhook_id": obj.get("account_webhook_id"),
