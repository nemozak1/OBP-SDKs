...
class OBPv400GetFastFirehoseAccountsAtOneBank200ResponseAccountsInner(BaseModel):
    """
    ...
    owners: Optional[List[OBPv400GetFastFirehoseAccountsAtOneBank200ResponseAccountsInnerOwnersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "label": obj.get("label"),
            "owners": [OBPv400GetFastFirehoseAccountsAtOneBank200ResponseAccountsInnerOwnersInner.from_dict(_item) for _item in obj["owners"]] if obj.get("owners") is not None else None,
