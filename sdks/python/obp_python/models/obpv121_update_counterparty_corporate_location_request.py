...
class OBPv121UpdateCounterpartyCorporateLocationRequest(BaseModel):
    ...
    """ # noqa: E501
    corporate_location: Optional[OBPv300GetBranches200ResponseBranchesInnerLocation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "corporate_location": OBPv300GetBranches200ResponseBranchesInnerLocation.from_dict(obj["corporate_location"]) if obj.get("corporate_location") is not None else None
        })
        return _obj
