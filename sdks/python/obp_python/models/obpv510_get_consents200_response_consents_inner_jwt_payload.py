...
class OBPv510GetConsents200ResponseConsentsInnerJwtPayload(BaseModel):
    """
    ...
    request_headers: Optional[List[OBPv510GetConsents200ResponseConsentsInnerJwtPayloadRequestHeadersInner]] = None
    ...
    views: Optional[List[OBPv510GetConsents200ResponseConsentsInnerJwtPayloadViewsInner]] = None
    ...
    access: Optional[OBPv510GetConsents200ResponseConsentsInnerJwtPayloadAccess] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "email": obj.get("email"),
            "request_headers": [OBPv510GetConsents200ResponseConsentsInnerJwtPayloadRequestHeadersInner.from_dict(_item) for _item in obj["request_headers"]] if obj.get("request_headers") is not None else None,
            "jti": obj.get("jti"),
            "exp": obj.get("exp"),
            "createdByUserId": obj.get("createdByUserId"),
            "views": [OBPv510GetConsents200ResponseConsentsInnerJwtPayloadViewsInner.from_dict(_item) for _item in obj["views"]] if obj.get("views") is not None else None,
            ...
            "aud": obj.get("aud"),
            "iss": obj.get("iss"),
            "access": OBPv510GetConsents200ResponseConsentsInnerJwtPayloadAccess.from_dict(obj["access"]) if obj.get("access") is not None else None
        })
        return _obj
