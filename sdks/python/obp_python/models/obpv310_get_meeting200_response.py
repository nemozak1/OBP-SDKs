...
class OBPv310GetMeeting200Response(BaseModel):
    ...
    """ # noqa: E501
    present: Optional[OBPv310GetMeeting200ResponsePresent] = None
    ...
    keys: Optional[OBPv310GetMeeting200ResponseKeys] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "present": OBPv310GetMeeting200ResponsePresent.from_dict(obj["present"]) if obj.get("present") is not None else None,
            ...
            "keys": OBPv310GetMeeting200ResponseKeys.from_dict(obj["keys"]) if obj.get("keys") is not None else None
        })
        return _obj
