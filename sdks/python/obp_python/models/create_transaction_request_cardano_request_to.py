...
class CreateTransactionRequestCardanoRequestTo(BaseModel):
    """
    CreateTransactionRequestCardanoRequestTo
    """ # noqa: E501
    amount: Optional[CreateTransactionRequestCardanoRequestToAmount] = None
    address: Optional[StrictStr] = None
    assets: Optional[List[CreateTransactionRequestCardanoRequestToAssetsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amount": CreateTransactionRequestCardanoRequestToAmount.from_dict(obj["amount"]) if obj.get("amount") is not None else None,
            "address": obj.get("address"),
            "assets": [CreateTransactionRequestCardanoRequestToAssetsInner.from_dict(_item) for _item in obj["assets"]] if obj.get("assets") is not None else None
        })
        return _obj
