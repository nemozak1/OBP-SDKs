...
class CreateVRPConsentRequest200Response(BaseModel):
    """
    CreateVRPConsentRequest200Response
    """ # noqa: E501
    consumer_id: Optional[StrictStr] = None
    payload: Optional[CreateVRPConsentRequest200ResponsePayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payload": CreateVRPConsentRequest200ResponsePayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
