...
class GetStatusOfCreditCardOrder200Response(BaseModel):
    """
    GetStatusOfCreditCardOrder200Response
    """ # noqa: E501
    cards: Optional[List[GetStatusOfCreditCardOrder200ResponseCardsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cards": [GetStatusOfCreditCardOrder200ResponseCardsInner.from_dict(_item) for _item in obj["cards"]] if obj.get("cards") is not None else None
        })
        return _obj
