...
class CreateUserWithRolesRequest(BaseModel):
    ...
    """ # noqa: E501
    roles: Optional[List[CreateConsentImplicitRequestEntitlementsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": [CreateConsentImplicitRequestEntitlementsInner.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None,
