...
class Config200Response(BaseModel):
    """
    Config200Response
    """ # noqa: E501
    elastic_search: Optional[Config200ResponseElasticSearch] = None
    scopes: Optional[Config200ResponseScopes] = None
    akka: Optional[Config200ResponseAkka] = None
    cache: Optional[List[Config200ResponseCacheInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elastic_search": Config200ResponseElasticSearch.from_dict(obj["elastic_search"]) if obj.get("elastic_search") is not None else None,
            "scopes": Config200ResponseScopes.from_dict(obj["scopes"]) if obj.get("scopes") is not None else None,
            "akka": Config200ResponseAkka.from_dict(obj["akka"]) if obj.get("akka") is not None else None,
            "cache": [Config200ResponseCacheInner.from_dict(_item) for _item in obj["cache"]] if obj.get("cache") is not None else None
        })
        return _obj
