...
class GetCoreTransactionsForBankAccount200ResponseTransactionsInner(BaseModel):
    """
    ...
    other_account: Optional[GetCoreTransactionsForBankAccount200ResponseTransactionsInnerOtherAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "other_account": GetCoreTransactionsForBankAccount200ResponseTransactionsInnerOtherAccount.from_dict(obj["other_account"]) if obj.get("other_account") is not None else None,
