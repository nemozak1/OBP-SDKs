...
class GetOtherAccountsForBankAccount200Response(BaseModel):
    """
    GetOtherAccountsForBankAccount200Response
    """ # noqa: E501
    other_accounts: Optional[List[GetTransactionByIdForBankAccount200ResponseOtherAccount]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "other_accounts": [GetTransactionByIdForBankAccount200ResponseOtherAccount.from_dict(_item) for _item in obj["other_accounts"]] if obj.get("other_accounts") is not None else None
        })
        return _obj
