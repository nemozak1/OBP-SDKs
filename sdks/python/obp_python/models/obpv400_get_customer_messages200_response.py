...
class OBPv400GetCustomerMessages200Response(BaseModel):
    ...
    """ # noqa: E501
    messages: Optional[List[OBPv400GetCustomerMessages200ResponseMessagesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messages": [OBPv400GetCustomerMessages200ResponseMessagesInner.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
