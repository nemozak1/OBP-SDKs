...
class GetCallsLimit200Response(BaseModel):
    """
    GetCallsLimit200Response
    """ # noqa: E501
    limits: Optional[List[GetCallsLimit200ResponseLimitsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "limits": [GetCallsLimit200ResponseLimitsInner.from_dict(_item) for _item in obj["limits"]] if obj.get("limits") is not None else None
        })
        return _obj
