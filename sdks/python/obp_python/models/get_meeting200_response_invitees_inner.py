...
class GetMeeting200ResponseInviteesInner(BaseModel):
    """
    GetMeeting200ResponseInviteesInner
    """ # noqa: E501
    status: Optional[StrictStr] = None
    contact_details: Optional[GetMeeting200ResponseCreator] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contact_details": GetMeeting200ResponseCreator.from_dict(obj["contact_details"]) if obj.get("contact_details") is not None else None
        })
        return _obj
