...
class GetConsentInfos200Response(BaseModel):
    """
    GetConsentInfos200Response
    """ # noqa: E501
    consents: Optional[List[GetConsentInfos200ResponseConsentsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consents": [GetConsentInfos200ResponseConsentsInner.from_dict(_item) for _item in obj["consents"]] if obj.get("consents") is not None else None
        })
        return _obj
