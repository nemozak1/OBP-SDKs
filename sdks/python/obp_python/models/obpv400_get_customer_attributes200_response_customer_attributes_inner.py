...
class OBPv400GetCustomerAttributes200ResponseCustomerAttributesInner(BaseModel):
    """
    OBPv400GetCustomerAttributes200ResponseCustomerAttributesInner
    """ # noqa: E501
    customer_attribute_id: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customer_attribute_id": obj.get("customer_attribute_id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
            "value": obj.get("value")
        })
