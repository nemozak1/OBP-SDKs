...
class GetCheckbookOrders200Response(BaseModel):
    """
    GetCheckbookOrders200Response
    """ # noqa: E501
    account: Optional[GetCheckbookOrders200ResponseAccount] = None
    orders: Optional[List[GetCheckbookOrders200ResponseOrdersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": GetCheckbookOrders200ResponseAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
            "orders": [GetCheckbookOrders200ResponseOrdersInner.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
