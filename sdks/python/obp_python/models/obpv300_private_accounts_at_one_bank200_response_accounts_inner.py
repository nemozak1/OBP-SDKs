...
class OBPv300PrivateAccountsAtOneBank200ResponseAccountsInner(BaseModel):
    """
    ...
    views: Optional[List[OBPv300PrivateAccountsAtOneBank200ResponseAccountsInnerViewsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "views": [OBPv300PrivateAccountsAtOneBank200ResponseAccountsInnerViewsInner.from_dict(_item) for _item in obj["views"]] if obj.get("views") is not None else None
        })
        return _obj
