...
class OBPv200GetKycChecks200ResponseChecksInner(BaseModel):
    """
    ...
    satisfied: Optional[StrictBool] = None
    staff_user_id: Optional[StrictStr] = None
    staff_name: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "staff_user_id": obj.get("staff_user_id"),
