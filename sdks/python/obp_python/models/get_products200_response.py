...
class GetProducts200Response(BaseModel):
    ...
    """ # noqa: E501
    products: Optional[List[CreateProduct200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products": [CreateProduct200Response.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
        return _obj
