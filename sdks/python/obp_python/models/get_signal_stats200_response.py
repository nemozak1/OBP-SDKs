...
class GetSignalStats200Response(BaseModel):
    """
    GetSignalStats200Response
    """ # noqa: E501
    total_channels: Optional[StrictInt] = None
    channels: Optional[List[GetSignalChannelInfo200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "channels": [GetSignalChannelInfo200Response.from_dict(_item) for _item in obj["channels"]] if obj.get("channels") is not None else None,
