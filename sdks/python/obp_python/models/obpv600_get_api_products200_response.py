...
class OBPv600GetApiProducts200Response(BaseModel):
    ...
    """ # noqa: E501
    api_products: Optional[List[OBPv600GetApiProducts200ResponseApiProductsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api_products": [OBPv600GetApiProducts200ResponseApiProductsInner.from_dict(_item) for _item in obj["api_products"]] if obj.get("api_products") is not None else None
        })
        return _obj
