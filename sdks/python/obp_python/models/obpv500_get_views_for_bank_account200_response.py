...
class OBPv500GetViewsForBankAccount200Response(BaseModel):
    ...
    """ # noqa: E501
    views: Optional[List[OBPv500GetViewsForBankAccount200ResponseViewsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "views": [OBPv500GetViewsForBankAccount200ResponseViewsInner.from_dict(_item) for _item in obj["views"]] if obj.get("views") is not None else None
        })
        return _obj
