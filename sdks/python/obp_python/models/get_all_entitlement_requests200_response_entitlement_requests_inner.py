...
class GetAllEntitlementRequests200ResponseEntitlementRequestsInner(BaseModel):
    """
    GetAllEntitlementRequests200ResponseEntitlementRequestsInner
    """ # noqa: E501
    entitlement_request_id: Optional[StrictStr] = None
    role_name: Optional[StrictStr] = None
    bank_id: Optional[StrictStr] = None
    user: Optional[VerifyUserCredentials200Response] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entitlement_request_id": obj.get("entitlement_request_id"),
            "role_name": obj.get("role_name"),
            "bank_id": obj.get("bank_id"),
            "user": VerifyUserCredentials200Response.from_dict(obj["user"]) if obj.get("user") is not None else None,
