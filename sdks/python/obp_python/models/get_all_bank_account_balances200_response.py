...
class GetAllBankAccountBalances200Response(BaseModel):
    """
    GetAllBankAccountBalances200Response
    """ # noqa: E501
    balances: Optional[List[GetAllBankAccountBalances200ResponseBalancesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "balances": [GetAllBankAccountBalances200ResponseBalancesInner.from_dict(_item) for _item in obj["balances"]] if obj.get("balances") is not None else None
        })
        return _obj
