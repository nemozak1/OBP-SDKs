...
class CreateVRPConsentRequestRequest(BaseModel):
    """
    ...
    to_account: Optional[CreateVRPConsentRequestRequestToAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "to_account": CreateVRPConsentRequestRequestToAccount.from_dict(obj["to_account"]) if obj.get("to_account") is not None else None
        })
        return _obj
