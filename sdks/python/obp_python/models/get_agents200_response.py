...
class GetAgents200Response(BaseModel):
    ...
    """ # noqa: E501
    agents: Optional[List[GetAgents200ResponseAgentsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agents": [GetAgents200ResponseAgentsInner.from_dict(_item) for _item in obj["agents"]] if obj.get("agents") is not None else None
        })
        return _obj
