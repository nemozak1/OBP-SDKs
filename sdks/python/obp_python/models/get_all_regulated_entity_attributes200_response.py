...
class GetAllRegulatedEntityAttributes200Response(BaseModel):
    """
    GetAllRegulatedEntityAttributes200Response
    """ # noqa: E501
    attributes: Optional[List[GetRegulatedEntityAttributeById200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": [GetRegulatedEntityAttributeById200Response.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None
        })
        return _obj
