...
class GetCustomerAccountLinksByCustomerId200Response(BaseModel):
    """
    GetCustomerAccountLinksByCustomerId200Response
    """ # noqa: E501
    links: Optional[List[GetCustomerAccountLinksByCustomerId200ResponseLinksInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": [GetCustomerAccountLinksByCustomerId200ResponseLinksInner.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None
        })
        return _obj
