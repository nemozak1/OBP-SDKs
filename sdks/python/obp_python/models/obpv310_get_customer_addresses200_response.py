...
class OBPv310GetCustomerAddresses200Response(BaseModel):
    ...
    """ # noqa: E501
    addresses: Optional[List[OBPv310CreateCustomerAddress200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addresses": [OBPv310CreateCustomerAddress200Response.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None
        })
        return _obj
