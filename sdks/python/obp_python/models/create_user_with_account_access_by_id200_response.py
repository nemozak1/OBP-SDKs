...
class CreateUserWithAccountAccessById200Response(BaseModel):
    """
    CreateUserWithAccountAccessById200Response
    """ # noqa: E501
    head: Optional[CreateUserWithAccountAccessById200ResponseHead] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "head": CreateUserWithAccountAccessById200ResponseHead.from_dict(obj["head"]) if obj.get("head") is not None else None,
            "tl": obj.get("tl")
        })
        return _obj
