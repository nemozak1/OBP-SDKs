...
class OBPv500GetCustomerOverviewFlat200ResponseAccountsInner(BaseModel):
    """
    OBPv500GetCustomerOverviewFlat200ResponseAccountsInner
    """ # noqa: E501
    contracts: Optional[List[OBPv500GetCustomerOverviewFlat200ResponseAccountsInnerContractsInner]] = None
    account_attributes: Optional[List[OBPv500GetCustomerOverviewFlat200ResponseAccountsInnerAccountAttributesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contracts": [OBPv500GetCustomerOverviewFlat200ResponseAccountsInnerContractsInner.from_dict(_item) for _item in obj["contracts"]] if obj.get("contracts") is not None else None,
            "account_attributes": [OBPv500GetCustomerOverviewFlat200ResponseAccountsInnerAccountAttributesInner.from_dict(_item) for _item in obj["account_attributes"]] if obj.get("account_attributes") is not None else None,
