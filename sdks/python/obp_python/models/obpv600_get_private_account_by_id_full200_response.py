...
class OBPv600GetPrivateAccountByIdFull200Response(BaseModel):
    """
    ...
    views_available: Optional[List[OBPv600GetSystemViewById200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "views_available": [OBPv600GetSystemViewById200Response.from_dict(_item) for _item in obj["views_available"]] if obj.get("views_available") is not None else None,
