...
class GetTransactionTypes200Response(BaseModel):
    """
    GetTransactionTypes200Response
    """ # noqa: E501
    transaction_types: Optional[List[GetTransactionTypes200ResponseTransactionTypesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transaction_types": [GetTransactionTypes200ResponseTransactionTypesInner.from_dict(_item) for _item in obj["transaction_types"]] if obj.get("transaction_types") is not None else None
        })
        return _obj
