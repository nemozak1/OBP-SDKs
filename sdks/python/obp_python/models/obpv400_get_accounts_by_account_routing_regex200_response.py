...
class OBPv400GetAccountsByAccountRoutingRegex200Response(BaseModel):
    ...
    """ # noqa: E501
    accounts: Optional[List[OBPv400GetAccountsByAccountRoutingRegex200ResponseAccountsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [OBPv400GetAccountsByAccountRoutingRegex200ResponseAccountsInner.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
