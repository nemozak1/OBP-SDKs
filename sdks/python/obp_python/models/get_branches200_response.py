...
class GetBranches200Response(BaseModel):
    """
    GetBranches200Response
    """ # noqa: E501
    branches: Optional[List[GetBranches200ResponseBranchesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "branches": [GetBranches200ResponseBranchesInner.from_dict(_item) for _item in obj["branches"]] if obj.get("branches") is not None else None
        })
        return _obj
