...
class OBPv400CreateTransactionRequestCounterparty200ResponseDetailsToTransferToAccount(BaseModel):
    """
    ...
    to: Optional[OBPv400CreateTransactionRequestCounterparty200ResponseDetailsToTransferToAccountTo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "to": OBPv400CreateTransactionRequestCounterparty200ResponseDetailsToTransferToAccountTo.from_dict(obj["to"]) if obj.get("to") is not None else None,
