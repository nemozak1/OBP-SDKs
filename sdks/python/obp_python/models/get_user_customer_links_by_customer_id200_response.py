...
class GetUserCustomerLinksByCustomerId200Response(BaseModel):
    """
    GetUserCustomerLinksByCustomerId200Response
    """ # noqa: E501
    user_customer_links: Optional[List[GetUserCustomerLinksByCustomerId200ResponseUserCustomerLinksInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user_customer_links": [GetUserCustomerLinksByCustomerId200ResponseUserCustomerLinksInner.from_dict(_item) for _item in obj["user_customer_links"]] if obj.get("user_customer_links") is not None else None
        })
        return _obj
