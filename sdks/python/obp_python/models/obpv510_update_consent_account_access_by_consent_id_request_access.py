...
class OBPv510UpdateConsentAccountAccessByConsentIdRequestAccess(BaseModel):
    """
    OBPv510UpdateConsentAccountAccessByConsentIdRequestAccess
    """ # noqa: E501
    accounts: Optional[List[OBPv400CreateTransactionRequestCounterparty200ResponseDetailsToSepaCreditTransfersDebtorAccount]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [OBPv400CreateTransactionRequestCounterparty200ResponseDetailsToSepaCreditTransfersDebtorAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
