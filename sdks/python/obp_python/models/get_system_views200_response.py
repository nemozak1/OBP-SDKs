...
class GetSystemViews200Response(BaseModel):
    """
    GetSystemViews200Response
    """ # noqa: E501
    views: Optional[List[GetSystemViewById200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "views": [GetSystemViewById200Response.from_dict(_item) for _item in obj["views"]] if obj.get("views") is not None else None
        })
        return _obj
