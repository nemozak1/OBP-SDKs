...
class GetBankAccountsBalances200Response(BaseModel):
    """
    GetBankAccountsBalances200Response
    """ # noqa: E501
    accounts: Optional[List[GetBankAccountsBalances200ResponseAccountsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [GetBankAccountsBalances200ResponseAccountsInner.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
