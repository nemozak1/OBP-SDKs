...
class DataWarehouseSearchRequest(BaseModel):
    """
    DataWarehouseSearchRequest
    """ # noqa: E501
    query: Optional[DataWarehouseSearchRequestQuery] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "query": DataWarehouseSearchRequestQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
