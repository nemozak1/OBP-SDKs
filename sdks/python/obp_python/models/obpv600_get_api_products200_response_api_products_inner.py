...
class OBPv600GetApiProducts200ResponseApiProductsInner(BaseModel):
    """
    ...
    attributes: Optional[List[OBPv600CreateApiProductAttribute200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": [OBPv600CreateApiProductAttribute200Response.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None,
