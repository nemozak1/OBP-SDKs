...
class OBPv300GetFirehoseTransactionsForBankAccount200Response(BaseModel):
    ...
    """ # noqa: E501
    transactions: Optional[List[OBPv310GetTransactionByIdForBankAccount200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": [OBPv310GetTransactionByIdForBankAccount200Response.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
