...
class GetAllCounterpartyAttributes200Response(BaseModel):
    """
    GetAllCounterpartyAttributes200Response
    """ # noqa: E501
    attributes: Optional[List[GetAllCounterpartyAttributes200ResponseAttributesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": [GetAllCounterpartyAttributes200ResponseAttributesInner.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None
        })
        return _obj
