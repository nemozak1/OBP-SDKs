...
class BackupSystemDynamicEntity200Response(BaseModel):
    """
    ...
    var_schema: Optional[BackupBankLevelDynamicEntity200ResponseSchema] = Field(default=None, alias="schema")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schema": BackupBankLevelDynamicEntity200ResponseSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None,
