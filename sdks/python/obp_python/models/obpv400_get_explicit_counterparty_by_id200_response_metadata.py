...
class OBPv400GetExplicitCounterpartyById200ResponseMetadata(BaseModel):
    """
    OBPv400GetExplicitCounterpartyById200ResponseMetadata
    """ # noqa: E501
    public_alias: Optional[StrictStr] = None
    physical_location: Optional[OBPv400GetExplicitCounterpartyById200ResponseMetadataPhysicalLocation] = None
    image_url: Optional[StrictStr] = None
    private_alias: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    more_info: Optional[StrictStr] = None
    corporate_location: Optional[OBPv400GetExplicitCounterpartyById200ResponseMetadataPhysicalLocation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "physical_location": OBPv400GetExplicitCounterpartyById200ResponseMetadataPhysicalLocation.from_dict(obj["physical_location"]) if obj.get("physical_location") is not None else None,
            "image_url": obj.get("image_url"),
            "private_alias": obj.get("private_alias"),
            "url": obj.get("url"),
            "more_info": obj.get("more_info"),
            "corporate_location": OBPv400GetExplicitCounterpartyById200ResponseMetadataPhysicalLocation.from_dict(obj["corporate_location"]) if obj.get("corporate_location") is not None else None,
