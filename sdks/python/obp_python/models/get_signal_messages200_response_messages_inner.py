...
class GetSignalMessages200ResponseMessagesInner(BaseModel):
    """
    GetSignalMessages200ResponseMessagesInner
    """ # noqa: E501
    sender_consumer_id: Optional[StrictStr] = None
    timestamp: Optional[StrictStr] = None
    payload: Optional[GetSignalMessages200ResponseMessagesInnerPayload] = None
    channel_name: Optional[StrictStr] = None
    sender_user_id: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sender_consumer_id": obj.get("sender_consumer_id"),
            "timestamp": obj.get("timestamp"),
            "payload": GetSignalMessages200ResponseMessagesInnerPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None,
