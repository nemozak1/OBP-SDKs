...
class RegulatedEntities200Response(BaseModel):
    """
    RegulatedEntities200Response
    """ # noqa: E501
    entities: Optional[List[GetRegulatedEntityById200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [GetRegulatedEntityById200Response.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None
        })
        return _obj
