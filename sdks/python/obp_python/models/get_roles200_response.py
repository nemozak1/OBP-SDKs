...
class GetRoles200Response(BaseModel):
    ...
    GetRoles200Response
    """ # noqa: E501
    roles: Optional[List[GetRoles200ResponseRolesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": [GetRoles200ResponseRolesInner.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj
