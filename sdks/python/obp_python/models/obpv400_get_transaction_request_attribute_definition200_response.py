...
class OBPv400GetTransactionRequestAttributeDefinition200Response(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[List[OBPv400GetTransactionRequestAttributeDefinition200ResponseAttributesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": [OBPv400GetTransactionRequestAttributeDefinition200ResponseAttributesInner.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None
        })
        return _obj
