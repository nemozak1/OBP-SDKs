...
class OBPv300GetCustomersForUser200Response(BaseModel):
    ...
    """ # noqa: E501
    customers: Optional[List[OBPv300GetCustomersForUser200ResponseCustomersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customers": [OBPv300GetCustomersForUser200ResponseCustomersInner.from_dict(_item) for _item in obj["customers"]] if obj.get("customers") is not None else None
        })
        return _obj
