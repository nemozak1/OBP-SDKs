...
class OBPv600GetCacheInfo200Response(BaseModel):
    ...
    namespaces: Optional[List[OBPv600GetCacheInfo200ResponseNamespacesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "namespaces": [OBPv600GetCacheInfo200ResponseNamespacesInner.from_dict(_item) for _item in obj["namespaces"]] if obj.get("namespaces") is not None else None
        })
        return _obj
