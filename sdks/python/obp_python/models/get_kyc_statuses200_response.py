...
class GetKycStatuses200Response(BaseModel):
    """
    GetKycStatuses200Response
    """ # noqa: E501
    statuses: Optional[List[GetKycStatuses200ResponseStatusesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statuses": [GetKycStatuses200ResponseStatusesInner.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
