...
class GetKycDocuments200Response(BaseModel):
    """
    GetKycDocuments200Response
    """ # noqa: E501
    documents: Optional[List[AddKycDocument200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documents": [AddKycDocument200Response.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None
        })
        return _obj
