...
class OBPv600GetAllCounterpartyAttributes200Response(BaseModel):
    """
    OBPv600GetAllCounterpartyAttributes200Response
    """ # noqa: E501
    attributes: Optional[List[OBPv600GetAllCounterpartyAttributes200ResponseAttributesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": [OBPv600GetAllCounterpartyAttributes200ResponseAttributesInner.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None
        })
        return _obj
