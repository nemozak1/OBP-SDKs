...
class GetGroupEntitlements200Response(BaseModel):
    """
    GetGroupEntitlements200Response
    """ # noqa: E501
    entitlements: Optional[List[GetGroupEntitlements200ResponseEntitlementsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entitlements": [GetGroupEntitlements200ResponseEntitlementsInner.from_dict(_item) for _item in obj["entitlements"]] if obj.get("entitlements") is not None else None
        })
        return _obj
