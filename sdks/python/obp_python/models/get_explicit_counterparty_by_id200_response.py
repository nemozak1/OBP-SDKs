...
class GetExplicitCounterpartyById200Response(BaseModel):
    """
    ...
    metadata: Optional[GetExplicitCounterpartyById200ResponseMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": GetExplicitCounterpartyById200ResponseMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
