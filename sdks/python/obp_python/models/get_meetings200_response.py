...
class GetMeetings200Response(BaseModel):
    """
    GetMeetings200Response
    """ # noqa: E501
    meetings: Optional[List[GetMeeting200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meetings": [GetMeeting200Response.from_dict(_item) for _item in obj["meetings"]] if obj.get("meetings") is not None else None
        })
        return _obj
