...
class OBPv310GetCheckbookOrders200Response(BaseModel):
    ...
    """ # noqa: E501
    account: Optional[OBPv310GetCheckbookOrders200ResponseAccount] = None
    orders: Optional[List[OBPv310GetCheckbookOrders200ResponseOrdersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": OBPv310GetCheckbookOrders200ResponseAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
            "orders": [OBPv310GetCheckbookOrders200ResponseOrdersInner.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
