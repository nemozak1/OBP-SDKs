...
class GetCacheNamespaces200Response(BaseModel):
    """
    GetCacheNamespaces200Response
    """ # noqa: E501
    namespaces: Optional[List[GetCacheNamespaces200ResponseNamespacesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "namespaces": [GetCacheNamespaces200ResponseNamespacesInner.from_dict(_item) for _item in obj["namespaces"]] if obj.get("namespaces") is not None else None
        })
        return _obj
