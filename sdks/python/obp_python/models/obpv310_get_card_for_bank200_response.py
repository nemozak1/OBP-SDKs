...
class OBPv310GetCardForBank200Response(BaseModel):
    ...
    account: Optional[OBPv310GetCardForBank200ResponseAccount] = None
    valid_from_date: Optional[datetime] = None
    card_attributes: Optional[List[OBPv310CreateCardAttribute200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "account": OBPv310GetCardForBank200ResponseAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
            "valid_from_date": obj.get("valid_from_date"),
            "card_attributes": [OBPv310CreateCardAttribute200Response.from_dict(_item) for _item in obj["card_attributes"]] if obj.get("card_attributes") is not None else None,
