...
class OBPv300GetCoreTransactionsForBankAccount200Response(BaseModel):
    ...
    """ # noqa: E501
    transactions: Optional[List[OBPv300GetCoreTransactionsForBankAccount200ResponseTransactionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": [OBPv300GetCoreTransactionsForBankAccount200ResponseTransactionsInner.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
