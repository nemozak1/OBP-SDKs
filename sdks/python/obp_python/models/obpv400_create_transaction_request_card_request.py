...
class OBPv400CreateTransactionRequestCardRequest(BaseModel):
    ...
    card: Optional[OBPv400CreateTransactionRequestCardRequestCard] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "card": OBPv400CreateTransactionRequestCardRequestCard.from_dict(obj["card"]) if obj.get("card") is not None else None,
