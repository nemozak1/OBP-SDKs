...
class CreateProductCollectionRequest(BaseModel):
    """
    CreateProductCollectionRequest
    """ # noqa: E501
    parent_product_code: Optional[StrictStr] = None
    children_product_codes: Optional[List[StrictStr]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "children_product_codes": obj.get("children_product_codes")
        })
        return _obj
