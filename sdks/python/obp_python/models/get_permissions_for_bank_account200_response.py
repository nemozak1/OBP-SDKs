...
class GetPermissionsForBankAccount200Response(BaseModel):
    """
    GetPermissionsForBankAccount200Response
    """ # noqa: E501
    permissions: Optional[List[GetPermissionsForBankAccount200ResponsePermissionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissions": [GetPermissionsForBankAccount200ResponsePermissionsInner.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None
        })
        return _obj
