...
class GetSocialMediaHandles200Response(BaseModel):
    """
    GetSocialMediaHandles200Response
    """ # noqa: E501
    checks: Optional[List[GetSocialMediaHandles200ResponseChecksInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "checks": [GetSocialMediaHandles200ResponseChecksInner.from_dict(_item) for _item in obj["checks"]] if obj.get("checks") is not None else None
        })
        return _obj
