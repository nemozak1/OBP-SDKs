...
class OBPv400GetUserCustomerLinksByCustomerId200ResponseUserCustomerLinksInner(BaseModel):
    """
    ...
    date_inserted: Optional[datetime] = None
    user_customer_link_id: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user_customer_link_id": obj.get("user_customer_link_id")
        })
        return _obj
