...
class OBPv310GetProductCollection200ResponseProductsInner(BaseModel):
    """
    ...
    product_attributes: Optional[List[OBPv400GetProduct200ResponseAttributesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "product_attributes": [OBPv400GetProduct200ResponseAttributesInner.from_dict(_item) for _item in obj["product_attributes"]] if obj.get("product_attributes") is not None else None,
