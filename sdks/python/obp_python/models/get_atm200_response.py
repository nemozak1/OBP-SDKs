...
class GetAtm200Response(BaseModel):
    """
    GetAtm200Response
    """ # noqa: E501
    ...
    attributes: Optional[List[GetAtmAttribute200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": [GetAtmAttribute200Response.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None,
