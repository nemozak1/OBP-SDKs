...
class GetCrmEvents200Response(BaseModel):
    """
    GetCrmEvents200Response
    """ # noqa: E501
    crm_events: Optional[List[GetCrmEvents200ResponseCrmEventsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "crm_events": [GetCrmEvents200ResponseCrmEventsInner.from_dict(_item) for _item in obj["crm_events"]] if obj.get("crm_events") is not None else None
        })
        return _obj
