...
class GetMetricsTopConsumers200Response(BaseModel):
    """
    GetMetricsTopConsumers200Response
    """ # noqa: E501
    top_consumers: Optional[List[GetMetricsTopConsumers200ResponseTopConsumersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "top_consumers": [GetMetricsTopConsumers200ResponseTopConsumersInner.from_dict(_item) for _item in obj["top_consumers"]] if obj.get("top_consumers") is not None else None
        })
        return _obj
