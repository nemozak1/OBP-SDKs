...
class GetAllEntitlements200Response(BaseModel):
    """
    GetAllEntitlements200Response
    """ # noqa: E501
    list: Optional[List[GetAllEntitlements200ResponseListInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [GetAllEntitlements200ResponseListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
