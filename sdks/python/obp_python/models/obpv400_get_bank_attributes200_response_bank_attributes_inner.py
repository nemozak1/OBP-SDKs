...
class OBPv400GetBankAttributes200ResponseBankAttributesInner(BaseModel):
    """
    OBPv400GetBankAttributes200ResponseBankAttributesInner
    """ # noqa: E501
    name: Optional[StrictStr] = None
    is_active: Optional[StrictBool] = None
    bank_attribute_id: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bank_attribute_id": obj.get("bank_attribute_id"),
