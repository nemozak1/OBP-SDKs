...
class GetCurrenciesAtBank200Response(BaseModel):
    """
    GetCurrenciesAtBank200Response
    """ # noqa: E501
    currencies: Optional[List[GetCurrenciesAtBank200ResponseCurrenciesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currencies": [GetCurrenciesAtBank200ResponseCurrenciesInner.from_dict(_item) for _item in obj["currencies"]] if obj.get("currencies") is not None else None
        })
        return _obj
