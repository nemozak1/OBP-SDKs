...
class OBPv510CreateVRPConsentRequest200ResponsePayloadToAccountLimit(BaseModel):
    """
    OBPv510CreateVRPConsentRequest200ResponsePayloadToAccountLimit
    """ # noqa: E501
    max_monthly_amount: Optional[StrictInt] = None
    max_number_of_monthly_transactions: Optional[StrictInt] = None
    max_single_amount: Optional[StrictInt] = None
    currency: Optional[StrictStr] = None
    max_number_of_yearly_transactions: Optional[StrictInt] = None
    max_yearly_amount: Optional[StrictInt] = None
