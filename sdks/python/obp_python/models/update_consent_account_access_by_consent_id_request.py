...
class UpdateConsentAccountAccessByConsentIdRequest(BaseModel):
    """
    UpdateConsentAccountAccessByConsentIdRequest
    """ # noqa: E501
    access: Optional[UpdateConsentAccountAccessByConsentIdRequestAccess] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "access": UpdateConsentAccountAccessByConsentIdRequestAccess.from_dict(obj["access"]) if obj.get("access") is not None else None
        })
        return _obj
