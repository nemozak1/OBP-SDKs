...
class GetConsentByConsentRequestId200Response(BaseModel):
    """
    GetConsentByConsentRequestId200Response
    """ # noqa: E501
    jwt: Optional[StrictStr] = None
    account_access: Optional[GetConsents200ResponseConsentsInnerJwtPayloadViewsInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jwt": obj.get("jwt"),
            "account_access": GetConsents200ResponseConsentsInnerJwtPayloadViewsInner.from_dict(obj["account_access"]) if obj.get("account_access") is not None else None,
