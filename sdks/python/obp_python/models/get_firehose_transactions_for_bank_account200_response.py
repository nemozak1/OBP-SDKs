...
class GetFirehoseTransactionsForBankAccount200Response(BaseModel):
    """
    GetFirehoseTransactionsForBankAccount200Response
    """ # noqa: E501
    transactions: Optional[List[GetTransactionByIdForBankAccount200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": [GetTransactionByIdForBankAccount200Response.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
