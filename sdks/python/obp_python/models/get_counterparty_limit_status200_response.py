...
class GetCounterpartyLimitStatus200Response(BaseModel):
    """
    ...
    status: Optional[GetCounterpartyLimitStatus200ResponseStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": GetCounterpartyLimitStatus200ResponseStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
