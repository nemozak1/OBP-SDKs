...
class GetCardsForBank200Response(BaseModel):
    """
    GetCardsForBank200Response
    """ # noqa: E501
    cards: Optional[List[GetCardsForBank200ResponseCardsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cards": [GetCardsForBank200ResponseCardsInner.from_dict(_item) for _item in obj["cards"]] if obj.get("cards") is not None else None
        })
        return _obj
