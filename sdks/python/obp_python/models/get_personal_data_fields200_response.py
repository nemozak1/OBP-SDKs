...
class GetPersonalDataFields200Response(BaseModel):
    """
    GetPersonalDataFields200Response
    """ # noqa: E501
    user_attributes: Optional[List[GetPersonalDataFields200ResponseUserAttributesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user_attributes": [GetPersonalDataFields200ResponseUserAttributesInner.from_dict(_item) for _item in obj["user_attributes"]] if obj.get("user_attributes") is not None else None
        })
        return _obj
