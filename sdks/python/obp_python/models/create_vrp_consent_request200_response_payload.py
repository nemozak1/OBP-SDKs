...
class CreateVRPConsentRequest200ResponsePayload(BaseModel):
    """
    CreateVRPConsentRequest200ResponsePayload
    """ # noqa: E501
    from_account: Optional[CreateVRPConsentRequestRequestFromAccount] = None
    to_account: Optional[CreateVRPConsentRequest200ResponsePayloadToAccount] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "from_account": CreateVRPConsentRequestRequestFromAccount.from_dict(obj["from_account"]) if obj.get("from_account") is not None else None,
            "to_account": CreateVRPConsentRequest200ResponsePayloadToAccount.from_dict(obj["to_account"]) if obj.get("to_account") is not None else None,
