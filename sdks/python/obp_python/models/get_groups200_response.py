...
class GetGroups200Response(BaseModel):
    ...
    """ # noqa: E501
    groups: Optional[List[GetGroups200ResponseGroupsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [GetGroups200ResponseGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
