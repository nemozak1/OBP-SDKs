...
class OBPv200GetPermissionsForBankAccount200Response(BaseModel):
    ...
    """ # noqa: E501
    permissions: Optional[List[OBPv200GetPermissionsForBankAccount200ResponsePermissionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "permissions": [OBPv200GetPermissionsForBankAccount200ResponsePermissionsInner.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None
        })
        return _obj
