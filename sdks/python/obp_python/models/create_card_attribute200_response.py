...
class CreateCardAttribute200Response(BaseModel):
    """
    ...
    bank_id: Optional[GetTransactionTypes200ResponseTransactionTypesInnerId] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bank_id": GetTransactionTypes200ResponseTransactionTypesInnerId.from_dict(obj["bank_id"]) if obj.get("bank_id") is not None else None,
