...
class GetConsents200Response(BaseModel):
    """
    GetConsents200Response
    """ # noqa: E501
    number_of_rows: Optional[StrictInt] = None
    consents: Optional[List[GetConsents200ResponseConsentsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consents": [GetConsents200ResponseConsentsInner.from_dict(_item) for _item in obj["consents"]] if obj.get("consents") is not None else None
        })
        return _obj
