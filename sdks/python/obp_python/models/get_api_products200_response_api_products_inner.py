...
class GetApiProducts200ResponseApiProductsInner(BaseModel):
    """
    ...
    attributes: Optional[List[CreateApiProductAttribute200Response]] = None
    per_hour_call_limit: Optional[StrictInt] = None
    bank_id: Optional[StrictStr] = None
    api_product_id: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": [CreateApiProductAttribute200Response.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None,
            "per_hour_call_limit": obj.get("per_hour_call_limit"),
            "bank_id": obj.get("bank_id"),
            "api_product_id": obj.get("api_product_id"),
