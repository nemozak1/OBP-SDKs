...
class GetProductCollection200Response(BaseModel):
    """
    GetProductCollection200Response
    """ # noqa: E501
    products: Optional[List[GetProductCollection200ResponseProductsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products": [GetProductCollection200ResponseProductsInner.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None,
