...
class GetApiProducts200Response(BaseModel):
    """
    GetApiProducts200Response
    """ # noqa: E501
    api_products: Optional[List[GetApiProducts200ResponseApiProductsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api_products": [GetApiProducts200ResponseApiProductsInner.from_dict(_item) for _item in obj["api_products"]] if obj.get("api_products") is not None else None
        })
        return _obj
