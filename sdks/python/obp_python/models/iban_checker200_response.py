...
class IbanChecker200Response(BaseModel):
    """
    IbanChecker200Response
    """ # noqa: E501
    is_valid: Optional[StrictBool] = None
    details: Optional[IbanChecker200ResponseDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": IbanChecker200ResponseDetails.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
        return _obj
