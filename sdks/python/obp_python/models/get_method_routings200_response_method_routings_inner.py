...
class GetMethodRoutings200ResponseMethodRoutingsInner(BaseModel):
    """
    ...
    parameters: Optional[List[GetExplicitCounterpartyById200ResponseBespokeInner]] = None
    method_routing_id: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parameters": [GetExplicitCounterpartyById200ResponseBespokeInner.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None,
            "method_routing_id": obj.get("method_routing_id")
        })
        return _obj
