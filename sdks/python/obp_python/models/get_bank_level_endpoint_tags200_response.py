...
class GetBankLevelEndpointTags200Response(BaseModel):
    """
    GetBankLevelEndpointTags200Response
    """ # noqa: E501
    head: Optional[UpdateSystemLevelEndpointTag200Response] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "head": UpdateSystemLevelEndpointTag200Response.from_dict(obj["head"]) if obj.get("head") is not None else None,
            "tl": obj.get("tl")
        })
        return _obj
