...
class GetBanks200Response(BaseModel):
    """
    GetBanks200Response
    """ # noqa: E501
    banks: Optional[List[GetBank200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "banks": [GetBank200Response.from_dict(_item) for _item in obj["banks"]] if obj.get("banks") is not None else None
        })
        return _obj
