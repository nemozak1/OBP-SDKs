...
class OBPv310GetCheckbookOrders200ResponseAccount(BaseModel):
    """
    ...
    branch_routings: Optional[List[OBPv310GetCheckbookOrders200ResponseAccountAccountRoutingsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "branch_routings": [OBPv310GetCheckbookOrders200ResponseAccountAccountRoutingsInner.from_dict(_item) for _item in obj["branch_routings"]] if obj.get("branch_routings") is not None else None
        })
        return _obj
