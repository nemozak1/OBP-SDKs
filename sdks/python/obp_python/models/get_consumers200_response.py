...
class GetConsumers200Response(BaseModel):
    ...
    """ # noqa: E501
    consumers: Optional[List[UpdateConsumerName200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consumers": [UpdateConsumerName200Response.from_dict(_item) for _item in obj["consumers"]] if obj.get("consumers") is not None else None
        })
        return _obj
