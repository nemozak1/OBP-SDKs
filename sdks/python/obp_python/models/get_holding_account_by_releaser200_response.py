...
class GetHoldingAccountByReleaser200Response(BaseModel):
    """
    GetHoldingAccountByReleaser200Response
    """ # noqa: E501
    accounts: Optional[List[GetPublicAccountById200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [GetPublicAccountById200Response.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
