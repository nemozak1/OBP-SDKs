...
class OBPv300GetCoreTransactionsForBankAccount200ResponseTransactionsInnerDetails(BaseModel):
    """
    OBPv300GetCoreTransactionsForBankAccount200ResponseTransactionsInnerDetails
    """ # noqa: E501
    new_balance: Optional[OBPv500GetMyCustomersAtBank200ResponseCustomersInnerCreditLimit] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "new_balance": OBPv500GetMyCustomersAtBank200ResponseCustomersInnerCreditLimit.from_dict(obj["new_balance"]) if obj.get("new_balance") is not None else None,
