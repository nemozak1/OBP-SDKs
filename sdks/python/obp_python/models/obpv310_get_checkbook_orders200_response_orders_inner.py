...
class OBPv310GetCheckbookOrders200ResponseOrdersInner(BaseModel):
    """
    OBPv310GetCheckbookOrders200ResponseOrdersInner
    """ # noqa: E501
    order: Optional[OBPv310GetCheckbookOrders200ResponseOrdersInnerOrder] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "order": OBPv310GetCheckbookOrders200ResponseOrdersInnerOrder.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
