...
class GetCheckbookOrders200ResponseOrdersInner(BaseModel):
    """
    GetCheckbookOrders200ResponseOrdersInner
    """ # noqa: E501
    order: Optional[GetCheckbookOrders200ResponseOrdersInnerOrder] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "order": GetCheckbookOrders200ResponseOrdersInnerOrder.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
