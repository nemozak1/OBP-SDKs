...
class GetTransactionsForBankAccount200Response(BaseModel):
    """
    GetTransactionsForBankAccount200Response
    """ # noqa: E501
    transactions: Optional[List[GetTransactionsForBankAccount200ResponseTransactionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": [GetTransactionsForBankAccount200ResponseTransactionsInner.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
