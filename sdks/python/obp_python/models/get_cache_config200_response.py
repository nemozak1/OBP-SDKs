...
class GetCacheConfig200Response(BaseModel):
    """
    GetCacheConfig200Response
    """ # noqa: E501
    global_prefix: Optional[StrictStr] = None
    redis_status: Optional[GetCacheConfig200ResponseRedisStatus] = None
    environment: Optional[StrictStr] = None
    in_memory_status: Optional[GetCacheConfig200ResponseInMemoryStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "redis_status": GetCacheConfig200ResponseRedisStatus.from_dict(obj["redis_status"]) if obj.get("redis_status") is not None else None,
            "environment": obj.get("environment"),
            "in_memory_status": GetCacheConfig200ResponseInMemoryStatus.from_dict(obj["in_memory_status"]) if obj.get("in_memory_status") is not None else None,
