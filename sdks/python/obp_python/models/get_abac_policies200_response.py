...
class GetAbacPolicies200Response(BaseModel):
    """
    GetAbacPolicies200Response
    """ # noqa: E501
    policies: Optional[List[GetAbacPolicies200ResponsePoliciesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [GetAbacPolicies200ResponsePoliciesInner.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
