...
class OBPv600GetPersonalDataFields200Response(BaseModel):
    ...
    """ # noqa: E501
    user_attributes: Optional[List[OBPv600GetPersonalDataFields200ResponseUserAttributesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user_attributes": [OBPv600GetPersonalDataFields200ResponseUserAttributesInner.from_dict(_item) for _item in obj["user_attributes"]] if obj.get("user_attributes") is not None else None
        })
        return _obj
