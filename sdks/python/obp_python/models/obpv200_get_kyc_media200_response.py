...
class OBPv200GetKycMedia200Response(BaseModel):
    ...
    """ # noqa: E501
    medias: Optional[List[OBPv200AddKycMedia200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "medias": [OBPv200AddKycMedia200Response.from_dict(_item) for _item in obj["medias"]] if obj.get("medias") is not None else None
        })
        return _obj
