...
class GetMetrics200Response(BaseModel):
    ...
    """ # noqa: E501
    metrics: Optional[List[GetMetrics200ResponseMetricsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metrics": [GetMetrics200ResponseMetricsInner.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None
        })
        return _obj
