...
class RateLimitsApi:
    ...
    def get_rate_limiting_info(
        ...
        _param = self._get_rate_limiting_info_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetRateLimitingInfo200Response",
            '500': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_rate_limiting_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetRateLimitingInfo200Response]:
        """Get Rate Limiting Info
    ...
    @validate_call
    def get_rate_limiting_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_rate_limiting_info_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
