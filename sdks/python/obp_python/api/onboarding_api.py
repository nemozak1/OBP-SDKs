...
class OnboardingApi:
    ...
    def create_account(
        ...
        add_account_request: Annotated[AddAccountRequest, Field(description="Request body")],
        ...
        :type accountid: str
        :param add_account_request: Request body (required)
    ...
    def create_account_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddAccount200Response]:
        """Create Account (PUT)
    ...
    def create_user(
        self,
        create_user_request: Annotated[CreateUserRequest, Field(description="Request body")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "VerifyUserCredentials200Response",
            '500': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    def create_user_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VerifyUserCredentials200Response]:
        """Create User (v6.0.0)
