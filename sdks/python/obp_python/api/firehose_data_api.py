...
class FirehoseDataApi:
    ...
    @validate_call
    def get_fast_firehose_accounts_at_one_bank(
        self,
        ...
        _param = self._get_fast_firehose_accounts_at_one_bank_serialize(
            bankid=bankid,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetFastFirehoseAccountsAtOneBank200Response",
            '404': None,
            '500': None,
        }
    ...
    @validate_call
    def get_fast_firehose_accounts_at_one_bank_with_http_info(
        self,
        bankid: Annotated[StrictStr, Field(description="The BANKID identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetFastFirehoseAccountsAtOneBank200Response]:
        """Get Fast Firehose Accounts at Bank
    ...
    @validate_call
    def get_fast_firehose_accounts_at_one_bank_without_preload_content(
        self,
        bankid: Annotated[StrictStr, Field(description="The BANKID identifier")],
        _request_timeout: Union[
            None,
    ...
    def _get_fast_firehose_accounts_at_one_bank_serialize(
        self,
        bankid,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_firehose_accounts_at_one_bank(
        self,
        bankid: Annotated[StrictStr, Field(description="The BANKID identifier")],
        ...
        _param = self._get_firehose_accounts_at_one_bank_serialize(
            bankid=bankid,
            viewid=viewid,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetFirehoseAccountsAtOneBank200Response",
            '404': None,
            '500': None,
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def get_firehose_accounts_at_one_bank_with_http_info(
        self,
        bankid: Annotated[StrictStr, Field(description="The BANKID identifier")],
        viewid: Annotated[StrictStr, Field(description="The VIEWID identifier")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetFirehoseAccountsAtOneBank200Response]:
        """Get Firehose Accounts at Bank
    ...
    @validate_call
    def get_firehose_accounts_at_one_bank_without_preload_content(
        self,
        bankid: Annotated[StrictStr, Field(description="The BANKID identifier")],
        viewid: Annotated[StrictStr, Field(description="The VIEWID identifier")],
        _request_timeout: Union[
    ...
    def _get_firehose_accounts_at_one_bank_serialize(
        self,
        bankid,
        viewid,
        _request_auth,
    ...
    def get_firehose_customers(
        ...
        _param = self._get_firehose_customers_serialize(
            bankid=bankid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetMyCustomersAtBank200Response",
            '500': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_firehose_customers_with_http_info(
        self,
        bankid: Annotated[StrictStr, Field(description="The BANKID identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetMyCustomersAtBank200Response]:
        """Get Firehose Customers
    ...
    @validate_call
    def get_firehose_customers_without_preload_content(
        self,
        bankid: Annotated[StrictStr, Field(description="The BANKID identifier")],
        _request_timeout: Union[
            None,
    ...
    def _get_firehose_customers_serialize(
        self,
        bankid,
        _request_auth,
        _content_type,
