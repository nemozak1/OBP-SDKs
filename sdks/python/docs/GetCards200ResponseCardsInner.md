...
json = "{}"
# create an instance of GetCards200ResponseCardsInner from a JSON string
get_cards200_response_cards_inner_instance = GetCards200ResponseCardsInner.from_json(json)
# print the JSON string representation of the object
print(GetCards200ResponseCardsInner.to_json())

# convert the object into a dict
get_cards200_response_cards_inner_dict = get_cards200_response_cards_inner_instance.to_dict()
# create an instance of GetCards200ResponseCardsInner from a dict
get_cards200_response_cards_inner_from_dict = GetCards200ResponseCardsInner.from_dict(get_cards200_response_cards_inner_dict)
```
