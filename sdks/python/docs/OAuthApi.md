...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OAuthApi->get_o_auth2_server_jwks_uris:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OAuthApi->get_o_auth2_server_jwks_uris: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OAuthApi->get_obp_connector_loopback:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OAuthApi->get_obp_connector_loopback: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OAuthApi->get_oidc_client:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OAuthApi->get_oidc_client: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OAuthApi->verify_oidc_client:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OAuthApi->verify_oidc_client: %s\n" % e)
```
