...
------------ | ------------- | ------------- | -------------
**transactions** | [**List[OBPv300GetCoreTransactionsForBankAccount200ResponseTransactionsInner]**](OBPv300GetCoreTransactionsForBankAccount200ResponseTransactionsInner.md) |  | [optional] 
