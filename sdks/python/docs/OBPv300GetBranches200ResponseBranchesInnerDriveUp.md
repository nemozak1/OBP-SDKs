...
json = "{}"
# create an instance of OBPv300GetBranches200ResponseBranchesInnerDriveUp from a JSON string
obpv300_get_branches200_response_branches_inner_drive_up_instance = OBPv300GetBranches200ResponseBranchesInnerDriveUp.from_json(json)
# print the JSON string representation of the object
print(OBPv300GetBranches200ResponseBranchesInnerDriveUp.to_json())

# convert the object into a dict
obpv300_get_branches200_response_branches_inner_drive_up_dict = obpv300_get_branches200_response_branches_inner_drive_up_instance.to_dict()
# create an instance of OBPv300GetBranches200ResponseBranchesInnerDriveUp from a dict
obpv300_get_branches200_response_branches_inner_drive_up_from_dict = OBPv300GetBranches200ResponseBranchesInnerDriveUp.from_dict(obpv300_get_branches200_response_branches_inner_drive_up_dict)
```
