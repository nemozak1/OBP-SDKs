...
json = "{}"
# create an instance of GetCustomerByCustomerNumber200Response from a JSON string
get_customer_by_customer_number200_response_instance = GetCustomerByCustomerNumber200Response.from_json(json)
# print the JSON string representation of the object
print(GetCustomerByCustomerNumber200Response.to_json())

# convert the object into a dict
get_customer_by_customer_number200_response_dict = get_customer_by_customer_number200_response_instance.to_dict()
# create an instance of GetCustomerByCustomerNumber200Response from a dict
get_customer_by_customer_number200_response_from_dict = GetCustomerByCustomerNumber200Response.from_dict(get_customer_by_customer_number200_response_dict)
```
