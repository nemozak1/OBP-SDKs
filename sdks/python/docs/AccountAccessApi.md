...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AccountAccessApi->create_user_with_account_access_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountAccessApi->create_user_with_account_access_by_id: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AccountAccessApi->grant_user_access_to_view_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountAccessApi->grant_user_access_to_view_by_id: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AccountAccessApi->revoke_user_access_to_view_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountAccessApi->revoke_user_access_to_view_by_id: %s\n" % e)
```
