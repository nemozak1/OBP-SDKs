...
json = "{}"
# create an instance of OBPv500GetViewsForBankAccount200ResponseViewsInner from a JSON string
obpv500_get_views_for_bank_account200_response_views_inner_instance = OBPv500GetViewsForBankAccount200ResponseViewsInner.from_json(json)
# print the JSON string representation of the object
print(OBPv500GetViewsForBankAccount200ResponseViewsInner.to_json())

# convert the object into a dict
obpv500_get_views_for_bank_account200_response_views_inner_dict = obpv500_get_views_for_bank_account200_response_views_inner_instance.to_dict()
# create an instance of OBPv500GetViewsForBankAccount200ResponseViewsInner from a dict
obpv500_get_views_for_bank_account200_response_views_inner_from_dict = OBPv500GetViewsForBankAccount200ResponseViewsInner.from_dict(obpv500_get_views_for_bank_account200_response_views_inner_dict)
```
