...
json = "{}"
# create an instance of GetAtm200Response from a JSON string
get_atm200_response_instance = GetAtm200Response.from_json(json)
# print the JSON string representation of the object
print(GetAtm200Response.to_json())

# convert the object into a dict
get_atm200_response_dict = get_atm200_response_instance.to_dict()
# create an instance of GetAtm200Response from a dict
get_atm200_response_from_dict = GetAtm200Response.from_dict(get_atm200_response_dict)
```
