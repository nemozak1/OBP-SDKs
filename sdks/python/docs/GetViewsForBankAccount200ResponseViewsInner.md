...
json = "{}"
# create an instance of GetViewsForBankAccount200ResponseViewsInner from a JSON string
get_views_for_bank_account200_response_views_inner_instance = GetViewsForBankAccount200ResponseViewsInner.from_json(json)
# print the JSON string representation of the object
print(GetViewsForBankAccount200ResponseViewsInner.to_json())

# convert the object into a dict
get_views_for_bank_account200_response_views_inner_dict = get_views_for_bank_account200_response_views_inner_instance.to_dict()
# create an instance of GetViewsForBankAccount200ResponseViewsInner from a dict
get_views_for_bank_account200_response_views_inner_from_dict = GetViewsForBankAccount200ResponseViewsInner.from_dict(get_views_for_bank_account200_response_views_inner_dict)
```
