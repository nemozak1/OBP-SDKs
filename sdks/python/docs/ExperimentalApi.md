...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ExperimentalApi->create_meeting:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExperimentalApi->create_meeting: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ExperimentalApi->get_meeting:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExperimentalApi->get_meeting: %s\n" % e)
```
...
with obp_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ExperimentalApi->get_meetings:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExperimentalApi->get_meetings: %s\n" % e)
```
