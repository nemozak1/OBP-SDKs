...
json = "{}"
# create an instance of UpdateAtmRequest from a JSON string
update_atm_request_instance = UpdateAtmRequest.from_json(json)
# print the JSON string representation of the object
print(UpdateAtmRequest.to_json())

# convert the object into a dict
update_atm_request_dict = update_atm_request_instance.to_dict()
# create an instance of UpdateAtmRequest from a dict
update_atm_request_from_dict = UpdateAtmRequest.from_dict(update_atm_request_dict)
```
