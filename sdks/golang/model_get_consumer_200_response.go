...
// checks if the GetConsumer200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetConsumer200Response{}

// GetConsumer200Response struct for GetConsumer200Response
type GetConsumer200Response struct {
...
func (o GetConsumer200Response) MarshalJSON() ([]byte, error) {
...
func (o GetConsumer200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetConsumer200Response struct {
	value *GetConsumer200Response
	isSet bool
}

func (v NullableGetConsumer200Response) Get() *GetConsumer200Response {
	return v.value
}

func (v *NullableGetConsumer200Response) Set(val *GetConsumer200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetConsumer200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetConsumer200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetConsumer200Response(val *GetConsumer200Response) *NullableGetConsumer200Response {
	return &NullableGetConsumer200Response{value: val, isSet: true}
}

func (v NullableGetConsumer200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetConsumer200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
