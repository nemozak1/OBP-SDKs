...
*/
func (a *FirehoseDataAPIService) GetFastFirehoseAccountsAtOneBank(ctx context.Context, bankid string) ApiGetFastFirehoseAccountsAtOneBankRequest {
	return ApiGetFastFirehoseAccountsAtOneBankRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
func (a *FirehoseDataAPIService) GetFastFirehoseAccountsAtOneBankExecute(r ApiGetFastFirehoseAccountsAtOneBankRequest) (*GetFastFirehoseAccountsAtOneBank200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FirehoseDataAPIService.GetFastFirehoseAccountsAtOneBank")
	if err != nil {
...
*/
func (a *FirehoseDataAPIService) GetFirehoseAccountsAtOneBank(ctx context.Context, bankid string, viewid string) ApiGetFirehoseAccountsAtOneBankRequest {
	return ApiGetFirehoseAccountsAtOneBankRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
func (a *FirehoseDataAPIService) GetFirehoseAccountsAtOneBankExecute(r ApiGetFirehoseAccountsAtOneBankRequest) (*GetFirehoseAccountsAtOneBank200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FirehoseDataAPIService.GetFirehoseAccountsAtOneBank")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *FirehoseDataAPIService) GetFirehoseCustomers(ctx context.Context, bankid string) ApiGetFirehoseCustomersRequest {
	return ApiGetFirehoseCustomersRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
func (a *FirehoseDataAPIService) GetFirehoseCustomersExecute(r ApiGetFirehoseCustomersRequest) (*GetMyCustomersAtBank200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FirehoseDataAPIService.GetFirehoseCustomers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *FirehoseDataAPIService) GetFirehoseTransactionsForBankAccount(ctx context.Context, bankid string, accountid string, viewid string) ApiGetFirehoseTransactionsForBankAccountRequest {
	return ApiGetFirehoseTransactionsForBankAccountRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
func (a *FirehoseDataAPIService) GetFirehoseTransactionsForBankAccountExecute(r ApiGetFirehoseTransactionsForBankAccountRequest) (*GetFirehoseTransactionsForBankAccount200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FirehoseDataAPIService.GetFirehoseTransactionsForBankAccount")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
