...
*/
func (a *OwnerViewRequiredAPIService) CreateUserWithAccountAccessById(ctx context.Context, bankid string, accountid string, viewid string) ApiCreateUserWithAccountAccessByIdRequest {
	return ApiCreateUserWithAccountAccessByIdRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
func (a *OwnerViewRequiredAPIService) CreateUserWithAccountAccessByIdExecute(r ApiCreateUserWithAccountAccessByIdRequest) (*CreateUserWithAccountAccessById200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OwnerViewRequiredAPIService.CreateUserWithAccountAccessById")
	if err != nil {
...
*/
func (a *OwnerViewRequiredAPIService) GrantUserAccessToViewById(ctx context.Context, bankid string, accountid string, viewid string) ApiGrantUserAccessToViewByIdRequest {
	return ApiGrantUserAccessToViewByIdRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
func (a *OwnerViewRequiredAPIService) GrantUserAccessToViewByIdExecute(r ApiGrantUserAccessToViewByIdRequest) (*CreateUserWithAccountAccessById200ResponseHead, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OwnerViewRequiredAPIService.GrantUserAccessToViewById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *OwnerViewRequiredAPIService) RevokeUserAccessToViewById(ctx context.Context, bankid string, accountid string, viewid string) ApiRevokeUserAccessToViewByIdRequest {
	return ApiRevokeUserAccessToViewByIdRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
func (a *OwnerViewRequiredAPIService) RevokeUserAccessToViewByIdExecute(r ApiRevokeUserAccessToViewByIdRequest) (*RevokeUserAccessToViewById200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OwnerViewRequiredAPIService.RevokeUserAccessToViewById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
