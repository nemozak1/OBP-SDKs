...
// checks if the GetCustomerChildren200ResponseCustomersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCustomerChildren200ResponseCustomersInner{}

// GetCustomerChildren200ResponseCustomersInner struct for GetCustomerChildren200ResponseCustomersInner
type GetCustomerChildren200ResponseCustomersInner struct {
...
func NewGetCustomerChildren200ResponseCustomersInner() *GetCustomerChildren200ResponseCustomersInner {
	this := GetCustomerChildren200ResponseCustomersInner{}
	return &this
}
...
func (o GetCustomerChildren200ResponseCustomersInner) MarshalJSON() ([]byte, error) {
...
func (o GetCustomerChildren200ResponseCustomersInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetCustomerChildren200ResponseCustomersInner struct {
	value *GetCustomerChildren200ResponseCustomersInner
	isSet bool
}

func (v NullableGetCustomerChildren200ResponseCustomersInner) Get() *GetCustomerChildren200ResponseCustomersInner {
	return v.value
}

func (v *NullableGetCustomerChildren200ResponseCustomersInner) Set(val *GetCustomerChildren200ResponseCustomersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCustomerChildren200ResponseCustomersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCustomerChildren200ResponseCustomersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCustomerChildren200ResponseCustomersInner(val *GetCustomerChildren200ResponseCustomersInner) *NullableGetCustomerChildren200ResponseCustomersInner {
	return &NullableGetCustomerChildren200ResponseCustomersInner{value: val, isSet: true}
}

func (v NullableGetCustomerChildren200ResponseCustomersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCustomerChildren200ResponseCustomersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
