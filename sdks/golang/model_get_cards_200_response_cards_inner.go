...
// checks if the GetCards200ResponseCardsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCards200ResponseCardsInner{}

// GetCards200ResponseCardsInner struct for GetCards200ResponseCardsInner
type GetCards200ResponseCardsInner struct {
...
func NewGetCards200ResponseCardsInner() *GetCards200ResponseCardsInner {
	this := GetCards200ResponseCardsInner{}
	return &this
}
...
// GetBankCardNumber returns the BankCardNumber field value if set, zero value otherwise.
func (o *GetCards200ResponseCardsInner) GetBankCardNumber() string {
	if o == nil || IsNil(o.BankCardNumber) {
		var ret string
		return ret
	}
...
// GetBankCardNumberOk returns a tuple with the BankCardNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetBankCardNumber gets a reference to the given string and assigns it to the BankCardNumber field.
...
func (o GetCards200ResponseCardsInner) MarshalJSON() ([]byte, error) {
...
func (o GetCards200ResponseCardsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetCards200ResponseCardsInner struct {
	value *GetCards200ResponseCardsInner
	isSet bool
}

func (v NullableGetCards200ResponseCardsInner) Get() *GetCards200ResponseCardsInner {
	return v.value
}

func (v *NullableGetCards200ResponseCardsInner) Set(val *GetCards200ResponseCardsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCards200ResponseCardsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCards200ResponseCardsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCards200ResponseCardsInner(val *GetCards200ResponseCardsInner) *NullableGetCards200ResponseCardsInner {
	return &NullableGetCards200ResponseCardsInner{value: val, isSet: true}
}

func (v NullableGetCards200ResponseCardsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCards200ResponseCardsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
