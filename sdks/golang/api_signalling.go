...
*/
func (a *SignallingAPIService) DeleteSignalChannel(ctx context.Context, channelname string) ApiDeleteSignalChannelRequest {
	return ApiDeleteSignalChannelRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *SignallingAPIService) DeleteSignalChannelExecute(r ApiDeleteSignalChannelRequest) (*DeleteSignalChannel200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SignallingAPIService.DeleteSignalChannel")
	if err != nil {
...
*/
func (a *SignallingAPIService) GetSignalChannelInfo(ctx context.Context, channelname string) ApiGetSignalChannelInfoRequest {
	return ApiGetSignalChannelInfoRequest{
		ApiService: a,
		ctx: ctx,
		channelname: channelname,
...
func (a *SignallingAPIService) GetSignalChannelInfoExecute(r ApiGetSignalChannelInfoRequest) (*GetSignalChannelInfo200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SignallingAPIService.GetSignalChannelInfo")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *SignallingAPIService) GetSignalChannels(ctx context.Context) ApiGetSignalChannelsRequest {
	return ApiGetSignalChannelsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SignallingAPIService) GetSignalChannelsExecute(r ApiGetSignalChannelsRequest) (*GetSignalChannels200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SignallingAPIService.GetSignalChannels")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *SignallingAPIService) GetSignalMessages(ctx context.Context, channelname string) ApiGetSignalMessagesRequest {
	return ApiGetSignalMessagesRequest{
		ApiService: a,
		ctx: ctx,
		channelname: channelname,
...
func (a *SignallingAPIService) GetSignalMessagesExecute(r ApiGetSignalMessagesRequest) (*GetSignalMessages200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SignallingAPIService.GetSignalMessages")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *SignallingAPIService) GetSignalStats(ctx context.Context) ApiGetSignalStatsRequest {
	return ApiGetSignalStatsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SignallingAPIService) GetSignalStatsExecute(r ApiGetSignalStatsRequest) (*GetSignalStats200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SignallingAPIService.GetSignalStats")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *SignallingAPIService) PublishSignalMessage(ctx context.Context, channelname string) ApiPublishSignalMessageRequest {
	return ApiPublishSignalMessageRequest{
		ApiService: a,
		ctx: ctx,
		channelname: channelname,
...
func (a *SignallingAPIService) PublishSignalMessageExecute(r ApiPublishSignalMessageRequest) (*PublishSignalMessage200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SignallingAPIService.PublishSignalMessage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
