...
// checks if the GetCardsForBank200ResponseCardsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCardsForBank200ResponseCardsInner{}

// GetCardsForBank200ResponseCardsInner struct for GetCardsForBank200ResponseCardsInner
type GetCardsForBank200ResponseCardsInner struct {
...
func NewGetCardsForBank200ResponseCardsInner() *GetCardsForBank200ResponseCardsInner {
	this := GetCardsForBank200ResponseCardsInner{}
	return &this
}
...
func (o GetCardsForBank200ResponseCardsInner) MarshalJSON() ([]byte, error) {
...
func (o GetCardsForBank200ResponseCardsInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetCardsForBank200ResponseCardsInner struct {
	value *GetCardsForBank200ResponseCardsInner
	isSet bool
}

func (v NullableGetCardsForBank200ResponseCardsInner) Get() *GetCardsForBank200ResponseCardsInner {
	return v.value
}

func (v *NullableGetCardsForBank200ResponseCardsInner) Set(val *GetCardsForBank200ResponseCardsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCardsForBank200ResponseCardsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCardsForBank200ResponseCardsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCardsForBank200ResponseCardsInner(val *GetCardsForBank200ResponseCardsInner) *NullableGetCardsForBank200ResponseCardsInner {
	return &NullableGetCardsForBank200ResponseCardsInner{value: val, isSet: true}
}

func (v NullableGetCardsForBank200ResponseCardsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCardsForBank200ResponseCardsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
