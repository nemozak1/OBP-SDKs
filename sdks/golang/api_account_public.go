...
*/
func (a *AccountPublicAPIService) GetPublicAccountById(ctx context.Context, bankid string, accountid string, viewid string) ApiGetPublicAccountByIdRequest {
	return ApiGetPublicAccountByIdRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
func (a *AccountPublicAPIService) GetPublicAccountByIdExecute(r ApiGetPublicAccountByIdRequest) (*GetPublicAccountById200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountPublicAPIService.GetPublicAccountById")
	if err != nil {
...
*/
func (a *AccountPublicAPIService) PublicAccountsAllBanks(ctx context.Context) ApiPublicAccountsAllBanksRequest {
	return ApiPublicAccountsAllBanksRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AccountPublicAPIService) PublicAccountsAllBanksExecute(r ApiPublicAccountsAllBanksRequest) (*PublicAccountsAllBanks200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountPublicAPIService.PublicAccountsAllBanks")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *AccountPublicAPIService) PublicAccountsAtOneBank(ctx context.Context, bankid string) ApiPublicAccountsAtOneBankRequest {
	return ApiPublicAccountsAtOneBankRequest{
		ApiService: a,
		ctx: ctx,
		bankid: bankid,
...
// Execute executes the request
//  @return PublicAccountsAllBanks200Response
func (a *AccountPublicAPIService) PublicAccountsAtOneBankExecute(r ApiPublicAccountsAtOneBankRequest) (*PublicAccountsAllBanks200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountPublicAPIService.PublicAccountsAtOneBank")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
