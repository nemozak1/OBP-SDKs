...
func main() {
	...
	resp, r, err := apiClient.SignallingAPI.DeleteSignalChannel(context.Background(), channelname).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `SignallingAPI.DeleteSignalChannel``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `DeleteSignalChannel`: DeleteSignalChannel200Response
	fmt.Fprintf(os.Stdout, "Response from `SignallingAPI.DeleteSignalChannel`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SignallingAPI.GetSignalChannelInfo(context.Background(), channelname).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `SignallingAPI.GetSignalChannelInfo``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetSignalChannelInfo`: GetSignalChannelInfo200Response
	fmt.Fprintf(os.Stdout, "Response from `SignallingAPI.GetSignalChannelInfo`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SignallingAPI.GetSignalChannels(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `SignallingAPI.GetSignalChannels``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetSignalChannels`: GetSignalChannels200Response
	fmt.Fprintf(os.Stdout, "Response from `SignallingAPI.GetSignalChannels`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SignallingAPI.GetSignalMessages(context.Background(), channelname).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `SignallingAPI.GetSignalMessages``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetSignalMessages`: GetSignalMessages200Response
	fmt.Fprintf(os.Stdout, "Response from `SignallingAPI.GetSignalMessages`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SignallingAPI.GetSignalStats(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `SignallingAPI.GetSignalStats``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetSignalStats`: GetSignalStats200Response
	fmt.Fprintf(os.Stdout, "Response from `SignallingAPI.GetSignalStats`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SignallingAPI.PublishSignalMessage(context.Background(), channelname).PublishSignalMessageRequest(publishSignalMessageRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `SignallingAPI.PublishSignalMessage``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PublishSignalMessage`: PublishSignalMessage200Response
	fmt.Fprintf(os.Stdout, "Response from `SignallingAPI.PublishSignalMessage`: %v\n", resp)
}
```
