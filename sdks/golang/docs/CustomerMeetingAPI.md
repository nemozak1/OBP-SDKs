...
func main() {
	...
	resp, r, err := apiClient.CustomerMeetingAPI.CreateMeeting(context.Background(), bankid).CreateMeetingRequest(createMeetingRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CustomerMeetingAPI.CreateMeeting``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CreateMeeting`: GetMeeting200Response
	fmt.Fprintf(os.Stdout, "Response from `CustomerMeetingAPI.CreateMeeting`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CustomerMeetingAPI.GetMeeting(context.Background(), bankid, meetingid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CustomerMeetingAPI.GetMeeting``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetMeeting`: GetMeeting200Response
	fmt.Fprintf(os.Stdout, "Response from `CustomerMeetingAPI.GetMeeting`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CustomerMeetingAPI.GetMeetings(context.Background(), bankid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CustomerMeetingAPI.GetMeetings``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetMeetings`: GetMeetings200Response
	fmt.Fprintf(os.Stdout, "Response from `CustomerMeetingAPI.GetMeetings`: %v\n", resp)
}
```
