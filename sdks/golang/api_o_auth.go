...
*/
func (a *OAuthAPIService) GetOAuth2ServerJWKsURIs(ctx context.Context) ApiGetOAuth2ServerJWKsURIsRequest {
	return ApiGetOAuth2ServerJWKsURIsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OAuthAPIService) GetOAuth2ServerJWKsURIsExecute(r ApiGetOAuth2ServerJWKsURIsRequest) (*GetOAuth2ServerJWKsURIs200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuthAPIService.GetOAuth2ServerJWKsURIs")
	if err != nil {
...
*/
func (a *OAuthAPIService) GetObpConnectorLoopback(ctx context.Context) ApiGetObpConnectorLoopbackRequest {
	return ApiGetObpConnectorLoopbackRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OAuthAPIService) GetObpConnectorLoopbackExecute(r ApiGetObpConnectorLoopbackRequest) (*GetObpConnectorLoopback200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuthAPIService.GetObpConnectorLoopback")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *OAuthAPIService) GetOidcClient(ctx context.Context, clientid string) ApiGetOidcClientRequest {
	return ApiGetOidcClientRequest{
		ApiService: a,
		ctx: ctx,
		clientid: clientid,
...
func (a *OAuthAPIService) GetOidcClientExecute(r ApiGetOidcClientRequest) (*GetOidcClient200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuthAPIService.GetOidcClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *OAuthAPIService) VerifyOidcClient(ctx context.Context) ApiVerifyOidcClientRequest {
	return ApiVerifyOidcClientRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OAuthAPIService) VerifyOidcClientExecute(r ApiVerifyOidcClientRequest) (*VerifyOidcClient200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuthAPIService.VerifyOidcClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
