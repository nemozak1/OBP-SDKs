...
// Add Entitlement for a User
RoleAPI.addEntitlement(userid: userid, createConsentImplicitRequestEntitlementsInner: createConsentImplicitRequestEntitlementsInner) { (response, error) in
...
// Create Entitlement Request for current User
RoleAPI.addEntitlementRequest(createConsentImplicitRequestEntitlementsInner: createConsentImplicitRequestEntitlementsInner) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create (DAuth) User with Roles
RoleAPI.createUserWithRoles(createUserWithRolesRequest: createUserWithRolesRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Entitlement
RoleAPI.deleteEntitlement(entitlementid: entitlementid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Entitlement Request
RoleAPI.deleteEntitlementRequest(entitlementrequestid: entitlementrequestid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get all Entitlement Requests
RoleAPI.getAllEntitlementRequests() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get all Entitlements
RoleAPI.getAllEntitlements() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlement Requests for a User
RoleAPI.getEntitlementRequests(userid: userid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlement Requests for the current User
RoleAPI.getEntitlementRequestsForCurrentUser() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlements for User
RoleAPI.getEntitlements(userid: userid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlements and Permissions for a User
RoleAPI.getEntitlementsAndPermissions(userid: userid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlements for User at Bank
RoleAPI.getEntitlementsByBankAndUser(bankid: bankid, userid: userid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlements for One Bank
RoleAPI.getEntitlementsForBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Entitlements for the current User
RoleAPI.getEntitlementsForCurrentUser() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getRoles**
```swift
    open class func getRoles(completion: @escaping (_ data: GetRoles200Response?, _ error: Error?) -> Void)
```
...
// Get Roles
RoleAPI.getRoles() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Roles with Entitlement Counts
RoleAPI.getRolesWithEntitlementCountsAtAllBanks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
