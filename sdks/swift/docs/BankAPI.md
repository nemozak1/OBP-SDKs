...
// Create an Account Webhook
BankAPI.createAccountWebhook(bankid: bankid, createAccountWebhookRequest: createAccountWebhookRequest) { (response, error) in
...
# **createBank**
```swift
    open class func createBank(createBankRequest: CreateBankRequest, completion: @escaping (_ data: GetBank200Response?, _ error: Error?) -> Void)
```
...
let createBankRequest = createBank_request(bankRoutings: [getCheckbookOrders_200_response_account_account_routings_inner(address: "address_example", scheme: "scheme_example")], website: "website_example", fullName: "fullName_example", logo: "logo_example", bankId: "bankId_example", bankCode: "bankCode_example") // CreateBankRequest | Request body

// Create Bank
BankAPI.createBank(createBankRequest: createBankRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create bank level Account Notification Webhook
BankAPI.createBankAccountNotificationWebhook(bankid: bankid, createSystemAccountNotificationWebhookRequest: createSystemAccountNotificationWebhookRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Bank Attribute
BankAPI.createBankAttribute(bankid: bankid, updateAtmAttributeRequest: updateAtmAttributeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create or Update Bank Attribute Definition
BankAPI.createOrUpdateBankAttributeDefinition(bankid: bankid, createOrUpdateTransactionRequestAttributeDefinitionRequest: createOrUpdateTransactionRequestAttributeDefinitionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func createSettlementAccount(bankid: String, createSettlementAccountRequest: CreateSettlementAccountRequest, completion: @escaping (_ data: CreateSettlementAccount200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let createSettlementAccountRequest = createSettlementAccount_request(branchId: "branchId_example", accountRoutings: [getCheckbookOrders_200_response_account_account_routings_inner(address: "address_example", scheme: "scheme_example")], label: "label_example", balance: getMyCustomersAtBank_200_response_customers_inner_credit_limit(currency: "currency_example", amount: "amount_example"), paymentSystem: "paymentSystem_example", userId: "userId_example") // CreateSettlementAccountRequest | Request body

// Create Settlement Account
BankAPI.createSettlementAccount(bankid: bankid, createSettlementAccountRequest: createSettlementAccountRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create system level Account Notification Webhook
BankAPI.createSystemAccountNotificationWebhook(createSystemAccountNotificationWebhookRequest: createSystemAccountNotificationWebhookRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func createTransactionType(bankid: String, getTransactionTypes200ResponseTransactionTypesInner: GetTransactionTypes200ResponseTransactionTypesInner, completion: @escaping (_ data: CreateTransactionType200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let getTransactionTypes200ResponseTransactionTypesInner = getTransactionTypes_200_response_transaction_types_inner(description: "description_example", shortCode: "shortCode_example", bankId: "bankId_example", id: getTransactionTypes_200_response_transaction_types_inner_id(value: "value_example"), charge: getMyCustomersAtBank_200_response_customers_inner_credit_limit(currency: "currency_example", amount: "amount_example"), summary: "summary_example") // GetTransactionTypes200ResponseTransactionTypesInner | Request body

// Create Transaction Type at bank
BankAPI.createTransactionType(bankid: bankid, getTransactionTypes200ResponseTransactionTypesInner: getTransactionTypes200ResponseTransactionTypesInner) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Bank Attribute
BankAPI.deleteBankAttribute(bankid: bankid, bankattributeid: bankattributeid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **deleteBankCascade**
```swift
    open class func deleteBankCascade(bankid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Bank Cascade
BankAPI.deleteBankCascade(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Enable/Disable an Account Webhook
BankAPI.enableDisableAccountWebhook(bankid: bankid, enableDisableAccountWebhookRequest: enableDisableAccountWebhookRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Webhooks
BankAPI.getAccountWebhooks(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Bank
BankAPI.getBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Bank Attribute By BANK_ATTRIBUTE_ID
BankAPI.getBankAttribute(bankid: bankid, bankattributeid: bankattributeid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Bank Attributes
BankAPI.getBankAttributes(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Banks
BankAPI.getBanks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Branch
BankAPI.getBranch(bankid: bankid, branchid: branchid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Branches for a Bank
BankAPI.getBranches(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Settlement accounts at Bank
BankAPI.getSettlementAccounts(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transaction Request Types at Bank
BankAPI.getTransactionRequestTypesSupportedByBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transaction Types at Bank
BankAPI.getTransactionTypes(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **updateBank**
```swift
    open class func updateBank(updateBankRequest: UpdateBankRequest, completion: @escaping (_ data: UpdateBank200Response?, _ error: Error?) -> Void)
```
...
let updateBankRequest = updateBank_request(bankRoutings: [getCheckbookOrders_200_response_account_account_routings_inner(address: "address_example", scheme: "scheme_example")], website: "website_example", fullName: "fullName_example", logo: "logo_example", id: "id_example", bankCode: "bankCode_example") // UpdateBankRequest | Request body

// Update Bank
BankAPI.updateBank(updateBankRequest: updateBankRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Bank Attribute
BankAPI.updateBankAttribute(bankid: bankid, bankattributeid: bankattributeid, updateAtmAttributeRequest: updateAtmAttributeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
