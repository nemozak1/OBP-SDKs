...
// Add User to a Consent
ConsentAPI.addConsentUser(bankid: bankid, consentid: consentid, addConsentUserRequest: addConsentUserRequest) { (response, error) in
...
// Answer Consent Challenge
ConsentAPI.answerConsentChallenge(bankid: bankid, consentid: consentid, answerConsentChallengeRequest: answerConsentChallengeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent By CONSENT_REQUEST_ID (EMAIL)
ConsentAPI.createConsentByConsentRequestIdEmail(consentrequestid: consentrequestid, email: email) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent By CONSENT_REQUEST_ID (IMPLICIT)
ConsentAPI.createConsentByConsentRequestIdImplicit(consentrequestid: consentrequestid, implicit: implicit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent By CONSENT_REQUEST_ID (SMS)
ConsentAPI.createConsentByConsentRequestIdSms(consentrequestid: consentrequestid, sms: sms) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent (EMAIL)
ConsentAPI.createConsentEmail(bankid: bankid, email: email, createConsentEmailRequest: createConsentEmailRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent (IMPLICIT)
ConsentAPI.createConsentImplicit(implicit: implicit, createConsentImplicitRequest: createConsentImplicitRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent Request
ConsentAPI.createConsentRequest(createConsentRequestRequest: createConsentRequestRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent (SMS)
ConsentAPI.createConsentSms(bankid: bankid, sms: sms, createConsentSmsRequest: createConsentSmsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent Request VRP
ConsentAPI.createVRPConsentRequest(createVRPConsentRequestRequest: createVRPConsentRequestRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent By Consent Id via User
ConsentAPI.getConsentByConsentId(consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent By Consent Id via Consumer
ConsentAPI.getConsentByConsentIdViaConsumer(consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent By Consent Request Id via Consumer
ConsentAPI.getConsentByConsentRequestId(consentrequestid: consentrequestid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents Info
ConsentAPI.getConsentInfos() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents Info At Bank
ConsentAPI.getConsentInfosByBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent Request
ConsentAPI.getConsentRequest(consentrequestid: consentrequestid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consents
ConsentAPI.getConsents() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consents at Bank
ConsentAPI.getConsentsAtBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents
ConsentAPI.getMyConsents() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents at Bank
ConsentAPI.getMyConsentsByBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Provide client's certificate info of a current call
ConsentAPI.mtlsClientCertificateInfo() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke Consent at Bank
ConsentAPI.revokeConsentAtBank(bankid: bankid, consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke My Consent
ConsentAPI.revokeMyConsent(consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke Consent used in the Current Call
ConsentAPI.selfRevokeConsent() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Consent Account Access by CONSENT_ID
ConsentAPI.updateConsentAccountAccessByConsentId(bankid: bankid, consentid: consentid, updateConsentAccountAccessByConsentIdRequest: updateConsentAccountAccessByConsentIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Consent Status
ConsentAPI.updateConsentStatus(bankid: bankid, consentid: consentid, updateTransactionRequestStatusRequest: updateTransactionRequestStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Consent Status by CONSENT_ID
ConsentAPI.updateConsentStatusByConsent(bankid: bankid, consentid: consentid, updateTransactionRequestStatusRequest: updateTransactionRequestStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Created by User of Consent by CONSENT_ID
ConsentAPI.updateConsentUserIdByConsentId(bankid: bankid, consentid: consentid, addConsentUserRequest: addConsentUserRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
