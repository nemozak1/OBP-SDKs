...
// Create Customer Message
PersonAPI.addCustomerMessage(bankid: bankid, customerid: customerid, addCustomerMessageRequest: addCustomerMessageRequest) { (response, error) in
...
// Create Agent
PersonAPI.createAgent(bankid: bankid, createAgentRequest: createAgentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Customer
PersonAPI.createCustomer(bankid: bankid, createCustomerRequest: createCustomerRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Customer Message
PersonAPI.createCustomerMessage(bankid: bankid, customerid: customerid, createCustomerMessageRequest: createCustomerMessageRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Agent status
PersonAPI.updateAgentStatus(bankid: bankid, agentid: agentid, updateAgentStatusRequest: updateAgentStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
