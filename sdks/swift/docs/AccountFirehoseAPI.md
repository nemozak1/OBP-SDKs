...
// Get Fast Firehose Accounts at Bank
AccountFirehoseAPI.getFastFirehoseAccountsAtOneBank(bankid: bankid) { (response, error) in
...
// Get Firehose Accounts at Bank
AccountFirehoseAPI.getFirehoseAccountsAtOneBank(bankid: bankid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getFirehoseTransactionsForBankAccount(bankid: String, accountid: String, viewid: String, completion: @escaping (_ data: GetFirehoseTransactionsForBankAccount200Response?, _ error: Error?) -> Void)
```
...
// Get Firehose Transactions for Account
AccountFirehoseAPI.getFirehoseTransactionsForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
