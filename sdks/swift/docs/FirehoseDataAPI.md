...
// Get Fast Firehose Accounts at Bank
FirehoseDataAPI.getFastFirehoseAccountsAtOneBank(bankid: bankid) { (response, error) in
...
// Get Firehose Accounts at Bank
FirehoseDataAPI.getFirehoseAccountsAtOneBank(bankid: bankid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Firehose Customers
FirehoseDataAPI.getFirehoseCustomers(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Firehose Transactions for Account
FirehoseDataAPI.getFirehoseTransactionsForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
