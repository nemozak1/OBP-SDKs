...
// Create Custom View
ViewCustomAPI.createCustomView(bankid: bankid, accountid: accountid, viewid: viewid, createCustomViewRequest: createCustomViewRequest) { (response, error) in
...
// Create Custom View (Management)
ViewCustomAPI.createCustomViewManagement(bankid: bankid, accountid: accountid, createCustomViewManagementRequest: createCustomViewManagementRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create (DAuth) User with Account Access
ViewCustomAPI.createUserWithAccountAccessById(bankid: bankid, accountid: accountid, viewid: viewid, createUserWithAccountAccessByIdRequest: createUserWithAccountAccessByIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Custom View
ViewCustomAPI.createViewForBankAccount(bankid: bankid, accountid: accountid, createCustomViewManagementRequest: createCustomViewManagementRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Custom View
ViewCustomAPI.deleteCustomView(bankid: bankid, accountid: accountid, viewid: viewid, targetviewid: targetviewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Custom View
ViewCustomAPI.deleteViewForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts Held
ViewCustomAPI.getAccountsHeld(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Custom View
ViewCustomAPI.getCustomView(bankid: bankid, accountid: accountid, viewid: viewid, targetviewid: targetviewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getCustomViewById**
```swift
    open class func getCustomViewById(bankid: String, accountid: String, viewid: String, completion: @escaping (_ data: GetSystemViewById200Response?, _ error: Error?) -> Void)
```
...
// Get Custom View
ViewCustomAPI.getCustomViewById(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getCustomViews**
```swift
    open class func getCustomViews(completion: @escaping (_ data: GetCustomViews200Response?, _ error: Error?) -> Void)
```
...
// Get Custom Views
ViewCustomAPI.getCustomViews() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account access for User
ViewCustomAPI.getPermissionForUserForBankAccount(bankid: bankid, accountid: accountid, provider: provider, providerid: providerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get access
ViewCustomAPI.getPermissionsForBankAccount(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getSystemViewById**
```swift
    open class func getSystemViewById(viewid: String, completion: @escaping (_ data: GetSystemViewById200Response?, _ error: Error?) -> Void)
```
...
// Get System View
ViewCustomAPI.getSystemViewById(viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getSystemViews**
```swift
    open class func getSystemViews(completion: @escaping (_ data: GetSystemViews200Response?, _ error: Error?) -> Void)
```
...
// Get System Views
ViewCustomAPI.getSystemViews() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Users With Account Access
ViewCustomAPI.getUsersWithAccountAccess(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getViewPermissions**
```swift
    open class func getViewPermissions(completion: @escaping (_ data: GetViewPermissions200Response?, _ error: Error?) -> Void)
```
...
// Get View Permissions
ViewCustomAPI.getViewPermissions() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Views for Account
ViewCustomAPI.getViewsForBankAccount(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Grant User access to View
ViewCustomAPI.grantUserAccessToViewById(bankid: bankid, accountid: accountid, viewid: viewid, revokeUserAccessToViewByIdRequest: revokeUserAccessToViewByIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Has Account Access
ViewCustomAPI.hasAccountAccess(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke User access to View
ViewCustomAPI.revokeUserAccessToViewById(bankid: bankid, accountid: accountid, viewid: viewid, revokeUserAccessToViewByIdRequest: revokeUserAccessToViewByIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Custom View
ViewCustomAPI.updateCustomView(bankid: bankid, accountid: accountid, viewid: viewid, targetviewid: targetviewid, updateCustomViewRequest: updateCustomViewRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **updateSystemView**
```swift
    open class func updateSystemView(viewid: String, updateSystemViewRequest: UpdateSystemViewRequest, completion: @escaping (_ data: GetSystemViewById200Response?, _ error: Error?) -> Void)
```
...
let viewid = "viewid_example" // String | The VIEWID identifier
let updateSystemViewRequest = updateSystemView_request(canGrantAccessToViews: ["canGrantAccessToViews_example"], description: "description_example", isPublic: false, hideMetadataIfAliasUsed: false, canRevokeAccessToViews: ["canRevokeAccessToViews_example"], whichAliasToUse: "whichAliasToUse_example", isFirehose: false, metadataView: "metadataView_example", allowedActions: ["allowedActions_example"]) // UpdateSystemViewRequest | Request body

// Update System View
ViewCustomAPI.updateSystemView(viewid: viewid, updateSystemViewRequest: updateSystemViewRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Custom View
ViewCustomAPI.updateViewForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid, updateViewForBankAccountRequest: updateViewForBankAccountRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
