...
```swift
    open class func createUserInvitation(bankid: String, createUserInvitationRequest: CreateUserInvitationRequest, completion: @escaping (_ data: GetUserInvitations200Response?, _ error: Error?) -> Void)
```
...
let createUserInvitationRequest = createUserInvitation_request(firstName: "firstName_example", email: "email_example", country: "country_example", purpose: "purpose_example", company: "company_example", lastName: "lastName_example") // CreateUserInvitationRequest | Request body

// Create User Invitation
UserInvitationAPI.createUserInvitation(bankid: bankid, createUserInvitationRequest: createUserInvitationRequest) { (response, error) in
...
# **getUserInvitation**
```swift
    open class func getUserInvitation(bankid: String, secretlink: String, completion: @escaping (_ data: GetUserInvitations200Response?, _ error: Error?) -> Void)
```
...
// Get User Invitation
UserInvitationAPI.getUserInvitation(bankid: bankid, secretlink: secretlink) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getUserInvitationAnonymous(bankid: String, getUserInvitationAnonymousRequest: GetUserInvitationAnonymousRequest, completion: @escaping (_ data: GetUserInvitations200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let getUserInvitationAnonymousRequest = getUserInvitationAnonymous_request(secretKey: 123) // GetUserInvitationAnonymousRequest | Request body

// Get User Invitation Information
UserInvitationAPI.getUserInvitationAnonymous(bankid: bankid, getUserInvitationAnonymousRequest: getUserInvitationAnonymousRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getUserInvitations**
```swift
    open class func getUserInvitations(bankid: String, completion: @escaping (_ data: GetUserInvitations200Response?, _ error: Error?) -> Void)
```
...
// Get User Invitations
UserInvitationAPI.getUserInvitations(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
