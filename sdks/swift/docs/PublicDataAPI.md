...
// Get Accounts at Bank
PublicDataAPI.getAccountsAtBank(bankid: bankid) { (response, error) in
...
// Get Public Accounts at all Banks
PublicDataAPI.publicAccountsAllBanks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Public Accounts at Bank
PublicDataAPI.publicAccountsAtOneBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
