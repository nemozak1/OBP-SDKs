...
# **sandboxDataImport**
```swift
    open class func sandboxDataImport(sandboxDataImportRequest: SandboxDataImportRequest, completion: @escaping (_ data: UpdateTransactionNarrative200Response?, _ error: Error?) -> Void)
```
...
let sandboxDataImportRequest = sandboxDataImport_request(crmEvents: [sandboxDataImport_request_crm_events_inner(channel: "channel_example", bankId: "bankId_example", id: "id_example", customer: sandboxDataImport_request_crm_events_inner_customer(number: "number_example", name: "name_example"), category: "category_example", detail: "detail_example", actualDate: Date())], users: [sandboxDataImport_request_users_inner(email: "email_example", userName: "userName_example", password: "password_example")], products: [sandboxDataImport_request_products_inner(name: "name_example", moreInfoUrl: "moreInfoUrl_example", superFamily: "superFamily_example", code: "code_example", bankId: "bankId_example", meta: getProductTree_200_response_parent_product_parent_product_meta(license: getProductTree_200_response_parent_product_parent_product_meta_license(name: "name_example", id: "id_example")), category: "category_example", family: "family_example")], banks: [sandboxDataImport_request_banks_inner(website: "website_example", fullName: "fullName_example", logo: "logo_example", id: "id_example", shortName: "shortName_example")], branches: [sandboxDataImport_request_branches_inner(name: "name_example", location: getBranches_200_response_branches_inner_location(latitude: 123, longitude: 123), driveUp: sandboxDataImport_request_branches_inner_driveUp(hours: "hours_example"), bankId: "bankId_example", id: "id_example", meta: nil, lobby: nil, address: sandboxDataImport_request_branches_inner_address(city: "city_example", line2: "line2_example", state: "state_example", postCode: "postCode_example", county: "county_example", countryCode: "countryCode_example", line3: "line3_example", line1: "line1_example"))], transactions: [sandboxDataImport_request_transactions_inner(id: "id_example", thisAccount: sandboxDataImport_request_transactions_inner_this_account(id: "id_example", bank: "bank_example"), details: sandboxDataImport_request_transactions_inner_details(newBalance: "newBalance_example", description: "description_example", completed: "completed_example", type: "type_example", value: "value_example", posted: "posted_example"))], accounts: [sandboxDataImport_request_accounts_inner(generateAuditorsView: false, number: "number_example", IBAN: "IBAN_example", label: "label_example", owners: ["owners_example"], balance: getMyCustomersAtBank_200_response_customers_inner_credit_limit(currency: "currency_example", amount: "amount_example"), bank: "bank_example", id: "id_example", type: "type_example", generateAccountantsView: false, generatePublicView: false)], atms: [sandboxDataImport_request_atms_inner(name: "name_example", location: nil, bankId: "bankId_example", id: "id_example", meta: nil, address: nil)]) // SandboxDataImportRequest | Request body

// Create sandbox
SandboxAPI.sandboxDataImport(sandboxDataImportRequest: sandboxDataImportRequest) { (response, error) in
