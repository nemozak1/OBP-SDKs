...
// Add KYC Check
KYCAPI.addKycCheck(bankid: bankid, customerid: customerid, kyccheckid: kyccheckid, addKycCheckRequest: addKycCheckRequest) { (response, error) in
...
// Add KYC Document
KYCAPI.addKycDocument(bankid: bankid, customerid: customerid, kycdocumentid: kycdocumentid, addKycDocumentRequest: addKycDocumentRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Add KYC Media
KYCAPI.addKycMedia(bankid: bankid, customerid: customerid, kycmediaid: kycmediaid, addKycMediaRequest: addKycMediaRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Add KYC Status
KYCAPI.addKycStatus(bankid: bankid, customerid: customerid, addKycStatusRequest: addKycStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Tax Residence
KYCAPI.createTaxResidence(bankid: bankid, customerid: customerid, createTaxResidenceRequest: createTaxResidenceRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create User Invitation
KYCAPI.createUserInvitation(bankid: bankid, createUserInvitationRequest: createUserInvitationRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Customer Address
KYCAPI.deleteCustomerAddress(bankid: bankid, customerid: customerid, customeraddressid: customeraddressid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Tax Residence
KYCAPI.deleteTaxResidence(bankid: bankid, customerid: customerid, taxresidenceid: taxresidenceid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Customer Addresses
KYCAPI.getCustomerAddresses(bankid: bankid, customerid: customerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Customer by CUSTOMER_NUMBER
KYCAPI.getCustomerByCustomerNumber(bankid: bankid, getCustomerOverviewFlatRequest: getCustomerOverviewFlatRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Customer Overview
KYCAPI.getCustomerOverview(bankid: bankid, getCustomerOverviewFlatRequest: getCustomerOverviewFlatRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Customer Overview Flat
KYCAPI.getCustomerOverviewFlat(bankid: bankid, getCustomerOverviewFlatRequest: getCustomerOverviewFlatRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Customers by MOBILE_PHONE_NUMBER
KYCAPI.getCustomersByCustomerPhoneNumber(bankid: bankid, createTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo: createTransactionRequestCounterparty200ResponseDetailsToTransferToPhoneTo) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Customers by Legal Name
KYCAPI.getCustomersByLegalName(bankid: bankid, getCustomersByLegalNameRequest: getCustomersByLegalNameRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Customer KYC Checks
KYCAPI.getKycChecks(customerid: customerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Customer KYC Documents
KYCAPI.getKycDocuments(customerid: customerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get KYC Media for a customer
KYCAPI.getKycMedia(customerid: customerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Customer KYC statuses
KYCAPI.getKycStatuses(customerid: customerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Tax Residences of Customer
KYCAPI.getTaxResidence(bankid: bankid, customerid: customerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get User Invitation Information
KYCAPI.getUserInvitationAnonymous(bankid: bankid, getUserInvitationAnonymousRequest: getUserInvitationAnonymousRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
