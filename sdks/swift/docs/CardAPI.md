...
# **addCardForBank**
```swift
    open class func addCardForBank(bankid: String, addCardForBankRequest: AddCardForBankRequest, completion: @escaping (_ data: AddCardForBank200Response?, _ error: Error?) -> Void)
```
...
let addCardForBankRequest = addCardForBank_request(allows: ["allows_example"], expiresDate: Date(), networks: ["networks_example"], customerId: "customerId_example", issueNumber: "issueNumber_example", replacement: getCardsForBank_200_response_cards_inner_replacement(requestedDate: Date(), reasonRequested: "reasonRequested_example"), enabled: false, collected: Date(), brand: "brand_example", cardNumber: "cardNumber_example", technology: "technology_example", accountId: "accountId_example", pinReset: [nil], serialNumber: "serialNumber_example", validFromDate: Date(), nameOnCard: "nameOnCard_example", posted: Date(), cardType: "cardType_example") // AddCardForBankRequest | Request body

// Create Card
CardAPI.addCardForBank(bankid: bankid, addCardForBankRequest: addCardForBankRequest) { (response, error) in
...
// Create Card Attribute
CardAPI.createCardAttribute(bankid: bankid, cardid: cardid, createPersonalDataFieldRequest: createPersonalDataFieldRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create or Update Card Attribute Definition
CardAPI.createOrUpdateCardAttributeDefinition(bankid: bankid, createOrUpdateTransactionRequestAttributeDefinitionRequest: createOrUpdateTransactionRequestAttributeDefinitionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Card Attribute Definition
CardAPI.deleteCardAttributeDefinition(bankid: bankid, attributedefinitionid: attributedefinitionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **deleteCardForBank**
```swift
    open class func deleteCardForBank(bankid: String, cardid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Card
CardAPI.deleteCardForBank(bankid: bankid, cardid: cardid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Card Attribute Definition
CardAPI.getCardAttributeDefinition(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getCardForBank**
```swift
    open class func getCardForBank(bankid: String, cardid: String, completion: @escaping (_ data: GetCardForBank200Response?, _ error: Error?) -> Void)
```
...
// Get Card By Id
CardAPI.getCardForBank(bankid: bankid, cardid: cardid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getCards**
```swift
    open class func getCards(completion: @escaping (_ data: GetCards200Response?, _ error: Error?) -> Void)
```
...
// Get cards for the current user
CardAPI.getCards() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getCardsForBank**
```swift
    open class func getCardsForBank(bankid: String, completion: @escaping (_ data: GetCardsForBank200Response?, _ error: Error?) -> Void)
```
...
// Get Cards for the specified bank
CardAPI.getCardsForBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getStatusOfCreditCardOrder(bankid: String, accountid: String, viewid: String, completion: @escaping (_ data: GetStatusOfCreditCardOrder200Response?, _ error: Error?) -> Void)
```
...
// Get status of Credit Card order 
CardAPI.getStatusOfCreditCardOrder(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Card Attribute
CardAPI.updateCardAttribute(bankid: bankid, cardid: cardid, cardattributeid: cardattributeid, createPersonalDataFieldRequest: createPersonalDataFieldRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **updatedCardForBank**
```swift
    open class func updatedCardForBank(bankid: String, cardid: String, updatedCardForBankRequest: UpdatedCardForBankRequest, completion: @escaping (_ data: GetCardsForBank200ResponseCardsInner?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let cardid = "cardid_example" // String | The CARDID identifier
let updatedCardForBankRequest = updatedCardForBank_request(allows: ["allows_example"], expiresDate: Date(), networks: ["networks_example"], customerId: "customerId_example", issueNumber: "issueNumber_example", replacement: getCardsForBank_200_response_cards_inner_replacement(requestedDate: Date(), reasonRequested: "reasonRequested_example"), enabled: false, collected: Date(), technology: "technology_example", accountId: "accountId_example", pinReset: [nil], serialNumber: "serialNumber_example", validFromDate: Date(), nameOnCard: "nameOnCard_example", posted: Date(), cardType: "cardType_example") // UpdatedCardForBankRequest | Request body

// Update Card
CardAPI.updatedCardForBank(bankid: bankid, cardid: cardid, updatedCardForBankRequest: updatedCardForBankRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
