...
// Add a Transaction Comment
TransactionAPI.addCommentForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid, getTransactionTypes200ResponseTransactionTypesInnerId: getTransactionTypes200ResponseTransactionTypesInnerId) { (response, error) in
...
// Add a Transaction Image
TransactionAPI.addImageForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid, addImageForViewOnTransactionRequest: addImageForViewOnTransactionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Add a Transaction Tag
TransactionAPI.addTagForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid, getTransactionTypes200ResponseTransactionTypesInnerId: getTransactionTypes200ResponseTransactionTypesInnerId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Add a Transaction Narrative
TransactionAPI.addTransactionNarrative(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid, getTransactionNarrative200Response: getTransactionNarrative200Response) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Add a Transaction where Tag
TransactionAPI.addWhereTagForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid, updateWhereTagForViewOnTransactionRequest: updateWhereTagForViewOnTransactionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create or Update Transaction Attribute Definition
TransactionAPI.createOrUpdateTransactionAttributeDefinition(bankid: bankid, createOrUpdateTransactionRequestAttributeDefinitionRequest: createOrUpdateTransactionRequestAttributeDefinitionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Transaction Attribute
TransactionAPI.createTransactionAttribute(bankid: bankid, accountid: accountid, transactionid: transactionid, createPersonalDataFieldRequest: createPersonalDataFieldRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete a Transaction Comment
TransactionAPI.deleteCommentForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid, commentid: commentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete a Transaction Image
TransactionAPI.deleteImageForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid, imageid: imageid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete a Transaction Tag
TransactionAPI.deleteTagForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid, tagid: tagid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete Transaction Attribute Definition
TransactionAPI.deleteTransactionAttributeDefinition(bankid: bankid, attributedefinitionid: attributedefinitionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func deleteTransactionCascade(bankid: String, accountid: String, transactionid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Transaction Cascade
TransactionAPI.deleteTransactionCascade(bankid: bankid, accountid: accountid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete a Transaction Narrative
TransactionAPI.deleteTransactionNarrative(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Delete a Transaction Tag
TransactionAPI.deleteWhereTagForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getBalancingTransaction(transactionid: String, completion: @escaping (_ data: GetDoubleEntryTransaction200Response?, _ error: Error?) -> Void)
```
...
// Get Balancing Transaction
TransactionAPI.getBalancingTransaction(transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transaction Comments
TransactionAPI.getCommentsForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transactions for Account (Core)
TransactionAPI.getCoreTransactionsForBankAccount(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getDoubleEntryTransaction(bankid: String, accountid: String, viewid: String, transactionid: String, completion: @escaping (_ data: GetDoubleEntryTransaction200Response?, _ error: Error?) -> Void)
```
...
// Get Double Entry Transaction
TransactionAPI.getDoubleEntryTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Firehose Transactions for Account
TransactionAPI.getFirehoseTransactionsForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transaction Images
TransactionAPI.getImagesForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Other Account of Transaction
TransactionAPI.getOtherAccountForTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transaction Tags
TransactionAPI.getTagsForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transaction Attribute By Id
TransactionAPI.getTransactionAttributeById(bankid: bankid, accountid: accountid, transactionid: transactionid, attributeid: attributeid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transaction Attribute Definition
TransactionAPI.getTransactionAttributeDefinition(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transaction Attributes
TransactionAPI.getTransactionAttributes(bankid: bankid, accountid: accountid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func getTransactionByIdForBankAccount(bankid: String, accountid: String, viewid: String, transactionid: String, completion: @escaping (_ data: GetTransactionByIdForBankAccount200Response?, _ error: Error?) -> Void)
```
...
// Get Transaction by Id
TransactionAPI.getTransactionByIdForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get a Transaction Narrative
TransactionAPI.getTransactionNarrative(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transactions for Account (Full)
TransactionAPI.getTransactionsForBankAccount(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get a Transaction where Tag
TransactionAPI.getWhereTagForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update Transaction Attribute
TransactionAPI.updateTransactionAttribute(bankid: bankid, accountid: accountid, transactionid: transactionid, accountattributeid: accountattributeid, createPersonalDataFieldRequest: createPersonalDataFieldRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update a Transaction Narrative
TransactionAPI.updateTransactionNarrative(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid, getTransactionNarrative200Response: getTransactionNarrative200Response) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update a Transaction where Tag
TransactionAPI.updateWhereTagForViewOnTransaction(bankid: bankid, accountid: accountid, viewid: viewid, transactionid: transactionid, updateWhereTagForViewOnTransactionRequest: updateWhereTagForViewOnTransactionRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
