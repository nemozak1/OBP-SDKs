...
# **addConsentUser**
```swift
    open class func addConsentUser(bankid: String, consentid: String, addConsentUserRequest: AddConsentUserRequest, completion: @escaping (_ data: CreateConsentImplicit200Response?, _ error: Error?) -> Void)
```
...
let addConsentUserRequest = addConsentUser_request(userId: "userId_example") // AddConsentUserRequest | Request body

// Add User to a Consent
AccountInformationServiceAISAPI.addConsentUser(bankid: bankid, consentid: consentid, addConsentUserRequest: addConsentUserRequest) { (response, error) in
...
// Answer Consent Challenge
AccountInformationServiceAISAPI.answerConsentChallenge(bankid: bankid, consentid: consentid, answerConsentChallengeRequest: answerConsentChallengeRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts at all Banks (private)
AccountInformationServiceAISAPI.corePrivateAccountsAllBanks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent By CONSENT_REQUEST_ID (EMAIL)
AccountInformationServiceAISAPI.createConsentByConsentRequestIdEmail(consentrequestid: consentrequestid, email: email) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent By CONSENT_REQUEST_ID (IMPLICIT)
AccountInformationServiceAISAPI.createConsentByConsentRequestIdImplicit(consentrequestid: consentrequestid, implicit: implicit) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent By CONSENT_REQUEST_ID (SMS)
AccountInformationServiceAISAPI.createConsentByConsentRequestIdSms(consentrequestid: consentrequestid, sms: sms) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent (EMAIL)
AccountInformationServiceAISAPI.createConsentEmail(bankid: bankid, email: email, createConsentEmailRequest: createConsentEmailRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent (IMPLICIT)
AccountInformationServiceAISAPI.createConsentImplicit(implicit: implicit, createConsentImplicitRequest: createConsentImplicitRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent Request
AccountInformationServiceAISAPI.createConsentRequest(createConsentRequestRequest: createConsentRequestRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Create Consent (SMS)
AccountInformationServiceAISAPI.createConsentSms(bankid: bankid, sms: sms, createConsentSmsRequest: createConsentSmsRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts Held
AccountInformationServiceAISAPI.getAccountsHeld(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Bank
AccountInformationServiceAISAPI.getBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Balances by BANK_ID and ACCOUNT_ID through the VIEW_ID
AccountInformationServiceAISAPI.getBankAccountBalances(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Balances by BANK_ID
AccountInformationServiceAISAPI.getBankAccountsBalances(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account Balances by BANK_ID through the VIEW_ID
AccountInformationServiceAISAPI.getBankAccountsBalancesThroughView(bankid: bankid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Banks
AccountInformationServiceAISAPI.getBanks() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent By Consent Id via User
AccountInformationServiceAISAPI.getConsentByConsentId(consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent By Consent Id via Consumer
AccountInformationServiceAISAPI.getConsentByConsentIdViaConsumer(consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent By Consent Request Id via Consumer
AccountInformationServiceAISAPI.getConsentByConsentRequestId(consentrequestid: consentrequestid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents Info
AccountInformationServiceAISAPI.getConsentInfos() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents Info At Bank
AccountInformationServiceAISAPI.getConsentInfosByBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consent Request
AccountInformationServiceAISAPI.getConsentRequest(consentrequestid: consentrequestid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consents
AccountInformationServiceAISAPI.getConsents() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Consents at Bank
AccountInformationServiceAISAPI.getConsentsAtBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account by Id (Core) through the VIEW_ID
AccountInformationServiceAISAPI.getCoreAccountByIdThroughView(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Account by Id (Core)
AccountInformationServiceAISAPI.getCoreAccountByIdV600(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transactions for Account (Core)
AccountInformationServiceAISAPI.getCoreTransactionsForBankAccount(bankid: bankid, accountid: accountid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents
AccountInformationServiceAISAPI.getMyConsents() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get My Consents at Bank
AccountInformationServiceAISAPI.getMyConsentsByBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts at Bank (IDs only)
AccountInformationServiceAISAPI.getPrivateAccountIdsbyBankId(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get JSON Web Key (JWK)
AccountInformationServiceAISAPI.getServerJWK() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Transaction Types at Bank
AccountInformationServiceAISAPI.getTransactionTypes(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Provide client's certificate info of a current call
AccountInformationServiceAISAPI.mtlsClientCertificateInfo() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Accounts at Bank (Minimal)
AccountInformationServiceAISAPI.privateAccountsAtOneBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke Consent at Bank
AccountInformationServiceAISAPI.revokeConsentAtBank(bankid: bankid, consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke My Consent
AccountInformationServiceAISAPI.revokeMyConsent(consentid: consentid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Revoke Consent used in the Current Call
AccountInformationServiceAISAPI.selfRevokeConsent() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func updateConsentAccountAccessByConsentId(bankid: String, consentid: String, updateConsentAccountAccessByConsentIdRequest: UpdateConsentAccountAccessByConsentIdRequest, completion: @escaping (_ data: CreateConsentImplicit200Response?, _ error: Error?) -> Void)
```
...
let bankid = "bankid_example" // String | The BANKID identifier
let consentid = "consentid_example" // String | The CONSENTID identifier
let updateConsentAccountAccessByConsentIdRequest = updateConsentAccountAccessByConsentId_request(access: updateConsentAccountAccessByConsentId_request_access(accounts: [createTransactionRequestCounterparty_200_response_details_to_sepa_credit_transfers_debtorAccount(iban: "iban_example")])) // UpdateConsentAccountAccessByConsentIdRequest | Request body

// Update Consent Account Access by CONSENT_ID
AccountInformationServiceAISAPI.updateConsentAccountAccessByConsentId(bankid: bankid, consentid: consentid, updateConsentAccountAccessByConsentIdRequest: updateConsentAccountAccessByConsentIdRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **updateConsentStatus**
```swift
    open class func updateConsentStatus(bankid: String, consentid: String, updateTransactionRequestStatusRequest: UpdateTransactionRequestStatusRequest, completion: @escaping (_ data: CreateConsentImplicit200Response?, _ error: Error?) -> Void)
```
...
// Update Consent Status
AccountInformationServiceAISAPI.updateConsentStatus(bankid: bankid, consentid: consentid, updateTransactionRequestStatusRequest: updateTransactionRequestStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func updateConsentStatusByConsent(bankid: String, consentid: String, updateTransactionRequestStatusRequest: UpdateTransactionRequestStatusRequest, completion: @escaping (_ data: CreateConsentImplicit200Response?, _ error: Error?) -> Void)
```
...
// Update Consent Status by CONSENT_ID
AccountInformationServiceAISAPI.updateConsentStatusByConsent(bankid: bankid, consentid: consentid, updateTransactionRequestStatusRequest: updateTransactionRequestStatusRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func updateConsentUserIdByConsentId(bankid: String, consentid: String, addConsentUserRequest: AddConsentUserRequest, completion: @escaping (_ data: CreateConsentImplicit200Response?, _ error: Error?) -> Void)
```
...
// Update Created by User of Consent by CONSENT_ID
AccountInformationServiceAISAPI.updateConsentUserIdByConsentId(bankid: bankid, consentid: consentid, addConsentUserRequest: addConsentUserRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
