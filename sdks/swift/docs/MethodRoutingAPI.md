...
// Create MethodRouting
MethodRoutingAPI.createMethodRouting(createMethodRoutingRequest: createMethodRoutingRequest) { (response, error) in
...
// Delete MethodRouting
MethodRoutingAPI.deleteMethodRouting(methodroutingid: methodroutingid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Connector Method Names
MethodRoutingAPI.getConnectorMethodNames() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get MethodRoutings
MethodRoutingAPI.getMethodRoutings() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update MethodRouting
MethodRoutingAPI.updateMethodRouting(methodroutingid: methodroutingid, createMethodRoutingRequest: createMethodRoutingRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
