...
// Create Consent By CONSENT_REQUEST_ID (EMAIL)
VRPAPI.createConsentByConsentRequestIdEmail(consentrequestid: consentrequestid, email: email) { (response, error) in
...
// Create Consent Request VRP
VRPAPI.createVRPConsentRequest(createVRPConsentRequestRequest: createVRPConsentRequestRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
