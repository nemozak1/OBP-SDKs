...
// Create Corporate Customer
CorporateCustomerAPI.createCorporateCustomer(bankid: bankid, createCorporateCustomerRequest: createCorporateCustomerRequest) { (response, error) in
...
// Get Corporate Customer by CUSTOMER_ID
CorporateCustomerAPI.getCorporateCustomerByCustomerId(bankid: bankid, customerid: customerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Corporate Customer Subsidiaries
CorporateCustomerAPI.getCorporateCustomerSubsidiaries(bankid: bankid, customerid: customerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Corporate Customers at Bank
CorporateCustomerAPI.getCorporateCustomersAtOneBank(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
