...
```swift
    open class func addSystemViewPermission(viewid: String, addSystemViewPermissionRequest: AddSystemViewPermissionRequest, completion: @escaping (_ data: AddSystemViewPermission200Response?, _ error: Error?) -> Void)
```
...
let addSystemViewPermissionRequest = addSystemViewPermission_request(extraData: ["extraData_example"], permissionName: "permissionName_example") // AddSystemViewPermissionRequest | Request body

// Add Permission to a System View
ViewSystemAPI.addSystemViewPermission(viewid: viewid, addSystemViewPermissionRequest: addSystemViewPermissionRequest) { (response, error) in
...
# **createSystemView**
```swift
    open class func createSystemView(createSystemViewRequest: CreateSystemViewRequest, completion: @escaping (_ data: GetViewsForBankAccount200ResponseViewsInner?, _ error: Error?) -> Void)
```
...
let createSystemViewRequest = createSystemView_request(canGrantAccessToViews: ["canGrantAccessToViews_example"], name: "name_example", description: "description_example", isPublic: false, hideMetadataIfAliasUsed: false, canRevokeAccessToViews: ["canRevokeAccessToViews_example"], whichAliasToUse: "whichAliasToUse_example", metadataView: "metadataView_example", allowedActions: ["allowedActions_example"]) // CreateSystemViewRequest | Request body

// Create System View
ViewSystemAPI.createSystemView(createSystemViewRequest: createSystemViewRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **deleteSystemView**
```swift
    open class func deleteSystemView(viewid: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete System View
ViewSystemAPI.deleteSystemView(viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
```swift
    open class func deleteSystemViewPermission(viewid: String, permissionname: String, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
...
// Delete Permission to a System View
ViewSystemAPI.deleteSystemViewPermission(viewid: viewid, permissionname: permissionname) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Custom View
ViewSystemAPI.getCustomViewById(bankid: bankid, accountid: accountid, viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Custom Views
ViewSystemAPI.getCustomViews() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getSystemView**
```swift
    open class func getSystemView(viewid: String, completion: @escaping (_ data: GetViewsForBankAccount200ResponseViewsInner?, _ error: Error?) -> Void)
```
...
// Get System View
ViewSystemAPI.getSystemView(viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get System View
ViewSystemAPI.getSystemViewById(viewid: viewid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get System Views
ViewSystemAPI.getSystemViews() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getSystemViewsIds**
```swift
    open class func getSystemViewsIds(completion: @escaping (_ data: GetSystemViewsIds200Response?, _ error: Error?) -> Void)
```
...
// Get Ids of System Views
ViewSystemAPI.getSystemViewsIds() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get View Permissions
ViewSystemAPI.getViewPermissions() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Update System View
ViewSystemAPI.updateSystemView(viewid: viewid, updateSystemViewRequest: updateSystemViewRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
