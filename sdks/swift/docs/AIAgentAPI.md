...
// Delete Signal Channel
AIAgentAPI.deleteSignalChannel(channelname: channelname) { (response, error) in
...
// Get Signal Channel Info
AIAgentAPI.getSignalChannelInfo(channelname: channelname) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// List Signal Channels
AIAgentAPI.getSignalChannels() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Signal Messages
AIAgentAPI.getSignalMessages(channelname: channelname) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Signal Channel Stats
AIAgentAPI.getSignalStats() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Publish Signal Message
AIAgentAPI.publishSignalMessage(channelname: channelname, publishSignalMessageRequest: publishSignalMessageRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
