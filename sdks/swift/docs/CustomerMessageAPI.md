...
// Create Customer Message
CustomerMessageAPI.addCustomerMessage(bankid: bankid, customerid: customerid, addCustomerMessageRequest: addCustomerMessageRequest) { (response, error) in
...
// Create Customer Message
CustomerMessageAPI.createCustomerMessage(bankid: bankid, customerid: customerid, createCustomerMessageRequest: createCustomerMessageRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Customer Messages for a Customer
CustomerMessageAPI.getCustomerMessages(bankid: bankid, customerid: customerid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Customer Messages for all Customers
CustomerMessageAPI.getCustomersMessages(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
