...
// Delete Signal Channel
SignallingAPI.deleteSignalChannel(channelname: channelname) { (response, error) in
...
// Get Signal Channel Info
SignallingAPI.getSignalChannelInfo(channelname: channelname) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// List Signal Channels
SignallingAPI.getSignalChannels() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Signal Messages
SignallingAPI.getSignalMessages(channelname: channelname) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Signal Channel Stats
SignallingAPI.getSignalStats() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Publish Signal Message
SignallingAPI.publishSignalMessage(channelname: channelname, publishSignalMessageRequest: publishSignalMessageRequest) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
