...
// Create Meeting (video conference/call)
ExperimentalAPI.createMeeting(bankid: bankid, createMeetingRequest: createMeetingRequest) { (response, error) in
...
// Get Meeting
ExperimentalAPI.getMeeting(bankid: bankid, meetingid: meetingid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Meetings
ExperimentalAPI.getMeetings(bankid: bankid) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
