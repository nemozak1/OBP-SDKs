...
# **getApiGlossary**
```swift
    open class func getApiGlossary(completion: @escaping (_ data: GetApiGlossary200Response?, _ error: Error?) -> Void)
```
...
// Get Glossary of the API
DocumentationAPI.getApiGlossary() { (response, error) in
...
// Get Bank Level Dynamic Resource Docs
DocumentationAPI.getBankLevelDynamicResourceDocsObp(bankid: bankid, apiversion: apiversion) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Message Docs
DocumentationAPI.getMessageDocs(connector: connector) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Message Docs as JSON Schema
DocumentationAPI.getMessageDocsJsonSchema(connector: connector) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Message Docs Swagger
DocumentationAPI.getMessageDocsSwagger(connector: connector) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Resource Docs
DocumentationAPI.getResourceDocsObp(apiversion: apiversion) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get OpenAPI 3.1 documentation
DocumentationAPI.getResourceDocsOpenAPI31(apiversion: apiversion) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Swagger documentation
DocumentationAPI.getResourceDocsSwagger(apiversion: apiversion) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
// Get Scanned API Versions
DocumentationAPI.getScannedApiVersions() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
