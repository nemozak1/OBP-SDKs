...
open class DocumentationAPI {
    ...
    /**
     ...
     - returns: GetApiGlossary200Response
     */
    open class func getApiGlossary(apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> GetApiGlossary200Response {
        return try await getApiGlossaryWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<GetApiGlossary200Response> 
     */
    open class func getApiGlossaryWithRequestBuilder(apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<GetApiGlossary200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetApiGlossary200Response>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
