...
open class MetricAPI {
    ...
    /**
     ...
     - parameter apiConfiguration: The configuration for the http request.
     - returns: GetMetricsTopConsumers200Response
     */
    open class func getMetricsTopConsumers(apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> GetMetricsTopConsumers200Response {
        return try await getMetricsTopConsumersWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - API Key:
       ...
       - name: DirectLogin
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<GetMetricsTopConsumers200Response> 
     */
    open class func getMetricsTopConsumersWithRequestBuilder(apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<GetMetricsTopConsumers200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetMetricsTopConsumers200Response>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
