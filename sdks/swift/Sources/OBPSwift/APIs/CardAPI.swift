...
open class CardAPI {
    ...
    /**
     ...
     - parameter addCardForBankRequest: (body) Request body 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: AddCardForBank200Response
     */
    open class func addCardForBank(bankid: String, addCardForBankRequest: AddCardForBankRequest, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> AddCardForBank200Response {
        return try await addCardForBankWithRequestBuilder(bankid: bankid, addCardForBankRequest: addCardForBankRequest, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter addCardForBankRequest: (body) Request body 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<AddCardForBank200Response> 
     */
    open class func addCardForBankWithRequestBuilder(bankid: String, addCardForBankRequest: AddCardForBankRequest, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<AddCardForBank200Response> {
        ...
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: addCardForBankRequest, codableHelper: apiConfiguration.codableHelper)
        ...
        let localVariableRequestBuilder: RequestBuilder<AddCardForBank200Response>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - returns: Void
     */
    open class func deleteCardForBank(bankid: String, cardid: String, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) {
        return try await deleteCardForBankWithRequestBuilder(bankid: bankid, cardid: cardid, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func deleteCardForBankWithRequestBuilder(bankid: String, cardid: String, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<Void> {
    ...
    /**
     ...
     - parameter cardid: (path) The CARDID identifier 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: GetCardForBank200Response
     */
    open class func getCardForBank(bankid: String, cardid: String, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> GetCardForBank200Response {
        return try await getCardForBankWithRequestBuilder(bankid: bankid, cardid: cardid, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter cardid: (path) The CARDID identifier 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<GetCardForBank200Response> 
     */
    open class func getCardForBankWithRequestBuilder(bankid: String, cardid: String, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<GetCardForBank200Response> {
        var localVariablePath = "/obp/v3.1.0/management/banks/{bankid}/cards/{cardid}"
        let bankidPreEscape = "\(APIHelper.mapValueToPathItem(bankid))"
        let bankidPostEscape = bankidPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{bankid}", with: bankidPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<GetCardForBank200Response>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter apiConfiguration: The configuration for the http request.
     - returns: GetCards200Response
     */
    open class func getCards(apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> GetCards200Response {
        return try await getCardsWithRequestBuilder(apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - API Key:
       ...
       - name: DirectLogin
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<GetCards200Response> 
     */
    open class func getCardsWithRequestBuilder(apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<GetCards200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetCards200Response>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter bankid: (path) The BANKID identifier 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: GetCardsForBank200Response
     */
    open class func getCardsForBank(bankid: String, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> GetCardsForBank200Response {
        return try await getCardsForBankWithRequestBuilder(bankid: bankid, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter bankid: (path) The BANKID identifier 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<GetCardsForBank200Response> 
     */
    open class func getCardsForBankWithRequestBuilder(bankid: String, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<GetCardsForBank200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetCardsForBank200Response>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter apiConfiguration: The configuration for the http request.
     - returns: GetStatusOfCreditCardOrder200Response
     */
    open class func getStatusOfCreditCardOrder(bankid: String, accountid: String, viewid: String, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> GetStatusOfCreditCardOrder200Response {
        return try await getStatusOfCreditCardOrderWithRequestBuilder(bankid: bankid, accountid: accountid, viewid: viewid, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter viewid: (path) The VIEWID identifier 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<GetStatusOfCreditCardOrder200Response> 
     */
    open class func getStatusOfCreditCardOrderWithRequestBuilder(bankid: String, accountid: String, viewid: String, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<GetStatusOfCreditCardOrder200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetStatusOfCreditCardOrder200Response>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter bankid: (path) The BANKID identifier 
     - parameter cardid: (path) The CARDID identifier 
     - parameter updatedCardForBankRequest: (body) Request body 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: GetCardsForBank200ResponseCardsInner
     */
    open class func updatedCardForBank(bankid: String, cardid: String, updatedCardForBankRequest: UpdatedCardForBankRequest, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> GetCardsForBank200ResponseCardsInner {
        return try await updatedCardForBankWithRequestBuilder(bankid: bankid, cardid: cardid, updatedCardForBankRequest: updatedCardForBankRequest, apiConfiguration: apiConfiguration).execute().body
    }
    ...
    /**
     ...
     - parameter updatedCardForBankRequest: (body) Request body 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: RequestBuilder<GetCardsForBank200ResponseCardsInner> 
     */
    open class func updatedCardForBankWithRequestBuilder(bankid: String, cardid: String, updatedCardForBankRequest: UpdatedCardForBankRequest, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<GetCardsForBank200ResponseCardsInner> {
        var localVariablePath = "/obp/v3.1.0/management/banks/{bankid}/cards/{cardid}"
        let bankidPreEscape = "\(APIHelper.mapValueToPathItem(bankid))"
        let bankidPostEscape = bankidPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{bankid}", with: bankidPostEscape, options: .literal, range: nil)
        ...
        localVariablePath = localVariablePath.replacingOccurrences(of: "{cardid}", with: cardidPostEscape, options: .literal, range: nil)
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: updatedCardForBankRequest, codableHelper: apiConfiguration.codableHelper)
        ...
        let localVariableRequestBuilder: RequestBuilder<GetCardsForBank200ResponseCardsInner>.Type = apiConfiguration.requestBuilderFactory.getBuilder()
