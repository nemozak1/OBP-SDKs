...
open class SandboxAPI {
    ...
    /**
     ...
     - parameter sandboxDataImportRequest: (body) Request body 
     - parameter apiConfiguration: The configuration for the http request.
     - returns: UpdateTransactionNarrative200Response
     */
    open class func sandboxDataImport(sandboxDataImportRequest: SandboxDataImportRequest, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) async throws(ErrorResponse) -> UpdateTransactionNarrative200Response {
        return try await sandboxDataImportWithRequestBuilder(sandboxDataImportRequest: sandboxDataImportRequest, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func sandboxDataImportWithRequestBuilder(sandboxDataImportRequest: SandboxDataImportRequest, apiConfiguration: OBPSwiftAPIConfiguration = OBPSwiftAPIConfiguration.shared) -> RequestBuilder<UpdateTransactionNarrative200Response> {
        let localVariablePath = "/obp/v2.1.0/sandbox/data-import"
        let localVariableURLString = apiConfiguration.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: sandboxDataImportRequest, codableHelper: apiConfiguration.codableHelper)
