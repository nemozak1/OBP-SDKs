...
import com.openbankproject.model.SandboxDataImportRequest;
...
public class SandboxApi {
   ...
   * @param sandboxDataImportRequest Request body (required)
   * @return UpdateTransactionNarrative200Response
   * @throws ApiException if fails to make API call
   */
  public UpdateTransactionNarrative200Response sandboxDataImport(@javax.annotation.Nonnull SandboxDataImportRequest sandboxDataImportRequest) throws ApiException {
    return sandboxDataImport(sandboxDataImportRequest, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public UpdateTransactionNarrative200Response sandboxDataImport(@javax.annotation.Nonnull SandboxDataImportRequest sandboxDataImportRequest, Map<String, String> headers) throws ApiException {
    ApiResponse<UpdateTransactionNarrative200Response> localVarResponse = sandboxDataImportWithHttpInfo(sandboxDataImportRequest, headers);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UpdateTransactionNarrative200Response> sandboxDataImportWithHttpInfo(@javax.annotation.Nonnull SandboxDataImportRequest sandboxDataImportRequest) throws ApiException {
    return sandboxDataImportWithHttpInfo(sandboxDataImportRequest, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<UpdateTransactionNarrative200Response> sandboxDataImportWithHttpInfo(@javax.annotation.Nonnull SandboxDataImportRequest sandboxDataImportRequest, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = sandboxDataImportRequestBuilder(sandboxDataImportRequest, headers);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("sandboxDataImport", localVarResponse);
        }
  ...
  private HttpRequest.Builder sandboxDataImportRequestBuilder(@javax.annotation.Nonnull SandboxDataImportRequest sandboxDataImportRequest, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'sandboxDataImportRequest' is set
    if (sandboxDataImportRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'sandboxDataImportRequest' when calling sandboxDataImport");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(sandboxDataImportRequest);
