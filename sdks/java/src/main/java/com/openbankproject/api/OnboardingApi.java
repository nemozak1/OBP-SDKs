...
public class OnboardingApi {
   ...
   * @param addAccountRequest Request body (required)
   * @return AddAccount200Response
   * @throws ApiException if fails to make API call
   */
  public AddAccount200Response createAccount(@javax.annotation.Nonnull String bankid, @javax.annotation.Nonnull String accountid, @javax.annotation.Nonnull AddAccountRequest addAccountRequest) throws ApiException {
    return createAccount(bankid, accountid, addAccountRequest, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public AddAccount200Response createAccount(@javax.annotation.Nonnull String bankid, @javax.annotation.Nonnull String accountid, @javax.annotation.Nonnull AddAccountRequest addAccountRequest, Map<String, String> headers) throws ApiException {
    ApiResponse<AddAccount200Response> localVarResponse = createAccountWithHttpInfo(bankid, accountid, addAccountRequest, headers);
   ...
   * @param accountid The ACCOUNTID identifier (required)
   * @param addAccountRequest Request body (required)
   * @return ApiResponse&lt;AddAccount200Response&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<AddAccount200Response> createAccountWithHttpInfo(@javax.annotation.Nonnull String bankid, @javax.annotation.Nonnull String accountid, @javax.annotation.Nonnull AddAccountRequest addAccountRequest) throws ApiException {
    return createAccountWithHttpInfo(bankid, accountid, addAccountRequest, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<AddAccount200Response> createAccountWithHttpInfo(@javax.annotation.Nonnull String bankid, @javax.annotation.Nonnull String accountid, @javax.annotation.Nonnull AddAccountRequest addAccountRequest, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = createAccountRequestBuilder(bankid, accountid, addAccountRequest, headers);
    try {
      ...
      try {
        ...
        if (localVarResponseBody == null) {
          return new ApiResponse<AddAccount200Response>(
        ...
        AddAccount200Response responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<AddAccount200Response>() {});
  ...
  private HttpRequest.Builder createAccountRequestBuilder(@javax.annotation.Nonnull String bankid, @javax.annotation.Nonnull String accountid, @javax.annotation.Nonnull AddAccountRequest addAccountRequest, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'bankid' is set
    if (bankid == null) {
      throw new ApiException(400, "Missing the required parameter 'bankid' when calling createAccount");
    }
    // verify the required parameter 'accountid' is set
    if (accountid == null) {
      throw new ApiException(400, "Missing the required parameter 'accountid' when calling createAccount");
    }
    // verify the required parameter 'addAccountRequest' is set
    if (addAccountRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'addAccountRequest' when calling createAccount");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(addAccountRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public VerifyUserCredentials200Response createUser(@javax.annotation.Nonnull CreateUserRequest createUserRequest) throws ApiException {
    return createUser(createUserRequest, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public VerifyUserCredentials200Response createUser(@javax.annotation.Nonnull CreateUserRequest createUserRequest, Map<String, String> headers) throws ApiException {
    ApiResponse<VerifyUserCredentials200Response> localVarResponse = createUserWithHttpInfo(createUserRequest, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<VerifyUserCredentials200Response> createUserWithHttpInfo(@javax.annotation.Nonnull CreateUserRequest createUserRequest) throws ApiException {
    return createUserWithHttpInfo(createUserRequest, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<VerifyUserCredentials200Response> createUserWithHttpInfo(@javax.annotation.Nonnull CreateUserRequest createUserRequest, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = createUserRequestBuilder(createUserRequest, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<VerifyUserCredentials200Response>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        VerifyUserCredentials200Response responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<VerifyUserCredentials200Response>() {});
  ...
  private HttpRequest.Builder createUserRequestBuilder(@javax.annotation.Nonnull CreateUserRequest createUserRequest, Map<String, String> headers) throws ApiException {
