...
public class GetUsers200Response {
  ...
  private List<GetUsers200ResponseUsersInner> users = new ArrayList<>();

  public GetUsers200Response() { 
  }

  public GetUsers200Response users(@javax.annotation.Nullable List<GetUsers200ResponseUsersInner> users) {
    this.users = users;
    return this;
  }

  public GetUsers200Response addUsersItem(GetUsers200ResponseUsersInner usersItem) {
    if (this.users == null) {
  ...
  public List<GetUsers200ResponseUsersInner> getUsers() {
    return users;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_USERS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUsers(@javax.annotation.Nullable List<GetUsers200ResponseUsersInner> users) {
    this.users = users;
  }
