...
| [**createConsentByConsentRequestIdEmailWithHttpInfo**](VrpApi.md#createConsentByConsentRequestIdEmailWithHttpInfo) | **POST** /obp/v5.0.0/consumer/consent-requests/{consentrequestid}/{email}/consents | Create Consent By CONSENT_REQUEST_ID (EMAIL) |
...
| [**createVRPConsentRequestWithHttpInfo**](VrpApi.md#createVRPConsentRequestWithHttpInfo) | **POST** /obp/v5.1.0/consumer/vrp-consent-requests | Create Consent Request VRP |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling VrpApi#createConsentByConsentRequestIdEmail");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling VrpApi#createVRPConsentRequest");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
