...
| [**createOrUpdateWebUiPropsWithHttpInfo**](WebUiPropsApi.md#createOrUpdateWebUiPropsWithHttpInfo) | **PUT** /obp/v6.0.0/management/webui_props/{webuipropname} | Create or Update WebUiProps |
| [**createWebUiProps**](WebUiPropsApi.md#createWebUiProps) | **POST** /obp/v3.1.0/management/webui_props | Create WebUiProps |
| [**createWebUiPropsWithHttpInfo**](WebUiPropsApi.md#createWebUiPropsWithHttpInfo) | **POST** /obp/v3.1.0/management/webui_props | Create WebUiProps |
...
| [**deleteWebUiPropsWithHttpInfo**](WebUiPropsApi.md#deleteWebUiPropsWithHttpInfo) | **DELETE** /obp/v6.0.0/management/webui_props/{webuipropname} | Delete WebUiProps |
| [**getWebUiProp**](WebUiPropsApi.md#getWebUiProp) | **GET** /obp/v6.0.0/webui-props/{webuipropname} | Get WebUiProp by Name |
| [**getWebUiPropWithHttpInfo**](WebUiPropsApi.md#getWebUiPropWithHttpInfo) | **GET** /obp/v6.0.0/webui-props/{webuipropname} | Get WebUiProp by Name |
| [**getWebUiProps**](WebUiPropsApi.md#getWebUiProps) | **GET** /obp/v6.0.0/webui-props | Get WebUiProps |
| [**getWebUiPropsWithHttpInfo**](WebUiPropsApi.md#getWebUiPropsWithHttpInfo) | **GET** /obp/v6.0.0/webui-props | Get WebUiProps |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CreateWebUiProps200Response result = apiInstance.createOrUpdateWebUiProps(webuipropname, getTransactionTypes200ResponseTransactionTypesInnerId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling WebUiPropsApi#createOrUpdateWebUiProps");
...
## createOrUpdateWebUiPropsWithHttpInfo

> ApiResponse<CreateWebUiProps200Response> createOrUpdateWebUiProps createOrUpdateWebUiPropsWithHttpInfo(webuipropname, getTransactionTypes200ResponseTransactionTypesInnerId)
...
public class Example {
    public static void main(String[] args) {
        ...
        GetTransactionTypes200ResponseTransactionTypesInnerId getTransactionTypes200ResponseTransactionTypesInnerId = new GetTransactionTypes200ResponseTransactionTypesInnerId(); // GetTransactionTypes200ResponseTransactionTypesInnerId | Request body
        try {
            ApiResponse<CreateWebUiProps200Response> response = apiInstance.createOrUpdateWebUiPropsWithHttpInfo(webuipropname, getTransactionTypes200ResponseTransactionTypesInnerId);
...
ApiResponse<[**CreateWebUiProps200Response**](CreateWebUiProps200Response.md)>
...
public class Example {
    public static void main(String[] args) {
        ...
        WebUiPropsApi apiInstance = new WebUiPropsApi(defaultClient);
        CreateTransactionRequestCounterparty200ResponseAttributesInner createTransactionRequestCounterparty200ResponseAttributesInner = new CreateTransactionRequestCounterparty200ResponseAttributesInner(); // CreateTransactionRequestCounterparty200ResponseAttributesInner | Request body
        try {
            CreateWebUiProps200Response result = apiInstance.createWebUiProps(createTransactionRequestCounterparty200ResponseAttributesInner);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling WebUiPropsApi#createWebUiProps");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## createWebUiPropsWithHttpInfo

> ApiResponse<CreateWebUiProps200Response> createWebUiProps createWebUiPropsWithHttpInfo(createTransactionRequestCounterparty200ResponseAttributesInner)
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateTransactionRequestCounterparty200ResponseAttributesInner createTransactionRequestCounterparty200ResponseAttributesInner = new CreateTransactionRequestCounterparty200ResponseAttributesInner(); // CreateTransactionRequestCounterparty200ResponseAttributesInner | Request body
        try {
            ApiResponse<CreateWebUiProps200Response> response = apiInstance.createWebUiPropsWithHttpInfo(createTransactionRequestCounterparty200ResponseAttributesInner);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
> void deleteWebUiProps(webuipropname)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling WebUiPropsApi#deleteWebUiProps");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## deleteWebUiPropsWithHttpInfo

> ApiResponse<Void> deleteWebUiProps deleteWebUiPropsWithHttpInfo(webuipropname)
...
public class Example {
    public static void main(String[] args) {
        ...
        String webuipropname = "webuipropname_example"; // String | The WEBUIPROPNAME identifier
        try {
            ApiResponse<Void> response = apiInstance.deleteWebUiPropsWithHttpInfo(webuipropname);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
        } catch (ApiException e) {
            System.err.println("Exception when calling WebUiPropsApi#deleteWebUiProps");
...
public class Example {
    public static void main(String[] args) {
        ...
        String webuipropname = "webuipropname_example"; // String | The WEBUIPROPNAME identifier
        try {
            GetWebUiProps200ResponseWebuiPropsInner result = apiInstance.getWebUiProp(webuipropname);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling WebUiPropsApi#getWebUiProp");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getWebUiPropWithHttpInfo

> ApiResponse<GetWebUiProps200ResponseWebuiPropsInner> getWebUiProp getWebUiPropWithHttpInfo(webuipropname)
...
public class Example {
    public static void main(String[] args) {
        ...
        String webuipropname = "webuipropname_example"; // String | The WEBUIPROPNAME identifier
        try {
            ApiResponse<GetWebUiProps200ResponseWebuiPropsInner> response = apiInstance.getWebUiPropWithHttpInfo(webuipropname);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**GetWebUiProps200ResponseWebuiPropsInner**](GetWebUiProps200ResponseWebuiPropsInner.md)>
...
public class Example {
    public static void main(String[] args) {
        ...
        WebUiPropsApi apiInstance = new WebUiPropsApi(defaultClient);
        try {
            GetWebUiProps200Response result = apiInstance.getWebUiProps();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling WebUiPropsApi#getWebUiProps");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getWebUiPropsWithHttpInfo

> ApiResponse<GetWebUiProps200Response> getWebUiProps getWebUiPropsWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        WebUiPropsApi apiInstance = new WebUiPropsApi(defaultClient);
        try {
            ApiResponse<GetWebUiProps200Response> response = apiInstance.getWebUiPropsWithHttpInfo();
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**GetWebUiProps200Response**](GetWebUiProps200Response.md)>
