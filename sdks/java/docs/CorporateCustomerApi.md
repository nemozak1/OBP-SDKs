...
| [**createCorporateCustomerWithHttpInfo**](CorporateCustomerApi.md#createCorporateCustomerWithHttpInfo) | **POST** /obp/v6.0.0/banks/{bankid}/corporate-customers | Create Corporate Customer |
...
| [**getCorporateCustomerByCustomerIdWithHttpInfo**](CorporateCustomerApi.md#getCorporateCustomerByCustomerIdWithHttpInfo) | **GET** /obp/v6.0.0/banks/{bankid}/corporate-customers/{customerid} | Get Corporate Customer by CUSTOMER_ID |
...
| [**getCorporateCustomerSubsidiariesWithHttpInfo**](CorporateCustomerApi.md#getCorporateCustomerSubsidiariesWithHttpInfo) | **GET** /obp/v6.0.0/banks/{bankid}/corporate-customers/{customerid}/subsidiaries | Get Corporate Customer Subsidiaries |
...
| [**getCorporateCustomersAtOneBankWithHttpInfo**](CorporateCustomerApi.md#getCorporateCustomersAtOneBankWithHttpInfo) | **GET** /obp/v6.0.0/banks/{bankid}/corporate-customers | Get Corporate Customers at Bank |
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateCorporateCustomerRequest createCorporateCustomerRequest = new CreateCorporateCustomerRequest(); // CreateCorporateCustomerRequest | Request body
        try {
            GetCustomerChildren200ResponseCustomersInner result = apiInstance.createCorporateCustomer(bankid, createCorporateCustomerRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CorporateCustomerApi#createCorporateCustomer");
...
## createCorporateCustomerWithHttpInfo

> ApiResponse<GetCustomerChildren200ResponseCustomersInner> createCorporateCustomer createCorporateCustomerWithHttpInfo(bankid, createCorporateCustomerRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateCorporateCustomerRequest createCorporateCustomerRequest = new CreateCorporateCustomerRequest(); // CreateCorporateCustomerRequest | Request body
        try {
            ApiResponse<GetCustomerChildren200ResponseCustomersInner> response = apiInstance.createCorporateCustomerWithHttpInfo(bankid, createCorporateCustomerRequest);
...
ApiResponse<[**GetCustomerChildren200ResponseCustomersInner**](GetCustomerChildren200ResponseCustomersInner.md)>
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            GetCustomerByCustomerNumber200Response result = apiInstance.getCorporateCustomerByCustomerId(bankid, customerid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CorporateCustomerApi#getCorporateCustomerByCustomerId");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getCorporateCustomerByCustomerIdWithHttpInfo

> ApiResponse<GetCustomerByCustomerNumber200Response> getCorporateCustomerByCustomerId getCorporateCustomerByCustomerIdWithHttpInfo(bankid, customerid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String customerid = "customerid_example"; // String | The CUSTOMERID identifier
        try {
            ApiResponse<GetCustomerByCustomerNumber200Response> response = apiInstance.getCorporateCustomerByCustomerIdWithHttpInfo(bankid, customerid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        String customerid = "customerid_example"; // String | The CUSTOMERID identifier
        try {
            GetCustomerChildren200Response result = apiInstance.getCorporateCustomerSubsidiaries(bankid, customerid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CorporateCustomerApi#getCorporateCustomerSubsidiaries");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getCorporateCustomerSubsidiariesWithHttpInfo

> ApiResponse<GetCustomerChildren200Response> getCorporateCustomerSubsidiaries getCorporateCustomerSubsidiariesWithHttpInfo(bankid, customerid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String customerid = "customerid_example"; // String | The CUSTOMERID identifier
        try {
            ApiResponse<GetCustomerChildren200Response> response = apiInstance.getCorporateCustomerSubsidiariesWithHttpInfo(bankid, customerid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        String bankid = "bankid_example"; // String | The BANKID identifier
        try {
            GetCustomerChildren200Response result = apiInstance.getCorporateCustomersAtOneBank(bankid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CorporateCustomerApi#getCorporateCustomersAtOneBank");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getCorporateCustomersAtOneBankWithHttpInfo

> ApiResponse<GetCustomerChildren200Response> getCorporateCustomersAtOneBank getCorporateCustomersAtOneBankWithHttpInfo(bankid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String bankid = "bankid_example"; // String | The BANKID identifier
        try {
            ApiResponse<GetCustomerChildren200Response> response = apiInstance.getCorporateCustomersAtOneBankWithHttpInfo(bankid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
