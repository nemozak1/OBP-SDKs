...
|------------- | ------------- | -------------|
| [**getFirehoseTransactionsForBankAccount**](TransactionFirehoseApi.md#getFirehoseTransactionsForBankAccount) | **GET** /obp/v3.0.0/banks/{bankid}/firehose/accounts/{accountid}/views/{viewid}/transactions | Get Firehose Transactions for Account |
| [**getFirehoseTransactionsForBankAccountWithHttpInfo**](TransactionFirehoseApi.md#getFirehoseTransactionsForBankAccountWithHttpInfo) | **GET** /obp/v3.0.0/banks/{bankid}/firehose/accounts/{accountid}/views/{viewid}/transactions | Get Firehose Transactions for Account |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling TransactionFirehoseApi#getFirehoseTransactionsForBankAccount");
