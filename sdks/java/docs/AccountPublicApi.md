...
| [**getPublicAccountByIdWithHttpInfo**](AccountPublicApi.md#getPublicAccountByIdWithHttpInfo) | **GET** /obp/v3.0.0/banks/{bankid}/public/accounts/{accountid}/{viewid}/account | Get Public Account by Id |
...
| [**publicAccountsAllBanksWithHttpInfo**](AccountPublicApi.md#publicAccountsAllBanksWithHttpInfo) | **GET** /obp/v2.0.0/accounts/public | Get Public Accounts at all Banks |
...
| [**publicAccountsAtOneBankWithHttpInfo**](AccountPublicApi.md#publicAccountsAtOneBankWithHttpInfo) | **GET** /obp/v2.0.0/banks/{bankid}/accounts/public | Get Public Accounts at Bank |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            GetPublicAccountById200Response result = apiInstance.getPublicAccountById(bankid, accountid, viewid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling AccountPublicApi#getPublicAccountById");
...
## getPublicAccountByIdWithHttpInfo

> ApiResponse<GetPublicAccountById200Response> getPublicAccountById getPublicAccountByIdWithHttpInfo(bankid, accountid, viewid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String viewid = "viewid_example"; // String | The VIEWID identifier
        try {
            ApiResponse<GetPublicAccountById200Response> response = apiInstance.getPublicAccountByIdWithHttpInfo(bankid, accountid, viewid);
...
ApiResponse<[**GetPublicAccountById200Response**](GetPublicAccountById200Response.md)>
...
public class Example {
    public static void main(String[] args) {
        ...
        AccountPublicApi apiInstance = new AccountPublicApi(defaultClient);
        try {
            PublicAccountsAllBanks200Response result = apiInstance.publicAccountsAllBanks();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling AccountPublicApi#publicAccountsAllBanks");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## publicAccountsAllBanksWithHttpInfo

> ApiResponse<PublicAccountsAllBanks200Response> publicAccountsAllBanks publicAccountsAllBanksWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        AccountPublicApi apiInstance = new AccountPublicApi(defaultClient);
        try {
            ApiResponse<PublicAccountsAllBanks200Response> response = apiInstance.publicAccountsAllBanksWithHttpInfo();
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**PublicAccountsAllBanks200Response**](PublicAccountsAllBanks200Response.md)>
...
public class Example {
    public static void main(String[] args) {
        ...
        String bankid = "bankid_example"; // String | The BANKID identifier
        try {
            PublicAccountsAllBanks200Response result = apiInstance.publicAccountsAtOneBank(bankid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling AccountPublicApi#publicAccountsAtOneBank");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## publicAccountsAtOneBankWithHttpInfo

> ApiResponse<PublicAccountsAllBanks200Response> publicAccountsAtOneBank publicAccountsAtOneBankWithHttpInfo(bankid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String bankid = "bankid_example"; // String | The BANKID identifier
        try {
            ApiResponse<PublicAccountsAllBanks200Response> response = apiInstance.publicAccountsAtOneBankWithHttpInfo(bankid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
