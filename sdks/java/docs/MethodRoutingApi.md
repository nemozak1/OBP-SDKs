...
| [**createMethodRoutingWithHttpInfo**](MethodRoutingApi.md#createMethodRoutingWithHttpInfo) | **POST** /obp/v3.1.0/management/method_routings | Create MethodRouting |
...
| [**deleteMethodRoutingWithHttpInfo**](MethodRoutingApi.md#deleteMethodRoutingWithHttpInfo) | **DELETE** /obp/v3.1.0/management/method_routings/{methodroutingid} | Delete MethodRouting |
...
| [**getConnectorMethodNamesWithHttpInfo**](MethodRoutingApi.md#getConnectorMethodNamesWithHttpInfo) | **GET** /obp/v6.0.0/system/connector-method-names | Get Connector Method Names |
| [**getMethodRoutings**](MethodRoutingApi.md#getMethodRoutings) | **GET** /obp/v3.1.0/management/method_routings | Get MethodRoutings |
| [**getMethodRoutingsWithHttpInfo**](MethodRoutingApi.md#getMethodRoutingsWithHttpInfo) | **GET** /obp/v3.1.0/management/method_routings | Get MethodRoutings |
...
| [**updateMethodRoutingWithHttpInfo**](MethodRoutingApi.md#updateMethodRoutingWithHttpInfo) | **PUT** /obp/v3.1.0/management/method_routings/{methodroutingid} | Update MethodRouting |
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateMethodRoutingRequest createMethodRoutingRequest = new CreateMethodRoutingRequest(); // CreateMethodRoutingRequest | Request body
        try {
            GetMethodRoutings200ResponseMethodRoutingsInner result = apiInstance.createMethodRouting(createMethodRoutingRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling MethodRoutingApi#createMethodRouting");
...
## createMethodRoutingWithHttpInfo

> ApiResponse<GetMethodRoutings200ResponseMethodRoutingsInner> createMethodRouting createMethodRoutingWithHttpInfo(createMethodRoutingRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateMethodRoutingRequest createMethodRoutingRequest = new CreateMethodRoutingRequest(); // CreateMethodRoutingRequest | Request body
        try {
            ApiResponse<GetMethodRoutings200ResponseMethodRoutingsInner> response = apiInstance.createMethodRoutingWithHttpInfo(createMethodRoutingRequest);
...
ApiResponse<[**GetMethodRoutings200ResponseMethodRoutingsInner**](GetMethodRoutings200ResponseMethodRoutingsInner.md)>
...
> void deleteMethodRouting(methodroutingid)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling MethodRoutingApi#deleteMethodRouting");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## deleteMethodRoutingWithHttpInfo

> ApiResponse<Void> deleteMethodRouting deleteMethodRoutingWithHttpInfo(methodroutingid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String methodroutingid = "methodroutingid_example"; // String | The METHODROUTINGID identifier
        try {
            ApiResponse<Void> response = apiInstance.deleteMethodRoutingWithHttpInfo(methodroutingid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
        } catch (ApiException e) {
            System.err.println("Exception when calling MethodRoutingApi#deleteMethodRouting");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling MethodRoutingApi#getConnectorMethodNames");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        MethodRoutingApi apiInstance = new MethodRoutingApi(defaultClient);
        try {
            GetMethodRoutings200Response result = apiInstance.getMethodRoutings();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling MethodRoutingApi#getMethodRoutings");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getMethodRoutingsWithHttpInfo

> ApiResponse<GetMethodRoutings200Response> getMethodRoutings getMethodRoutingsWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        MethodRoutingApi apiInstance = new MethodRoutingApi(defaultClient);
        try {
            ApiResponse<GetMethodRoutings200Response> response = apiInstance.getMethodRoutingsWithHttpInfo();
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**GetMethodRoutings200Response**](GetMethodRoutings200Response.md)>
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateMethodRoutingRequest createMethodRoutingRequest = new CreateMethodRoutingRequest(); // CreateMethodRoutingRequest | Request body
        try {
            GetMethodRoutings200ResponseMethodRoutingsInner result = apiInstance.updateMethodRouting(methodroutingid, createMethodRoutingRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling MethodRoutingApi#updateMethodRouting");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## updateMethodRoutingWithHttpInfo

> ApiResponse<GetMethodRoutings200ResponseMethodRoutingsInner> updateMethodRouting updateMethodRoutingWithHttpInfo(methodroutingid, createMethodRoutingRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateMethodRoutingRequest createMethodRoutingRequest = new CreateMethodRoutingRequest(); // CreateMethodRoutingRequest | Request body
        try {
            ApiResponse<GetMethodRoutings200ResponseMethodRoutingsInner> response = apiInstance.updateMethodRoutingWithHttpInfo(methodroutingid, createMethodRoutingRequest);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
