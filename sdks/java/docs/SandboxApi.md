...
| [**sandboxDataImportWithHttpInfo**](SandboxApi.md#sandboxDataImportWithHttpInfo) | **POST** /obp/v2.1.0/sandbox/data-import | Create sandbox |



## sandboxDataImport

> UpdateTransactionNarrative200Response sandboxDataImport(sandboxDataImportRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        SandboxDataImportRequest sandboxDataImportRequest = new SandboxDataImportRequest(); // SandboxDataImportRequest | Request body
        try {
            UpdateTransactionNarrative200Response result = apiInstance.sandboxDataImport(sandboxDataImportRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SandboxApi#sandboxDataImport");
...
## sandboxDataImportWithHttpInfo

> ApiResponse<UpdateTransactionNarrative200Response> sandboxDataImport sandboxDataImportWithHttpInfo(sandboxDataImportRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        SandboxDataImportRequest sandboxDataImportRequest = new SandboxDataImportRequest(); // SandboxDataImportRequest | Request body
        try {
            ApiResponse<UpdateTransactionNarrative200Response> response = apiInstance.sandboxDataImportWithHttpInfo(sandboxDataImportRequest);
