...
| [**deleteSignalChannelWithHttpInfo**](ChannelApi.md#deleteSignalChannelWithHttpInfo) | **DELETE** /obp/v6.0.0/signal/channels/{channelname} | Delete Signal Channel |
...
| [**getSignalChannelInfoWithHttpInfo**](ChannelApi.md#getSignalChannelInfoWithHttpInfo) | **GET** /obp/v6.0.0/signal/channels/{channelname}/info | Get Signal Channel Info |
| [**getSignalChannels**](ChannelApi.md#getSignalChannels) | **GET** /obp/v6.0.0/signal/channels | List Signal Channels |
| [**getSignalChannelsWithHttpInfo**](ChannelApi.md#getSignalChannelsWithHttpInfo) | **GET** /obp/v6.0.0/signal/channels | List Signal Channels |
...
| [**getSignalMessagesWithHttpInfo**](ChannelApi.md#getSignalMessagesWithHttpInfo) | **GET** /obp/v6.0.0/signal/channels/{channelname}/messages | Get Signal Messages |
| [**getSignalStats**](ChannelApi.md#getSignalStats) | **GET** /obp/v6.0.0/signal/channels/stats | Get Signal Channel Stats |
| [**getSignalStatsWithHttpInfo**](ChannelApi.md#getSignalStatsWithHttpInfo) | **GET** /obp/v6.0.0/signal/channels/stats | Get Signal Channel Stats |
...
| [**publishSignalMessageWithHttpInfo**](ChannelApi.md#publishSignalMessageWithHttpInfo) | **POST** /obp/v6.0.0/signal/channels/{channelname}/messages | Publish Signal Message |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ChannelApi#deleteSignalChannel");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ChannelApi#getSignalChannelInfo");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ChannelApi#getSignalChannels");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ChannelApi#getSignalMessages");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ChannelApi#getSignalStats");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ChannelApi#publishSignalMessage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
