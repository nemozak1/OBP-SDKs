...
| [**createRetailCustomerWithHttpInfo**](RetailCustomerApi.md#createRetailCustomerWithHttpInfo) | **POST** /obp/v6.0.0/banks/{bankid}/retail-customers | Create Retail Customer |
...
| [**getRetailCustomerByCustomerIdWithHttpInfo**](RetailCustomerApi.md#getRetailCustomerByCustomerIdWithHttpInfo) | **GET** /obp/v6.0.0/banks/{bankid}/retail-customers/{customerid} | Get Retail Customer by CUSTOMER_ID |
...
| [**getRetailCustomersAtOneBankWithHttpInfo**](RetailCustomerApi.md#getRetailCustomersAtOneBankWithHttpInfo) | **GET** /obp/v6.0.0/banks/{bankid}/retail-customers | Get Retail Customers at Bank |
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateRetailCustomerRequest createRetailCustomerRequest = new CreateRetailCustomerRequest(); // CreateRetailCustomerRequest | Request body
        try {
            GetCustomerChildren200ResponseCustomersInner result = apiInstance.createRetailCustomer(bankid, createRetailCustomerRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailCustomerApi#createRetailCustomer");
...
## createRetailCustomerWithHttpInfo

> ApiResponse<GetCustomerChildren200ResponseCustomersInner> createRetailCustomer createRetailCustomerWithHttpInfo(bankid, createRetailCustomerRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateRetailCustomerRequest createRetailCustomerRequest = new CreateRetailCustomerRequest(); // CreateRetailCustomerRequest | Request body
        try {
            ApiResponse<GetCustomerChildren200ResponseCustomersInner> response = apiInstance.createRetailCustomerWithHttpInfo(bankid, createRetailCustomerRequest);
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            GetCustomerByCustomerNumber200Response result = apiInstance.getRetailCustomerByCustomerId(bankid, customerid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailCustomerApi#getRetailCustomerByCustomerId");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getRetailCustomerByCustomerIdWithHttpInfo

> ApiResponse<GetCustomerByCustomerNumber200Response> getRetailCustomerByCustomerId getRetailCustomerByCustomerIdWithHttpInfo(bankid, customerid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String customerid = "customerid_example"; // String | The CUSTOMERID identifier
        try {
            ApiResponse<GetCustomerByCustomerNumber200Response> response = apiInstance.getRetailCustomerByCustomerIdWithHttpInfo(bankid, customerid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        String bankid = "bankid_example"; // String | The BANKID identifier
        try {
            GetCustomerChildren200Response result = apiInstance.getRetailCustomersAtOneBank(bankid);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailCustomerApi#getRetailCustomersAtOneBank");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getRetailCustomersAtOneBankWithHttpInfo

> ApiResponse<GetCustomerChildren200Response> getRetailCustomersAtOneBank getRetailCustomersAtOneBankWithHttpInfo(bankid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String bankid = "bankid_example"; // String | The BANKID identifier
        try {
            ApiResponse<GetCustomerChildren200Response> response = apiInstance.getRetailCustomersAtOneBankWithHttpInfo(bankid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
