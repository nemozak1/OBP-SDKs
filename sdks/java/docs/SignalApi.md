...
| [**deleteSignalChannelWithHttpInfo**](SignalApi.md#deleteSignalChannelWithHttpInfo) | **DELETE** /obp/v6.0.0/signal/channels/{channelname} | Delete Signal Channel |
...
| [**getSignalChannelInfoWithHttpInfo**](SignalApi.md#getSignalChannelInfoWithHttpInfo) | **GET** /obp/v6.0.0/signal/channels/{channelname}/info | Get Signal Channel Info |
| [**getSignalChannels**](SignalApi.md#getSignalChannels) | **GET** /obp/v6.0.0/signal/channels | List Signal Channels |
| [**getSignalChannelsWithHttpInfo**](SignalApi.md#getSignalChannelsWithHttpInfo) | **GET** /obp/v6.0.0/signal/channels | List Signal Channels |
| [**getSignalMessages**](SignalApi.md#getSignalMessages) | **GET** /obp/v6.0.0/signal/channels/{channelname}/messages | Get Signal Messages |
| [**getSignalMessagesWithHttpInfo**](SignalApi.md#getSignalMessagesWithHttpInfo) | **GET** /obp/v6.0.0/signal/channels/{channelname}/messages | Get Signal Messages |
| [**getSignalStats**](SignalApi.md#getSignalStats) | **GET** /obp/v6.0.0/signal/channels/stats | Get Signal Channel Stats |
| [**getSignalStatsWithHttpInfo**](SignalApi.md#getSignalStatsWithHttpInfo) | **GET** /obp/v6.0.0/signal/channels/stats | Get Signal Channel Stats |
...
| [**publishSignalMessageWithHttpInfo**](SignalApi.md#publishSignalMessageWithHttpInfo) | **POST** /obp/v6.0.0/signal/channels/{channelname}/messages | Publish Signal Message |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling SignalApi#deleteSignalChannel");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling SignalApi#getSignalChannelInfo");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling SignalApi#getSignalChannels");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling SignalApi#getSignalMessages");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling SignalApi#getSignalStats");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling SignalApi#publishSignalMessage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
