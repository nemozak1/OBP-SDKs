...
| [**createMeetingWithHttpInfo**](ExperimentalApi.md#createMeetingWithHttpInfo) | **POST** /obp/v3.1.0/banks/{bankid}/meetings | Create Meeting (video conference/call) |
| [**getMeeting**](ExperimentalApi.md#getMeeting) | **GET** /obp/v3.1.0/banks/{bankid}/meetings/{meetingid} | Get Meeting |
| [**getMeetingWithHttpInfo**](ExperimentalApi.md#getMeetingWithHttpInfo) | **GET** /obp/v3.1.0/banks/{bankid}/meetings/{meetingid} | Get Meeting |
| [**getMeetings**](ExperimentalApi.md#getMeetings) | **GET** /obp/v3.1.0/banks/{bankid}/meetings | Get Meetings |
| [**getMeetingsWithHttpInfo**](ExperimentalApi.md#getMeetingsWithHttpInfo) | **GET** /obp/v3.1.0/banks/{bankid}/meetings | Get Meetings |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ExperimentalApi#createMeeting");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ExperimentalApi#getMeeting");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ExperimentalApi#getMeetings");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
