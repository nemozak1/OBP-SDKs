...
| [**addCustomerMessageWithHttpInfo**](PersonApi.md#addCustomerMessageWithHttpInfo) | **POST** /obp/v1.4.0/banks/{bankid}/customer/{customerid}/messages | Create Customer Message |
| [**createAgent**](PersonApi.md#createAgent) | **POST** /obp/v5.1.0/banks/{bankid}/agents | Create Agent |
| [**createAgentWithHttpInfo**](PersonApi.md#createAgentWithHttpInfo) | **POST** /obp/v5.1.0/banks/{bankid}/agents | Create Agent |
| [**createCustomer**](PersonApi.md#createCustomer) | **POST** /obp/v6.0.0/banks/{bankid}/customers | Create Customer |
| [**createCustomerWithHttpInfo**](PersonApi.md#createCustomerWithHttpInfo) | **POST** /obp/v6.0.0/banks/{bankid}/customers | Create Customer |
...
| [**createCustomerMessageWithHttpInfo**](PersonApi.md#createCustomerMessageWithHttpInfo) | **POST** /obp/v4.0.0/banks/{bankid}/customers/{customerid}/messages | Create Customer Message |
| [**updateAgentStatus**](PersonApi.md#updateAgentStatus) | **PUT** /obp/v5.1.0/banks/{bankid}/agents/{agentid} | Update Agent status |
| [**updateAgentStatusWithHttpInfo**](PersonApi.md#updateAgentStatusWithHttpInfo) | **PUT** /obp/v5.1.0/banks/{bankid}/agents/{agentid} | Update Agent status |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling PersonApi#addCustomerMessage");
...
public class Example {
    public static void main(String[] args) {
        ...
        PersonApi apiInstance = new PersonApi(defaultClient);
        String bankid = "bankid_example"; // String | The BANKID identifier
        CreateAgentRequest createAgentRequest = new CreateAgentRequest(); // CreateAgentRequest | Request body
        try {
            GetAgent200Response result = apiInstance.createAgent(bankid, createAgentRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PersonApi#createAgent");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> ApiResponse<GetAgent200Response> createAgent createAgentWithHttpInfo(bankid, createAgentRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateAgentRequest createAgentRequest = new CreateAgentRequest(); // CreateAgentRequest | Request body
        try {
            ApiResponse<GetAgent200Response> response = apiInstance.createAgentWithHttpInfo(bankid, createAgentRequest);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**GetAgent200Response**](GetAgent200Response.md)>
...
public class Example {
    public static void main(String[] args) {
        ...
        PersonApi apiInstance = new PersonApi(defaultClient);
        String bankid = "bankid_example"; // String | The BANKID identifier
        CreateCustomerRequest createCustomerRequest = new CreateCustomerRequest(); // CreateCustomerRequest | Request body
        try {
            GetCustomerChildren200ResponseCustomersInner result = apiInstance.createCustomer(bankid, createCustomerRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PersonApi#createCustomer");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> ApiResponse<GetCustomerChildren200ResponseCustomersInner> createCustomer createCustomerWithHttpInfo(bankid, createCustomerRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        CreateCustomerRequest createCustomerRequest = new CreateCustomerRequest(); // CreateCustomerRequest | Request body
        try {
            ApiResponse<GetCustomerChildren200ResponseCustomersInner> response = apiInstance.createCustomerWithHttpInfo(bankid, createCustomerRequest);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling PersonApi#createCustomerMessage");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
public class Example {
    public static void main(String[] args) {
        ...
        UpdateAgentStatusRequest updateAgentStatusRequest = new UpdateAgentStatusRequest(); // UpdateAgentStatusRequest | Request body
        try {
            GetAgent200Response result = apiInstance.updateAgentStatus(bankid, agentid, updateAgentStatusRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PersonApi#updateAgentStatus");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## updateAgentStatusWithHttpInfo

> ApiResponse<GetAgent200Response> updateAgentStatus updateAgentStatusWithHttpInfo(bankid, agentid, updateAgentStatusRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        UpdateAgentStatusRequest updateAgentStatusRequest = new UpdateAgentStatusRequest(); // UpdateAgentStatusRequest | Request body
        try {
            ApiResponse<GetAgent200Response> response = apiInstance.updateAgentStatusWithHttpInfo(bankid, agentid, updateAgentStatusRequest);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
